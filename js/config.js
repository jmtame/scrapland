"use strict";
/* SCRAPLAND — game constants: tile/world size and the colour palette.
   The game is a set of classic scripts sharing one global scope, loaded in order by index.html. */

const TILE = 64;                        // grid / building cell size (world px)
const WORLD = { w: 13824, h: 9216 };    // map size (world px)
const PLAYER_R = 16;                    // player collision radius
const GATHER_RANGE = 64;                // max distance to harvest a resource node

/* Colour palette, grouped by what it paints. */
const COL = {
