...
`)}var a1={[yd]:"Linear",[_d]:"Reinhard",[vd]:"Cineon",[Md]:"ACESFilmic",[wd]:"AgX",[Td]:"Neutral",[bd]:"Custom"};function l1(n,e){let t=a1[e];return t===void 0?(Qe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Uc=new F;function c1(){mt.getLuminanceCoefficients(Uc);let n=Uc.x.toFixed(4),e=Uc.y.toFixed(4),t=Uc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+g);let v=y+m+o,M=y+g+a,A=Vm(s,s.VERTEX_SHADER,v),E=Vm(s,s.FRAGMENT_SHADER,M);s.attachShader(x,A),s.attachShader(x,E),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function P(C){if(n.debug.checkShaderErrors){let N=s.getProgramInfoLog(x)||"",W=s.getShaderInfoLog(A)||"",Y=s.getShaderInfoLog(E)||"",U=N.trim(),H=W.trim(),$=Y.trim(),le=!0,he=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(le=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,A,E);else{let ye=Wm(s,A,"vertex"),Ce=Wm(s,E,"fragment");je("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,V1=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],G1=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],jm=new gt,Qo=new F,Gd=new F;function W1(n,e,t){let i=new yr,s=new Pe,r=new Pe,o=new Kt,a=new Il,l=new Pl,c={},d=t.maxTextureSize,h={[Fi]:xn,[xn]:Fi,[In]:In},f=new Bn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pe},radius:{value:4}},vertexShader:z1,fragmentShader:H1}),u=f.clone();u.defines.HORIZONTAL_PASS=1;let p=new qt;p.setAttribute("position",new en(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new ge(p,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Go;let g=this.type;this.render=function(E,P,_){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;this.type===Gp&&(Qe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Go);let b=n.getRenderTarget(),S=n.getActiveCubeFace(),C=n.getActiveMipmapLevel(),N=n.state;N.setBlending(_i),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);let W=g!==this.type;W&&P.traverse(function(Y){Y.material&&(Array.isArray(Y.material)?Y.material.forEach(U=>U.needsUpdate=!0):Y.material.needsUpdate=!0)});for(let Y=0,U=E.length;Y<U;Y++){let H=E[Y],$=H.shadow;if($===void 0){Qe("WebGLShadowMap:",H,"has no shadow.");continue}if($.autoUpdate===!1&&$.needsUpdate===!1)continue;s.copy($.mapSize);let le=$.getFrameExtents();s.multiply(le),r.copy($.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/le.x),s.x=r.x*le.x,$.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/le.y),s.y=r.y*le.y,$.mapSize.y=r.y));let he=n.state.buffers.depth.getReversed();if($.camera._reversedDepth=he,$.map===null||W===!0){if($.map!==null&&($.map.depthTexture!==null&&($.map.depthTexture.dispose(),$.map.depthTexture=null),$.map.dispose()),this.type===wr){if(H.isPointLight){Qe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}$.map=new Fn(s.x,s.y,{format:ds,type:Mi,minFilter:gn,magFilter:gn,generateMipmaps:!1}),$.map.texture.name=H.name+".shadowMap",$.map.depthTexture=new Hi(s.x,s.y,Zn),$.map.depthTexture.name=H.name+".shadowMapDepth",$.map.depthTexture.format=fi,$.map.depthTexture.compareFunction=null,$.map.depthTexture.minFilter=pn,$.map.depthTexture.magFilter=pn}else H.isPointLight?($.map=new Fc(s.x),$.map.depthTexture=new Ml(s.x,ii)):($.map=new Fn(s.x,s.y),$.map.depthTexture=new Hi(s.x,s.y,ii)),$.map.depthTexture.name=H.name+".shadowMap",$.map.depthTexture.format=fi,this.type===Go?($.map.depthTexture.compareFunction=he?Lc:Dc,$.map.depthTexture.minFilter=gn,$.map.depthTexture.magFilter=gn):($.map.depthTexture.compareFunction=null,$.map.depthTexture.minFilter=pn,$.map.depthTexture.magFilter=pn);$.camera.updateProjectionMatrix()}let ye=$.map.isWebGLCubeRenderTarget?6:1;for(let Ce=0;Ce<ye;Ce++){if($.map.isWebGLCubeRenderTarget)n.setRenderTarget($.map,Ce),n.clear();else{Ce===0&&(n.setRenderTarget($.map),n.clear());let Ue=$.getViewport(Ce);o.set(r.x*Ue.x,r.y*Ue.y,r.x*Ue.z,r.y*Ue.w),N.viewport(o)}if(H.isPointLight){let Ue=$.camera,Ke=$.matrix,ie=H.distance||Ue.far;ie!==Ue.far&&(Ue.far=ie,Ue.updateProjectionMatrix()),Qo.setFromMatrixPosition(H.matrixWorld),Ue.position.copy(Qo),Gd.copy(Ue.position),Gd.add(V1[Ce]),Ue.up.copy(G1[Ce]),Ue.lookAt(Gd),Ue.updateMatrixWorld(),Ke.makeTranslation(-Qo.x,-Qo.y,-Qo.z),jm.multiplyMatrices(Ue.projectionMatrix,Ue.matrixWorldInverse),$._frustum.setFromProjectionMatrix(jm,Ue.coordinateSystem,Ue.reversedDepth)}else $.updateMatrices(H);i=$.getFrustum(),M(P,_,$.camera,H,this.type)}$.isPointLightShadow!==!0&&this.type===wr&&y($,_),$.needsUpdate=!1}g=this.type,m.needsUpdate=!1,n.setRenderTarget(b,S,C)};function y(E,P){let _=e.update(x);f.defines.VSM_SAMPLES!==E.blurSamples&&(f.defines.VSM_SAMPLES=E.blurSamples,u.defines.VSM_SAMPLES=E.blurSamples,f.needsUpdate=!0,u.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new Fn(s.x,s.y,{format:ds,type:Mi})),f.uniforms.shadow_pass.value=E.map.depthTexture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,n.setRenderTarget(E.mapPass),n.clear(),n.renderBufferDirect(P,null,_,f,x,null),u.uniforms.shadow_pass.value=E.mapPass.texture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,n.setRenderTarget(E.map),n.clear(),n.renderBufferDirect(P,null,_,u,x,null)}function v(E,P,_,b){let S=null,C=_.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(C!==void 0)S=C;else if(S=_.isPointLight===!0?l:a,n.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){let N=S.uuid,W=P.uuid,Y=c[N];Y===void 0&&(Y={},c[N]=Y);let U=Y[W];U===void 0&&(U=S.clone(),Y[W]=U,P.addEventListener("dispose",A)),S=U}if(S.visible=P.visible,S.wireframe=P.wireframe,b===wr?S.side=P.shadowSide!==null?P.shadowSide:P.side:S.side=P.shadowSide!==null?P.shadowSide:h[P.side],S.alphaMap=P.alphaMap,S.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,S.map=P.map,S.clipShadows=P.clipShadows,S.clippingPlanes=P.clippingPlanes,S.clipIntersection=P.clipIntersection,S.displacementMap=P.displacementMap,S.displacementScale=P.displacementScale,S.displacementBias=P.displacementBias,S.wireframeLinewidth=P.wireframeLinewidth,S.linewidth=P.linewidth,_.isPointLight===!0&&S.isMeshDistanceMaterial===!0){let N=n.properties.get(S);N.light=_}return S}function M(E,P,_,b,S){if(E.visible===!1)return;if(E.layers.test(P.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&S===wr)&&(!E.frustumCulled||i.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,E.matrixWorld);let W=e.update(E),Y=E.material;if(Array.isArray(Y)){let U=W.groups;for(let H=0,$=U.length;H<$;H++){let le=U[H],he=Y[le.materialIndex];if(he&&he.visible){let ye=v(E,he,b,S);E.onBeforeShadow(n,E,P,_,W,ye,le),n.renderBufferDirect(_,null,W,ye,E,le),E.onAfterShadow(n,E,P,_,W,ye,le)}}}else if(Y.visible){let U=v(E,Y,b,S);E.onBeforeShadow(n,E,P,_,W,U,null),n.renderBufferDirect(_,null,W,U,E,null),E.onAfterShadow(n,E,P,_,W,U,null)}}let N=E.children;for(let W=0,Y=N.length;W<Y;W++)M(N[W],P,_,b,S)}function A(E){E.target.removeEventListener("dispose",A);for(let _ in c){let b=c[_],S=E.target.uuid;S in b&&(b[S].dispose(),delete b[S])}}}function X1(n,e){function t(){let V=!1,Te=new Kt,ce=null,ke=new Kt(0,0,0,0);return{setMask:function(Re){ce!==Re&&!V&&(n.colorMask(Re,Re,Re,Re),ce=Re)},setLocked:function(Re){V=Re},setClear:function(Re,xe,Ge,ot,tn){tn===!0&&(Re*=ot,xe*=ot,Ge*=ot),Te.set(Re,xe,Ge,ot),ke.equals(Te)===!1&&(n.clearColor(Re,xe,Ge,ot),ke.copy(Te))},reset:function(){V=!1,ce=null,ke.set(-1,0,0,0)}}}function i(){let V=!1,Te=!1,ce=null,ke=null,Re=null;return{setReversed:function(xe){if(Te!==xe){let Ge=e.get("EXT_clip_control");xe?Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.ZERO_TO_ONE_EXT):Ge.clipControlEXT(Ge.LOWER_LEFT_EXT,Ge.NEGATIVE_ONE_TO_ONE_EXT),Te=xe;let ot=Re;Re=null,this.setClear(ot)}},getReversed:function(){return Te},setTest:function(xe){xe?k(n.DEPTH_TEST):D(n.DEPTH_TEST)},setMask:function(xe){ce!==xe&&!V&&(n.depthMask(xe),ce=xe)},setFunc:function(xe){if(Te&&(xe=bm[xe]),ke!==xe){switch(xe){case rl:n.depthFunc(n.NEVER);break;case ol:n.depthFunc(n.ALWAYS);break;case al:n.depthFunc(n.LESS);break;case Rs:n.depthFunc(n.LEQUAL);break;case ll:n.depthFunc(n.EQUAL);break;case cl:n.depthFunc(n.GEQUAL);break;case hl:n.depthFunc(n.GREATER);break;case dl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ke=xe}},setLocked:function(xe){V=xe},setClear:function(xe){Re!==xe&&(Re=xe,Te&&(xe=1-xe),n.clearDepth(xe))},reset:function(){V=!1,ce=null,ke=null,Re=null,Te=!1}}}function s(){let V=!1,Te=null,ce=null,ke=null,Re=null,xe=null,Ge=null,ot=null,tn=null;return{setTest:function(It){V||(It?k(n.STENCIL_TEST):D(n.STENCIL_TEST))},setMask:function(It){Te!==It&&!V&&(n.stencilMask(It),Te=It)},setFunc:function(It,Ti,si){(ce!==It||ke!==Ti||Re!==si)&&(n.stencilFunc(It,Ti,si),ce=It,ke=Ti,Re=si)},setOp:function(It,Ti,si){(xe!==It||Ge!==Ti||ot!==si)&&(n.stencilOp(It,Ti,si),xe=It,Ge=Ti,ot=si)},setLocked:function(It){V=It},setClear:function(It){tn!==It&&(n.clearStencil(It),tn=It)},reset:function(){V=!1,Te=null,ce=null,ke=null,Re=null,xe=null,Ge=null,ot=null,tn=null}}}let r=new t,o=new i,a=new s,l=new WeakMap,c=new WeakMap,d={},h={},f={},u=new WeakMap,p=[],x=null,m=!1,g=null,y=null,v=null,M=null,A=null,E=null,P=null,_=new nt(0,0,0),b=0,S=!1,C=null,N=null,W=null,Y=null,U=null,H=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),$=!1,le=0,he=n.getParameter(n.VERSION);he.indexOf("WebGL")!==-1?(le=parseFloat(/^WebGL (\d)/.exec(he)[1]),$=le>=1):he.indexOf("OpenGL ES")!==-1&&(le=parseFloat(/^OpenGL ES (\d)/.exec(he)[1]),$=le>=2);let ye=null,Ce={},Ue=n.getParameter(n.SCISSOR_BOX),Ke=n.getParameter(n.VIEWPORT),ie=new Kt().fromArray(Ue),ne=new Kt().fromArray(Ke);function B(V,Te,ce,ke){let Re=new Uint8Array(4),xe=n.createTexture();n.bindTexture(V,xe),n.texParameteri(V,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(V,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ge=0;Ge<ce;Ge++)V===n.TEXTURE_3D||V===n.TEXTURE_2D_ARRAY?n.texImage3D(Te,0,n.RGBA,1,1,ke,0,n.RGBA,n.UNSIGNED_BYTE,Re):n.texImage2D(Te+Ge,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Re);return xe}let O={};O[n.TEXTURE_2D]=B(n.TEXTURE_2D,n.TEXTURE_2D,1),O[n.TEXTURE_CUBE_MAP]=B(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),O[n.TEXTURE_2D_ARRAY]=B(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),O[n.TEXTURE_3D]=B(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),k(n.DEPTH_TEST),o.setFunc(Rs),Ee(!1),ze(md),k(n.CULL_FACE),re(_i);function k(V){d[V]!==!0&&(n.enable(V),d[V]=!0)}function D(V){d[V]!==!1&&(n.disable(V),d[V]=!1)}function L(V,Te){return f[V]!==Te?(n.bindFramebuffer(V,Te),f[V]=Te,V===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=Te),V===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=Te),!0):!1}function se(V,Te){let ce=p,ke=!1;if(V){ce=u.get(Te),ce===void 0&&(ce=[],u.set(Te,ce));let Re=V.textures;if(ce.length!==Re.length||ce[0]!==n.COLOR_ATTACHMENT0){for(let xe=0,Ge=Re.length;xe<Ge;xe++)ce[xe]=n.COLOR_ATTACHMENT0+xe;ce.length=Re.length,ke=!0}}else ce[0]!==n.BACK&&(ce[0]=n.BACK,ke=!0);ke&&n.drawBuffers(ce)}function T(V){return x!==V?(n.useProgram(V),x=V,!0):!1}let X={[is]:n.FUNC_ADD,[Xp]:n.FUNC_SUBTRACT,[qp]:n.FUNC_REVERSE_SUBTRACT};X[Yp]=n.MIN,X[Zp]=n.MAX;let q={[$p]:n.ZERO,[Kp]:n.ONE,[Jp]:n.SRC_COLOR,[il]:n.SRC_ALPHA,[im]:n.SRC_ALPHA_SATURATE,[tm]:n.DST_COLOR,[Qp]:n.DST_ALPHA,[jp]:n.ONE_MINUS_SRC_COLOR,[sl]:n.ONE_MINUS_SRC_ALPHA,[nm]:n.ONE_MINUS_DST_COLOR,[em]:n.ONE_MINUS_DST_ALPHA,[sm]:n.CONSTANT_COLOR,[rm]:n.ONE_MINUS_CONSTANT_COLOR,[om]:n.CONSTANT_ALPHA,[am]:n.ONE_MINUS_CONSTANT_ALPHA};function re(V,Te,ce,ke,Re,xe,Ge,ot,tn,It){if(V===_i){m===!0&&(D(n.BLEND),m=!1);return}if(m===!1&&(k(n.BLEND),m=!0),V!==Wp){if(V!==g||It!==S){if((y!==is||A!==is)&&(n.blendEquation(n.FUNC_ADD),y=is,A=is),It)switch(V){case ns:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wn:n.blendFunc(n.ONE,n.ONE);break;case gd:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case xd:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:je("WebGLState: Invalid blending: ",V);break}else switch(V){case ns:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case wn:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case gd:je("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case xd:je("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:je("WebGLState: Invalid blending: ",V);break}v=null,M=null,E=null,P=null,_.set(0,0,0),b=0,g=V,S=It}return}Re=Re||Te,xe=xe||ce,Ge=Ge||ke,(Te!==y||Re!==A)&&(n.blendEquationSeparate(X[Te],X[Re]),y=Te,A=Re),(ce!==v||ke!==M||xe!==E||Ge!==P)&&(n.blendFuncSeparate(q[ce],q[ke],q[xe],q[Ge]),v=ce,M=ke,E=xe,P=Ge),(ot.equals(_)===!1||tn!==b)&&(n.blendColor(ot.r,ot.g,ot.b,tn),_.copy(ot),b=tn),g=V,S=!1}function Q(V,Te){V.side===In?D(n.CULL_FACE):k(n.CULL_FACE);let ce=V.side===xn;Te&&(ce=!ce),Ee(ce),V.blending===ns&&V.transparent===!1?re(_i):re(V.blending,V.blendEquation,V.blendSrc,V.blendDst,V.blendEquationAlpha,V.blendSrcAlpha,V.blendDstAlpha,V.blendColor,V.blendAlpha,V.premultipliedAlpha),o.setFunc(V.depthFunc),o.setTest(V.depthTest),o.setMask(V.depthWrite),r.setMask(V.colorWrite);let ke=V.stencilWrite;a.setTest(ke),ke&&(a.setMask(V.stencilWriteMask),a.setFunc(V.stencilFunc,V.stencilRef,V.stencilFuncMask),a.setOp(V.stencilFail,V.stencilZFail,V.stencilZPass)),z(V.polygonOffset,V.polygonOffsetFactor,V.polygonOffsetUnits),V.alphaToCoverage===!0?k(n.SAMPLE_ALPHA_TO_COVERAGE):D(n.SAMPLE_ALPHA_TO_COVERAGE)}function Ee(V){C!==V&&(V?n.frontFace(n.CW):n.frontFace(n.CCW),C=V)}function ze(V){V!==Hp?(k(n.CULL_FACE),V!==N&&(V===md?n.cullFace(n.BACK):V===Vp?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):D(n.CULL_FACE),N=V}function Ve(V){V!==W&&($&&n.lineWidth(V),W=V)}function z(V,Te,ce){V?(k(n.POLYGON_OFFSET_FILL),(Y!==Te||U!==ce)&&(Y=Te,U=ce,o.getReversed()&&(Te=-Te),n.polygonOffset(Te,ce))):D(n.POLYGON_OFFSET_FILL)}function tt(V){V?k(n.SCISSOR_TEST):D(n.SCISSOR_TEST)}function et(V){V===void 0&&(V=n.TEXTURE0+H-1),ye!==V&&(n.activeTexture(V),ye=V)}function xt(V,Te,ce){ce===void 0&&(ye===null?ce=n.TEXTURE0+H-1:ce=ye);let ke=Ce[ce];ke===void 0&&(ke={type:void 0,texture:void 0},Ce[ce]=ke),(ke.type!==V||ke.texture!==Te)&&(ye!==ce&&(n.activeTexture(ce),ye=ce),n.bindTexture(V,Te||O[V]),ke.type=V,ke.texture=Te)}function Me(){let V=Ce[ye];V!==void 0&&V.type!==void 0&&(n.bindTexture(V.type,null),V.type=void 0,V.texture=void 0)}function St(){try{n.compressedTexImage2D(...arguments)}catch(V){je("WebGLState:",V)}}function I(){try{n.compressedTexImage3D(...arguments)}catch(V){je("WebGLState:",V)}}function w(){try{n.texSubImage2D(...arguments)}catch(V){je("WebGLState:",V)}}function K(){try{n.texSubImage3D(...arguments)}catch(V){je("WebGLState:",V)}}function ae(){try{n.compressedTexSubImage2D(...arguments)}catch(V){je("WebGLState:",V)}}function pe(){try{n.compressedTexSubImage3D(...arguments)}catch(V){je("WebGLState:",V)}}function ve(){try{n.texStorage2D(...arguments)}catch(V){je("WebGLState:",V)}}function be(){try{n.texStorage3D(...arguments)}catch(V){je("WebGLState:",V)}}function oe(){try{n.texImage2D(...arguments)}catch(V){je("WebGLState:",V)}}function de(){try{n.texImage3D(...arguments)}catch(V){je("WebGLState:",V)}}function Le(V){return h[V]!==void 0?h[V]:n.getParameter(V)}function Oe(V,Te){h[V]!==Te&&(n.pixelStorei(V,Te),h[V]=Te)}function Ae(V){ie.equals(V)===!1&&(n.scissor(V.x,V.y,V.z,V.w),ie.copy(V))}function we(V){ne.equals(V)===!1&&(n.viewport(V.x,V.y,V.z,V.w),ne.copy(V))}function st(V,Te){let ce=c.get(Te);ce===void 0&&(ce=new WeakMap,c.set(Te,ce));let ke=ce.get(V);ke===void 0&&(ke=n.getUniformBlockIndex(Te,V.name),ce.set(V,ke))}function lt(V,Te){let ke=c.get(Te).get(V);l.get(Te)!==ke&&(n.uniformBlockBinding(Te,ke,V.__bindingPointIndex),l.set(Te,ke))}function bt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),d={},h={},ye=null,Ce={},f={},u=new WeakMap,p=[],x=null,m=!1,g=null,y=null,v=null,M=null,A=null,E=null,P=null,_=new nt(0,0,0),b=0,S=!1,C=null,N=null,W=null,Y=null,U=null,ie.set(0,0,n.canvas.width,n.canvas.height),ne.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:k,disable:D,bindFramebuffer:L,drawBuffers:se,useProgram:T,setBlending:re,setMaterial:Q,setFlipSided:Ee,setCullFace:ze,setLineWidth:Ve,setPolygonOffset:z,setScissorTest:tt,activeTexture:et,bindTexture:xt,unbindTexture:Me,compressedTexImage2D:St,compressedTexImage3D:I,texImage2D:oe,texImage3D:de,pixelStorei:Oe,getParameter:Le,updateUBOMapping:st,uniformBlockBinding:lt,texStorage2D:ve,texStorage3D:be,texSubImage2D:w,texSubImage3D:K,compressedTexSubImage2D:ae,compressedTexSubImage3D:pe,scissor:Ae,viewport:we,reset:bt}}function q1(n,e,t,i,s,r,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Pe,d=new WeakMap,h=new Set,f,u=new WeakMap,p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(I,w){return p?new OffscreenCanvas(I,w):po("canvas")}function m(I,w,K){let ae=1,pe=St(I);if((pe.width>K||pe.height>K)&&(ae=K/Math.max(pe.width,pe.height)),ae<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){let ve=Math.floor(ae*pe.width),be=Math.floor(ae*pe.height);f===void 0&&(f=x(ve,be));let oe=w?x(ve,be):f;return oe.width=ve,oe.height=be,oe.getContext("2d").drawImage(I,0,0,ve,be),Qe("WebGLRenderer: Texture has been resized from ("+pe.width+"x"+pe.height+") to ("+ve+"x"+be+")."),oe}else return"data"in I&&Qe("WebGLRenderer: Image in DataTexture is too big ("+pe.width+"x"+pe.height+")."),I;return I}function g(I){return I.generateMipmaps}function y(I){n.generateMipmap(I)}function v(I){return I.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?n.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function M(I,w,K,ae,pe,ve=!1){if(I!==null){if(n[I]!==void 0)return n[I];Qe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let be;ae&&(be=e.get("EXT_texture_norm16"),be||Qe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let oe=w;if(w===n.RED&&(K===n.FLOAT&&(oe=n.R32F),K===n.HALF_FLOAT&&(oe=n.R16F),K===n.UNSIGNED_BYTE&&(oe=n.R8),K===n.UNSIGNED_SHORT&&be&&(oe=be.R16_EXT),K===n.SHORT&&be&&(oe=be.R16_SNORM_EXT)),w===n.RED_INTEGER&&(K===n.UNSIGNED_BYTE&&(oe=n.R8UI),K===n.UNSIGNED_SHORT&&(oe=n.R16UI),K===n.UNSIGNED_INT&&(oe=n.R32UI),K===n.BYTE&&(oe=n.R8I),K===n.SHORT&&(oe=n.R16I),K===n.INT&&(oe=n.R32I)),w===n.RG&&(K===n.FLOAT&&(oe=n.RG32F),K===n.HALF_FLOAT&&(oe=n.RG16F),K===n.UNSIGNED_BYTE&&(oe=n.RG8),K===n.UNSIGNED_SHORT&&be&&(oe=be.RG16_EXT),K===n.SHORT&&be&&(oe=be.RG16_SNORM_EXT)),w===n.RG_INTEGER&&(K===n.UNSIGNED_BYTE&&(oe=n.RG8UI),K===n.UNSIGNED_SHORT&&(oe=n.RG16UI),K===n.UNSIGNED_INT&&(oe=n.RG32UI),K===n.BYTE&&(oe=n.RG8I),K===n.SHORT&&(oe=n.RG16I),K===n.INT&&(oe=n.RG32I)),w===n.RGB_INTEGER&&(K===n.UNSIGNED_BYTE&&(oe=n.RGB8UI),K===n.UNSIGNED_SHORT&&(oe=n.RGB16UI),K===n.UNSIGNED_INT&&(oe=n.RGB32UI),K===n.BYTE&&(oe=n.RGB8I),K===n.SHORT&&(oe=n.RGB16I),K===n.INT&&(oe=n.RGB32I)),w===n.RGBA_INTEGER&&(K===n.UNSIGNED_BYTE&&(oe=n.RGBA8UI),K===n.UNSIGNED_SHORT&&(oe=n.RGBA16UI),K===n.UNSIGNED_INT&&(oe=n.RGBA32UI),K===n.BYTE&&(oe=n.RGBA8I),K===n.SHORT&&(oe=n.RGBA16I),K===n.INT&&(oe=n.RGBA32I)),w===n.RGB&&(K===n.UNSIGNED_SHORT&&be&&(oe=be.RGB16_EXT),K===n.SHORT&&be&&(oe=be.RGB16_SNORM_EXT),K===n.UNSIGNED_INT_5_9_9_9_REV&&(oe=n.RGB9_E5),K===n.UNSIGNED_INT_10F_11F_11F_REV&&(oe=n.R11F_G11F_B10F)),w===n.RGBA){let de=ve?uo:mt.getTransfer(pe);K===n.FLOAT&&(oe=n.RGBA32F),K===n.HALF_FLOAT&&(oe=n.RGBA16F),K===n.UNSIGNED_BYTE&&(oe=de===Rt?n.SRGB8_ALPHA8:n.RGBA8),K===n.UNSIGNED_SHORT&&be&&(oe=be.RGBA16_EXT),K===n.SHORT&&be&&(oe=be.RGBA16_SNORM_EXT),K===n.UNSIGNED_SHORT_4_4_4_4&&(oe=n.RGBA4),K===n.UNSIGNED_SHORT_5_5_5_1&&(oe=n.RGB5_A1)}return(oe===n.R16F||oe===n.R32F||oe===n.RG16F||oe===n.RG32F||oe===n.RGBA16F||oe===n.RGBA32F)&&e.get("EXT_color_buffer_float"),oe}function A(I,w){let K;return I?w===null||w===ii||w===Er?K=n.DEPTH24_STENCIL8:w===Zn?K=n.DEPTH32F_STENCIL8:w===Tr&&(K=n.DEPTH24_STENCIL8,Qe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):w===null||w===ii||w===Er?K=n.DEPTH_COMPONENT24:w===Zn?K=n.DEPTH_COMPONENT32F:w===Tr&&(K=n.DEPTH_COMPONENT16),K}function E(I,w){return g(I)===!0||I.isFramebufferTexture&&I.minFilter!==pn&&I.minFilter!==gn?Math.log2(Math.max(w.width,w.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?w.mipmaps.length:1}function P(I){let w=I.target;w.removeEventListener("dispose",P),b(w),w.isVideoTexture&&d.delete(w),w.isHTMLTexture&&h.delete(w)}function _(I){let w=I.target;w.removeEventListener("dispose",_),C(w)}function b(I){let w=i.get(I);if(w.__webglInit===void 0)return;let K=I.source,ae=u.get(K);if(ae){let pe=ae[w.__cacheKey];pe.usedTimes--,pe.usedTimes===0&&S(I),Object.keys(ae).length===0&&u.delete(K)}i.remove(I)}function S(I){let w=i.get(I);n.deleteTexture(w.__webglTexture);let K=I.source,ae=u.get(K);delete ae[w.__cacheKey],o.memory.textures--}function C(I){let w=i.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),i.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let ae=0;ae<6;ae++){if(Array.isArray(w.__webglFramebuffer[ae]))for(let pe=0;pe<w.__webglFramebuffer[ae].length;pe++)n.deleteFramebuffer(w.__webglFramebuffer[ae][pe]);else n.deleteFramebuffer(w.__webglFramebuffer[ae]);w.__webglDepthbuffer&&n.deleteRenderbuffer(w.__webglDepthbuffer[ae])}else{if(Array.isArray(w.__webglFramebuffer))for(let ae=0;ae<w.__webglFramebuffer.length;ae++)n.deleteFramebuffer(w.__webglFramebuffer[ae]);else n.deleteFramebuffer(w.__webglFramebuffer);if(w.__webglDepthbuffer&&n.deleteRenderbuffer(w.__webglDepthbuffer),w.__webglMultisampledFramebuffer&&n.deleteFramebuffer(w.__webglMultisampledFramebuffer),w.__webglColorRenderbuffer)for(let ae=0;ae<w.__webglColorRenderbuffer.length;ae++)w.__webglColorRenderbuffer[ae]&&n.deleteRenderbuffer(w.__webglColorRenderbuffer[ae]);w.__webglDepthRenderbuffer&&n.deleteRenderbuffer(w.__webglDepthRenderbuffer)}let K=I.textures;for(let ae=0,pe=K.length;ae<pe;ae++){let ve=i.get(K[ae]);ve.__webglTexture&&(n.deleteTexture(ve.__webglTexture),o.memory.textures--),i.remove(K[ae])}i.remove(I)}let N=0;function W(){N=0}function Y(){return N}function U(I){N=I}function H(){let I=N;return I>=s.maxTextures&&Qe("WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+s.maxTextures),N+=1,I}function $(I){let w=[];return w.push(I.wrapS),w.push(I.wrapT),w.push(I.wrapR||0),w.push(I.magFilter),w.push(I.minFilter),w.push(I.anisotropy),w.push(I.internalFormat),w.push(I.format),w.push(I.type),w.push(I.generateMipmaps),w.push(I.premultiplyAlpha),w.push(I.flipY),w.push(I.unpackAlignment),w.push(I.colorSpace),w.join()}function le(I,w){let K=i.get(I);if(I.isVideoTexture&&xt(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&K.__version!==I.version){let ae=I.image;if(ae===null)Qe("WebGLRenderer: Texture marked for update but no image data found.");else if(ae.complete===!1)Qe("WebGLRenderer: Texture marked for update but image is incomplete");else{D(K,I,w);return}}else I.isExternalTexture&&(K.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,K.__webglTexture,n.TEXTURE0+w)}function he(I,w){let K=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&K.__version!==I.version){D(K,I,w);return}else I.isExternalTexture&&(K.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,K.__webglTexture,n.TEXTURE0+w)}function ye(I,w){let K=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&K.__version!==I.version){D(K,I,w);return}t.bindTexture(n.TEXTURE_3D,K.__webglTexture,n.TEXTURE0+w)}function Ce(I,w){let K=i.get(I);if(I.isCubeDepthTexture!==!0&&I.version>0&&K.__version!==I.version){L(K,I,w);return}t.bindTexture(n.TEXTURE_CUBE_MAP,K.__webglTexture,n.TEXTURE0+w)}let Ue={[di]:n.REPEAT,[hi]:n.CLAMP_TO_EDGE,[fl]:n.MIRRORED_REPEAT},Ke={[pn]:n.NEAREST,[hm]:n.NEAREST_MIPMAP_NEAREST,[Xo]:n.NEAREST_MIPMAP_LINEAR,[gn]:n.LINEAR,[Yl]:n.LINEAR_MIPMAP_NEAREST,[vi]:n.LINEAR_MIPMAP_LINEAR},ie={[um]:n.NEVER,[ym]:n.ALWAYS,[pm]:n.LESS,[Dc]:n.LEQUAL,[mm]:n.EQUAL,[Lc]:n.GEQUAL,[gm]:n.GREATER,[xm]:n.NOTEQUAL};function ne(I,w){if(w.type===Zn&&e.has("OES_texture_float_linear")===!1&&(w.magFilter===gn||w.magFilter===Yl||w.magFilter===Xo||w.magFilter===vi||w.minFilter===gn||w.minFilter===Yl||w.minFilter===Xo||w.minFilter===vi)&&Qe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(I,n.TEXTURE_WRAP_S,Ue[w.wrapS]),n.texParameteri(I,n.TEXTURE_WRAP_T,Ue[w.wrapT]),(I===n.TEXTURE_3D||I===n.TEXTURE_2D_ARRAY)&&n.texParameteri(I,n.TEXTURE_WRAP_R,Ue[w.wrapR]),n.texParameteri(I,n.TEXTURE_MAG_FILTER,Ke[w.magFilter]),n.texParameteri(I,n.TEXTURE_MIN_FILTER,Ke[w.minFilter]),w.compareFunction&&(n.texParameteri(I,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(I,n.TEXTURE_COMPARE_FUNC,ie[w.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(w.magFilter===pn||w.minFilter!==Xo&&w.minFilter!==vi||w.type===Zn&&e.has("OES_texture_float_linear")===!1)return;if(w.anisotropy>1||i.get(w).__currentAnisotropy){let K=e.get("EXT_texture_filter_anisotropic");n.texParameterf(I,K.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(w.anisotropy,s.getMaxAnisotropy())),i.get(w).__currentAnisotropy=w.anisotropy}}}function B(I,w){let K=!1;I.__webglInit===void 0&&(I.__webglInit=!0,w.addEventListener("dispose",P));let ae=w.source,pe=u.get(ae);pe===void 0&&(pe={},u.set(ae,pe));let ve=$(w);if(ve!==I.__cacheKey){pe[ve]===void 0&&(pe[ve]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,K=!0),pe[ve].usedTimes++;let be=pe[I.__cacheKey];be!==void 0&&(pe[I.__cacheKey].usedTimes--,be.usedTimes===0&&S(w)),I.__cacheKey=ve,I.__webglTexture=pe[ve].texture}return K}function O(I,w,K){return Math.floor(Math.floor(I/K)/w)}function k(I,w,K,ae){let ve=I.updateRanges;if(ve.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,w.width,w.height,K,ae,w.data);else{ve.sort((Oe,Ae)=>Oe.start-Ae.start);let be=0;for(let Oe=1;Oe<ve.length;Oe++){let Ae=ve[be],we=ve[Oe],st=Ae.start+Ae.count,lt=O(we.start,w.width,4),bt=O(Ae.start,w.width,4);we.start<=st+1&&lt===bt&&O(we.start+we.count-1,w.width,4)===lt?Ae.count=Math.max(Ae.count,we.start+we.count-Ae.start):(++be,ve[be]=we)}ve.length=be+1;let oe=t.getParameter(n.UNPACK_ROW_LENGTH),de=t.getParameter(n.UNPACK_SKIP_PIXELS),Le=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,w.width);for(let Oe=0,Ae=ve.length;Oe<Ae;Oe++){let we=ve[Oe],st=Math.floor(we.start/4),lt=Math.ceil(we.count/4),bt=st%w.width,V=Math.floor(st/w.width),Te=lt,ce=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,bt),t.pixelStorei(n.UNPACK_SKIP_ROWS,V),t.texSubImage2D(n.TEXTURE_2D,0,bt,V,Te,ce,K,ae,w.data)}I.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,oe),t.pixelStorei(n.UNPACK_SKIP_PIXELS,de),t.pixelStorei(n.UNPACK_SKIP_ROWS,Le)}}function D(I,w,K){let ae=n.TEXTURE_2D;(w.isDataArrayTexture||w.isCompressedArrayTexture)&&(ae=n.TEXTURE_2D_ARRAY),w.isData3DTexture&&(ae=n.TEXTURE_3D);let pe=B(I,w),ve=w.source;t.bindTexture(ae,I.__webglTexture,n.TEXTURE0+K);let be=i.get(ve);if(ve.version!==be.__version||pe===!0){if(t.activeTexture(n.TEXTURE0+K),(typeof ImageBitmap<"u"&&w.image instanceof ImageBitmap)===!1){let ce=mt.getPrimaries(mt.workingColorSpace),ke=w.colorSpace===Vi?null:mt.getPrimaries(w.colorSpace),Re=w.colorSpace===Vi||ce===ke?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,w.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Re)}t.pixelStorei(n.UNPACK_ALIGNMENT,w.unpackAlignment);let de=m(w.image,!1,s.maxTextureSize);de=Me(w,de);let Le=r.convert(w.format,w.colorSpace),Oe=r.convert(w.type),Ae=M(w.internalFormat,Le,Oe,w.normalized,w.colorSpace,w.isVideoTexture);ne(ae,w);let we,st=w.mipmaps,lt=w.isVideoTexture!==!0,bt=be.__version===void 0||pe===!0,V=ve.dataReady,Te=E(w,de);if(w.isDepthTexture)Ae=A(w.format===hs,w.type),bt&&(lt?t.texStorage2D(n.TEXTURE_2D,1,Ae,de.width,de.height):t.texImage2D(n.TEXTURE_2D,0,Ae,de.width,de.height,0,Le,Oe,null));else if(w.isDataTexture)if(st.length>0){lt&&bt&&t.texStorage2D(n.TEXTURE_2D,Te,Ae,st[0].width,st[0].height);for(let ce=0,ke=st.length;ce<ke;ce++)we=st[ce],lt?V&&t.texSubImage2D(n.TEXTURE_2D,ce,0,0,we.width,we.height,Le,Oe,we.data):t.texImage2D(n.TEXTURE_2D,ce,Ae,we.width,we.height,0,Le,Oe,we.data);w.generateMipmaps=!1}else lt?(bt&&t.texStorage2D(n.TEXTURE_2D,Te,Ae,de.width,de.height),V&&k(w,de,Le,Oe)):t.texImage2D(n.TEXTURE_2D,0,Ae,de.width,de.height,0,Le,Oe,de.data);else if(w.isCompressedTexture)if(w.isCompressedArrayTexture){lt&&bt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Te,Ae,st[0].width,st[0].height,de.depth);for(let ce=0,ke=st.length;ce<ke;ce++)if(we=st[ce],w.format!==$n)if(Le!==null)if(lt){if(V)if(w.layerUpdates.size>0){let Re=Fd(we.width,we.height,w.format,w.type);for(let xe of w.layerUpdates){let Ge=we.data.subarray(xe*Re/we.data.BYTES_PER_ELEMENT,(xe+1)*Re/we.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ce,0,0,xe,we.width,we.height,1,Le,Ge)}w.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ce,0,0,0,we.width,we.height,de.depth,Le,we.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ce,Ae,we.width,we.height,de.depth,0,we.data,0,0);else Qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else lt?V&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ce,0,0,0,we.width,we.height,de.depth,Le,Oe,we.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ce,Ae,we.width,we.height,de.depth,0,Le,Oe,we.data)}else{lt&&bt&&t.texStorage2D(n.TEXTURE_2D,Te,Ae,st[0].width,st[0].height);for(let ce=0,ke=st.length;ce<ke;ce++)we=st[ce],w.format!==$n?Le!==null?lt?V&&t.compressedTexSubImage2D(n.TEXTURE_2D,ce,0,0,we.width,we.height,Le,we.data):t.compressedTexImage2D(n.TEXTURE_2D,ce,Ae,we.width,we.height,0,we.data):Qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):lt?V&&t.texSubImage2D(n.TEXTURE_2D,ce,0,0,we.width,we.height,Le,Oe,we.data):t.texImage2D(n.TEXTURE_2D,ce,Ae,we.width,we.height,0,Le,Oe,we.data)}else if(w.isDataArrayTexture)if(lt){if(bt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Te,Ae,de.width,de.height,de.depth),V)if(w.layerUpdates.size>0){let ce=Fd(de.width,de.height,w.format,w.type);for(let ke of w.layerUpdates){let Re=de.data.subarray(ke*ce/de.data.BYTES_PER_ELEMENT,(ke+1)*ce/de.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ke,de.width,de.height,1,Le,Oe,Re)}w.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,de.width,de.height,de.depth,Le,Oe,de.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ae,de.width,de.height,de.depth,0,Le,Oe,de.data);else if(w.isData3DTexture)lt?(bt&&t.texStorage3D(n.TEXTURE_3D,Te,Ae,de.width,de.height,de.depth),V&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,de.width,de.height,de.depth,Le,Oe,de.data)):t.texImage3D(n.TEXTURE_3D,0,Ae,de.width,de.height,de.depth,0,Le,Oe,de.data);else if(w.isFramebufferTexture){if(bt)if(lt)t.texStorage2D(n.TEXTURE_2D,Te,Ae,de.width,de.height);else{let ce=de.width,ke=de.height;for(let Re=0;Re<Te;Re++)t.texImage2D(n.TEXTURE_2D,Re,Ae,ce,ke,0,Le,Oe,null),ce>>=1,ke>>=1}}else if(w.isHTMLTexture){if("texElementImage2D"in n){let ce=n.canvas;if(ce.hasAttribute("layoutsubtree")||ce.setAttribute("layoutsubtree","true"),de.parentNode!==ce){ce.appendChild(de),h.add(w),ce.onpaint=ot=>{let tn=ot.changedElements;for(let It of h)tn.includes(It.image)&&(It.needsUpdate=!0)},ce.requestPaint();return}let ke=0,Re=n.RGBA,xe=n.RGBA,Ge=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,ke,Re,xe,Ge,de),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(st.length>0){if(lt&&bt){let ce=St(st[0]);t.texStorage2D(n.TEXTURE_2D,Te,Ae,ce.width,ce.height)}for(let ce=0,ke=st.length;ce<ke;ce++)we=st[ce],lt?V&&t.texSubImage2D(n.TEXTURE_2D,ce,0,0,Le,Oe,we):t.texImage2D(n.TEXTURE_2D,ce,Ae,Le,Oe,we);w.generateMipmaps=!1}else if(lt){if(bt){let ce=St(de);t.texStorage2D(n.TEXTURE_2D,Te,Ae,ce.width,ce.height)}V&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Le,Oe,de)}else t.texImage2D(n.TEXTURE_2D,0,Ae,Le,Oe,de);g(w)&&y(ae),be.__version=ve.version,w.onUpdate&&w.onUpdate(w)}I.__version=w.version}function L(I,w,K){if(w.image.length!==6)return;let ae=B(I,w),pe=w.source;t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+K);let ve=i.get(pe);if(pe.version!==ve.__version||ae===!0){t.activeTexture(n.TEXTURE0+K);let be=mt.getPrimaries(mt.workingColorSpace),oe=w.colorSpace===Vi?null:mt.getPrimaries(w.colorSpace),de=w.colorSpace===Vi||be===oe?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,w.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,w.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);let Le=w.isCompressedTexture||w.image[0].isCompressedTexture,Oe=w.image[0]&&w.image[0].isDataTexture,Ae=[];for(let xe=0;xe<6;xe++)!Le&&!Oe?Ae[xe]=m(w.image[xe],!0,s.maxCubemapSize):Ae[xe]=Oe?w.image[xe].image:w.image[xe],Ae[xe]=Me(w,Ae[xe]);let we=Ae[0],st=r.convert(w.format,w.colorSpace),lt=r.convert(w.type),bt=M(w.internalFormat,st,lt,w.normalized,w.colorSpace),V=w.isVideoTexture!==!0,Te=ve.__version===void 0||ae===!0,ce=pe.dataReady,ke=E(w,we);ne(n.TEXTURE_CUBE_MAP,w);let Re;if(Le){V&&Te&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ke,bt,we.width,we.height);for(let xe=0;xe<6;xe++){Re=Ae[xe].mipmaps;for(let Ge=0;Ge<Re.length;Ge++){let ot=Re[Ge];w.format!==$n?st!==null?V?ce&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Ge,0,0,ot.width,ot.height,st,ot.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Ge,bt,ot.width,ot.height,0,ot.data):Qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):V?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Ge,0,0,ot.width,ot.height,st,lt,ot.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Ge,bt,ot.width,ot.height,0,st,lt,ot.data)}}}else{if(Re=w.mipmaps,V&&Te){Re.length>0&&ke++;let xe=St(Ae[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ke,bt,xe.width,xe.height)}for(let xe=0;xe<6;xe++)if(Oe){V?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,0,0,Ae[xe].width,Ae[xe].height,st,lt,Ae[xe].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,bt,Ae[xe].width,Ae[xe].height,0,st,lt,Ae[xe].data);for(let Ge=0;Ge<Re.length;Ge++){let tn=Re[Ge].image[xe].image;V?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Ge+1,0,0,tn.width,tn.height,st,lt,tn.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Ge+1,bt,tn.width,tn.height,0,st,lt,tn.data)}}else{V?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,0,0,st,lt,Ae[xe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,bt,st,lt,Ae[xe]);for(let Ge=0;Ge<Re.length;Ge++){let ot=Re[Ge];V?ce&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Ge+1,0,0,st,lt,ot.image[xe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Ge+1,bt,st,lt,ot.image[xe])}}}g(w)&&y(n.TEXTURE_CUBE_MAP),ve.__version=pe.version,w.onUpdate&&w.onUpdate(w)}I.__version=w.version}function se(I,w,K,ae,pe,ve){let be=r.convert(K.format,K.colorSpace),oe=r.convert(K.type),de=M(K.internalFormat,be,oe,K.normalized,K.colorSpace),Le=i.get(w),Oe=i.get(K);if(Oe.__renderTarget=w,!Le.__hasExternalTextures){let Ae=Math.max(1,w.width>>ve),we=Math.max(1,w.height>>ve);pe===n.TEXTURE_3D||pe===n.TEXTURE_2D_ARRAY?t.texImage3D(pe,ve,de,Ae,we,w.depth,0,be,oe,null):t.texImage2D(pe,ve,de,Ae,we,0,be,oe,null)}t.bindFramebuffer(n.FRAMEBUFFER,I),et(w)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ae,pe,Oe.__webglTexture,0,tt(w)):(pe===n.TEXTURE_2D||pe>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&pe<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ae,pe,Oe.__webglTexture,ve),t.bindFramebuffer(n.FRAMEBUFFER,null)}function T(I,w,K){if(n.bindRenderbuffer(n.RENDERBUFFER,I),w.depthBuffer){let ae=w.depthTexture,pe=ae&&ae.isDepthTexture?ae.type:null,ve=A(w.stencilBuffer,pe),be=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;et(w)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,tt(w),ve,w.width,w.height):K?n.renderbufferStorageMultisample(n.RENDERBUFFER,tt(w),ve,w.width,w.height):n.renderbufferStorage(n.RENDERBUFFER,ve,w.width,w.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,be,n.RENDERBUFFER,I)}else{let ae=w.textures;for(let pe=0;pe<ae.length;pe++){let ve=ae[pe],be=r.convert(ve.format,ve.colorSpace),oe=r.convert(ve.type),de=M(ve.internalFormat,be,oe,ve.normalized,ve.colorSpace);et(w)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,tt(w),de,w.width,w.height):K?n.renderbufferStorageMultisample(n.RENDERBUFFER,tt(w),de,w.width,w.height):n.renderbufferStorage(n.RENDERBUFFER,de,w.width,w.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function X(I,w,K){let ae=w.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,I),!(w.depthTexture&&w.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let pe=i.get(w.depthTexture);if(pe.__renderTarget=w,(!pe.__webglTexture||w.depthTexture.image.width!==w.width||w.depthTexture.image.height!==w.height)&&(w.depthTexture.image.width=w.width,w.depthTexture.image.height=w.height,w.depthTexture.needsUpdate=!0),ae){if(pe.__webglInit===void 0&&(pe.__webglInit=!0,w.depthTexture.addEventListener("dispose",P)),pe.__webglTexture===void 0){pe.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,pe.__webglTexture),ne(n.TEXTURE_CUBE_MAP,w.depthTexture);let Le=r.convert(w.depthTexture.format),Oe=r.convert(w.depthTexture.type),Ae;w.depthTexture.format===fi?Ae=n.DEPTH_COMPONENT24:w.depthTexture.format===hs&&(Ae=n.DEPTH24_STENCIL8);for(let we=0;we<6;we++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+we,0,Ae,w.width,w.height,0,Le,Oe,null)}}else le(w.depthTexture,0);let ve=pe.__webglTexture,be=tt(w),oe=ae?n.TEXTURE_CUBE_MAP_POSITIVE_X+K:n.TEXTURE_2D,de=w.depthTexture.format===hs?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(w.depthTexture.format===fi)et(w)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,de,oe,ve,0,be):n.framebufferTexture2D(n.FRAMEBUFFER,de,oe,ve,0);else if(w.depthTexture.format===hs)et(w)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,de,oe,ve,0,be):n.framebufferTexture2D(n.FRAMEBUFFER,de,oe,ve,0);else throw new Error("Unknown depthTexture format")}function q(I){let w=i.get(I),K=I.isWebGLCubeRenderTarget===!0;if(w.__boundDepthTexture!==I.depthTexture){let ae=I.depthTexture;if(w.__depthDisposeCallback&&w.__depthDisposeCallback(),ae){let pe=()=>{delete w.__boundDepthTexture,delete w.__depthDisposeCallback,ae.removeEventListener("dispose",pe)};ae.addEventListener("dispose",pe),w.__depthDisposeCallback=pe}w.__boundDepthTexture=ae}if(I.depthTexture&&!w.__autoAllocateDepthBuffer)if(K)for(let ae=0;ae<6;ae++)X(w.__webglFramebuffer[ae],I,ae);else{let ae=I.texture.mipmaps;ae&&ae.length>0?X(w.__webglFramebuffer[0],I,0):X(w.__webglFramebuffer,I,0)}else if(K){w.__webglDepthbuffer=[];for(let ae=0;ae<6;ae++)if(t.bindFramebuffer(n.FRAMEBUFFER,w.__webglFramebuffer[ae]),w.__webglDepthbuffer[ae]===void 0)w.__webglDepthbuffer[ae]=n.createRenderbuffer(),T(w.__webglDepthbuffer[ae],I,!1);else{let pe=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ve=w.__webglDepthbuffer[ae];n.bindRenderbuffer(n.RENDERBUFFER,ve),n.framebufferRenderbuffer(n.FRAMEBUFFER,pe,n.RENDERBUFFER,ve)}}else{let ae=I.texture.mipmaps;if(ae&&ae.length>0?t.bindFramebuffer(n.FRAMEBUFFER,w.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,w.__webglFramebuffer),w.__webglDepthbuffer===void 0)w.__webglDepthbuffer=n.createRenderbuffer(),T(w.__webglDepthbuffer,I,!1);else{let pe=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ve=w.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ve),n.framebufferRenderbuffer(n.FRAMEBUFFER,pe,n.RENDERBUFFER,ve)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function re(I,w,K){let ae=i.get(I);w!==void 0&&se(ae.__webglFramebuffer,I,I.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),K!==void 0&&q(I)}function Q(I){let w=I.texture,K=i.get(I),ae=i.get(w);I.addEventListener("dispose",_);let pe=I.textures,ve=I.isWebGLCubeRenderTarget===!0,be=pe.length>1;if(be||(ae.__webglTexture===void 0&&(ae.__webglTexture=n.createTexture()),ae.__version=w.version,o.memory.textures++),ve){K.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(w.mipmaps&&w.mipmaps.length>0){K.__webglFramebuffer[oe]=[];for(let de=0;de<w.mipmaps.length;de++)K.__webglFramebuffer[oe][de]=n.createFramebuffer()}else K.__webglFramebuffer[oe]=n.createFramebuffer()}else{if(w.mipmaps&&w.mipmaps.length>0){K.__webglFramebuffer=[];for(let oe=0;oe<w.mipmaps.length;oe++)K.__webglFramebuffer[oe]=n.createFramebuffer()}else K.__webglFramebuffer=n.createFramebuffer();if(be)for(let oe=0,de=pe.length;oe<de;oe++){let Le=i.get(pe[oe]);Le.__webglTexture===void 0&&(Le.__webglTexture=n.createTexture(),o.memory.textures++)}if(I.samples>0&&et(I)===!1){K.__webglMultisampledFramebuffer=n.createFramebuffer(),K.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,K.__webglMultisampledFramebuffer);for(let oe=0;oe<pe.length;oe++){let de=pe[oe];K.__webglColorRenderbuffer[oe]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,K.__webglColorRenderbuffer[oe]);let Le=r.convert(de.format,de.colorSpace),Oe=r.convert(de.type),Ae=M(de.internalFormat,Le,Oe,de.normalized,de.colorSpace,I.isXRRenderTarget===!0),we=tt(I);n.renderbufferStorageMultisample(n.RENDERBUFFER,we,Ae,I.width,I.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+oe,n.RENDERBUFFER,K.__webglColorRenderbuffer[oe])}n.bindRenderbuffer(n.RENDERBUFFER,null),I.depthBuffer&&(K.__webglDepthRenderbuffer=n.createRenderbuffer(),T(K.__webglDepthRenderbuffer,I,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ve){t.bindTexture(n.TEXTURE_CUBE_MAP,ae.__webglTexture),ne(n.TEXTURE_CUBE_MAP,w);for(let oe=0;oe<6;oe++)if(w.mipmaps&&w.mipmaps.length>0)for(let de=0;de<w.mipmaps.length;de++)se(K.__webglFramebuffer[oe][de],I,w,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,de);else se(K.__webglFramebuffer[oe],I,w,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);g(w)&&y(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(be){for(let oe=0,de=pe.length;oe<de;oe++){let Le=pe[oe],Oe=i.get(Le),Ae=n.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(Ae=I.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Ae,Oe.__webglTexture),ne(Ae,Le),se(K.__webglFramebuffer,I,Le,n.COLOR_ATTACHMENT0+oe,Ae,0),g(Le)&&y(Ae)}t.unbindTexture()}else{let oe=n.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(oe=I.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(oe,ae.__webglTexture),ne(oe,w),w.mipmaps&&w.mipmaps.length>0)for(let de=0;de<w.mipmaps.length;de++)se(K.__webglFramebuffer[de],I,w,n.COLOR_ATTACHMENT0,oe,de);else se(K.__webglFramebuffer,I,w,n.COLOR_ATTACHMENT0,oe,0);g(w)&&y(oe),t.unbindTexture()}I.depthBuffer&&q(I)}function Ee(I){let w=I.textures;for(let K=0,ae=w.length;K<ae;K++){let pe=w[K];if(g(pe)){let ve=v(I),be=i.get(pe).__webglTexture;t.bindTexture(ve,be),y(ve),t.unbindTexture()}}}let ze=[],Ve=[];function z(I){if(I.samples>0){if(et(I)===!1){let w=I.textures,K=I.width,ae=I.height,pe=n.COLOR_BUFFER_BIT,ve=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,be=i.get(I),oe=w.length>1;if(oe)for(let Le=0;Le<w.length;Le++)t.bindFramebuffer(n.FRAMEBUFFER,be.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,be.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,be.__webglMultisampledFramebuffer);let de=I.texture.mipmaps;de&&de.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,be.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,be.__webglFramebuffer);for(let Le=0;Le<w.length;Le++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(pe|=n.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(pe|=n.STENCIL_BUFFER_BIT)),oe){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,be.__webglColorRenderbuffer[Le]);let Oe=i.get(w[Le]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Oe,0)}n.blitFramebuffer(0,0,K,ae,0,0,K,ae,pe,n.NEAREST),l===!0&&(ze.length=0,Ve.length=0,ze.push(n.COLOR_ATTACHMENT0+Le),I.depthBuffer&&I.resolveDepthBuffer===!1&&(ze.push(ve),Ve.push(ve),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Ve)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ze))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),oe)for(let Le=0;Le<w.length;Le++){t.bindFramebuffer(n.FRAMEBUFFER,be.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.RENDERBUFFER,be.__webglColorRenderbuffer[Le]);let Oe=i.get(w[Le]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,be.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Le,n.TEXTURE_2D,Oe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,be.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&l){let w=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[w])}}}function tt(I){return Math.min(s.maxSamples,I.samples)}function et(I){let w=i.get(I);return I.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&w.__useRenderToTexture!==!1}function xt(I){let w=o.render.frame;d.get(I)!==w&&(d.set(I,w),I.update())}function Me(I,w){let K=I.colorSpace,ae=I.format,pe=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||K!==fo&&K!==Vi&&(mt.getTransfer(K)===Rt?(ae!==$n||pe!==Pn)&&Qe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):je("WebGLTextures: Unsupported texture color space:",K)),w}function St(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(c.width=I.naturalWidth||I.width,c.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(c.width=I.displayWidth,c.height=I.displayHeight):(c.width=I.width,c.height=I.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=W,this.getTextureUnits=Y,this.setTextureUnits=U,this.setTexture2D=le,this.setTexture2DArray=he,this.setTexture3D=ye,this.setTextureCube=Ce,this.rebindTextures=re,this.setupRenderTarget=Q,this.updateRenderTargetMipmap=Ee,this.updateMultisampleRenderTarget=z,this.setupDepthRenderbuffer=q,this.setupFrameBufferTexture=se,this.useMultisampledRTT=et,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Y1(n,e){function t(i,s=Vi){let r,o=mt.getTransfer(s);if(i===Pn)return n.UNSIGNED_BYTE;if(i===$l)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Kl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Cd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Sd)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Ad)return n.BYTE;if(i===Rd)return n.SHORT;if(i===Tr)return n.UNSIGNED_SHORT;if(i===Zl)return n.INT;if(i===ii)return n.UNSIGNED_INT;if(i===Zn)return n.FLOAT;if(i===Mi)return n.HALF_FLOAT;if(i===Id)return n.ALPHA;if(i===Pd)return n.RGB;if(i===$n)return n.RGBA;if(i===fi)return n.DEPTH_COMPONENT;if(i===hs)return n.DEPTH_STENCIL;if(i===Jl)return n.RED;if(i===jl)return n.RED_INTEGER;if(i===ds)return n.RG;if(i===Ql)return n.RG_INTEGER;if(i===ec)return n.RGBA_INTEGER;if(i===qo||i===Yo||i===Zo||i===$o)if(o===Rt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===qo)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Yo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Zo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===$o)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===qo)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Yo)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Zo)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===$o)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===tc||i===nc||i===ic||i===sc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===tc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===nc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ic)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===sc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===rc||i===oc||i===ac||i===lc||i===cc||i===Ko||i===hc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===rc||i===oc)return o===Rt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===ac)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===lc)return r.COMPRESSED_R11_EAC;if(i===cc)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Ko)return r.COMPRESSED_RG11_EAC;if(i===hc)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===dc||i===fc||i===uc||i===pc||i===mc||i===gc||i===xc||i===yc||i===_c||i===vc||i===Mc||i===bc||i===wc||i===Tc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===dc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===fc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===uc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===pc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===mc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===gc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===xc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===yc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===_c)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===vc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Mc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===bc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===wc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Tc)return o===Rt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Ec||i===Ac||i===Rc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Ec)return o===Rt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ac)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Rc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Cc||i===Sc||i===Jo||i===Ic)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Cc)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Sc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Jo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Ic)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Er?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}var Z1=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`,Jd=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let i=new Eo(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,i=new Bn({vertexShader:Z1,fragmentShader:$1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new ge(new Yn(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},jd=class extends ui{constructor(e,t){super();let i=this,s=null,r=1,o=null,a="local-floor",l=1,c=null,d=null,h=null,f=null,u=null,p=null,x=typeof XRWebGLBinding<"u",m=new Jd,g={},y=t.getContextAttributes(),v=null,M=null,A=[],E=[],P=new Pe,_=null,b=new bn;b.viewport=new Kt;let S=new bn;S.viewport=new Kt;let C=[b,S],N=new Gl,W=null,Y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(B){let O=A[B];return O===void 0&&(O=new gr,A[B]=O),O.getTargetRaySpace()},this.getControllerGrip=function(B){let O=A[B];return O===void 0&&(O=new gr,A[B]=O),O.getGripSpace()},this.getHand=function(B){let O=A[B];return O===void 0&&(O=new gr,A[B]=O),O.getHandSpace()};function U(B){let O=E.indexOf(B.inputSource);if(O===-1)return;let k=A[O];k!==void 0&&(k.update(B.inputSource,B.frame,c||o),k.dispatchEvent({type:B.type,data:B.inputSource}))}function H(){s.removeEventListener("select",U),s.removeEventListener("selectstart",U),s.removeEventListener("selectend",U),s.removeEventListener("squeeze",U),s.removeEventListener("squeezestart",U),s.removeEventListener("squeezeend",U),s.removeEventListener("end",H),s.removeEventListener("inputsourceschange",$);for(let B=0;B<A.length;B++){let O=E[B];O!==null&&(E[B]=null,A[B].disconnect(O))}W=null,Y=null,m.reset();for(let B in g)delete g[B];e.setRenderTarget(v),u=null,f=null,h=null,s=null,M=null,ne.stop(),i.isPresenting=!1,e.setPixelRatio(_),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(B){r=B,i.isPresenting===!0&&Qe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(B){a=B,i.isPresenting===!0&&Qe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(B){c=B},this.getBaseLayer=function(){return f!==null?f:u},this.getBinding=function(){return h===null&&x&&(h=new XRWebGLBinding(s,t)),h},this.getFrame=function(){return p},this.getSession=function(){return s},this.setSession=async function(B){if(s=B,s!==null){if(v=e.getRenderTarget(),s.addEventListener("select",U),s.addEventListener("selectstart",U),s.addEventListener("selectend",U),s.addEventListener("squeeze",U),s.addEventListener("squeezestart",U),s.addEventListener("squeezeend",U),s.addEventListener("end",H),s.addEventListener("inputsourceschange",$),y.xrCompatible!==!0&&await t.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(P),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let k=null,D=null,L=null;y.depth&&(L=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,k=y.stencil?hs:fi,D=y.stencil?Er:ii);let se={colorFormat:t.RGBA8,depthFormat:L,scaleFactor:r};h=this.getBinding(),f=h.createProjectionLayer(se),s.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),M=new Fn(f.textureWidth,f.textureHeight,{format:$n,type:Pn,depthTexture:new Hi(f.textureWidth,f.textureHeight,D,void 0,void 0,void 0,void 0,void 0,void 0,k),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let k={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:r};u=new XRWebGLLayer(s,t,k),s.updateRenderState({baseLayer:u}),e.setPixelRatio(1),e.setSize(u.framebufferWidth,u.framebufferHeight,!1),M=new Fn(u.framebufferWidth,u.framebufferHeight,{format:$n,type:Pn,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),ne.setContext(s),ne.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function $(B){for(let O=0;O<B.removed.length;O++){let k=B.removed[O],D=E.indexOf(k);D>=0&&(E[D]=null,A[D].disconnect(k))}for(let O=0;O<B.added.length;O++){let k=B.added[O],D=E.indexOf(k);if(D===-1){for(let se=0;se<A.length;se++)if(se>=E.length){E.push(k),D=se;break}else if(E[se]===null){E[se]=k,D=se;break}if(D===-1)break}let L=A[D];L&&L.connect(k)}}let le=new F,he=new F;function ye(B,O,k){le.setFromMatrixPosition(O.matrixWorld),he.setFromMatrixPosition(k.matrixWorld);let D=le.distanceTo(he),L=O.projectionMatrix.elements,se=k.projectionMatrix.elements,T=L[14]/(L[10]-1),X=L[14]/(L[10]+1),q=(L[9]+1)/L[5],re=(L[9]-1)/L[5],Q=(L[8]-1)/L[0],Ee=(se[8]+1)/se[0],ze=T*Q,Ve=T*Ee,z=D/(-Q+Ee),tt=z*-Q;if(O.matrixWorld.decompose(B.position,B.quaternion,B.scale),B.translateX(tt),B.translateZ(z),B.matrixWorld.compose(B.position,B.quaternion,B.scale),B.matrixWorldInverse.copy(B.matrixWorld).invert(),L[10]===-1)B.projectionMatrix.copy(O.projectionMatrix),B.projectionMatrixInverse.copy(O.projectionMatrixInverse);else{let et=T+z,xt=X+z,Me=ze-tt,St=Ve+(D-tt),I=q*X/xt*et,w=re*X/xt*et;B.projectionMatrix.makePerspective(Me,St,I,w,et,xt),B.projectionMatrixInverse.copy(B.projectionMatrix).invert()}}function Ce(B,O){O===null?B.matrixWorld.copy(B.matrix):B.matrixWorld.multiplyMatrices(O.matrixWorld,B.matrix),B.matrixWorldInverse.copy(B.matrixWorld).invert()}this.updateCamera=function(B){if(s===null)return;let O=B.near,k=B.far;m.texture!==null&&(m.depthNear>0&&(O=m.depthNear),m.depthFar>0&&(k=m.depthFar)),N.near=S.near=b.near=O,N.far=S.far=b.far=k,(W!==N.near||Y!==N.far)&&(s.updateRenderState({depthNear:N.near,depthFar:N.far}),W=N.near,Y=N.far),N.layers.mask=B.layers.mask|6,b.layers.mask=N.layers.mask&-5,S.layers.mask=N.layers.mask&-3;let D=B.parent,L=N.cameras;Ce(N,D);for(let se=0;se<L.length;se++)Ce(L[se],D);L.length===2?ye(N,b,S):N.projectionMatrix.copy(b.projectionMatrix),Ue(B,N,D)};function Ue(B,O,k){k===null?B.matrix.copy(O.matrixWorld):(B.matrix.copy(k.matrixWorld),B.matrix.invert(),B.matrix.multiply(O.matrixWorld)),B.matrix.decompose(B.position,B.quaternion,B.scale),B.updateMatrixWorld(!0),B.projectionMatrix.copy(O.projectionMatrix),B.projectionMatrixInverse.copy(O.projectionMatrixInverse),B.isPerspectiveCamera&&(B.fov=gl*2*Math.atan(1/B.projectionMatrix.elements[5]),B.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(f===null&&u===null))return l},this.setFoveation=function(B){l=B,f!==null&&(f.fixedFoveation=B),u!==null&&u.fixedFoveation!==void 0&&(u.fixedFoveation=B)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(N)},this.getCameraTexture=function(B){return g[B]};let Ke=null;function ie(B,O){if(d=O.getViewerPose(c||o),p=O,d!==null){let k=d.views;u!==null&&(e.setRenderTargetFramebuffer(M,u.framebuffer),e.setRenderTarget(M));let D=!1;k.length!==N.cameras.length&&(N.cameras.length=0,D=!0);for(let X=0;X<k.length;X++){let q=k[X],re=null;if(u!==null)re=u.getViewport(q);else{let Ee=h.getViewSubImage(f,q);re=Ee.viewport,X===0&&(e.setRenderTargetTextures(M,Ee.colorTexture,Ee.depthStencilTexture),e.setRenderTarget(M))}let Q=C[X];Q===void 0&&(Q=new bn,Q.layers.enable(X),Q.viewport=new Kt,C[X]=Q),Q.matrix.fromArray(q.transform.matrix),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.projectionMatrix.fromArray(q.projectionMatrix),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert(),Q.viewport.set(re.x,re.y,re.width,re.height),X===0&&(N.matrix.copy(Q.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),D===!0&&N.cameras.push(Q)}let L=s.enabledFeatures;if(L&&L.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&x){h=i.getBinding();let X=h.getDepthInformation(k[0]);X&&X.isValid&&X.texture&&m.init(X,s.renderState)}if(L&&L.includes("camera-access")&&x){e.state.unbindTexture(),h=i.getBinding();for(let X=0;X<k.length;X++){let q=k[X].camera;if(q){let re=g[q];re||(re=new Eo,g[q]=re);let Q=h.getCameraImage(q);re.sourceTexture=Q}}}}for(let k=0;k<A.length;k++){let D=E[k],L=A[k];D!==null&&L!==void 0&&L.update(D,O,c||o)}Ke&&Ke(B,O),O.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:O}),p=null}let ne=new Qm;ne.setAnimationLoop(ie),this.setAnimationLoop=function(B){Ke=B},this.dispose=function(){}}},K1=new gt,r0=new rt;r0.set(-1,0,0,0,1,0,0,0,1);function J1(n,e){function t(m,g){m.matrixAutoUpdate===!0&&m.updateMatrix(),g.value.copy(m.matrix)}function i(m,g){g.color.getRGB(m.fogColor.value,Nd(n)),g.isFog?(m.fogNear.value=g.near,m.fogFar.value=g.far):g.isFogExp2&&(m.fogDensity.value=g.density)}function s(m,g,y,v,M){g.isNodeMaterial?g.uniformsNeedUpdate=!1:g.isMeshBasicMaterial?r(m,g):g.isMeshLambertMaterial?(r(m,g),g.envMap&&(m.envMapIntensity.value=g.envMapIntensity)):g.isMeshToonMaterial?(r(m,g),h(m,g)):g.isMeshPhongMaterial?(r(m,g),d(m,g),g.envMap&&(m.envMapIntensity.value=g.envMapIntensity)):g.isMeshStandardMaterial?(r(m,g),f(m,g),g.isMeshPhysicalMaterial&&u(m,g,M)):g.isMeshMatcapMaterial?(r(m,g),p(m,g)):g.isMeshDepthMaterial?r(m,g):g.isMeshDistanceMaterial?(r(m,g),x(m,g)):g.isMeshNormalMaterial?r(m,g):g.isLineBasicMaterial?(o(m,g),g.isLineDashedMaterial&&a(m,g)):g.isPointsMaterial?l(m,g,y,v):g.isSpriteMaterial?c(m,g):g.isShadowMaterial?(m.color.value.copy(g.color),m.opacity.value=g.opacity):g.isShaderMaterial&&(g.uniformsNeedUpdate=!1)}function r(m,g){m.opacity.value=g.opacity,g.color&&m.diffuse.value.copy(g.color),g.emissive&&m.emissive.value.copy(g.emissive).multiplyScalar(g.emissiveIntensity),g.map&&(m.map.value=g.map,t(g.map,m.mapTransform)),g.alphaMap&&(m.alphaMap.value=g.alphaMap,t(g.alphaMap,m.alphaMapTransform)),g.bumpMap&&(m.bumpMap.value=g.bumpMap,t(g.bumpMap,m.bumpMapTransform),m.bumpScale.value=g.bumpScale,g.side===xn&&(m.bumpScale.value*=-1)),g.normalMap&&(m.normalMap.value=g.normalMap,t(g.normalMap,m.normalMapTransform),m.normalScale.value.copy(g.normalScale),g.side===xn&&m.normalScale.value.negate()),g.displacementMap&&(m.displacementMap.value=g.displacementMap,t(g.displacementMap,m.displacementMapTransform),m.displacementScale.value=g.displacementScale,m.displacementBias.value=g.displacementBias),g.emissiveMap&&(m.emissiveMap.value=g.emissiveMap,t(g.emissiveMap,m.emissiveMapTransform)),g.specularMap&&(m.specularMap.value=g.specularMap,t(g.specularMap,m.specularMapTransform)),g.alphaTest>0&&(m.alphaTest.value=g.alphaTest);let y=e.get(g),v=y.envMap,M=y.envMapRotation;v&&(m.envMap.value=v,m.envMapRotation.value.setFromMatrix4(K1.makeRotationFromEuler(M)).transpose(),v.isCubeTexture&&v.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(r0),m.reflectivity.value=g.reflectivity,m.ior.value=g.ior,m.refractionRatio.value=g.refractionRatio),g.lightMap&&(m.lightMap.value=g.lightMap,m.lightMapIntensity.value=g.lightMapIntensity,t(g.lightMap,m.lightMapTransform)),g.aoMap&&(m.aoMap.value=g.aoMap,m.aoMapIntensity.value=g.aoMapIntensity,t(g.aoMap,m.aoMapTransform))}function o(m,g){m.diffuse.value.copy(g.color),m.opacity.value=g.opacity,g.map&&(m.map.value=g.map,t(g.map,m.mapTransform))}function a(m,g){m.dashSize.value=g.dashSize,m.totalSize.value=g.dashSize+g.gapSize,m.scale.value=g.scale}function l(m,g,y,v){m.diffuse.value.copy(g.color),m.opacity.value=g.opacity,m.size.value=g.size*y,m.scale.value=v*.5,g.map&&(m.map.value=g.map,t(g.map,m.uvTransform)),g.alphaMap&&(m.alphaMap.value=g.alphaMap,t(g.alphaMap,m.alphaMapTransform)),g.alphaTest>0&&(m.alphaTest.value=g.alphaTest)}function c(m,g){m.diffuse.value.copy(g.color),m.opacity.value=g.opacity,m.rotation.value=g.rotation,g.map&&(m.map.value=g.map,t(g.map,m.mapTransform)),g.alphaMap&&(m.alphaMap.value=g.alphaMap,t(g.alphaMap,m.alphaMapTransform)),g.alphaTest>0&&(m.alphaTest.value=g.alphaTest)}function d(m,g){m.specular.value.copy(g.specular),m.shininess.value=Math.max(g.shininess,1e-4)}function h(m,g){g.gradientMap&&(m.gradientMap.value=g.gradientMap)}function f(m,g){m.metalness.value=g.metalness,g.metalnessMap&&(m.metalnessMap.value=g.metalnessMap,t(g.metalnessMap,m.metalnessMapTransform)),m.roughness.value=g.roughness,g.roughnessMap&&(m.roughnessMap.value=g.roughnessMap,t(g.roughnessMap,m.roughnessMapTransform)),g.envMap&&(m.envMapIntensity.value=g.envMapIntensity)}function u(m,g,y){m.ior.value=g.ior,g.sheen>0&&(m.sheenColor.value.copy(g.sheenColor).multiplyScalar(g.sheen),m.sheenRoughness.value=g.sheenRoughness,g.sheenColorMap&&(m.sheenColorMap.value=g.sheenColorMap,t(g.sheenColorMap,m.sheenColorMapTransform)),g.sheenRoughnessMap&&(m.sheenRoughnessMap.value=g.sheenRoughnessMap,t(g.sheenRoughnessMap,m.sheenRoughnessMapTransform))),g.clearcoat>0&&(m.clearcoat.value=g.clearcoat,m.clearcoatRoughness.value=g.clearcoatRoughness,g.clearcoatMap&&(m.clearcoatMap.value=g.clearcoatMap,t(g.clearcoatMap,m.clearcoatMapTransform)),g.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=g.clearcoatRoughnessMap,t(g.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),g.clearcoatNormalMap&&(m.clearcoatNormalMap.value=g.clearcoatNormalMap,t(g.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(g.clearcoatNormalScale),g.side===xn&&m.clearcoatNormalScale.value.negate())),g.dispersion>0&&(m.dispersion.value=g.dispersion),g.iridescence>0&&(m.iridescence.value=g.iridescence,m.iridescenceIOR.value=g.iridescenceIOR,m.iridescenceThicknessMinimum.value=g.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=g.iridescenceThicknessRange[1],g.iridescenceMap&&(m.iridescenceMap.value=g.iridescenceMap,t(g.iridescenceMap,m.iridescenceMapTransform)),g.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=g.iridescenceThicknessMap,t(g.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),g.transmission>0&&(m.transmission.value=g.transmission,m.transmissionSamplerMap.value=y.texture,m.transmissionSamplerSize.value.set(y.width,y.height),g.transmissionMap&&(m.transmissionMap.value=g.transmissionMap,t(g.transmissionMap,m.transmissionMapTransform)),m.thickness.value=g.thickness,g.thicknessMap&&(m.thicknessMap.value=g.thicknessMap,t(g.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=g.attenuationDistance,m.attenuationColor.value.copy(g.attenuationColor)),g.anisotropy>0&&(m.anisotropyVector.value.set(g.anisotropy*Math.cos(g.anisotropyRotation),g.anisotropy*Math.sin(g.anisotropyRotation)),g.anisotropyMap&&(m.anisotropyMap.value=g.anisotropyMap,t(g.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=g.specularIntensity,m.specularColor.value.copy(g.specularColor),g.specularColorMap&&(m.specularColorMap.value=g.specularColorMap,t(g.specularColorMap,m.specularColorMapTransform)),g.specularIntensityMap&&(m.specularIntensityMap.value=g.specularIntensityMap,t(g.specularIntensityMap,m.specularIntensityMapTransform))}function p(m,g){g.matcap&&(m.matcap.value=g.matcap)}function x(m,g){let y=e.get(g).light;m.referencePosition.value.setFromMatrixPosition(y.matrixWorld),m.nearDistance.value=y.shadow.camera.near,m.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function j1(n,e,t,i){let s={},r={},o=[],a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,v){let M=v.program;i.uniformBlockBinding(y,M)}function c(y,v){let M=s[y.id];M===void 0&&(p(y),M=d(y),s[y.id]=M,y.addEventListener("dispose",m));let A=v.program;i.updateUBOMapping(y,A);let E=e.render.frame;r[y.id]!==E&&(f(y),r[y.id]=E)}function d(y){let v=h();y.__bindingPointIndex=v;let M=n.createBuffer(),A=y.__size,E=y.usage;return n.bindBuffer(n.UNIFORM_BUFFER,M),n.bufferData(n.UNIFORM_BUFFER,A,E),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,v,M),M}function h(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return je("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(y){let v=s[y.id],M=y.uniforms,A=y.__cache;n.bindBuffer(n.UNIFORM_BUFFER,v);for(let E=0,P=M.length;E<P;E++){let _=Array.isArray(M[E])?M[E]:[M[E]];for(let b=0,S=_.length;b<S;b++){let C=_[b];if(u(C,E,b,A)===!0){let N=C.__offset,W=Array.isArray(C.value)?C.value:[C.value],Y=0;for(let U=0;U<W.length;U++){let H=W[U],$=x(H);typeof H=="number"||typeof H=="boolean"?(C.__data[0]=H,n.bufferSubData(n.UNIFORM_BUFFER,N+Y,C.__data)):H.isMatrix3?(C.__data[0]=H.elements[0],C.__data[1]=H.elements[1],C.__data[2]=H.elements[2],C.__data[3]=0,C.__data[4]=H.elements[3],C.__data[5]=H.elements[4],C.__data[6]=H.elements[5],C.__data[7]=0,C.__data[8]=H.elements[6],C.__data[9]=H.elements[7],C.__data[10]=H.elements[8],C.__data[11]=0):ArrayBuffer.isView(H)?C.__data.set(new H.constructor(H.buffer,H.byteOffset,C.__data.length)):(H.toArray(C.__data,Y),Y+=$.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,N,C.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function u(y,v,M,A){let E=y.value,P=v+"_"+M;if(A[P]===void 0)return typeof E=="number"||typeof E=="boolean"?A[P]=E:ArrayBuffer.isView(E)?A[P]=E.slice():A[P]=E.clone(),!0;{let _=A[P];if(typeof E=="number"||typeof E=="boolean"){if(_!==E)return A[P]=E,!0}else{if(ArrayBuffer.isView(E))return!0;if(_.equals(E)===!1)return _.copy(E),!0}}return!1}function p(y){let v=y.uniforms,M=0,A=16;for(let P=0,_=v.length;P<_;P++){let b=Array.isArray(v[P])?v[P]:[v[P]];for(let S=0,C=b.length;S<C;S++){let N=b[S],W=Array.isArray(N.value)?N.value:[N.value];for(let Y=0,U=W.length;Y<U;Y++){let H=W[Y],$=x(H),le=M%A,he=le%$.boundary,ye=le+he;M+=he,ye!==0&&A-ye<$.storage&&(M+=A-ye),N.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=M,M+=$.storage}}}let E=M%A;return E>0&&(M+=A-E),y.__size=M,y.__cache={},this}function x(y){let v={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(v.boundary=4,v.storage=4):y.isVector2?(v.boundary=8,v.storage=8):y.isVector3||y.isColor?(v.boundary=16,v.storage=12):y.isVector4?(v.boundary=16,v.storage=16):y.isMatrix3?(v.boundary=48,v.storage=48):y.isMatrix4?(v.boundary=64,v.storage=64):y.isTexture?Qe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(v.boundary=16,v.storage=y.byteLength):Qe("WebGLRenderer: Unsupported uniform value type.",y),v}function m(y){let v=y.target;v.removeEventListener("dispose",m);let M=o.indexOf(v.__bindingPointIndex);o.splice(M,1),n.deleteBuffer(s[v.id]),delete s[v.id],delete r[v.id]}function g(){for(let y in s)n.deleteBuffer(s[y]);o=[],s={},r={}}return{bind:l,update:c,dispose:g}}var Q1=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),bi=null;function eb(){return bi===null&&(bi=new bo(Q1,16,16,ds,Mi),bi.name="DFG_LUT",bi.minFilter=gn,bi.magFilter=gn,bi.wrapS=hi,bi.wrapT=hi,bi.generateMipmaps=!1,bi.needsUpdate=!0),bi}var Oc=class{constructor(e={}){let{canvas:t=_m(),context:i=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1,outputBufferType:u=Pn}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;let x=u,m=new Set([ec,Ql,jl]),g=new Set([Pn,ii,Tr,Er,$l,Kl]),y=new Uint32Array(4),v=new Int32Array(4),M=new F,A=null,E=null,P=[],_=[],b=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ni,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let S=this,C=!1,N=null;this._outputColorSpace=on;let W=0,Y=0,U=null,H=-1,$=null,le=new Kt,he=new Kt,ye=null,Ce=new nt(0),Ue=0,Ke=t.width,ie=t.height,ne=1,B=null,O=null,k=new Kt(0,0,Ke,ie),D=new Kt(0,0,Ke,ie),L=!1,se=new yr,T=!1,X=!1,q=new gt,re=new F,Q=new Kt,Ee={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},ze=!1;function Ve(){return U===null?ne:1}let z=i;function tt(R,Z){return t.getContext(R,Z)}try{let R={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"184"}`),t.addEventListener("webglcontextlost",xe,!1),t.addEventListener("webglcontextrestored",Ge,!1),t.addEventListener("webglcontextcreationerror",ot,!1),z===null){let Z="webgl2";if(z=tt(Z,R),z===null)throw tt(Z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw je("WebGLRenderer: "+R.message),R}let et,xt,Me,St,I,w,K,ae,pe,ve,be,oe,de,Le,Oe,Ae,we,st,lt,bt,V,Te,ce;function ke(){et=new aM(z),et.init(),V=new Y1(z,et),xt=new Qv(z,et,e,V),Me=new X1(z,et),xt.reversedDepthBuffer&&f&&Me.buffers.depth.setReversed(!0),St=new hM(z),I=new P1,w=new q1(z,et,Me,I,xt,V,St),K=new oM(S),ae=new py(z),Te=new Jv(z,ae),pe=new lM(z,ae,St,Te),ve=new fM(z,pe,ae,Te,St),st=new dM(z,xt,w),Oe=new eM(I),be=new I1(S,K,et,xt,Te,Oe),oe=new J1(S,I),de=new L1,Le=new B1(et),we=new Kv(S,K,Me,ve,p,l),Ae=new W1(S,ve,xt),ce=new j1(z,St,xt,Me),lt=new jv(z,et,St),bt=new cM(z,et,St),St.programs=be.programs,S.capabilities=xt,S.extensions=et,S.properties=I,S.renderLists=de,S.shadowMap=Ae,S.state=Me,S.info=St}ke(),x!==Pn&&(b=new pM(x,t.width,t.height,s,r));let Re=new jd(S,z);this.xr=Re,this.getContext=function(){return z},this.getContextAttributes=function(){return z.getContextAttributes()},this.forceContextLoss=function(){let R=et.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){let R=et.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return ne},this.setPixelRatio=function(R){R!==void 0&&(ne=R,this.setSize(Ke,ie,!1))},this.getSize=function(R){return R.set(Ke,ie)},this.setSize=function(R,Z,te=!0){if(Re.isPresenting){Qe("WebGLRenderer: Can't change size while VR device is presenting.");return}Ke=R,ie=Z,t.width=Math.floor(R*ne),t.height=Math.floor(Z*ne),te===!0&&(t.style.width=R+"px",t.style.height=Z+"px"),b!==null&&b.setSize(t.width,t.height),this.setViewport(0,0,R,Z)},this.getDrawingBufferSize=function(R){return R.set(Ke*ne,ie*ne).floor()},this.setDrawingBufferSize=function(R,Z,te){Ke=R,ie=Z,ne=te,t.width=Math.floor(R*te),t.height=Math.floor(Z*te),this.setViewport(0,0,R,Z)},this.setEffects=function(R){if(x===Pn){je("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(R){for(let Z=0;Z<R.length;Z++)if(R[Z].isOutputPass===!0){Qe("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}b.setEffects(R||[])},this.getCurrentViewport=function(R){return R.copy(le)},this.getViewport=function(R){return R.copy(k)},this.setViewport=function(R,Z,te,J){R.isVector4?k.set(R.x,R.y,R.z,R.w):k.set(R,Z,te,J),Me.viewport(le.copy(k).multiplyScalar(ne).round())},this.getScissor=function(R){return R.copy(D)},this.setScissor=function(R,Z,te,J){R.isVector4?D.set(R.x,R.y,R.z,R.w):D.set(R,Z,te,J),Me.scissor(he.copy(D).multiplyScalar(ne).round())},this.getScissorTest=function(){return L},this.setScissorTest=function(R){Me.setScissorTest(L=R)},this.setOpaqueSort=function(R){B=R},this.setTransparentSort=function(R){O=R},this.getClearColor=function(R){return R.copy(we.getClearColor())},this.setClearColor=function(){we.setClearColor(...arguments)},this.getClearAlpha=function(){return we.getClearAlpha()},this.setClearAlpha=function(){we.setClearAlpha(...arguments)},this.clear=function(R=!0,Z=!0,te=!0){let J=0;if(R){let j=!1;if(U!==null){let De=U.texture.format;j=m.has(De)}if(j){let De=U.texture.type,Be=g.has(De),Ie=we.getClearColor(),He=we.getClearAlpha(),Xe=Ie.r,at=Ie.g,dt=Ie.b;Be?(y[0]=Xe,y[1]=at,y[2]=dt,y[3]=He,z.clearBufferuiv(z.COLOR,0,y)):(v[0]=Xe,v[1]=at,v[2]=dt,v[3]=He,z.clearBufferiv(z.COLOR,0,v))}else J|=z.COLOR_BUFFER_BIT}Z&&(J|=z.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),te&&(J|=z.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),J!==0&&z.clear(J)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(R){R.setRenderer(this),N=R},this.dispose=function(){t.removeEventListener("webglcontextlost",xe,!1),t.removeEventListener("webglcontextrestored",Ge,!1),t.removeEventListener("webglcontextcreationerror",ot,!1),we.dispose(),de.dispose(),Le.dispose(),I.dispose(),K.dispose(),ve.dispose(),Te.dispose(),ce.dispose(),be.dispose(),Re.dispose(),Re.removeEventListener("sessionstart",rf),Re.removeEventListener("sessionend",of),ms.stop()};function xe(R){R.preventDefault(),mo("WebGLRenderer: Context Lost."),C=!0}function Ge(){mo("WebGLRenderer: Context Restored."),C=!1;let R=St.autoReset,Z=Ae.enabled,te=Ae.autoUpdate,J=Ae.needsUpdate,j=Ae.type;ke(),St.autoReset=R,Ae.enabled=Z,Ae.autoUpdate=te,Ae.needsUpdate=J,Ae.type=j}function ot(R){je("WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function tn(R){let Z=R.target;Z.removeEventListener("dispose",tn),It(Z)}function It(R){Ti(R),I.remove(R)}function Ti(R){let Z=I.get(R).programs;Z!==void 0&&(Z.forEach(function(te){be.releaseProgram(te)}),R.isShaderMaterial&&be.releaseShaderCache(R))}this.renderBufferDirect=function(R,Z,te,J,j,De){Z===null&&(Z=Ee);let Be=j.isMesh&&j.matrixWorld.determinant()<0,Ie=R0(R,Z,te,J,j);Me.setMaterial(J,Be);let He=te.index,Xe=1;if(J.wireframe===!0){if(He=pe.getWireframeAttribute(te),He===void 0)return;Xe=2}let at=te.drawRange,dt=te.attributes.position,Ze=at.start*Xe,Pt=(at.start+at.count)*Xe;De!==null&&(Ze=Math.max(Ze,De.start*Xe),Pt=Math.min(Pt,(De.start+De.count)*Xe)),He!==null?(Ze=Math.max(Ze,0),Pt=Math.min(Pt,He.count)):dt!=null&&(Ze=Math.max(Ze,0),Pt=Math.min(Pt,dt.count));let nn=Pt-Ze;if(nn<0||nn===1/0)return;Te.setup(j,J,Ie,te,He);let Jt,Nt=lt;if(He!==null&&(Jt=ae.get(He),Nt=bt,Nt.setIndex(Jt)),j.isMesh)J.wireframe===!0?(Me.setLineWidth(J.wireframeLinewidth*Ve()),Nt.setMode(z.LINES)):Nt.setMode(z.TRIANGLES);else if(j.isLine){let yn=J.linewidth;yn===void 0&&(yn=1),Me.setLineWidth(yn*Ve()),j.isLineSegments?Nt.setMode(z.LINES):j.isLineLoop?Nt.setMode(z.LINE_LOOP):Nt.setMode(z.LINE_STRIP)}else j.isPoints?Nt.setMode(z.POINTS):j.isSprite&&Nt.setMode(z.TRIANGLES);if(j.isBatchedMesh)if(et.get("WEBGL_multi_draw"))Nt.renderMultiDraw(j._multiDrawStarts,j._multiDrawCounts,j._multiDrawCount);else{let yn=j._multiDrawStarts,Fe=j._multiDrawCounts,Dn=j._multiDrawCount,vt=He?ae.get(He).bytesPerElement:1,Hn=I.get(J).currentProgram.getUniforms();for(let ri=0;ri<Dn;ri++)Hn.setValue(z,"_gl_DrawID",ri),Nt.render(yn[ri]/vt,Fe[ri])}else if(j.isInstancedMesh)Nt.renderInstances(Ze,nn,j.count);else if(te.isInstancedBufferGeometry){let yn=te._maxInstanceCount!==void 0?te._maxInstanceCount:1/0,Fe=Math.min(te.instanceCount,yn);Nt.renderInstances(Ze,nn,Fe)}else Nt.render(Ze,nn)};function si(R,Z,te){R.transparent===!0&&R.side===In&&R.forceSinglePass===!1?(R.side=xn,R.needsUpdate=!0,sa(R,Z,te),R.side=Fi,R.needsUpdate=!0,sa(R,Z,te),R.side=In):sa(R,Z,te)}this.compile=function(R,Z,te=null){te===null&&(te=R),E=Le.get(te),E.init(Z),_.push(E),te.traverseVisible(function(j){j.isLight&&j.layers.test(Z.layers)&&(E.pushLight(j),j.castShadow&&E.pushShadow(j))}),R!==te&&R.traverseVisible(function(j){j.isLight&&j.layers.test(Z.layers)&&(E.pushLight(j),j.castShadow&&E.pushShadow(j))}),E.setupLights();let J=new Set;return R.traverse(function(j){if(!(j.isMesh||j.isPoints||j.isLine||j.isSprite))return;let De=j.material;if(De)if(Array.isArray(De))for(let Be=0;Be<De.length;Be++){let Ie=De[Be];si(Ie,te,j),J.add(Ie)}else si(De,te,j),J.add(De)}),E=_.pop(),J},this.compileAsync=function(R,Z,te=null){let J=this.compile(R,Z,te);return new Promise(j=>{function De(){if(J.forEach(function(Be){I.get(Be).currentProgram.isReady()&&J.delete(Be)}),J.size===0){j(R);return}setTimeout(De,10)}et.get("KHR_parallel_shader_compile")!==null?De():setTimeout(De,10)})};let Yc=null;function E0(R){Yc&&Yc(R)}function rf(){ms.stop()}function of(){ms.start()}let ms=new Qm;ms.setAnimationLoop(E0),typeof self<"u"&&ms.setContext(self),this.setAnimationLoop=function(R){Yc=R,Re.setAnimationLoop(R),R===null?ms.stop():ms.start()},Re.addEventListener("sessionstart",rf),Re.addEventListener("sessionend",of),this.render=function(R,Z){if(Z!==void 0&&Z.isCamera!==!0){je("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;N!==null&&N.renderStart(R,Z);let te=Re.enabled===!0&&Re.isPresenting===!0,J=b!==null&&(U===null||te)&&b.begin(S,U);if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),Z.parent===null&&Z.matrixWorldAutoUpdate===!0&&Z.updateMatrixWorld(),Re.enabled===!0&&Re.isPresenting===!0&&(b===null||b.isCompositing()===!1)&&(Re.cameraAutoUpdate===!0&&Re.updateCamera(Z),Z=Re.getCamera()),R.isScene===!0&&R.onBeforeRender(S,R,Z,U),E=Le.get(R,_.length),E.init(Z),E.state.textureUnits=w.getTextureUnits(),_.push(E),q.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),se.setFromProjectionMatrix(q,ti,Z.reversedDepth),X=this.localClippingEnabled,T=Oe.init(this.clippingPlanes,X),A=de.get(R,P.length),A.init(),P.push(A),Re.enabled===!0&&Re.isPresenting===!0){let Be=S.xr.getDepthSensingMesh();Be!==null&&Zc(Be,Z,-1/0,S.sortObjects)}Zc(R,Z,0,S.sortObjects),A.finish(),S.sortObjects===!0&&A.sort(B,O),ze=Re.enabled===!1||Re.isPresenting===!1||Re.hasDepthSensing()===!1,ze&&we.addToRenderList(A,R),this.info.render.frame++,T===!0&&Oe.beginShadows();let j=E.state.shadowsArray;if(Ae.render(j,R,Z),T===!0&&Oe.endShadows(),this.info.autoReset===!0&&this.info.reset(),(J&&b.hasRenderPass())===!1){let Be=A.opaque,Ie=A.transmissive;if(E.setupLights(),Z.isArrayCamera){let He=Z.cameras;if(Ie.length>0)for(let Xe=0,at=He.length;Xe<at;Xe++){let dt=He[Xe];lf(Be,Ie,R,dt)}ze&&we.render(R);for(let Xe=0,at=He.length;Xe<at;Xe++){let dt=He[Xe];af(A,R,dt,dt.viewport)}}else Ie.length>0&&lf(Be,Ie,R,Z),ze&&we.render(R),af(A,R,Z)}U!==null&&Y===0&&(w.updateMultisampleRenderTarget(U),w.updateRenderTargetMipmap(U)),J&&b.end(S),R.isScene===!0&&R.onAfterRender(S,R,Z),Te.resetDefaultState(),H=-1,$=null,_.pop(),_.length>0?(E=_[_.length-1],w.setTextureUnits(E.state.textureUnits),T===!0&&Oe.setGlobalState(S.clippingPlanes,E.state.camera)):E=null,P.pop(),P.length>0?A=P[P.length-1]:A=null,N!==null&&N.renderEnd()};function Zc(R,Z,te,J){if(R.visible===!1)return;if(R.layers.test(Z.layers)){if(R.isGroup)te=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(Z);else if(R.isLightProbeGrid)E.pushLightProbeGrid(R);else if(R.isLight)E.pushLight(R),R.castShadow&&E.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||se.intersectsSprite(R)){J&&Q.setFromMatrixPosition(R.matrixWorld).applyMatrix4(q);let Be=ve.update(R),Ie=R.material;Ie.visible&&A.push(R,Be,Ie,te,Q.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||se.intersectsObject(R))){let Be=ve.update(R),Ie=R.material;if(J&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),Q.copy(R.boundingSphere.center)):(Be.boundingSphere===null&&Be.computeBoundingSphere(),Q.copy(Be.boundingSphere.center)),Q.applyMatrix4(R.matrixWorld).applyMatrix4(q)),Array.isArray(Ie)){let He=Be.groups;for(let Xe=0,at=He.length;Xe<at;Xe++){let dt=He[Xe],Ze=Ie[dt.materialIndex];Ze&&Ze.visible&&A.push(R,Be,Ze,te,Q.z,dt)}}else Ie.visible&&A.push(R,Be,Ie,te,Q.z,null)}}let De=R.children;for(let Be=0,Ie=De.length;Be<Ie;Be++)Zc(De[Be],Z,te,J)}function af(R,Z,te,J){let{opaque:j,transmissive:De,transparent:Be}=R;E.setupLightsView(te),T===!0&&Oe.setGlobalState(S.clippingPlanes,te),J&&Me.viewport(le.copy(J)),j.length>0&&ia(j,Z,te),De.length>0&&ia(De,Z,te),Be.length>0&&ia(Be,Z,te),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function lf(R,Z,te,J){if((te.isScene===!0?te.overrideMaterial:null)!==null)return;if(E.state.transmissionRenderTarget[J.id]===void 0){let Ze=et.has("EXT_color_buffer_half_float")||et.has("EXT_color_buffer_float");E.state.transmissionRenderTarget[J.id]=new Fn(1,1,{generateMipmaps:!0,type:Ze?Mi:Pn,minFilter:vi,samples:Math.max(4,xt.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:mt.workingColorSpace})}let De=E.state.transmissionRenderTarget[J.id],Be=J.viewport||le;De.setSize(Be.z*S.transmissionResolutionScale,Be.w*S.transmissionResolutionScale);let Ie=S.getRenderTarget(),He=S.getActiveCubeFace(),Xe=S.getActiveMipmapLevel();S.setRenderTarget(De),S.getClearColor(Ce),Ue=S.getClearAlpha(),Ue<1&&S.setClearColor(16777215,.5),S.clear(),ze&&we.render(te);let at=S.toneMapping;S.toneMapping=ni;let dt=J.viewport;if(J.viewport!==void 0&&(J.viewport=void 0),E.setupLightsView(J),T===!0&&Oe.setGlobalState(S.clippingPlanes,J),ia(R,te,J),w.updateMultisampleRenderTarget(De),w.updateRenderTargetMipmap(De),et.has("WEBGL_multisampled_render_to_texture")===!1){let Ze=!1;for(let Pt=0,nn=Z.length;Pt<nn;Pt++){let Jt=Z[Pt],{object:Nt,geometry:yn,material:Fe,group:Dn}=Jt;if(Fe.side===In&&Nt.layers.test(J.layers)){let vt=Fe.side;Fe.side=xn,Fe.needsUpdate=!0,cf(Nt,te,J,yn,Fe,Dn),Fe.side=vt,Fe.needsUpdate=!0,Ze=!0}}Ze===!0&&(w.updateMultisampleRenderTarget(De),w.updateRenderTargetMipmap(De))}S.setRenderTarget(Ie,He,Xe),S.setClearColor(Ce,Ue),dt!==void 0&&(J.viewport=dt),S.toneMapping=at}function ia(R,Z,te){let J=Z.isScene===!0?Z.overrideMaterial:null;for(let j=0,De=R.length;j<De;j++){let Be=R[j],{object:Ie,geometry:He,group:Xe}=Be,at=Be.material;at.allowOverride===!0&&J!==null&&(at=J),Ie.layers.test(te.layers)&&cf(Ie,Z,te,He,at,Xe)}}function cf(R,Z,te,J,j,De){R.onBeforeRender(S,Z,te,J,j,De),R.modelViewMatrix.multiplyMatrices(te.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),j.onBeforeRender(S,Z,te,J,R,De),j.transparent===!0&&j.side===In&&j.forceSinglePass===!1?(j.side=xn,j.needsUpdate=!0,S.renderBufferDirect(te,Z,J,j,R,De),j.side=Fi,j.needsUpdate=!0,S.renderBufferDirect(te,Z,J,j,R,De),j.side=In):S.renderBufferDirect(te,Z,J,j,R,De),R.onAfterRender(S,Z,te,J,j,De)}function sa(R,Z,te){Z.isScene!==!0&&(Z=Ee);let J=I.get(R),j=E.state.lights,De=E.state.shadowsArray,Be=j.state.version,Ie=be.getParameters(R,j.state,De,Z,te,E.state.lightProbeGridArray),He=be.getProgramCacheKey(Ie),Xe=J.programs;J.environment=R.isMeshStandardMaterial||R.isMeshLambertMaterial||R.isMeshPhongMaterial?Z.environment:null,J.fog=Z.fog;let at=R.isMeshStandardMaterial||R.isMeshLambertMaterial&&!R.envMap||R.isMeshPhongMaterial&&!R.envMap;J.envMap=K.get(R.envMap||J.environment,at),J.envMapRotation=J.environment!==null&&R.envMap===null?Z.environmentRotation:R.envMapRotation,Xe===void 0&&(R.addEventListener("dispose",tn),Xe=new Map,J.programs=Xe);let dt=Xe.get(He);if(dt!==void 0){if(J.currentProgram===dt&&J.lightsStateVersion===Be)return df(R,Ie),dt}else Ie.uniforms=be.getUniforms(R),N!==null&&R.isNodeMaterial&&N.build(R,te,Ie),R.onBeforeCompile(Ie,S),dt=be.acquireProgram(Ie,He),Xe.set(He,dt),J.uniforms=Ie.uniforms;let Ze=J.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(Ze.clippingPlanes=Oe.uniform),df(R,Ie),J.needsLights=S0(R),J.lightsStateVersion=Be,J.needsLights&&(Ze.ambientLightColor.value=j.state.ambient,Ze.lightProbe.value=j.state.probe,Ze.directionalLights.value=j.state.directional,Ze.directionalLightShadows.value=j.state.directionalShadow,Ze.spotLights.value=j.state.spot,Ze.spotLightShadows.value=j.state.spotShadow,Ze.rectAreaLights.value=j.state.rectArea,Ze.ltc_1.value=j.state.rectAreaLTC1,Ze.ltc_2.value=j.state.rectAreaLTC2,Ze.pointLights.value=j.state.point,Ze.pointLightShadows.value=j.state.pointShadow,Ze.hemisphereLights.value=j.state.hemi,Ze.directionalShadowMatrix.value=j.state.directionalShadowMatrix,Ze.spotLightMatrix.value=j.state.spotLightMatrix,Ze.spotLightMap.value=j.state.spotLightMap,Ze.pointShadowMatrix.value=j.state.pointShadowMatrix),J.lightProbeGrid=E.state.lightProbeGridArray.length>0,J.currentProgram=dt,J.uniformsList=null,dt}function hf(R){if(R.uniformsList===null){let Z=R.currentProgram.getUniforms();R.uniformsList=Rr.seqWithValue(Z.seq,R.uniforms)}return R.uniformsList}function df(R,Z){let te=I.get(R);te.outputColorSpace=Z.outputColorSpace,te.batching=Z.batching,te.batchingColor=Z.batchingColor,te.instancing=Z.instancing,te.instancingColor=Z.instancingColor,te.instancingMorph=Z.instancingMorph,te.skinning=Z.skinning,te.morphTargets=Z.morphTargets,te.morphNormals=Z.morphNormals,te.morphColors=Z.morphColors,te.morphTargetsCount=Z.morphTargetsCount,te.numClippingPlanes=Z.numClippingPlanes,te.numIntersection=Z.numClipIntersection,te.vertexAlphas=Z.vertexAlphas,te.vertexTangents=Z.vertexTangents,te.toneMapping=Z.toneMapping}function A0(R,Z){if(R.length===0)return null;if(R.length===1)return R[0].texture!==null?R[0]:null;M.setFromMatrixPosition(Z.matrixWorld);for(let te=0,J=R.length;te<J;te++){let j=R[te];if(j.texture!==null&&j.boundingBox.containsPoint(M))return j}return null}function R0(R,Z,te,J,j){Z.isScene!==!0&&(Z=Ee),w.resetTextureUnits();let De=Z.fog,Be=J.isMeshStandardMaterial||J.isMeshLambertMaterial||J.isMeshPhongMaterial?Z.environment:null,Ie=U===null?S.outputColorSpace:U.isXRRenderTarget===!0?U.texture.colorSpace:mt.workingColorSpace,He=J.isMeshStandardMaterial||J.isMeshLambertMaterial&&!J.envMap||J.isMeshPhongMaterial&&!J.envMap,Xe=K.get(J.envMap||Be,He),at=J.vertexColors===!0&&!!te.attributes.color&&te.attributes.color.itemSize===4,dt=!!te.attributes.tangent&&(!!J.normalMap||J.anisotropy>0),Ze=!!te.morphAttributes.position,Pt=!!te.morphAttributes.normal,nn=!!te.morphAttributes.color,Jt=ni;J.toneMapped&&(U===null||U.isXRRenderTarget===!0)&&(Jt=S.toneMapping);let Nt=te.morphAttributes.position||te.morphAttributes.normal||te.morphAttributes.color,yn=Nt!==void 0?Nt.length:0,Fe=I.get(J),Dn=E.state.lights;if(T===!0&&(X===!0||R!==$)){let Bt=R===$&&J.id===H;Oe.setState(J,R,Bt)}let vt=!1;J.version===Fe.__version?(Fe.needsLights&&Fe.lightsStateVersion!==Dn.state.version||Fe.outputColorSpace!==Ie||j.isBatchedMesh&&Fe.batching===!1||!j.isBatchedMesh&&Fe.batching===!0||j.isBatchedMesh&&Fe.batchingColor===!0&&j.colorTexture===null||j.isBatchedMesh&&Fe.batchingColor===!1&&j.colorTexture!==null||j.isInstancedMesh&&Fe.instancing===!1||!j.isInstancedMesh&&Fe.instancing===!0||j.isSkinnedMesh&&Fe.skinning===!1||!j.isSkinnedMesh&&Fe.skinning===!0||j.isInstancedMesh&&Fe.instancingColor===!0&&j.instanceColor===null||j.isInstancedMesh&&Fe.instancingColor===!1&&j.instanceColor!==null||j.isInstancedMesh&&Fe.instancingMorph===!0&&j.morphTexture===null||j.isInstancedMesh&&Fe.instancingMorph===!1&&j.morphTexture!==null||Fe.envMap!==Xe||J.fog===!0&&Fe.fog!==De||Fe.numClippingPlanes!==void 0&&(Fe.numClippingPlanes!==Oe.numPlanes||Fe.numIntersection!==Oe.numIntersection)||Fe.vertexAlphas!==at||Fe.vertexTangents!==dt||Fe.morphTargets!==Ze||Fe.morphNormals!==Pt||Fe.morphColors!==nn||Fe.toneMapping!==Jt||Fe.morphTargetsCount!==yn||!!Fe.lightProbeGrid!=E.state.lightProbeGridArray.length>0)&&(vt=!0):(vt=!0,Fe.__version=J.version);let Hn=Fe.currentProgram;vt===!0&&(Hn=sa(J,Z,j),N&&J.isNodeMaterial&&N.onUpdateProgram(J,Hn,Fe));let ri=!1,Gi=!1,Os=!1,Ut=Hn.getUniforms(),sn=Fe.uniforms;if(Me.useProgram(Hn.program)&&(ri=!0,Gi=!0,Os=!0),J.id!==H&&(H=J.id,Gi=!0),Fe.needsLights){let Bt=A0(E.state.lightProbeGridArray,j);Fe.lightProbeGrid!==Bt&&(Fe.lightProbeGrid=Bt,Gi=!0)}if(ri||$!==R){Me.buffers.depth.getReversed()&&R.reversedDepth!==!0&&(R._reversedDepth=!0,R.updateProjectionMatrix()),Ut.setValue(z,"projectionMatrix",R.projectionMatrix),Ut.setValue(z,"viewMatrix",R.matrixWorldInverse);let Xi=Ut.map.cameraPosition;Xi!==void 0&&Xi.setValue(z,re.setFromMatrixPosition(R.matrixWorld)),xt.logarithmicDepthBuffer&&Ut.setValue(z,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(J.isMeshPhongMaterial||J.isMeshToonMaterial||J.isMeshLambertMaterial||J.isMeshBasicMaterial||J.isMeshStandardMaterial||J.isShaderMaterial)&&Ut.setValue(z,"isOrthographic",R.isOrthographicCamera===!0),$!==R&&($=R,Gi=!0,Os=!0)}if(Fe.needsLights&&(Dn.state.directionalShadowMap.length>0&&Ut.setValue(z,"directionalShadowMap",Dn.state.directionalShadowMap,w),Dn.state.spotShadowMap.length>0&&Ut.setValue(z,"spotShadowMap",Dn.state.spotShadowMap,w),Dn.state.pointShadowMap.length>0&&Ut.setValue(z,"pointShadowMap",Dn.state.pointShadowMap,w)),j.isSkinnedMesh){Ut.setOptional(z,j,"bindMatrix"),Ut.setOptional(z,j,"bindMatrixInverse");let Bt=j.skeleton;Bt&&(Bt.boneTexture===null&&Bt.computeBoneTexture(),Ut.setValue(z,"boneTexture",Bt.boneTexture,w))}j.isBatchedMesh&&(Ut.setOptional(z,j,"batchingTexture"),Ut.setValue(z,"batchingTexture",j._matricesTexture,w),Ut.setOptional(z,j,"batchingIdTexture"),Ut.setValue(z,"batchingIdTexture",j._indirectTexture,w),Ut.setOptional(z,j,"batchingColorTexture"),j._colorsTexture!==null&&Ut.setValue(z,"batchingColorTexture",j._colorsTexture,w));let Wi=te.morphAttributes;if((Wi.position!==void 0||Wi.normal!==void 0||Wi.color!==void 0)&&st.update(j,te,Hn),(Gi||Fe.receiveShadow!==j.receiveShadow)&&(Fe.receiveShadow=j.receiveShadow,Ut.setValue(z,"receiveShadow",j.receiveShadow)),(J.isMeshStandardMaterial||J.isMeshLambertMaterial||J.isMeshPhongMaterial)&&J.envMap===null&&Z.environment!==null&&(sn.envMapIntensity.value=Z.environmentIntensity),sn.dfgLUT!==void 0&&(sn.dfgLUT.value=eb()),Gi){if(Ut.setValue(z,"toneMappingExposure",S.toneMappingExposure),Fe.needsLights&&C0(sn,Os),De&&J.fog===!0&&oe.refreshFogUniforms(sn,De),oe.refreshMaterialUniforms(sn,J,ne,ie,E.state.transmissionRenderTarget[R.id]),Fe.needsLights&&Fe.lightProbeGrid){let Bt=Fe.lightProbeGrid;sn.probesSH.value=Bt.texture,sn.probesMin.value.copy(Bt.boundingBox.min),sn.probesMax.value.copy(Bt.boundingBox.max),sn.probesResolution.value.copy(Bt.resolution)}Rr.upload(z,hf(Fe),sn,w)}if(J.isShaderMaterial&&J.uniformsNeedUpdate===!0&&(Rr.upload(z,hf(Fe),sn,w),J.uniformsNeedUpdate=!1),J.isSpriteMaterial&&Ut.setValue(z,"center",j.center),Ut.setValue(z,"modelViewMatrix",j.modelViewMatrix),Ut.setValue(z,"normalMatrix",j.normalMatrix),Ut.setValue(z,"modelMatrix",j.matrixWorld),J.uniformsGroups!==void 0){let Bt=J.uniformsGroups;for(let Xi=0,Bs=Bt.length;Xi<Bs;Xi++){let ff=Bt[Xi];ce.update(ff,Hn),ce.bind(ff,Hn)}}return Hn}function C0(R,Z){R.ambientLightColor.needsUpdate=Z,R.lightProbe.needsUpdate=Z,R.directionalLights.needsUpdate=Z,R.directionalLightShadows.needsUpdate=Z,R.pointLights.needsUpdate=Z,R.pointLightShadows.needsUpdate=Z,R.spotLights.needsUpdate=Z,R.spotLightShadows.needsUpdate=Z,R.rectAreaLights.needsUpdate=Z,R.hemisphereLights.needsUpdate=Z}function S0(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return W},this.getActiveMipmapLevel=function(){return Y},this.getRenderTarget=function(){return U},this.setRenderTargetTextures=function(R,Z,te){let J=I.get(R);J.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,J.__autoAllocateDepthBuffer===!1&&(J.__useRenderToTexture=!1),I.get(R.texture).__webglTexture=Z,I.get(R.depthTexture).__webglTexture=J.__autoAllocateDepthBuffer?void 0:te,J.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,Z){let te=I.get(R);te.__webglFramebuffer=Z,te.__useDefaultFramebuffer=Z===void 0};let I0=z.createFramebuffer();this.setRenderTarget=function(R,Z=0,te=0){U=R,W=Z,Y=te;let J=null,j=!1,De=!1;if(R){let Ie=I.get(R);if(Ie.__useDefaultFramebuffer!==void 0){Me.bindFramebuffer(z.FRAMEBUFFER,Ie.__webglFramebuffer),le.copy(R.viewport),he.copy(R.scissor),ye=R.scissorTest,Me.viewport(le),Me.scissor(he),Me.setScissorTest(ye),H=-1;return}else if(Ie.__webglFramebuffer===void 0)w.setupRenderTarget(R);else if(Ie.__hasExternalTextures)w.rebindTextures(R,I.get(R.texture).__webglTexture,I.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){let at=R.depthTexture;if(Ie.__boundDepthTexture!==at){if(at!==null&&I.has(at)&&(R.width!==at.image.width||R.height!==at.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");w.setupDepthRenderbuffer(R)}}let He=R.texture;(He.isData3DTexture||He.isDataArrayTexture||He.isCompressedArrayTexture)&&(De=!0);let Xe=I.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(Xe[Z])?J=Xe[Z][te]:J=Xe[Z],j=!0):R.samples>0&&w.useMultisampledRTT(R)===!1?J=I.get(R).__webglMultisampledFramebuffer:Array.isArray(Xe)?J=Xe[te]:J=Xe,le.copy(R.viewport),he.copy(R.scissor),ye=R.scissorTest}else le.copy(k).multiplyScalar(ne).floor(),he.copy(D).multiplyScalar(ne).floor(),ye=L;if(te!==0&&(J=I0),Me.bindFramebuffer(z.FRAMEBUFFER,J)&&Me.drawBuffers(R,J),Me.viewport(le),Me.scissor(he),Me.setScissorTest(ye),j){let Ie=I.get(R.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ie.__webglTexture,te)}else if(De){let Ie=Z;for(let He=0;He<R.textures.length;He++){let Xe=I.get(R.textures[He]);z.framebufferTextureLayer(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0+He,Xe.__webglTexture,te,Ie)}}else if(R!==null&&te!==0){let Ie=I.get(R.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,Ie.__webglTexture,te)}H=-1},this.readRenderTargetPixels=function(R,Z,te,J,j,De,Be,Ie=0){if(!(R&&R.isWebGLRenderTarget)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let He=I.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Be!==void 0&&(He=He[Be]),He){Me.bindFramebuffer(z.FRAMEBUFFER,He);try{let Xe=R.textures[Ie],at=Xe.format,dt=Xe.type;if(R.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+Ie),!xt.textureFormatReadable(at)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!xt.textureTypeReadable(dt)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Z>=0&&Z<=R.width-J&&te>=0&&te<=R.height-j&&z.readPixels(Z,te,J,j,V.convert(at),V.convert(dt),De)}finally{let Xe=U!==null?I.get(U).__webglFramebuffer:null;Me.bindFramebuffer(z.FRAMEBUFFER,Xe)}}},this.readRenderTargetPixelsAsync=async function(R,Z,te,J,j,De,Be,Ie=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let He=I.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Be!==void 0&&(He=He[Be]),He)if(Z>=0&&Z<=R.width-J&&te>=0&&te<=R.height-j){Me.bindFramebuffer(z.FRAMEBUFFER,He);let Xe=R.textures[Ie],at=Xe.format,dt=Xe.type;if(R.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+Ie),!xt.textureFormatReadable(at))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!xt.textureTypeReadable(dt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Ze=z.createBuffer();z.bindBuffer(z.PIXEL_PACK_BUFFER,Ze),z.bufferData(z.PIXEL_PACK_BUFFER,De.byteLength,z.STREAM_READ),z.readPixels(Z,te,J,j,V.convert(at),V.convert(dt),0);let Pt=U!==null?I.get(U).__webglFramebuffer:null;Me.bindFramebuffer(z.FRAMEBUFFER,Pt);let nn=z.fenceSync(z.SYNC_GPU_COMMANDS_COMPLETE,0);return z.flush(),await Mm(z,nn,4),z.bindBuffer(z.PIXEL_PACK_BUFFER,Ze),z.getBufferSubData(z.PIXEL_PACK_BUFFER,0,De),z.deleteBuffer(Ze),z.deleteSync(nn),De}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,Z=null,te=0){let J=Math.pow(2,-te),j=Math.floor(R.image.width*J),De=Math.floor(R.image.height*J),Be=Z!==null?Z.x:0,Ie=Z!==null?Z.y:0;w.setTexture2D(R,0),z.copyTexSubImage2D(z.TEXTURE_2D,te,0,0,Be,Ie,j,De),Me.unbindTexture()};let P0=z.createFramebuffer(),D0=z.createFramebuffer();this.copyTextureToTexture=function(R,Z,te=null,J=null,j=0,De=0){let Be,Ie,He,Xe,at,dt,Ze,Pt,nn,Jt=R.isCompressedTexture?R.mipmaps[De]:R.image;if(te!==null)Be=te.max.x-te.min.x,Ie=te.max.y-te.min.y,He=te.isBox3?te.max.z-te.min.z:1,Xe=te.min.x,at=te.min.y,dt=te.isBox3?te.min.z:0;else{let sn=Math.pow(2,-j);Be=Math.floor(Jt.width*sn),Ie=Math.floor(Jt.height*sn),R.isDataArrayTexture?He=Jt.depth:R.isData3DTexture?He=Math.floor(Jt.depth*sn):He=1,Xe=0,at=0,dt=0}J!==null?(Ze=J.x,Pt=J.y,nn=J.z):(Ze=0,Pt=0,nn=0);let Nt=V.convert(Z.format),yn=V.convert(Z.type),Fe;Z.isData3DTexture?(w.setTexture3D(Z,0),Fe=z.TEXTURE_3D):Z.isDataArrayTexture||Z.isCompressedArrayTexture?(w.setTexture2DArray(Z,0),Fe=z.TEXTURE_2D_ARRAY):(w.setTexture2D(Z,0),Fe=z.TEXTURE_2D),Me.activeTexture(z.TEXTURE0),Me.pixelStorei(z.UNPACK_FLIP_Y_WEBGL,Z.flipY),Me.pixelStorei(z.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),Me.pixelStorei(z.UNPACK_ALIGNMENT,Z.unpackAlignment);let Dn=Me.getParameter(z.UNPACK_ROW_LENGTH),vt=Me.getParameter(z.UNPACK_IMAGE_HEIGHT),Hn=Me.getParameter(z.UNPACK_SKIP_PIXELS),ri=Me.getParameter(z.UNPACK_SKIP_ROWS),Gi=Me.getParameter(z.UNPACK_SKIP_IMAGES);Me.pixelStorei(z.UNPACK_ROW_LENGTH,Jt.width),Me.pixelStorei(z.UNPACK_IMAGE_HEIGHT,Jt.height),Me.pixelStorei(z.UNPACK_SKIP_PIXELS,Xe),Me.pixelStorei(z.UNPACK_SKIP_ROWS,at),Me.pixelStorei(z.UNPACK_SKIP_IMAGES,dt);let Os=R.isDataArrayTexture||R.isData3DTexture,Ut=Z.isDataArrayTexture||Z.isData3DTexture;if(R.isDepthTexture){let sn=I.get(R),Wi=I.get(Z),Bt=I.get(sn.__renderTarget),Xi=I.get(Wi.__renderTarget);Me.bindFramebuffer(z.READ_FRAMEBUFFER,Bt.__webglFramebuffer),Me.bindFramebuffer(z.DRAW_FRAMEBUFFER,Xi.__webglFramebuffer);for(let Bs=0;Bs<He;Bs++)Os&&(z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,I.get(R).__webglTexture,j,dt+Bs),z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,I.get(Z).__webglTexture,De,nn+Bs)),z.blitFramebuffer(Xe,at,Be,Ie,Ze,Pt,Be,Ie,z.DEPTH_BUFFER_BIT,z.NEAREST);Me.bindFramebuffer(z.READ_FRAMEBUFFER,null),Me.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else if(j!==0||R.isRenderTargetTexture||I.has(R)){let sn=I.get(R),Wi=I.get(Z);Me.bindFramebuffer(z.READ_FRAMEBUFFER,P0),Me.bindFramebuffer(z.DRAW_FRAMEBUFFER,D0);for(let Bt=0;Bt<He;Bt++)Os?z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,sn.__webglTexture,j,dt+Bt):z.framebufferTexture2D(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,sn.__webglTexture,j),Ut?z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,Wi.__webglTexture,De,nn+Bt):z.framebufferTexture2D(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,Wi.__webglTexture,De),j!==0?z.blitFramebuffer(Xe,at,Be,Ie,Ze,Pt,Be,Ie,z.COLOR_BUFFER_BIT,z.NEAREST):Ut?z.copyTexSubImage3D(Fe,De,Ze,Pt,nn+Bt,Xe,at,Be,Ie):z.copyTexSubImage2D(Fe,De,Ze,Pt,Xe,at,Be,Ie);Me.bindFramebuffer(z.READ_FRAMEBUFFER,null),Me.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else Ut?R.isDataTexture||R.isData3DTexture?z.texSubImage3D(Fe,De,Ze,Pt,nn,Be,Ie,He,Nt,yn,Jt.data):Z.isCompressedArrayTexture?z.compressedTexSubImage3D(Fe,De,Ze,Pt,nn,Be,Ie,He,Nt,Jt.data):z.texSubImage3D(Fe,De,Ze,Pt,nn,Be,Ie,He,Nt,yn,Jt):R.isDataTexture?z.texSubImage2D(z.TEXTURE_2D,De,Ze,Pt,Be,Ie,Nt,yn,Jt.data):R.isCompressedTexture?z.compressedTexSubImage2D(z.TEXTURE_2D,De,Ze,Pt,Jt.width,Jt.height,Nt,Jt.data):z.texSubImage2D(z.TEXTURE_2D,De,Ze,Pt,Be,Ie,Nt,yn,Jt);Me.pixelStorei(z.UNPACK_ROW_LENGTH,Dn),Me.pixelStorei(z.UNPACK_IMAGE_HEIGHT,vt),Me.pixelStorei(z.UNPACK_SKIP_PIXELS,Hn),Me.pixelStorei(z.UNPACK_SKIP_ROWS,ri),Me.pixelStorei(z.UNPACK_SKIP_IMAGES,Gi),De===0&&Z.generateMipmaps&&z.generateMipmap(Fe),Me.unbindTexture()},this.initRenderTarget=function(R){I.get(R).__webglFramebuffer===void 0&&w.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?w.setTextureCube(R,0):R.isData3DTexture?w.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?w.setTexture2DArray(R,0):w.setTexture2D(R,0),Me.unbindTexture()},this.resetState=function(){W=0,Y=0,U=null,Me.reset(),Te.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ti}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=mt._getDrawingBufferColorSpace(e),t.unpackColorSpace=mt._getUnpackColorSpace()}};function o0(n,e){let t=new Oc({canvas:e.canvas,antialias:!0});t.setPixelRatio(Math.min(2,devicePixelRatio||1)),t.setSize(e.VW,e.VH),t.outputColorSpace=on;let i=new yo;i.background=new nt(861232);let s=new bn(50,e.VW/e.VH,10,6e4),r=new Bo(15397624,4867128,.95);i.add(r);let o=new Ho(16773852,1.35);o.position.set(-.45,1,-.3).multiplyScalar(1e3),i.add(o);let a=new an;i.add(a),o.target=a,i.fog=new xo(10466494,2600,9e3);let l={renderer:t,scene:i,camera:s,sun:o,hemi:r,cx:n.player.x,cy:n.player.y,dist:1150,elev:.96,shakeX:0,shakeY:0,orbit:0,zoomFactor:1,_ray:new Vo,_plane:new Xn(new F(0,1,0),0),_v3:new F,lightLevel(){return .5+.5*Math.cos(Math.PI*2*(n.t%Lr/Lr))},resize(){s.aspect=e.VW/e.VH,s.updateProjectionMatrix(),t.setSize(e.VW,e.VH)},update(c){let d=n.player,h=d.x,f=d.y,u=1500*l.zoomFactor,p=.96;if(e.godView){h=ue.w/2,f=ue.h/2,p=1.52;let _=Math.tan(s.fov/2*Math.PI/180),b=(ue.h/2+500)/_,S=(ue.w/2+500)/(_*s.aspect);u=Math.max(b,S)*1.02}else d.inCopter&&n.copter&&(u=(1850+Math.hypot(n.copter.vx,n.copter.vy)*.9)*l.zoomFactor);l._wasGod!==e.godView&&(l._wasGod=e.godView,l.cx=h,l.cy=f,l.dist=u,l.elev=p);let x=Math.min(1,c*(e.godView?6:5));l.cx=Nr(l.cx,h,x),l.cy=Nr(l.cy,f,x),l.dist=Nr(l.dist,u,Math.min(1,c*4)),l.elev=Nr(l.elev,p,Math.min(1,c*4)),n.shake>0?(l.shakeX=(Math.random()*2-1)*n.shake,l.shakeY=(Math.random()*2-1)*n.shake):(l.shakeX=0,l.shakeY=0);let m=l.cx+l.shakeX,g=l.cy+l.shakeY,y=Math.sin(l.elev)*l.dist,v=Math.cos(l.elev)*l.dist,M=e.godView?0:l.orbit;s.position.set(m+Math.sin(M)*v,y,g+Math.cos(M)*v),s.lookAt(m,0,g),a.position.set(m,0,g);let A=l.lightLevel(),E=Math.sin((1-A)*Math.PI);o.intensity=1+A*.45,o.color.setHSL(.105-E*.045,.52+E*.25,.62-E*.06),r.intensity=.78+A*.25;let P=n.t%Lr/Lr*Math.PI*2;o.position.set(m+Math.cos(P)*1400,900+A*600,g+Math.sin(P)*1400-400),i.fog.near=l.dist*2.2,i.fog.far=l.dist*8,l._viewR=l.dist*1.9},render(){t.render(i,s)},screenToWorld(c,d){let h=new Pe(c/e.VW*2-1,-(d/e.VH)*2+1);l._ray.setFromCamera(h,s);let f=new F;return l._ray.ray.intersectPlane(l._plane,f),f?{x:f.x,y:f.z}:{x:l.cx,y:l.cy}},worldToScreen(c,d,h=0){return l._v3.set(c,h,d).project(s),{x:(l._v3.x+1)/2*e.VW,y:(-l._v3.y+1)/2*e.VH,behind:l._v3.z>1}},inView(c,d,h=0){let f=c-l.cx,u=d-l.cy;return f*f+u*u<(l._viewR+h)*(l._viewR+h)},viewRect(c=0){let d=l._viewR+c;return{x0:l.cx-d,y0:l.cy-d,x1:l.cx+d,y1:l.cy+d}},get zoom(){return 900/l.dist}};return l.update(.1),l}var Hc=.45;function l0(n,e){let t=Math.round(ue.w*Hc),i=Math.round(ue.h*Hc),s=document.createElement("canvas");s.width=t,s.height=i;let r=s.getContext("2d");r.save(),r.scale(Hc,Hc),tb(n,r),r.restore();let o=new qn(s);o.colorSpace=on,o.anisotropy=8,o.minFilter=vi;let a=new ge(new Yn(ue.w,ue.h),new Sn({map:o,transparent:!0}));a.rotation.x=-Math.PI/2,a.position.set(ue.w/2,0,ue.h/2),a.renderOrder=-1,e.add(a);let l=new ge(new Yn(ue.w*6,ue.h*6),new Sn({color:1060924}));l.rotation.x=-Math.PI/2,l.position.set(ue.w/2,-3,ue.h/2),e.add(l);let c=document.createElement("canvas");c.width=256,c.height=256;let d=c.getContext("2d");for(let A=0;A<260;A++){let E=Math.random()*256,P=Math.random()*256;d.fillStyle=`rgba(200,235,245,${.25+Math.random()*.5})`,d.fillRect(E,P,1.6+Math.random()*2.4,1.2)}let h=new qn(c);h.wrapS=h.wrapT=di,h.repeat.set(220,146);let f=new ge(new Yn(ue.w*6,ue.h*6),new Yt({map:h,transparent:!0,opacity:.5,depthWrite:!1,blending:wn}));f.rotation.x=-Math.PI/2,f.position.set(ue.w/2,-1.5,ue.h/2),f.renderOrder=-2,e.add(f);let u=h.clone();u.wrapS=u.wrapT=di,u.repeat.set(133,88);let p=new ge(new Yn(ue.w*6,ue.h*6),new Yt({map:u,transparent:!0,opacity:.3,depthWrite:!1,blending:wn}));p.rotation.x=-Math.PI/2,p.position.set(ue.w/2,-1.2,ue.h/2),p.renderOrder=-2,e.add(p);let x=[];for(let A of n.world.lakes){if(A.frozen)continue;let E=new vr;for(let C=0;C<=28;C++){let N=C/28*Math.PI*2,W=A.r*A.wob[C%28],Y=Math.cos(N)*W,U=-Math.sin(N)*W*.84;C?E.lineTo(Y,U):E.moveTo(Y,U)}let P=new ko(E),_=new ge(P,new Yt({color:3040376,transparent:!0,opacity:.45,depthWrite:!1}));_.rotation.x=-Math.PI/2,_.position.set(A.x,1.2,A.y),_.renderOrder=1,e.add(_);let b=h.clone();b.wrapS=b.wrapT=di,b.repeat.set(.045,.045);let S=new ge(P,new Yt({map:b,transparent:!0,opacity:.4,depthWrite:!1,blending:wn}));S.rotation.x=-Math.PI/2,S.position.set(A.x,1.5,A.y),S.renderOrder=2,e.add(S),x.push(b)}let m=document.createElement("canvas");m.width=4,m.height=256;let g=m.getContext("2d"),y=g.createLinearGradient(0,0,0,256);y.addColorStop(0,"#5d9bd3"),y.addColorStop(.62,"#9cc3dd"),y.addColorStop(.78,"#cfddd8"),y.addColorStop(1,"#dfe5da"),g.fillStyle=y,g.fillRect(0,0,4,256);let v=new qn(m);v.colorSpace=on;let M=new ge(new Ds(34e3,18,12,0,Math.PI*2,0,Math.PI/2),new Yt({map:v,side:xn,fog:!1}));return M.position.set(ue.w/2,-40,ue.h/2),e.add(M),e.background=null,{tex:o,sync(A,E,P){let _=f.material.map,b=p.material.map;_.offset.x+=A*.0022,_.offset.y+=A*.0013,b.offset.x-=A*.0011,b.offset.y+=A*8e-4;for(let C of x)C.offset.x+=A*.006,C.offset.y+=A*.0035;M.position.set(P.cx,-40,P.cy);let S=P.lightLevel();M.material.color.setHSL(.58,.18,.62+S*.38)}}}function a0(n,e,t){let i=(e+n.world.biomeRidge(t))/ue.w,s=.05,r=Ai((i-(1/3-s))/(2*s)),o=Ai((i-(2/3-s))/(2*s)),a=(f,u,p)=>[f[0]+(u[0]-f[0])*p,f[1]+(u[1]-f[1])*p,f[2]+(u[2]-f[2])*p],l=[181,154,102],c=[74,92,48],d=[185,199,209],h=a(l,c,r);return h=a(h,d,o),h}function Qd(n,e){e.beginPath(),n.world.islandPath.forEach((t,i)=>i?e.lineTo(t.x,t.y):e.moveTo(t.x,t.y)),e.closePath()}function tb(n,e){let t=ue.w,i=ue.h;e.lineJoin="round",e.strokeStyle="rgba(64,124,134,0.45)",e.lineWidth=64,Qd(n,e),e.stroke(),e.strokeStyle="rgba(90,150,158,0.30)",e.lineWidth=26,Qd(n,e),e.stroke(),e.save(),Qd(n,e),e.clip();let s=32;for(let h=0;h<i;h+=s)for(let f=0;f<t;f+=s){if(n.world.landFactor(f+s/2,h+s/2)<=-.25)continue;let[p,x,m]=a0(n,f+s/2,h+s/2),g=Zi(f/s|0,h/s|0),y=Zi(f/96|0,h/96|0),v=.88+g*.14+(y-.5)*.12-h/i*.06;p*=v,x*=v,m*=v,e.fillStyle=`rgb(${p|0},${x|0},${m|0})`,e.fillRect(f-1,h-1,s+2,s+2)}e.lineCap="round";let r=n.world.islandPath;for(let h=0;h<3;h++){let f=h===0?96:h===1?30:7;for(let u=0;u<r.length;u++){let p=r[u],x=r[(u+1)%r.length],m=n.world.biomeAt((p.x+x.x)/2,(p.y+x.y)/2)==="winter";e.strokeStyle=h===0?m?"rgba(214,227,235,0.95)":"rgba(186,166,120,0.95)":h===1?m?"rgba(168,190,204,0.9)":"rgba(146,128,92,0.9)":"rgba(240,248,252,0.55)",e.lineWidth=f,e.beginPath(),e.moveTo(p.x,p.y),e.lineTo(x.x,x.y),e.stroke()}}for(let h of n.world.lakes){e.save(),e.translate(h.x,h.y);let f=()=>{e.beginPath();for(let p=0;p<=28;p++){let x=p/28*Math.PI*2,m=h.r*h.wob[p%28],g=Math.cos(x)*m,y=Math.sin(x)*m*.84;p?e.lineTo(g,y):e.moveTo(g,y)}e.closePath()};e.save(),e.scale(1.06,1.06),f(),e.fillStyle=h.frozen?"rgba(238,246,251,.95)":"rgba(96,118,66,.7)",e.fill(),e.restore(),f();let u=e.createRadialGradient(0,-.3*h.r,h.r*.1,0,0,h.r);h.frozen?(u.addColorStop(0,"#dfeaf2"),u.addColorStop(1,"#96b2c8")):(u.addColorStop(0,"#33687c"),u.addColorStop(1,"#0c2531")),e.fillStyle=u,e.fill(),e.restore()}for(let h of n.world.monuments){let f=e.createRadialGradient(h.x,h.y,h.r*.2,h.x,h.y,h.r);f.addColorStop(0,"rgba(110,106,95,.5)"),f.addColorStop(.8,"rgba(98,94,84,.32)"),f.addColorStop(1,"rgba(90,86,76,0)"),e.fillStyle=f,e.beginPath(),e.arc(h.x,h.y,h.r,0,7),e.fill()}e.lineCap="round",e.lineJoin="round";let o=[];for(let h of n.world.roads){let f=null;for(let u=0;u<h.pts.length;u++)h.fade[u]>.05?(f||(f={rd:h,pts:[]}),f.pts.push(h.pts[u])):f&&(f.pts.length>1&&o.push(f),f=null);f&&f.pts.length>1&&o.push(f)}let a=(h,f)=>{let u=[];for(let p=0;p<h.length-1;p++){let x=h[p],m=h[p+1],g=Math.hypot(m.x-x.x,m.y-x.y),y=Math.max(1,Math.ceil(g/f));for(let v=0;v<y;v++)u.push({x:x.x+(m.x-x.x)*(v/y),y:x.y+(m.y-x.y)*(v/y)})}return u.push(h[h.length-1]),u},l=(h,f,u,p,x)=>{e.fillStyle=f,e.globalAlpha=x;let m=a(h.pts,u*.55);for(let g=0;g<m.length;g++){let y=m[g],v=Zi(y.x*.13|0,y.y*.13|0),M=Zi(y.x*.31|0,y.y*.07|0),A=u*(.86+v*.34),E=(M-.5)*p,P=(v-.5)*p;e.beginPath(),e.arc(y.x+E,y.y+P,A,0,7),e.fill()}e.globalAlpha=1};for(let h of o)l(h,"#564a31",h.rd.w*.62,9,.85);for(let h of o)l(h,"#6c5d3b",h.rd.w*.46,6,1);for(let h of o)l(h,"#75653f",h.rd.w*.3,8,.5);for(let h of o){e.fillStyle="#5d5034";let f=a(h.pts,34);for(let u=0;u<f.length;u++){let p=f[u],x=Zi(p.x*.21|0,p.y*.17|0);if(x<.45)continue;let m=f[Math.max(0,u-1)],g=f[Math.min(f.length-1,u+1)],y=Math.atan2(g.y-m.y,g.x-m.x)+Math.PI/2,v=x>.72?1:-1,M=h.rd.w*.58+x*53%1*14;e.globalAlpha=.4,e.beginPath(),e.arc(p.x+Math.cos(y)*M*v,p.y+Math.sin(y)*M*v,2.5+x*31%1*5,0,7),e.fill()}e.globalAlpha=1}e.globalAlpha=.3;for(let h of o)e.strokeStyle="#544731",e.lineWidth=4,e.beginPath(),h.pts.forEach((f,u)=>u?e.lineTo(f.x,f.y):e.moveTo(f.x,f.y)),e.stroke();e.globalAlpha=1;for(let h of o){let f=a(h.pts,90);e.fillStyle="rgba(58,48,30,0.5)";for(let u of f){let p=Zi(u.x*.07|0,u.y*.23|0);p>.82&&(e.beginPath(),e.ellipse(u.x+(p*91%1-.5)*h.rd.w*.5,u.y+(p*47%1-.5)*h.rd.w*.5,4+p*5,3+p*3,p*6,0,7),e.fill())}}let c=11;for(let h of n.world.crossings){let f=Math.cos(h.railAng),u=Math.sin(h.railAng);e.save(),e.translate(h.x,h.y),e.rotate(h.railAng);let p=e.createRadialGradient(0,0,10,0,0,64);p.addColorStop(0,"rgba(116,104,78,0.95)"),p.addColorStop(.7,"rgba(108,96,72,0.7)"),p.addColorStop(1,"rgba(100,90,68,0)"),e.fillStyle=p,e.beginPath(),e.ellipse(0,0,64,50,0,0,7),e.fill(),e.fillStyle="#7b6a45";for(let x of[-c-7,0,c+7])e.fillRect(-34,x-3.4,68,6.8);e.strokeStyle="rgba(60,50,34,0.5)",e.lineWidth=1.2;for(let x of[-c-7,0,c+7])e.strokeRect(-34,x-3.4,68,6.8);e.restore()}let d=(h,f)=>n.world.crossings.some(u=>(h-u.x)*(h-u.x)+(f-u.y)*(f-u.y)<2704);for(let h of n.world.rails){let f=()=>{e.beginPath(),h.pts.forEach((u,p)=>p?e.lineTo(u.x,u.y):e.moveTo(u.x,u.y))};f(),e.strokeStyle="rgba(87,77,64,0.85)",e.lineWidth=2*c+16,e.stroke(),f(),e.strokeStyle="rgba(107,95,78,0.85)",e.lineWidth=2*c+7,e.stroke(),e.strokeStyle="#3a2e1d",e.lineWidth=4.5;for(let u=0;u<h.pts.length-1;u++){let p=h.pts[u],x=h.pts[u+1],m=Math.hypot(x.x-p.x,x.y-p.y),g=Math.atan2(x.y-p.y,x.x-p.x),y=-Math.sin(g),v=Math.cos(g);for(let M=8;M<m;M+=24){let A=p.x+Math.cos(g)*M,E=p.y+Math.sin(g)*M;d(A,E)||(e.beginPath(),e.moveTo(A-y*(c+5),E-v*(c+5)),e.lineTo(A+y*(c+5),E+v*(c+5)),e.stroke())}}e.strokeStyle="#a4abb2",e.lineWidth=2.8;for(let u of[-c,c]){e.beginPath();for(let p=0;p<h.pts.length;p++){let x=h.pts[Math.max(0,p-1)],m=h.pts[Math.min(h.pts.length-1,p+1)],g=Math.atan2(m.y-x.y,m.x-x.x),y=-Math.sin(g),v=Math.cos(g),M=h.pts[p].x+y*u,A=h.pts[p].y+v*u;p?e.lineTo(M,A):e.moveTo(M,A)}e.stroke()}}for(let h=0;h<i;h+=96)for(let f=0;f<t;f+=96){if(!n.world.onLand(f,h)||n.world.lakeAt(f,h))continue;let u=Zi(f/96|0,h/96|0);if(u>.5)continue;let[p,x,m]=a0(n,f,h);e.fillStyle=`rgba(${p*.75|0},${x*.75|0},${m*.75|0},0.5)`,e.beginPath(),e.ellipse(f+u*80,h+u*7919%1*80,9+u*14,5+u*8,u*6,0,7),e.fill()}e.restore()}var ef=new Map;function _e(n,e={}){let t=n+JSON.stringify(e);return ef.has(t)||ef.set(t,new Sn({color:n,emissive:e.emissive||0,emissiveIntensity:e.emissiveIntensity??1,transparent:!!e.transparent,opacity:e.opacity??1,flatShading:!0})),ef.get(t)}var fe={box:new rs(1,1,1),cyl:new Ss(1,1,1,8),cyl6:new Ss(1,1.18,1,6),cone:new Ao(1,1,7),ico:new Ps(1,0),sphere:new Ds(1,8,6),quad:new Yn(1,1)},Vc=null;function nb(){if(Vc)return Vc;let n=document.createElement("canvas");n.width=64,n.height=64;let e=n.getContext("2d"),t=e.createRadialGradient(32,32,2,32,32,32);return t.addColorStop(0,"rgba(255,255,255,1)"),t.addColorStop(.4,"rgba(255,255,255,0.45)"),t.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=t,e.fillRect(0,0,64,64),Vc=new qn(n),Vc}var Gc=null;function Xc(){if(Gc)return Gc;let n=document.createElement("canvas");n.width=128,n.height=128;let e=n.getContext("2d"),t=e.createRadialGradient(64,64,6,64,64,64);t.addColorStop(0,"rgba(255,255,255,0.5)"),t.addColorStop(.55,"rgba(255,255,255,0.42)"),t.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=t,e.fillRect(0,0,128,128),e.globalCompositeOperation="destination-out";for(let i=0;i<5;i++){let s=i*1.26,r=58,o=e.createRadialGradient(64+Math.cos(s)*r,64+Math.sin(s)*r,2,64+Math.cos(s)*r,64+Math.sin(s)*r,26);o.addColorStop(0,"rgba(0,0,0,0.5)"),o.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=o,e.fillRect(0,0,128,128)}return Gc=new qn(n),Gc}var Wc=null;function nf(){if(Wc)return Wc;let n=document.createElement("canvas");n.width=64,n.height=64;let e=n.getContext("2d"),t=e.createRadialGradient(32,32,4,32,32,30);return t.addColorStop(0,"rgba(8,8,6,0.42)"),t.addColorStop(.7,"rgba(8,8,6,0.22)"),t.addColorStop(1,"rgba(8,8,6,0)"),e.fillStyle=t,e.fillRect(0,0,64,64),Wc=new qn(n),Wc}function us(n,e=60){let t=new ss({map:nb(),color:n,transparent:!0,blending:wn,depthWrite:!1,depthTest:!1}),i=new Cs(t);return i.scale.set(e,e,1),i.renderOrder=4,i}var tf=null;function Fs(n=40){tf||(tf=new yi(.5,14));let e=new Yt({map:nf(),transparent:!0,depthWrite:!1}),t=new ge(tf,e);return t.rotation.x=-Math.PI/2,t.scale.set(n,n*.8,1),t}var ta={wood:6111006,stone:5659747,metal:3948871,armored:2567996},Sr=new Map;function c0(n){let e=document.createElement("canvas");e.width=128,e.height=128;let t=e.getContext("2d"),i=ib(n.length*1337+7);if(n==="wood"){t.fillStyle="#86602e",t.fillRect(0,0,128,128);for(let r=0;r<128;r+=21){t.fillStyle=`rgba(${70+i()*50|0},${48+i()*34|0},${20+i()*16|0},0.55)`,t.fillRect(r,0,21,128),t.fillStyle="rgba(42,28,12,0.85)",t.fillRect(r,0,2,128),t.strokeStyle="rgba(50,34,14,0.30)",t.lineWidth=1;for(let o=0;o<5;o++){let a=r+4+i()*14;t.beginPath(),t.moveTo(a,0),t.bezierCurveTo(a+i()*4-2,40,a+i()*4-2,88,a,128),t.stroke()}if(i()>.55){let o=r+6+i()*10,a=i()*128;t.fillStyle="rgba(40,26,10,0.6)",t.beginPath(),t.ellipse(o,a,3.2,4.5,.3,0,7),t.fill(),t.strokeStyle="rgba(120,90,48,0.5)",t.beginPath(),t.ellipse(o,a,5,6.5,.3,0,7),t.stroke()}}t.fillStyle="rgba(255,235,200,0.05)",t.fillRect(0,0,128,10)}else if(n==="stone"){t.fillStyle="#7b8289",t.fillRect(0,0,128,128);let r=26;for(let o=0;o<5;o++){let a=o%2*26;for(let l=-26;l<128;l+=52){let c=l+a;t.fillStyle=`rgba(${108+i()*34|0},${114+i()*32|0},${120+i()*30|0},0.7)`,t.fillRect(c+2,o*r+2,48,r-4),t.strokeStyle="rgba(60,66,72,0.35)",t.lineWidth=1;for(let d=0;d<3;d++){let h=c+6+i()*38,f=o*r+5+i()*(r-10);t.beginPath(),t.moveTo(h,f),t.lineTo(h+6+i()*8,f+i()*3-1.5),t.stroke()}}t.fillStyle="rgba(70,76,82,0.9)",t.fillRect(0,o*r-1.5,128,3)}}else if(n==="metal"){t.fillStyle="#5b6168",t.fillRect(0,0,128,128);for(let r=0;r<128;r+=43){t.fillStyle=`rgba(${80+i()*26|0},${88+i()*22|0},${96+i()*20|0},0.45)`,t.fillRect(r+2,0,39,128),t.fillStyle="rgba(34,38,43,0.9)",t.fillRect(r,0,2.4,128);for(let o=8;o<128;o+=18)t.fillStyle="rgba(28,32,36,0.9)",t.beginPath(),t.arc(r+6,o,1.9,0,7),t.fill(),t.fillStyle="rgba(200,210,218,0.5)",t.beginPath(),t.arc(r+5.4,o-.6,.8,0,7),t.fill()}t.strokeStyle="rgba(168,178,188,0.25)";for(let r=0;r<7;r++){let o=i()*128,a=i()*128;t.beginPath(),t.moveTo(o,a),t.lineTo(o+10+i()*22,a+i()*6-3),t.stroke()}for(let r=0;r<5;r++){let o=i()*128,a=i()*128,l=t.createRadialGradient(o,a,1,o,a,7+i()*10);l.addColorStop(0,"rgba(140,72,30,0.5)"),l.addColorStop(1,"rgba(140,72,30,0)"),t.fillStyle=l,t.fillRect(o-18,a-18,36,36)}}else{t.fillStyle="#3c4a5e",t.fillRect(0,0,128,128),t.strokeStyle="rgba(22,28,38,0.9)",t.lineWidth=6,t.strokeRect(3,3,122,122),t.strokeStyle="rgba(30,38,50,0.85)",t.lineWidth=10,t.beginPath(),t.moveTo(0,0),t.lineTo(128,128),t.stroke(),t.beginPath(),t.moveTo(128,0),t.lineTo(0,128),t.stroke(),t.strokeStyle="rgba(110,130,160,0.35)",t.lineWidth=2,t.beginPath(),t.moveTo(0,0),t.lineTo(128,128),t.stroke(),t.beginPath(),t.moveTo(128,0),t.lineTo(0,128),t.stroke(),t.fillStyle="rgba(190,205,225,0.6)";for(let[r,o]of[[12,12],[116,12],[12,116],[116,116],[64,14],[64,114],[14,64],[114,64]])t.beginPath(),t.arc(r,o,2.6,0,7),t.fill();t.fillStyle="rgba(255,255,255,0.05)",t.fillRect(0,0,128,22)}let s=new qn(e);return s.wrapS=s.wrapT=di,s.colorSpace=on,s}function ib(n){let e=n>>>0;return()=>{e|=0,e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}function na(n){let e="w"+n;return Sr.has(e)||Sr.set(e,new Sn({map:c0(n),flatShading:!0})),Sr.get(e)}function h0(n){let e="f"+n;if(!Sr.has(e)){let t=new Sn({map:c0(n),flatShading:!0});t.color.setScalar(.72),Sr.set(e,t)}return Sr.get(e)}var d0=Math.PI*2;function f0(n,e){let t=n.resources.filter(D=>D.type==="tree"),i=n.resources.filter(D=>D.type==="stone"),s=n.resources.filter(D=>D.type==="metal"),r=new Lt(fe.cyl,_e(6111008),t.length),o=new Lt(fe.cone,_e(16777215),t.length),a=new Lt(fe.cone,_e(16777215),t.length),l=new Lt(fe.cone,_e(16777215),t.length),c=new Lt(fe.ico,_e(16777215),t.length),d=new Lt(fe.ico,_e(16777215),t.length),h=new Lt(fe.cone,_e(15660281),t.length),f=new Lt(fe.ico,_e(9278603),i.length),u=new Lt(fe.ico,_e(8094328),i.length),p=new Lt(fe.ico,_e(9271114),s.length),x=new Lt(fe.ico,_e(14198864,{emissive:6965776}),s.length),m=new Lt(fe.ico,_e(13145412,{emissive:5914124}),s.length);for(let D of[r,o,a,l,c,d,h,f,u,p,x,m])D.frustumCulled=!1,e.add(D);let g=new nt,y=new nt,v=[],M=[];t.forEach((D,L)=>{let se=.85+D.seed*7.3%1*.4,T=n.world.biomeAt(D.x,D.y)==="winter",X=!T&&D.seed*13.1%1<.42;v.push(T),M.push(X),g.setHex(T?3953968:3494175).multiplyScalar(se),y.setHex(T?5995082:5274160).multiplyScalar(se),o.setColorAt(L,g),a.setColorAt(L,y),l.setColorAt(L,y),g.setHex(4613672).multiplyScalar(se),y.setHex(6127926).multiplyScalar(se),c.setColorAt(L,g),d.setColorAt(L,y)});for(let D of[o,a,l,c,d])D.instanceColor&&(D.instanceColor.needsUpdate=!0);let A=new gt,E=0;function P(){let D=new F(.001,.001,.001);t.forEach((L,se)=>{let T=L.amount<=0?.001:.55+.45*(L.amount/L.max),X=(L.seed*13.7%1-.5)*.12,q=M[se];A.makeRotationZ(X).scale(new F(7*T,30*T,7*T)).setPosition(L.x,15*T,L.y),r.setMatrixAt(se,A),A.makeRotationY(L.seed).scale(q?D:new F(31*T,36*T,31*T)).setPosition(L.x,32*T,L.y),o.setMatrixAt(se,A),A.makeRotationY(L.seed*2).scale(q?D:new F(23*T,28*T,23*T)).setPosition(L.x+2,52*T,L.y-2),a.setMatrixAt(se,A),A.makeRotationY(L.seed*3).scale(q?D:new F(14*T,22*T,14*T)).setPosition(L.x+3,70*T,L.y-3),l.setMatrixAt(se,A),A.makeRotationY(L.seed).scale(q?new F(26*T,20*T,26*T):D).setPosition(L.x,42*T,L.y),c.setMatrixAt(se,A),A.makeRotationY(L.seed*2.3).scale(q?new F(17*T,14*T,17*T):D).setPosition(L.x+6*T,56*T,L.y-4*T),d.setMatrixAt(se,A);let re=v[se]?T:.001;A.makeScale(11*re,10*re,11*re).setPosition(L.x+3,80*re,L.y-3),h.setMatrixAt(se,A)}),i.forEach((L,se)=>{let T=L.amount<=0?.001:(.55+.45*(L.amount/L.max))*L.r;A.makeRotationY(L.seed).scale(new F(T,T*.75,T)).setPosition(L.x,T*.45,L.y),f.setMatrixAt(se,A),A.makeRotationY(L.seed*3).scale(new F(T*.45,T*.35,T*.45)).setPosition(L.x+T*.9,T*.2,L.y+T*.35),u.setMatrixAt(se,A)}),s.forEach((L,se)=>{let T=L.amount<=0?.001:(.55+.45*(L.amount/L.max))*L.r;A.makeRotationY(L.seed*2).scale(new F(T,T*.7,T)).setPosition(L.x,T*.42,L.y),p.setMatrixAt(se,A),A.makeScale(T*.4,T*.34,T*.4).setPosition(L.x+3,T*.85,L.y-2),x.setMatrixAt(se,A),A.makeScale(T*.26,T*.22,T*.26).setPosition(L.x-T*.5,T*.7,L.y+T*.3),m.setMatrixAt(se,A)});for(let L of[r,o,a,l,c,d,h,f,u,p,x,m])L.instanceMatrix.needsUpdate=!0}P();let _=new Lt(fe.ico,_e(7896708),n.world.boulders.length||1);n.world.boulders.forEach((D,L)=>{A.makeRotationY(D.seed).scale(new F(D.r,D.r*.8,D.r)).setPosition(D.x,D.r*.45,D.y),_.setMatrixAt(L,A)}),_.frustumCulled=!1,e.add(_);let b=new Lt(fe.ico,_e(8685967),n.world.rocks.length||1);n.world.rocks.forEach((D,L)=>{A.makeRotationY(D.seed).scale(new F(D.r,D.r*.6,D.r)).setPosition(D.x,D.r*.3,D.y),b.setMatrixAt(L,A)}),b.frustumCulled=!1,e.add(b);let S=new Lt(fe.cyl,_e(7032616),n.world.palms.length||1),C=new Lt(fe.cone,_e(5077552),n.world.palms.length||1);n.world.palms.forEach((D,L)=>{A.makeScale(3.4,44,3.4).setPosition(D.x,22,D.y),S.setMatrixAt(L,A),A.makeScale(26,14,26).setPosition(D.x,48,D.y),C.setMatrixAt(L,A)}),S.frustumCulled=!1,C.frustumCulled=!1,e.add(S,C);let N=n.world.flora.filter(D=>D.type==="cactus"),W=new Lt(fe.cyl,_e(5143098),N.length||1);N.forEach((D,L)=>{A.makeScale(4.5,22,4.5).setPosition(D.x,11,D.y),W.setMatrixAt(L,A)}),W.frustumCulled=!1,e.add(W);let Y=n.world.flora.filter(D=>D.type==="fern"||D.type==="shrub"),U=new Lt(fe.ico,_e(5599290),Y.length||1);Y.forEach((D,L)=>{A.makeScale(8,6,8).setPosition(D.x,4,D.y),U.setMatrixAt(L,A)}),U.frustumCulled=!1,e.add(U),sb(n,e);let H=n.barrels.map(D=>{let L;return D.crate?(L=new ge(fe.box,_e(9069104)),L.scale.set(D.r*1.8,D.r*1.5,D.r*1.8),L.position.set(D.x,D.r*.75,D.y)):(L=new ge(fe.cyl,_e(10768174)),L.scale.set(D.r*.9,D.r*1.7,D.r*.9),L.position.set(D.x,D.r*.85,D.y)),e.add(L),L}),$={quarryArm:null,gates:[],fadeables:[]};for(let D of n.world.monuments)ob(n,e,D,$);ab(n,e);for(let D of n.world.crossings){let L=new $e;L.position.set(D.x,0,D.y),L.rotation.y=-D.railAng;for(let se of[-1,1]){let T=new ge(fe.box,_e(2500139));T.scale.set(5,20,5),T.position.set(0,10,se*38),L.add(T);let X=new ge(fe.box,_e(12597802));X.scale.set(40,3.6,3.6),X.position.set(20,18,se*38);let q=new $e;q.position.set(0,18,se*38),X.position.set(20,0,0),q.add(X),L.add(q),$.gates.push({pivot:q,cr:D,side:se})}e.add(L)}let le=new $e;e.add(le);let he=new Map,ye=new Map,Ce=new Map,Ue=-1,Ke=new Set;function ie(D){if(D==="p1")return 8308816;let L=n.teams.find(se=>se.owner===D);return L?parseInt(L.col.slice(1),16):8947848}function ne(){if(n.nav.stamp!==Ue){Ue=n.nav.stamp,Ke.clear();for(let[D,L]of n.structures){Ke.add(D);let se=L.mat,T=ye.get(D);if(T&&T.sig!==se&&(le.remove(T.mesh),ye.delete(D),T=null),!T){let[X,q]=D.split(",").map(Number),re=new ge(fe.box,h0(L.mat||"wood"));re.scale.set(62,5,62),re.position.set(X*64+64/2,2.5,q*64+64/2),le.add(re),ye.set(D,{mesh:re,sig:se})}}for(let[D,L]of ye)Ke.has(D)||(le.remove(L.mesh),ye.delete(D));Ke.clear();for(let[D,L]of n.walls){if(L.hp<=0)continue;Ke.add(D);let se=L.type+L.mat+(L.open?"o":"c"),T=he.get(D);if(T&&T.sig!==se&&(le.remove(T.mesh),he.delete(D),T=null),!T){let X=kt(D,L),q=(X[0]+X[2])/2,re=(X[1]+X[3])/2,Q=X[0]===X[2],Ee=new $e;if(L.type==="door"&&L.open)for(let ze of[-26,26]){let Ve=new ge(fe.box,_e(ta[L.mat]||ta.wood));Ve.scale.set(Q?11:12,40,Q?12:11),Ve.position.set(Q?0:ze,20,Q?ze:0),Ee.add(Ve)}else{let ze=na(L.mat||"wood"),Ve=new ge(fe.box,ze),z=L.type==="door"?42:48;Ve.scale.set(Q?11:64,z,Q?64:11),Ve.position.y=z/2,L.type==="door"&&(Ve.material=ze.clone(),Ve.material.color.setScalar(.78)),Ee.add(Ve);let tt=new ge(fe.box,_e(ta[L.mat]||ta.wood));if(tt.scale.set(Q?13:66,4,Q?66:13),tt.position.y=z+2,Ee.add(tt),L.type==="door"){let et=new ge(fe.sphere,_e(14202462));et.scale.set(2.5,2.5,2.5),et.position.set(Q?7:10,22,Q?10:7),Ee.add(et)}}Ee.position.set(q,0,re),le.add(Ee),he.set(D,{mesh:Ee,sig:se})}}for(let[D,L]of he)Ke.has(D)||(le.remove(L.mesh),he.delete(D));Ke.clear();for(let[D,L]of n.deploys){Ke.add(D);let se=L.type+(L.tier||"")+L.owner,T=Ce.get(D);if(T&&T.sig!==se&&(le.remove(T.group),Ce.delete(D),T=null),!T){let[X,q]=D.split(",").map(Number),re=X*64+64/2,Q=q*64+64/2,Ee=new $e;Ee.position.set(re,0,Q);let ze={group:Ee,sig:se};if(L.type==="turret"){let Ve=L.tier===3?6277344:L.tier===2?14721594:10133928;for(let ae=0;ae<3;ae++){let pe=ae/3*d0+.5,ve=new ge(fe.cyl,_e(3027760));ve.scale.set(2.2,18,2.2),ve.position.set(Math.cos(pe)*11,8,Math.sin(pe)*11),ve.rotation.z=-Math.cos(pe)*.5,ve.rotation.x=Math.sin(pe)*.5,Ee.add(ve);let be=new ge(fe.box,_e(2303787));be.scale.set(6,2,6),be.position.set(Math.cos(pe)*16,1,Math.sin(pe)*16),Ee.add(be)}let z=new ge(fe.cyl,_e(3817284));z.scale.set(3.6,16,3.6),z.position.y=16,Ee.add(z);let tt=new $e;tt.position.y=26;for(let ae of[-1,1]){let pe=new ge(fe.box,_e(4870228));pe.scale.set(12,13,2.4),pe.position.set(0,2,ae*7.6),tt.add(pe)}let et=new ge(fe.box,_e(5659994));et.scale.set(13,9.5,12),et.position.y=3,tt.add(et);let xt=new ge(fe.cyl,_e(1316892));xt.scale.set(3.2,2,3.2),xt.rotation.z=Math.PI/2,xt.position.set(7.6,4.5,0),tt.add(xt);let Me=new ge(fe.sphere,_e(13777960,{emissive:13777960,emissiveIntensity:.8}));Me.scale.set(1.5,1.5,1.5),Me.position.set(9.2,4.5,0),tt.add(Me);let St=L.tier===3?22:L.tier===2?17:13,I=new ge(fe.box,_e(1974822));if(I.scale.set(St,3.8,3.4),I.position.set(St/2+5,-2.6,0),tt.add(I),L.tier===2){let ae=I.clone();ae.position.z=4.4,tt.add(ae)}let w=new ge(fe.cyl,_e(Ve,{emissive:Ve,emissiveIntensity:.45}));w.scale.set(2,2.6,2),w.rotation.z=Math.PI/2,w.position.set(St+6,-2.6,0),tt.add(w);let K=new ge(fe.cyl,_e(Ve,{emissive:Ve,emissiveIntensity:.3}));K.scale.set(4.1,2,4.1),K.position.y=21,Ee.add(K),Ee.add(tt),ze.pivot=tt}else if(L.type==="cupboard"){let Ve=new ge(fe.box,_e(ie(L.owner)));Ve.scale.set(42,40,42),Ve.position.y=20,Ee.add(Ve);let z=new ge(fe.box,_e(2891532));z.scale.set(46,5,46),z.position.y=42,Ee.add(z);let tt=us(7790698,26);tt.position.y=50,Ee.add(tt),ze.led=tt}else{let Ve=new ge(fe.box,_e(7031332));Ve.scale.set(40,24,40),Ve.position.y=12,Ee.add(Ve)}le.add(Ee),Ce.set(D,ze)}}for(let[D,L]of Ce)Ke.has(D)||(le.remove(L.group),Ce.delete(D))}}let B=new $e;e.add(B);let O=-1;function k(){if(n.fences.length!==O){O=n.fences.length,B.clear();for(let D of n.fences){let L=new ge(fe.box,_e(8215600));L.scale.set(46,22,5),L.position.set(D.x,11,D.y),L.rotation.y=-D.a,B.add(L)}}}return{sync(D){E-=D,E<=0&&(E=.25,P()),n.barrels.forEach((se,T)=>{H[T].visible=se.hp>0}),ne(),k();for(let[se,T]of Ce){let X=n.deploys.get(se);if(X&&(T.pivot&&(T.pivot.rotation.y=-(X.angle||0)),T.led&&X.store)){let q=X.store.wood+X.store.stone+X.store.metal>0;T.led.material.color.setHex(q?7790698:16734780)}}if($.quarryArm){let se=n.quarry;$.quarryArm.rotation.z=se&&se.owner?Math.sin(se.arm*2.4)*.35:-.18}for(let se of $.gates)se.pivot.rotation.z=(1-se.cr.gate)*1.35;let L=n.player;for(let se of $.fadeables){let T=L.x-se.x,X=L.y-se.y,re=!L.dead&&T*T+X*X<(se.r+90)*(se.r+90)?.3:1;for(let Q of se.mats)Q.opacity+=(re-Q.opacity)*Math.min(1,D*7)}}}}function sb(n,e){let{hash2:t}=rb,i=[],s=[],r=[],o=13824,a=9216;for(let u=120;u<a-120;u+=150)for(let p=120;p<o-120;p+=150){let x=t(p/150|0,u/150|0);if(x>.62)continue;let m=p+x*977%1*130,g=u+x*467%1*130;if(!n.world.onLand(m,g)||n.world.lakeAt(m,g)||n.world.pathDist(m,g)<40)continue;let y=n.world.biomeAt(m,g);y==="jungle"?i.push({x:m,y:g,h:x}):y==="desert"?x<.3&&s.push({x:m,y:g,h:x}):x<.4&&r.push({x:m,y:g,h:x})}let l=new gt,c=new nt,d=new Lt(fe.cone,_e(16777215),i.length||1);i.forEach((u,p)=>{let x=5+u.h*8;l.makeRotationY(u.h*6).scale(new F(x,x*1.8,x)).setPosition(u.x,x*.9,u.y),d.setMatrixAt(p,l),c.setHex(4876846).multiplyScalar(.8+u.h*37%1*.5),d.setColorAt(p,c)});let h=new Lt(fe.ico,_e(16777215),s.length||1);s.forEach((u,p)=>{let x=3+u.h*8;l.makeRotationY(u.h*9).scale(new F(x,x*.55,x)).setPosition(u.x,x*.3,u.y),h.setMatrixAt(p,l),c.setHex(10259040).multiplyScalar(.85+u.h*53%1*.3),h.setColorAt(p,c)});let f=new Lt(fe.sphere,_e(15265781),r.length||1);r.forEach((u,p)=>{let x=6+u.h*12;l.makeScale(x,x*.4,x*.8).setPosition(u.x,x*.16,u.y),f.setMatrixAt(p,l)});for(let u of[d,h,f])u.frustumCulled=!1,u.instanceColor&&(u.instanceColor.needsUpdate=!0),e.add(u)}var rb={hash2(n,e){let t=n*374761393+e*668265263|0;return t=t^t>>13|0,t=Math.imul(t,1274126177),((t^t>>16)>>>0)/4294967296}};function ob(n,e,t,i){let s=new $e;s.position.set(t.x,0,t.y);let r=(l,c,d,h,f,u,p,x,m=0,g)=>{let y=new ge(l,_e(c,g));return y.scale.set(d,h,f),y.position.set(u,p,x),y.rotation.y=m,s.add(y),y},o=[],a=(...l)=>{let c=r(...l),d=c.material.clone();return d.transparent=!0,c.material=d,o.push(d),c};if(t.type==="gas"){a(fe.box,11027246,216,8,30,0,64,-70);for(let l of[-96,-30,36,96])r(fe.box,4147024,6,60,6,l,30,-62);for(let l of[-58,0])r(fe.box,5989227,18,30,16,l,15,-22);a(fe.box,9081241,54,52,50,58,26,-16),r(fe.box,12574959,18,14,2,66,34,10),r(fe.box,13279562,26,26,6,-104,40,-62)}else if(t.type==="junk"){for(let l=0;l<5;l++){let c=l/5*d0;r(fe.ico,7238780,26,14,20,Math.cos(c)*70,8,Math.sin(c)*54,c)}r(fe.box,8011824,56,22,26,-58,11,-40,.3),r(fe.box,3824234,56,22,26,54,11,44,-.5),r(fe.cyl,2302237,12,16,12,70,8,-50),r(fe.cyl,2302237,12,16,12,-66,8,58)}else if(t.type==="warehouse"){a(fe.box,8291470,252,70,164,0,35,0),a(fe.box,5988971,264,10,176,0,74,0);for(let l of[-72,0,72])a(fe.box,2764597,60,46,4,l,23,84);a(fe.box,4870488,30,14,16,-38,84,0),a(fe.box,4870488,30,14,16,38,84,0)}else if(t.type==="quarry"){r(fe.cyl,3814438,46,8,28,-36,4,26),r(fe.box,3948871,12,64,12,8,32,-46);let l=new $e;l.position.set(14,60,-44);let c=new ge(fe.box,_e(8226963));c.scale.set(86,9,9),l.add(c);let d=new ge(fe.sphere,_e(10768430));d.scale.set(9,9,9),d.position.x=-43,l.add(d),s.add(l),i.quarryArm=l,r(fe.box,5061152,4,46,4,-44,23,-58),r(fe.box,7236186,24,13,2,-32,40,-58)}o.length&&i.fadeables.push({x:t.x,y:t.y,r:t.r,mats:o}),e.add(s)}function ab(n,e){let t=n.world.shop,i=new $e;i.position.set(t.x,0,t.y);let s=new ge(fe.cyl,_e(6969398));s.scale.set(46,6,46),s.position.y=3,i.add(s);let r=new ge(fe.box,_e(10120764));r.scale.set(60,24,22),r.position.set(0,16,2),i.add(r);let o=new ge(fe.cone,_e(11751744));o.scale.set(52,26,52),o.position.y=56,i.add(o);for(let l of[-34,34]){let c=new ge(fe.cyl,_e(6177574));c.scale.set(3,44,3),c.position.set(l,22,8),i.add(c)}let a=new ge(new Uo(wt-7,wt,72),new Yt({color:9885695,transparent:!0,opacity:.3,side:In,depthWrite:!1}));a.rotation.x=-Math.PI/2,a.position.y=1.2,i.add(a),e.add(i)}var sf=13081716,Ir=Math.PI*2;function Ft(n,e,t,i,s,r,o){let a=new ge(fe.box,_e(n));return a.scale.set(e,t,i),a.position.set(s,r,o),a}function yt(n,e,t,i,s,r=1,o=1){let a=new ge(fe.sphere,_e(n));return a.scale.set(e,e*r,e*o),a.position.set(t,i,s),a}var u0={pistol:n=>n.add(Ft(2303519,10,4,3.4,11,0,0)),rifle:n=>{n.add(Ft(2303519,20,3.6,3.4,15,0,0)),n.add(Ft(4864544,5,5,3.8,7,-1,0))},shotgun:n=>{n.add(Ft(2827808,16,4.6,4,13,0,0)),n.add(Ft(5980710,5,5.5,4.2,5,-1,0))},hmg:n=>{n.add(Ft(2303519,24,5,4.4,16,0,0)),n.add(Ft(3817271,6,7,4.8,10,-3,0))},tool:n=>{n.add(Ft(5980710,13,3,3,9,0,0)),n.add(Ft(12173511,4,8,3.4,16,1,0))},rocket:n=>{n.add(Ft(3751983,22,6.5,6,14,1,0)),n.add(Ft(16751421,3,7,6.4,25,1,0))},hammer:n=>{n.add(Ft(5980710,11,3,3,8,0,0)),n.add(Ft(10133928,4,7,4.4,14,1,0))},jack:n=>{n.add(Ft(1842204,4,4,3.4,6,1,0)),n.add(Ft(13279802,11,9,5.5,13,0,0)),n.add(Ft(3817271,4,5.5,4,20,-1,0)),n.add(Ft(12173511,11,2.6,2.6,27,-2,0))}};function m0(n,e={}){let t=new $e,i={};i.shadow=Fs(46),i.shadow.position.y=1,t.add(i.shadow),i.lower=new $e,t.add(i.lower);for(let c of["L","R"]){let d=new $e;d.position.set(0,12,c==="L"?-3.2:3.2);let h=Ft(3289130,4.6,12,4.6,0,-6,0);d.add(h),i.lower.add(d),i["leg"+c]=d}i.torso=Ft(n,10,14,12,0,24.5,0),t.add(i.torso),i.torsoShade=Ft(p0(n,.7),10.4,4.5,12.4,0,19,0),t.add(i.torsoShade),i.armor=Ft(9804963,11,10,13,.8,24.5,0),i.armor.visible=!1,t.add(i.armor),i.pack=Ft(4866100,4,9,8,-7,25,0),t.add(i.pack),i.armL=new $e,i.armL.position.set(0,30,-7.4);let s=Ft(sf,3.6,11,3.6,0,-5,0);i.armL.add(s),t.add(i.armL),i.armR=new $e,i.armR.position.set(2,29,7.4),i.armR.add(Ft(sf,9,3.6,3.6,4.5,0,-1.5)),i.gun=new $e,i.armR.add(i.gun),t.add(i.armR),i.head=new $e,i.head.position.y=38,i.head.add(yt(sf,5.6,0,0,0));let r=new ge(fe.sphere,_e(e.hairCol??3811864));r.scale.set(5.9,4.4,5.9),r.position.y=2.2,i.head.add(r);let o=new ge(fe.cyl,_e(n));o.scale.set(5.9,1.6,5.9),o.position.y=1.2,i.head.add(o),i.band=o,i.helmet=new $e;let a=new ge(fe.sphere,_e(10136504));a.scale.set(6.3,6.3,6.3),i.helmet.add(a);let l=Ft(1119516,3,3,9.5,4.6,-.5,0);return i.helmet.add(l),i.helmet.visible=!1,i.head.add(i.helmet),t.add(i.head),t.userData={parts:i,colHex:n,phase:Math.random()*7,setGun(c){t.userData.gunKind!==c&&(t.userData.gunKind=c,i.gun.clear(),(u0[c]||u0.pistol)(i.gun))},setArmor(c,d){i.armor.visible=c>0,c>0&&(i.armor.material=_e(c>=3?6126235:c===2?9804963:8746824)),i.helmet.visible=d>0,d>0&&(i.helmet.children[0].material=_e(d>=3?8163017:d===2?10136504:13482898))},setColor(c){t.userData.colHex!==c&&(t.userData.colHex=c,i.torso.material=_e(c),i.torsoShade.material=_e(p0(c,.7)),o.material=_e(c))},animate(c,d,h,f,u){let p=t.userData,x=Math.min(.1,Math.max(.001,c-(p.lastT??c)));p.lastT=c;let m=p.hipsCur??0,g=1,y=1;if(d>.05&&u!==null&&u!==void 0){let P=u%Ir;P>Math.PI&&(P-=Ir),P<-Math.PI&&(P+=Ir),Math.abs(P)>2.06&&(g=-1,y=.72,P=P>0?P-Math.PI:P+Math.PI),m=P}else d<=.05&&(m=0);let v=p.hipsCur??0,M=(m-v)%Ir;M>Math.PI&&(M-=Ir),M<-Math.PI&&(M+=Ir),v+=M*Math.min(1,x*14),p.hipsCur=v,i.lower.rotation.y=-v;let A=c*11+p.phase,E=Math.sin(A)*.75*d*y*g;if(i.legL.rotation.z=E,i.legR.rotation.z=-E,i.armL.rotation.z=-E*.55,t.position.y=Math.abs(Math.sin(A))*1.4*d,h&&f){i.armR.rotation.z=-.22+Math.sin(c*62)*.05;let P=Math.sin(c*57)*1.5,_=Math.sin(c*71)*1.1;t.position.y+=Math.abs(_)*.8,t.userData.judder={x:P,z:Math.cos(c*49)*1.3}}else t.userData.judder=null,h?i.armR.rotation.z=-.5+Math.sin(c*9)*.55:i.armR.rotation.z=0}},t.userData.setGun(e.gun||"pistol"),t}function p0(n,e){let t=Math.min(255,(n>>16&255)*e)|0,i=Math.min(255,(n>>8&255)*e)|0,s=Math.min(255,(n&255)*e)|0;return t<<16|i<<8|s}function qc(n,e,t,i,s,r){let o=[];for(let a of[-1,1])for(let l of[-1,1]){let c=new $e;c.position.set(a*i,r,l*s);let d=new ge(fe.cyl,_e(e));d.scale.set(t*.16,r,t*.16),d.position.y=-r/2,c.add(d),n.add(c),o.push({pivot:c,phase:a*l>0?0:Math.PI})}return o}function g0(n,e){let t=new $e,i={legs:[],extra:null},s={boar:[8282692,5521451],wolf:[7698047,4605773],bear:[6375471,3812380],polarbear:[14542315,11451592],alligator:[5599286,3229980],snake:[11704890,7430430],scorpion:[8278566,4664850]}[n]||[8947848,5592405],[r,o]=s,a=Fs(e*3.2);if(a.position.y=.8,t.add(a),n==="snake"){i.segs=[];for(let c=0;c<6;c++){let d=yt(c%2?o:r,e*(.55-c*.05),-c*e*.5,e*.4,0);t.add(d),i.segs.push(d)}let l=yt(r,e*.62,e*.45,e*.45,0,.8,.9);t.add(l),i.head=l}else if(n==="scorpion"){t.add(yt(o,e*.85,0,e*.4,0,.5,.8)),t.add(yt(r,e*.62,e*.2,e*.55,0,.5,.75));for(let h of[-1,1])t.add(Ft(r,e*.8,e*.2,e*.18,e*.75,e*.35,h*e*.5)),t.add(yt(o,e*.26,e*1.2,e*.35,h*e*.62));i.tail=new $e,i.tail.position.set(-e*.7,e*.5,0);let l=0,c=0;for(let h=0;h<3;h++)l-=e*.3,c+=e*.34,i.tail.add(yt(o,e*.2,l,c,0));let d=new ge(fe.cone,_e(3810320));d.scale.set(e*.14,e*.3,e*.14),d.position.set(l+e*.16,c+e*.22,0),d.rotation.z=-1,i.tail.add(d),t.add(i.tail)}else if(n==="alligator"){let l=e*.55;t.add(yt(o,e,0,l,0,.5,.72)),t.add(yt(r,e*.82,0,l+e*.18,0,.42,.6)),t.add(yt(r,e*.5,e*1.15,l,0,.5,.62)),t.add(Ft(o,e*.9,e*.16,e*.5,e*1.25,l-e*.1,0)),t.add(yt(o,e*.62,-e*1.05,l,0,.45,.6)),t.add(yt(o,e*.4,-e*1.7,l*.9,0,.45,.55));for(let c=0;c<4;c++){let d=new ge(fe.cone,_e(o));d.scale.set(e*.12,e*.25,e*.12),d.position.set(-e*.6+c*e*.42,l+e*.42,0),t.add(d)}i.legs=qc(t,o,e,e*.55,e*.5,l*.8)}else if(n==="bear"||n==="polarbear"){let l=e*.95;t.add(yt(r,e*.88,e*.2,l,0,.95,.78)),t.add(yt(o,e*.74,-e*.62,l*.88,0,.85,.74)),t.add(yt(r,e*.46,e*.05,l+e*.62,0)),t.add(yt(o,e*.16,-e*1.28,l*.95,0));let c=new $e;c.position.set(e*1,l+e*.42,0),c.add(yt(r,e*.42,0,0,0)),c.add(yt(o,e*.26,e*.4,-e*.06,0,.75,.7)),c.add(yt(1840144,e*.08,e*.62,-e*.04,0));for(let d of[-1,1])c.add(yt(o,e*.13,-e*.18,e*.36,d*e*.26)),c.add(yt(1314828,e*.05,e*.3,e*.12,d*e*.2));t.add(c),i.head=c,i.legs=qc(t,o,e*1.25,e*.52,e*.4,l*.92)}else if(n==="wolf"){let l=e*.95;t.add(yt(r,e*.85,e*.15,l,0,.62,.52)),t.add(yt(o,e*.66,-e*.6,l*.96,0,.55,.48));let c=new $e;c.add(yt(o,e*.22,-e*1.15,l+e*.1,0,1,.8)),c.add(yt(o,e*.16,-e*1.45,l+e*.3,0)),t.add(c);let d=new $e;d.position.set(e*.95,l+e*.3,0),d.add(yt(r,e*.34,0,0,0)),d.add(yt(o,e*.18,e*.36,-e*.05,0,.7,.6)),d.add(yt(1840144,e*.06,e*.52,-e*.02,0));for(let h of[-1,1]){let f=new ge(fe.cone,_e(o));f.scale.set(e*.1,e*.26,e*.1),f.position.set(-e*.12,e*.4,h*e*.18),d.add(f),d.add(yt(14206010,e*.05,e*.26,e*.1,h*e*.15))}t.add(d),i.head=d,i.legs=qc(t,o,e*.85,e*.5,e*.3,l*1)}else{let l=e*.66;t.add(yt(o,e*1,0,l,0,.72,.72)),t.add(yt(r,e*.88,e*.1,l+e*.08,0,.66,.64));for(let d=0;d<4;d++){let h=new ge(fe.cone,_e(4075554));h.scale.set(e*.1,e*.2,e*.1),h.position.set(e*.45-d*e*.3,l+e*.52-d*e*.03,0),t.add(h)}t.add(yt(o,e*.1,-e*1.05,l+e*.15,0));let c=new $e;c.position.set(e*.92,l,0),c.add(yt(r,e*.46,0,0,0,.9,.8)),c.add(yt(9071192,e*.2,e*.5,-e*.12,0,.7,.9));for(let d of[-1,1]){let h=new ge(fe.cone,_e(15261903));h.scale.set(e*.06,e*.2,e*.06),h.position.set(e*.42,-e*.16,d*e*.22),h.rotation.z=.6,c.add(h);let f=new ge(fe.cone,_e(o));f.scale.set(e*.1,e*.18,e*.1),f.position.set(-e*.2,e*.38,d*e*.24),f.rotation.x=d*.4,c.add(f),c.add(yt(1314828,e*.05,e*.3,e*.14,d*e*.22))}t.add(c),i.head=c,i.legs=qc(t,o,e*.95,e*.48,e*.36,l*.9)}return t.userData={...i,phase:Math.random()*7,animate(l,c){let d=l*9+t.userData.phase;for(let h of i.legs)h.pivot.rotation.z=Math.sin(d+h.phase)*.55*c;if(i.segs)for(let h=0;h<i.segs.length;h++)i.segs[h].position.z=Math.sin(l*7-h*.8)*e*.3*(.4+c);i.tail&&(i.tail.rotation.z=Math.sin(l*3)*.08),i.head&&!i.segs&&(i.head.rotation.z=Math.sin(l*2.2+t.userData.phase)*.06)}},t}var x0=Math.PI*2,lb={0:"tool",1:"pistol",2:"rifle",3:"hmg",4:"rocket",5:"hammer",6:"rifle",7:"shotgun",8:"hmg"},ps=class{constructor(e,t){this.scene=e,this.make=t,this.map=new Map,this.seen=new Set,this.miss=new Map}get(e,...t){this.seen.add(e);let i=this.map.get(e);return i||(i=this.make(...t),this.map.set(e,i),this.scene.add(i)),i.visible=!0,i}sweep(){for(let[e,t]of this.map)if(this.seen.has(e))this.miss.delete(e);else{t.visible=!1;let i=(this.miss.get(e)||0)+1;i>300?(this.scene.remove(t),this.map.delete(e),this.miss.delete(e)):this.miss.set(e,i)}this.seen.clear()}};function y0(n,e){let t=new ps(e,(O,k)=>m0(O,{gun:k})),i=new ps(e,(O,k)=>g0(O,k));function s(){return _e(1645589)}let r=(O,k,D,L,se,T,X)=>{let q=new ge(fe.box,_e(O));return q.scale.set(k,D,L),q.position.set(se,T,X),q},o=new ps(e,O=>{let k=new $e;k.add(r(3356462,34,3,24,2,8,0)),k.add(r(O,15,11,15,4,15,0)),k.add(r(O,13,16,3.4,-3,24,0)),k.add(r(2303519,9,7,12,15,13,0)),k.add(r(3817271,10,10,11,-11,14,0));let D=new ge(fe.cyl,_e(2895656));D.scale.set(2.4,16,2.4),D.position.set(-2,32,0),k.add(D),k.add(r(2895656,42,3.6,3.6,-32,22,0)),k.add(r(3356462,8,12,2.4,-51,26,0));let L=r(1645589,1.4,16,2.6,-53,24,3);k.add(L);for(let re of[-1,1]){let Q=new ge(fe.cyl,_e(2303519));Q.scale.set(1.8,52,1.8),Q.rotation.z=Math.PI/2,Q.position.set(2,2.5,re*13),k.add(Q),k.add(r(2303519,2,8,2,-8,5,re*13)),k.add(r(2303519,2,8,2,12,5,re*13))}let se=r(1645589,96,1.6,7,-2,41,0);k.add(se);let T=new $e;T.add(r(O,8,11,9,4,21,0));let X=new ge(fe.sphere,_e(13081716));X.scale.set(4.5,4.5,4.5),X.position.set(4,30,0),T.add(X),T.visible=!1,k.add(T);let q=Fs(86);return q.position.y=1,k.add(q),k.userData={rotor:se,tailRotor:L,sh:q,pilot:T},k}),a=new ps(e,O=>{let k=new $e;k.add(r(O,104,30,34,0,26,0)),k.add(r(2501666,104,8,35,0,13,0)),k.add(r(2040857,18,22,30,56,24,0)),k.add(r(10470104,6,9,26,64,30,0));let D=r(2896680,20,4,30,-56,12,0);D.rotation.z=.5,k.add(D);for(let q=0;q<4;q++)k.add(r(1316892,7,7,2,32-q*22,30,17.6));for(let q=0;q<4;q++)k.add(r(1316892,7,7,2,32-q*22,30,-17.6));k.add(r(3817524,26,10,20,-38,46,0));let L=r(2895656,4,12,4,38,46,0);k.add(L);let se=r(1645589,100,2,8,38,54,0);k.add(se);let T=r(1645589,100,2,8,-38,58,0);k.add(T);for(let[q,re]of[[44,14],[44,-14],[-40,16],[-40,-16]]){let Q=new ge(fe.cyl,_e(1316892));Q.scale.set(4.5,3,4.5),Q.rotation.x=Math.PI/2,Q.position.set(q,5,re),k.add(Q)}let X=Fs(150);return X.position.y=1,k.add(X),k.userData={rotor:se,rotor2:T,sh:X},k}),l=new ps(e,O=>O()),c=new ps(e,(O,k)=>us(O,k)),d=700,h=new Lt(fe.quad,new Yt({color:2366482,transparent:!0,opacity:.34,depthWrite:!1,side:In}),d);h.frustumCulled=!1,h.renderOrder=2,e.add(h);let f=new gt,u=new gt,p=new F,x=64,m=[],g=new Lt(fe.box,new Sn({color:16777215,flatShading:!0}),x);g.frustumCulled=!1,e.add(g);let y=new gt,v=new nt,M={wood:9069104,stone:8685967,metal:13145412},A=90,E=[],P=new qt,_=new Float32Array(A*3);P.setAttribute("position",new en(_,3));let b=new zi(P,new xi({color:16771491,size:6,transparent:!0,opacity:.95,blending:wn,depthWrite:!1,sizeAttenuation:!0}));b.frustumCulled=!1,e.add(b);function S(O){let k=O.jack?5:3;for(let D=0;D<k;D++){m.length>=x&&m.shift();let L=Math.random()*x0;m.push({x:O.x+Math.cos(L)*6,y:O.y+Math.sin(L)*6,h:18+Math.random()*14,vx:Math.cos(L)*(40+Math.random()*70),vy:Math.sin(L)*(40+Math.random()*70),vh:60+Math.random()*90,life:.85,rot:Math.random()*7,vrot:(Math.random()-.5)*14,s:2.2+Math.random()*(O.jack?3.4:2.2),col:M[O.kind]||9069104})}if(O.jack)for(let D=0;D<7;D++){E.length>=A&&E.shift();let L=Math.random()*x0;E.push({x:O.x,y:O.y,h:16,vx:Math.cos(L)*(90+Math.random()*160),vy:Math.sin(L)*(90+Math.random()*160),vh:40+Math.random()*120,life:.22+Math.random()*.14})}}function C(O){for(let D=m.length-1;D>=0;D--){let L=m[D];if(L.life-=O,L.life<=0){m.splice(D,1);continue}L.vh-=320*O,L.x+=L.vx*O,L.y+=L.vy*O,L.h+=L.vh*O,L.h<1.5&&(L.h=1.5,L.vh*=-.35,L.vx*=.6,L.vy*=.6),L.rot+=L.vrot*O}m.forEach((D,L)=>{y.makeRotationY(D.rot).scale(new F(D.s,D.s,D.s)).setPosition(D.x,D.h,D.y),g.setMatrixAt(L,y),v.setHex(D.col),g.setColorAt(L,v)}),g.count=m.length,g.instanceMatrix.needsUpdate=!0,g.instanceColor&&(g.instanceColor.needsUpdate=!0);let k=0;for(let D=E.length-1;D>=0;D--){let L=E[D];if(L.life-=O,L.life<=0){E.splice(D,1);continue}L.vh-=260*O,L.x+=L.vx*O,L.y+=L.vy*O,L.h=Math.max(1,L.h+L.vh*O)}for(let D of E){if(k>=A)break;_[k*3]=D.x,_[k*3+1]=D.h,_[k*3+2]=D.y,k++}P.setDrawRange(0,k),P.attributes.position.needsUpdate=!0}let N=46,W=[];for(let O=0;O<N;O++){let k=new Cs(new ss({map:Xc(),color:8817810,transparent:!0,opacity:0,depthWrite:!1}));k.visible=!1,e.add(k),W.push(k)}let Y=[];function U(O,k,D,L){Y.length>=N&&Y.shift(),Y.push({x:O,y:k,h:D,life:2.8,max:2.8,s0:26*L,drift:Math.random()*7})}function H(O){for(let k=Y.length-1;k>=0;k--){let D=Y[k];if(D.life-=O,D.life<=0){Y.splice(k,1);continue}D.h+=50*O,D.x+=n.wind*9*O,D.y+=Math.sin(D.drift)*3*O}W.forEach((k,D)=>{let L=Y[D];if(!L){k.visible=!1;return}k.visible=!0;let se=1-L.life/L.max,T=L.s0*(1+se*2.4);k.scale.set(T,T,1),k.position.set(L.x,L.h,L.y),k.material.opacity=.36*(L.life/L.max)*Math.min(1,se*6+.2)})}function $(O,k){let D=O.pts,L=0;for(let T=0;T<O.seg&&T<D.length-1;T++)L+=Math.hypot(D[T+1].x-D[T].x,D[T+1].y-D[T].y);L+=Math.hypot(O.x-D[Math.min(O.seg,D.length-1)].x,O.y-D[Math.min(O.seg,D.length-1)].y);let se=[];for(let T of k){let X=Math.max(.1,L+T),q=0,re=0;for(;q<D.length-2;){let z=Math.hypot(D[q+1].x-D[q].x,D[q+1].y-D[q].y);if(re+z>=X)break;re+=z,q++}let Q=D[q],Ee=D[q+1],ze=Math.hypot(Ee.x-Q.x,Ee.y-Q.y)||1,Ve=Math.max(0,Math.min(1,(X-re)/ze));se.push({x:Q.x+(Ee.x-Q.x)*Ve,y:Q.y+(Ee.y-Q.y)*Ve,a:Math.atan2(Ee.y-Q.y,Ee.x-Q.x)})}return se}let le=1200,he=new qt,ye=new Float32Array(le*3),Ce=new Float32Array(le*3);he.setAttribute("position",new en(ye,3)),he.setAttribute("color",new en(Ce,3));let Ue=new zi(he,new xi({size:7,vertexColors:!0,transparent:!0,opacity:.9,sizeAttenuation:!0,depthWrite:!1}));Ue.frustumCulled=!1,e.add(Ue);let Ke=new Map;function ie(O){let k=Ke.get(O);if(!k){k=new nt;try{if(O.startsWith("rgba")){let D=O.match(/rgba?\(([\d.]+),\s*([\d.]+),\s*([\d.]+)/);D&&k.setRGB(+D[1]/255,+D[2]/255,+D[3]/255)}else k.set(O)}catch{k.setRGB(.7,.7,.7)}Ke.set(O,k)}return k}let ne=1/60;function B(O,k,D,L,se,T={}){O.position.set(k,0,D),O.rotation.y=-L;let X=O.userData;X.setColor(se),T.gun&&X.setGun(T.gun),X.setArmor(T.bodyArmor||0,T.facemask||0);let q=null;(T.vx||T.vy)&&Math.hypot(T.vx,T.vy)>18&&(q=Math.atan2(T.vy,T.vx)-L),X.animate(n.t,T.moveAmt??0,!!T.gathering,!!T.jack,q),X.judder&&(O.position.x+=X.judder.x,O.position.z+=X.judder.z);let re=n.world.lakeAt(k,D),Q=re&&!re.frozen?30:0;X.sinkY=(X.sinkY??0)+(Q-(X.sinkY??0))*Math.min(1,ne*5),O.position.y-=X.sinkY}return{sync(O,k){ne=O;for(let T of n.units){if(T.dead||T.eliminated)continue;if(T.copter&&!T.copter.destroyed&&k.inView(T.copter.x,T.copter.y,200)){let Q=o.get(T.copter,parseInt(T.col.slice(1),16)),Ee=T.flying&&T.state==="trade";Q.position.set(T.copter.x,Ee?70:0,T.copter.y),Q.rotation.y=-(T.copter.angle||0),Q.userData.rotor.rotation.y=T.copter.rotor||0,Q.userData.tailRotor.rotation.z=(T.copter.rotor||0)*4,Q.userData.pilot.visible=Ee,Q.userData.sh.position.y=Ee?-68:1}if(T.flying||!k.inView(T.x,T.y,200))continue;let X=parseInt((T.ally?"#7ec850":T.col).slice(1),16),q=t.get(T,X,T.gun),re=Math.min(1,Math.hypot(T.vx,T.vy)/120);B(q,T.x,T.y,T.angle,X,{gun:T.gathering?T.jack?"jack":"tool":T.gun,moveAmt:re,gathering:T.gathering,jack:T.jack,bodyArmor:T.bodyArmor,facemask:T.facemask,vx:T.vx,vy:T.vy})}let D=n.player;if(!D.inCopter){let T=t.get(D,8030800,"pistol"),X=D.moving?1:0,q=n.slot===0&&n.jackhammer;B(T,D.x,D.y,D.angle,D.hurt>0?12876382:8030800,{gun:n.slot===0&&n.jackhammer?"jack":lb[n.slot]||"pistol",moveAmt:X,gathering:D.swing>0&&n.slot===0,jack:q,bodyArmor:D.bodyArmor,facemask:D.facemask,vx:D.vx,vy:D.vy}),D.dead&&(T.visible=!1)}if(n.copter&&!n.copter.destroyed){let T=o.get(n.copter,6121548),X=D.inCopter;T.position.set(n.copter.x,X?80:0,n.copter.y),T.rotation.y=-(n.copter.angle||0),T.userData.rotor.rotation.y=(n.copter.rotor||0)*3,T.userData.tailRotor.rotation.z=(n.copter.rotor||0)*11,T.userData.pilot.visible=X,T.userData.sh.position.y=X?-78:1}for(let T of n.guards){if(T.dead||!k.inView(T.x,T.y,150))continue;let X=t.get(T,12410412,"rifle"),q=Math.min(1,Math.hypot(T.vx||0,T.vy||0)/90+.2);B(X,T.x,T.y,T.angle,12410412,{gun:"rifle",moveAmt:q,facemask:1,vx:T.vx,vy:T.vy})}for(let T of n.animals){if(T.dead||!k.inView(T.x,T.y,150))continue;let X=i.get(T,T.type,T.r),q=0;T.type==="alligator"&&n.world.lakeAt(T.x,T.y)&&(q=T.r*.62),X.userData.sinkY=(X.userData.sinkY??0)+(q-(X.userData.sinkY??0))*Math.min(1,O*5),X.position.set(T.x,-X.userData.sinkY,T.y);let re=Math.hypot(T.vx||0,T.vy||0),Q=re>2?Math.atan2(T.vy,T.vx):T.dir;X.rotation.y=-Q,X.userData.animate(n.t,Math.min(1,re/80))}for(let T of n.transports){let X=T.owner===qe?8308816:parseInt((n.teams.find(Q=>Q.owner===T.owner)||{col:"#888888"}).col.slice(1),16),q=a.get(T,X),re=T.state==="fly"||T.state==="return"||T.riders.length>0;q.position.set(T.x,re?110:2,T.y),q.rotation.y=-T.angle,q.userData.rotor.rotation.y=T.rotor,q.userData.rotor2.rotation.y=-T.rotor,q.userData.sh.position.y=re?-106:1}for(let T of n.trains){let X=l.get(T,()=>{let Q=new $e,Ee=na("metal").clone();Ee.color.setScalar(.62);let ze=new ge(fe.box,Ee);ze.scale.set(54,30,26),ze.position.y=17,Q.add(ze),Q.add(r(2303788,18,14,27,-14,38,0)),Q.add(r(10470104,4,7,22,-4,39,0));let Ve=new ge(fe.cyl,_e(1843238));Ve.scale.set(4.5,12,4.5),Ve.position.set(16,38,0),Q.add(Ve);let z=r(2764339,12,10,24,30,8,0);z.rotation.z=-.5,Q.add(z);let tt=us(16771491,44);tt.position.set(30,20,0),Q.add(tt);let et=[];for(let xt=0;xt<4;xt++){let Me=new $e,St=na("wood").clone();St.color.setScalar(.78+xt%2*.14);let I=new ge(fe.box,St);I.scale.set(46,26,24),I.position.y=15,Me.add(I);let w=r(2893344,48,3.5,26,0,30,0);Me.add(w),Me.add(r(2038292,8,12,25,0,14,0)),Q.add(Me),et.push(Me)}return Q.userData={cars:et,smokeT:0},Q}),q=$(T,[0,-64,-116,-168,-220]),re=q[0];if(X.position.set(re.x,0,re.y),X.rotation.y=-re.a,X.userData.cars.forEach((Q,Ee)=>{let ze=q[Ee+1],Ve=ze.x-re.x,z=ze.y-re.y,tt=Math.cos(re.a),et=Math.sin(re.a);Q.position.set(Ve*tt+z*et,0,-Ve*et+z*tt),Q.rotation.y=-(ze.a-re.a)}),X.userData.smokeT-=O,X.userData.smokeT<=0){X.userData.smokeT=.12;let Q=re.x+Math.cos(re.a)*16,Ee=re.y+Math.sin(re.a)*16;U(Q,Ee,40,1)}}for(let T of n.convoys){if(T.dead)continue;let X=l.get(T,()=>{let q=new $e,re=new ge(fe.box,_e(5660746));re.scale.set(68,24,36),re.position.y=12,q.add(re);let Q=new $e;Q.position.y=28;let Ee=new ge(fe.cyl,_e(3752499));Ee.scale.set(12,9,12),Q.add(Ee);let ze=new ge(fe.box,_e(1250830));ze.scale.set(32,5,5),ze.position.x=20,Q.add(ze),q.add(Q),q.userData={turret:Q};let Ve=Fs(90);return Ve.position.y=1,q.add(Ve),q});X.position.set(T.x,0,T.y),X.rotation.y=-T.ang,X.userData.turret.rotation.y=-(T.taim-T.ang);for(let q of T.guards){if(q.dead)continue;let re=t.get(q,7305806,"rifle");B(re,q.x,q.y,q.angle,7305806,{gun:"rifle",moveAmt:.6,facemask:2})}}if(n.patrol){let T=n.patrol,X=l.get("patrol",()=>{let q=new $e;q.add(r(4740158,76,20,20,0,0,0)),q.add(r(3818548,76,6,21,0,-12,0));let re=new ge(fe.sphere,_e(4740158));re.scale.set(14,11,10),re.position.set(40,-1,0),q.add(re),q.add(r(1316892,14,8,14,26,8,0)),q.add(r(10470104,4,6,12,34,7,0)),q.add(r(1974822,10,6,6,36,-13,0)),q.add(r(1316892,14,2.6,2.6,46,-13,0));for(let Ve of[-1,1]){q.add(r(3818548,16,4,26,2,2,Ve*22));for(let z of[16,26]){let tt=new ge(fe.cyl,_e(2830374));tt.scale.set(4.5,16,4.5),tt.rotation.z=Math.PI/2,tt.position.set(4,-3,Ve*z),q.add(tt)}}q.add(r(3357744,52,6,6,-58,4,0)),q.add(r(3818548,9,18,3,-82,12,0));let Q=r(1645589,1.6,20,3,-84,10,4);q.add(Q);let Ee=r(2895656,5,8,5,0,13,0);q.add(Ee);let ze=r(1645589,124,2.2,9,0,19,0);return q.add(ze),q.userData={rotor:ze,tailRotor:Q},q});X.position.set(T.x,150,T.y),X.rotation.y=-T.angle,X.userData.rotor.rotation.y=T.rotor,X.userData.tailRotor.rotation.z=T.rotor*4}if(n.plane){let T=l.get("plane",()=>{let X=new $e,q=new ge(fe.sphere,_e(8291985));q.scale.set(28,8,8),X.add(q);let re=new ge(fe.box,_e(7041660));return re.scale.set(10,2,52),X.add(re),X});T.position.set(n.plane.x,320,n.plane.y),T.rotation.y=n.plane.vx<0?Math.PI:0}if(n.airdrop){let T=n.airdrop,X=l.get("airdrop",()=>{let re=new $e,Q=new ge(fe.box,_e(6120530));Q.scale.set(30,24,30),Q.position.y=12,re.add(Q);let Ee=new ge(fe.box,_e(16766827));Ee.scale.set(32,5,32),Ee.position.y=12,re.add(Ee);let ze=new ge(fe.cone,_e(12079162,{transparent:!0,opacity:.9}));return ze.scale.set(34,26,34),ze.position.y=56,re.add(ze),re.userData={chute:ze},re}),q=T.fall<1?(1-T.fall)*320:0;X.position.set(T.x+(T.fall<1?Math.sin(T.sway)*12:0),q,T.fall<1?T.gy:T.y),X.userData.chute.visible=T.fall<1}if(n.lockedCrate){let T=n.lockedCrate,X=l.get("crate",()=>{let re=new $e,Q=new ge(fe.box,_e(3948871));Q.scale.set(40,26,30),Q.position.y=13,re.add(Q);let Ee=us(16758858,22);return Ee.position.set(13,26,-8),re.add(Ee),re.userData={light:Ee},re});X.position.set(T.x,0,T.y);let q=T.blink%.8<.4;X.userData.light.visible=q,X.userData.light.material.color.setHex(T.started?16758858:13777960)}for(let T of n.bullets){let X=l.get(T,()=>{let Q=new $e,Ee=new ge(fe.sphere,new Yt({color:16767392,transparent:!0,opacity:.95,blending:wn,depthWrite:!1}));Ee.scale.set(3.4,3,3),Q.add(Ee);let ze=new ge(fe.cone,new Yt({color:16756820,transparent:!0,opacity:.5,blending:wn,depthWrite:!1}));ze.scale.set(2.6,30,2.6),ze.rotation.z=Math.PI/2,ze.position.x=-15,Q.add(ze);let Ve=new ge(fe.cone,new Yt({color:16749620,transparent:!0,opacity:.2,blending:wn,depthWrite:!1}));return Ve.scale.set(4.5,44,4.5),Ve.rotation.z=Math.PI/2,Ve.position.x=-22,Q.add(Ve),Q.userData={head:Ee,tail:ze,tail2:Ve},Q});X.position.set(T.x,18,T.y),X.rotation.y=-Math.atan2(T.vy,T.vx);let q=T.col==="hmg"?16738864:T.ricochet?10150655:16767392,re=T.col==="hmg"?15219732:T.ricochet?6076648:16756820;X.userData.head.material.color.setHex(q),X.userData.tail.material.color.setHex(re),X.userData.tail2.material.color.setHex(re)}for(let T of n.rockets){let X=l.get(T,()=>{let q=new $e,re=new ge(fe.cone,_e(3751983));re.scale.set(5,18,5),re.rotation.z=-Math.PI/2,q.add(re);let Q=us(16751421,34);return Q.position.x=-12,q.add(Q),q});X.position.set(T.x,18,T.y),X.rotation.y=-Math.atan2(T.vy,T.vx)}for(let T of n.grenades)l.get(T,()=>{let q=new ge(fe.sphere,_e(2898466));return q.scale.set(6,6,6),q}).position.set(T.x,8+Math.abs(Math.sin(T.bob*6))*8,T.y);for(let T of n.satchels){let X=l.get(T,()=>{let q=new ge(fe.box,_e(3814444));return q.scale.set(14,9,12),q.position.y=4,q});X.position.set(T.x,4,T.y),X.visible=Math.sin(n.t*18)>-.6}for(let T of n.loot){if(!k.inView(T.x,T.y,100))continue;let X=l.get(T,()=>{let re=new ge(fe.box,_e(14081248));return re.scale.set(9,9,9),re}),q={wood:12158022,stone:11186616,metal:15245902,scrap:14081248,ammo:16769162,rocket:16751194,sniper:12575743,satchel:13154442,gun:12896701};X.material=_e(q[T.kind]||14081248),X.position.set(T.x,8+Math.sin(T.bob*3)*2.5,T.y),X.rotation.y=T.bob}for(let T of n.fires){let X=c.get(T,16747050,90);X.position.set(T.x,16,T.y);let q=.8+Math.sin(n.t*11+T.x)*.25;X.scale.set(90*q,110*q,1)}for(let T of n.wrecks)l.get(T,()=>{let q=new $e,re=new ge(fe.box,_e(2499614));re.scale.set(30,14,20),re.position.y=7,re.rotation.y=.5,q.add(re);let Q=us(16755260,60);return Q.position.y=14,q.add(Q),q}).position.set(T.x,0,T.y);for(let T of n.scorch){let X=l.get(T,()=>{let q=new ge(new yi(1,12),new Yt({color:1314828,transparent:!0,opacity:.45,depthWrite:!1}));return q.rotation.x=-Math.PI/2,q.position.y=.8,q});X.position.set(T.x,.8,T.y),X.scale.set(T.r,T.r,1)}for(let T of n.flashes){let X=c.get(T,16757322,T.r*2.4);X.position.set(T.x,20,T.y);let q=T.life/T.max;X.material.opacity=q,X.scale.set(T.r*(2.6-q),T.r*(2.6-q),1)}if(n.muzzle){let T=c.get("muzzle",16766827,46);T.position.set(n.muzzle.x,18,n.muzzle.y),T.material.opacity=n.muzzle.t/.08}for(let T of n.events)T.type==="harvest"&&k.inView(T.x,T.y,300)&&S(T);C(O),H(O);let L=0;for(let T of n.footprints){if(L>=d)break;let X=1-T.t/10;if(X<.06||!k.inView(T.x,T.y,60))continue;let q=6.2*(.45+.55*X);f.makeRotationY(-T.a),u.makeRotationX(-Math.PI/2),f.multiply(u),p.set(q,q*.55,1),f.scale(p),f.setPosition(T.x,.45+L%9*.025,T.y),h.setMatrixAt(L,f),L++}h.count=L,h.instanceMatrix.needsUpdate=!0;let se=0;for(let T of n.particles){if(se>=le)break;ye[se*3]=T.x,ye[se*3+1]=10+(1-T.life/T.max)*14,ye[se*3+2]=T.y;let X=ie(T.col),q=Math.max(0,T.life/T.max);Ce[se*3]=X.r*q,Ce[se*3+1]=X.g*q,Ce[se*3+2]=X.b*q,se++}he.setDrawRange(0,se),he.attributes.position.needsUpdate=!0,he.attributes.color.needsUpdate=!0,t.sweep(),i.sweep(),o.sweep(),a.sweep(),l.sweep(),c.sweep()}}}function _0(n,e){let i=new qt,s=new Float32Array(700*3),r=[];for(let g=0;g<700;g++)r.push({x:Math.random(),z:Math.random(),y:Math.random(),sp:.4+Math.random()*.8});i.setAttribute("position",new en(s,3));let o=new xi({color:12374764,size:5,transparent:!0,opacity:0,depthWrite:!1}),a=new zi(i,o);a.frustumCulled=!1,e.add(a);let l=[],c=()=>{if(l.length||!n.clouds)return;let g=new Ps(1,0);for(let y of n.clouds){let v=new Sn({color:16251644,emissive:9279908,flatShading:!0,transparent:!0,opacity:.5,depthWrite:!1}),M=new $e;y.puffs.forEach((E,P)=>{let _=new ge(g,v),b=E.r*.45*(y.heavy?1:.85);_.scale.set(b,b*.45,b*.72),_.position.set(E.dx*.55,P*37%17-6,E.dy*.55),_.rotation.y=P*1.7,M.add(_)}),e.add(M);let A=new ge(new yi(y.r*1.05,14),new Yt({map:nf(),transparent:!0,opacity:.5*y.op,depthWrite:!1}));A.rotation.x=-Math.PI/2,A.scale.set(1.35,1,1),e.add(A),l.push({cl:y,g:M,sh:A,matC:v})}},d=[],h=new yi(1,16),f=()=>{if(!(d.length||!n.fogBanks))for(let g of n.fogBanks){let y=new $e,v=[];g.puffs.forEach((M,A)=>{let E=new Yt({map:Xc(),color:13160664,transparent:!0,opacity:0,depthWrite:!1}),P=new ge(h,E);P.rotation.x=-Math.PI/2;let _=M.r*(.85+A%3*.18);P.scale.set(_,_*.8,1),P.position.set(M.dx*.6,2+A*4.5,M.dy*.6),P.renderOrder=3+A,y.add(P),v.push({s:P,r:_,phase:A*1.7+g.dens*5,spin:(A%2?1:-1)*(.015+A*.004)})}),e.add(y),d.push({f:g,group:y,puffs:v})}},u=new qt,p=new Float32Array(120);u.setAttribute("position",new en(p,3));let x=new xi({color:14221190,size:9,transparent:!0,opacity:.9,blending:wn,depthWrite:!1,sizeAttenuation:!0}),m=new zi(u,x);return m.frustumCulled=!1,e.add(m),{sync(g,y){c(),f();let v=n.weather,M=(y.cx+n.world.biomeRidge(y.cy))/ue.w,A=.085,E=Ai((M-(2/3-A))/(2*A)),P=Ai((M-(1/3-A))/(2*A))*(1-E),_=v.rain*(P+E);if(o.opacity=Math.min(.75,_*.8),o.color.setHex(E>P?16054524:12374764),o.size=E>P?7:4.5,_>.02){let N=E>P?.12:.55;for(let W=0;W<700;W++){let Y=r[W],U=(Y.y+n.t*Y.sp*N)%1;s[W*3]=y.cx+(Y.x-.5)*2*1700+n.wind*60*U,s[W*3+1]=700*(1-U),s[W*3+2]=y.cy+(Y.z-.5)*2*1700}i.attributes.position.needsUpdate=!0}let b=y.lightLevel();for(let{cl:C,g:N,sh:W,matC:Y}of l){N.position.set(C.x,560,C.y),W.position.set(C.x+64,2.5,C.y+86);let U=C.x-y.cx,H=C.y-y.cy,$=Math.sqrt(U*U+H*H),le=($<700?.22:$<1400?.22+($-700)/700*.28:.5)*C.op;Y.opacity+=(le-Y.opacity)*Math.min(1,g*4),Y.color.setScalar(.82+b*.18),W.material.opacity=(.32+.26*b)*C.op}for(let{f:C,group:N,puffs:W}of d){let Y=n.world.biomeAt(C.x,C.y)==="winter";N.position.set(C.x,0,C.y);let U=Y?0:Math.min(.16,v.fog*C.dens*.15);for(let H of W){H.s.material.opacity=U,H.s.rotation.z=H.phase+n.t*H.spin;let $=1+Math.sin(n.t*.27+H.phase)*.07;H.s.scale.set(H.r*$,H.r*.8*$,1)}}let S=0;if(n.fireflies){let C=1-y.lightLevel();x.opacity=.35+.5*C+.3*Math.min(1,v.fog);for(let N of n.fireflies){if(S>=40)break;n.world.biomeAt(N.x,N.y)==="jungle"&&(p[S*3]=N.x,p[S*3+1]=16+Math.sin(N.ph)*8,p[S*3+2]=N.y,S++)}u.attributes.position.needsUpdate=!0}u.setDrawRange(0,S)}}}function v0(n,e,t){let i=document.createElement("canvas");i.id="overlay",i.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:5",document.body.appendChild(i);let s=i.getContext("2d");function r(){i.width=e.VW,i.height=e.VH}r(),addEventListener("resize",r);let o=(d,h,f=0)=>t.worldToScreen(d,h,f);function a(d,h,f,u,p){s.strokeStyle=u,s.lineWidth=2,p&&s.setLineDash(p),s.beginPath();for(let x=0;x<=36;x++){let m=x/36*Math.PI*2,g=o(d+Math.cos(m)*f,h+Math.sin(m)*f);x?s.lineTo(g.x,g.y):s.moveTo(g.x,g.y)}s.stroke(),s.setLineDash([])}return{draw(){let d=e.VW,h=e.VH;s.clearRect(0,0,d,h);let f=n.t;s.font="bold 13px Trebuchet MS",s.textAlign="center";for(let u of e.godView?[]:n.floats){let p=o(u.ox,u.y,40);if(p.behind)continue;let x=Math.max(0,u.life/u.max);s.globalAlpha=x,s.fillStyle="#000",s.fillText(u.text,p.x+1,p.y-u.lift+1),s.fillStyle=u.col,s.fillText(u.text,p.x,p.y-u.lift)}if(s.globalAlpha=1,n.buildMode&&!e.godView){let m=function(){for(let g in x.cost)if((n.inv[g]||0)<x.cost[g])return!1;return!0},u=qr(n,n.cmd.mx,n.cmd.my),p=oh(n,qe,n.buildPiece,u)&&m();s.fillStyle=p?"rgba(180,220,120,.4)":"rgba(210,80,60,.45)",s.strokeStyle=p?"#c4d66a":"#d2553c",s.lineWidth=2;let x=Qt[n.buildPiece];if(x.cat==="cell"){let g=u.gx*64,y=u.gy*64;s.beginPath(),[[0,0],[64,0],[64,64],[0,64]].forEach(([v,M],A)=>{let E=o(g+v,y+M);A?s.lineTo(E.x,E.y):s.moveTo(E.x,E.y)}),s.closePath(),s.fill(),s.stroke()}else{let g=kt(u.key,{type:n.buildPiece,rot:n.buildRot&1}),y=o(g[0],g[1]),v=o(g[2],g[3]);s.lineWidth=8,s.globalAlpha=.75,s.beginPath(),s.moveTo(y.x,y.y),s.lineTo(v.x,v.y),s.stroke(),s.globalAlpha=1}}if(!e.godView&&!n.player.inCopter){for(let[u,p]of n.deploys){if(p.type!=="cupboard"||p.owner!==qe)continue;let[x,m]=u.split(",").map(Number);a(x*64+32,m*64+32,zt,"rgba(126,200,80,0.3)",[10,8])}if(!n.shopOpen&&!n.storeOpen){let u=Math.floor(n.cmd.mx/64),p=Math.floor(n.cmd.my/64),x=n.deploys.get(u+","+p);x&&x.type==="turret"&&a(u*64+32,p*64+32,la[x.tier||1].range,"rgba(240,156,72,0.3)",[6,7]);let m=l(u,p);if(m){let g=o(m.x,m.y,50),y=Math.max(0,m.hp/m.max);s.fillStyle="rgba(0,0,0,.7)",s.fillRect(g.x-18,g.y-8,36,5),s.fillStyle=y>.5?"#7bbf4f":y>.25?"#d8b24a":"#c0432f",s.fillRect(g.x-18,g.y-8,36*y,5)}}}if(e.debugPaths){s.font="bold 10px Trebuchet MS";for(let u of n.units){if(u.dead||u.eliminated||u.flying||!t.inView(u.x,u.y,600))continue;let p=u.ally?"#7ec850":u.col;if(u.path&&u.pathI<u.path.length){s.strokeStyle=p,s.lineWidth=1.5,s.globalAlpha=.8,s.beginPath();let m=o(u.x,u.y);s.moveTo(m.x,m.y);for(let g=u.pathI;g<u.path.length;g++)m=o(u.path[g].x,u.path[g].y),s.lineTo(m.x,m.y);s.stroke(),s.globalAlpha=1}let x=o(u.x,u.y,56);s.fillStyle="#000",s.fillText(u.act||u.state,x.x+1,x.y+1),s.fillStyle=p,s.fillText(u.act||u.state,x.x,x.y)}}if(c(n.airdrop&&{x:n.airdrop.x,y:n.airdrop.fall<1?n.airdrop.gy:n.airdrop.y},"AIRDROP","#ffd76b","\u2708"),n.quarry){let u=n.teams.find(p=>p.owner===n.quarry.owner);c(n.quarry,"QUARRY",n.quarry.owner===qe?"#7ec850":u?u.col:"#b9b39d","Q")}if(n.lockedCrate){let u=n.lockedCrate;c(u,u.started?"CRATE "+Math.ceil(u.t)+"s":"LOCKED CRATE","#ffb84a","C")}if(e.godView){s.font="bold 9px Trebuchet MS";for(let p of n.teams)for(let x of p.bases){if(x.dead)continue;let m=o(x.hx,x.hy);s.fillStyle=p.col,s.fillRect(m.x-6,m.y-6,12,12),s.fillStyle="#fff",s.fillText(String(p.id+1),m.x,m.y+3.5)}for(let p of n.units){if(p.dead||p.eliminated)continue;let x=o(p.x,p.y);s.fillStyle=p.ally?"#7ec850":p.col,s.beginPath(),s.arc(x.x,x.y,p.primary?3.4:2.4,0,7),s.fill()}for(let p of n.raids){let x=o(p.x,p.y);s.fillStyle=`rgba(255,82,56,${.35+.4*(p.t/60)})`,s.beginPath(),s.arc(x.x,x.y,7+3*Math.sin(f*6),0,7),s.fill()}if(n.deathMark){let p=o(n.deathMark.x,n.deathMark.y);s.fillStyle="#000",s.beginPath(),s.arc(p.x,p.y,8,0,7),s.fill(),s.fillStyle="#fff",s.beginPath(),s.arc(p.x,p.y-1,5,0,7),s.fill()}let u=o(n.player.x,n.player.y);s.strokeStyle="#7ec850",s.lineWidth=2.5,s.beginPath(),s.arc(u.x,u.y,11+3*Math.sin(f*6),0,7),s.stroke(),s.font="bold 11px Trebuchet MS",s.fillStyle="#7ec850",s.fillText("YOU",u.x,u.y-18),s.fillStyle="#d8d0ba",s.font="bold 14px Trebuchet MS",s.fillText("Click anywhere on the map to travel there",d/2,h-66)}else{let u=e.mouseSX,p=e.mouseSY;if(u!==void 0){s.strokeStyle="rgba(225,235,195,.9)",s.lineWidth=3,s.lineCap="round";for(let[x,m]of[[1,0],[-1,0],[0,1],[0,-1]])s.beginPath(),s.moveTo(u+x*6,p+m*6),s.lineTo(u+x*15,p+m*15),s.stroke()}}if(n.raidAlarm){let u=Math.min(1,n.raidAlarm.t/1.5);s.fillStyle=`rgba(180,30,20,${.14*u})`,s.fillRect(0,0,d,h),s.textAlign="center",s.font="bold 22px Trebuchet MS",s.fillStyle="rgba(0,0,0,.7)",s.fillText("BASE UNDER ATTACK",d/2+2,54),s.fillStyle=`rgba(255,${80+110*(.5+.5*Math.sin(f*8))},55,${u})`,s.fillText("BASE UNDER ATTACK",d/2,52)}n.player.hurt>0&&(s.fillStyle=`rgba(150,28,18,${n.player.hurt*.4})`,s.fillRect(0,0,d,h)),n.player.dead&&(s.fillStyle="rgba(10,6,4,.55)",s.fillRect(0,0,d,h),s.textAlign="center",s.fillStyle="#e6d9b8",s.font="bold 44px Trebuchet MS",s.fillText("YOU DIED",d/2,h/2-4),s.fillStyle="#b9a06f",s.font="15px Trebuchet MS",s.fillText("respawning\u2026",d/2,h/2+24)),s.textAlign="left",s.font="bold 14px Trebuchet MS",n.elims.forEach((u,p)=>{let x=Math.min(1,u.t/3);s.globalAlpha=x,s.fillStyle="rgba(0,0,0,.5)",s.fillRect(d/2-130,92+p*24,264,20),s.fillStyle="#e2664a",s.fillText(u.text,d/2-122,106+p*24)}),s.globalAlpha=1,s.textAlign="center"}};function l(d,h){let f=n.deploys.get(d+","+h);if(f)return{x:d*64+32,y:h*64+32,hp:f.hp,max:f.max};let u=n.structures.get(d+","+h);if(u)return{x:d*64+32,y:h*64+32,hp:u.hp,max:u.max};for(let p of["V,"+d+","+h,"V,"+(d+1)+","+h,"H,"+d+","+h,"H,"+d+","+(h+1)]){let x=n.walls.get(p);if(!x)continue;let m=kt(p,x),g=(m[0]+m[2])/2,y=(m[1]+m[3])/2;if(Math.hypot(n.cmd.mx-g,n.cmd.my-y)<16)return{x:g,y,hp:x.hp,max:x.max}}return null}function c(d,h,f,u){if(!d)return;let p=o(d.x,d.y),x=e.VW,m=e.VH;if(s.textAlign="center",!p.behind&&p.x>0&&p.x<x&&p.y>0&&p.y<m){if(e.godView)return;s.font="bold 11px Trebuchet MS",s.fillStyle="rgba(0,0,0,.7)",s.fillText(h,p.x+1,p.y-49),s.fillStyle=f,s.fillText(h,p.x,p.y-50)}else{let g=Math.max(54,Math.min(x-54,p.x)),y=Math.max(54,Math.min(m-54,p.behind?m-54:p.y));s.fillStyle=f,s.globalAlpha=.92,s.beginPath(),s.arc(g,y,14,0,7),s.fill(),s.globalAlpha=1,s.fillStyle="#1c1812",s.font="bold 13px Trebuchet MS",s.fillText(u,g,y+4.5)}}}function b0(n,e,t,i){let s={},r=e.canvas,o=(c,d)=>{let h=t.screenToWorld(c,d);n.cmd.mx=h.x,n.cmd.my=h.y,e.mouseSX=c,e.mouseSY=d};addEventListener("keydown",c=>{let d=c.key.toLowerCase();if(n.storeOpen){(d==="escape"||d==="e")&&(n.storeOpen=null,i.closeModals()),c.preventDefault();return}if(n.shopOpen){(d==="escape"||d==="e")&&(n.shopOpen=!1,i.closeModals()),c.preventDefault();return}s[d]=!0,a(),d==="e"&&bu(n),d==="g"&&!n.player.inCopter&&Ru(n),d==="q"&&(n.buildMode?M0(n,1):n.player.inCopter||Au(n)),d==="t"&&!n.buildMode&&!n.player.inCopter&&gh(n,n.cmd.mx,n.cmd.my),/^Digit[1-9]$|^Numpad[1-9]$/.test(c.code)&&!n.player.inCopter&&Xr(n,+c.code.slice(-1)-1),d==="b"&&!n.player.inCopter&&Xr(n,n.buildMode?0:5),d==="r"&&(n.buildMode?n.buildRot=(n.buildRot+1)%4:yh(n)),d==="u"&&Eu(n),["w","a","s","d"," "].includes(d)&&c.preventDefault()}),addEventListener("keyup",c=>{s[c.key.toLowerCase()]=!1,a()}),addEventListener("blur",()=>{for(let c in s)s[c]=!1;a(),n.cmd.fireHeld=!1});function a(){let c=(s.d?1:0)-(s.a?1:0),d=(s.s?1:0)-(s.w?1:0),h=t.orbit||0,f=c*Math.cos(h)+d*Math.sin(h),u=-c*Math.sin(h)+d*Math.cos(h);n.cmd.right=f>.38,n.cmd.left=f<-.38,n.cmd.down=u>.38,n.cmd.up=u<-.38,n.cmd.run=!!s.shift}addEventListener("wheel",c=>{if(n.buildMode&&!n.shopOpen&&!n.storeOpen){M0(n,c.deltaY>0?1:-1),c.preventDefault();return}!e.godView&&!n.shopOpen&&!n.storeOpen&&t.zoomFactor!==void 0&&(t.zoomFactor=it(t.zoomFactor*(1+c.deltaY*.0011),.55,1.9),c.preventDefault())},{passive:!1});let l=null;r.addEventListener("mousedown",c=>{c.button===1&&!e.godView&&(l={x:c.clientX,start:t.orbit||0},c.preventDefault())}),addEventListener("mousemove",c=>{l&&t.orbit!==void 0&&(t.orbit=l.start+(c.clientX-l.x)*.006,a())}),addEventListener("mouseup",c=>{c.button===1&&(l=null)}),r.addEventListener("auxclick",c=>{c.button===1&&c.preventDefault()}),r.addEventListener("mousemove",c=>{let d=r.getBoundingClientRect();o(c.clientX-d.left,c.clientY-d.top)}),r.addEventListener("mousedown",c=>{let d=r.getBoundingClientRect();if(o(c.clientX-d.left,c.clientY-d.top),c.button===0){if(e.godView){cb(n,e);return}if(n.cmd.fireHeld=!0,n.buildMode)wu(n);else if(!n.shopOpen&&!n.storeOpen){let h=n.slot;ba(n)}}else c.button===2&&n.buildMode&&Tu(n)}),addEventListener("mouseup",()=>{n.cmd.fireHeld=!1}),r.addEventListener("contextmenu",c=>c.preventDefault()),setInterval(()=>{e.mouseSX!==void 0&&o(e.mouseSX,e.mouseSY)},50)}function M0(n,e){let t=gs.indexOf(n.buildPiece);n.buildPiece=gs[(t+e+gs.length)%gs.length]}function cb(n,e){let t=n.cmd.mx,i=n.cmd.my;t=it(t,jt,13824-jt),i=it(i,jt,9216-jt);for(let s=0;s<24&&Tt(n,t,i,jt);s++)t+=(Math.random()*2-1)*40,i+=(Math.random()*2-1)*40;n.player.x=t,n.player.y=i,n.player.inCopter=!1,e.godView=!1,document.getElementById("mapbtn").classList.remove("on"),document.getElementById("mapbtn").textContent="Map View",n.tip={text:"arrived",t:1.2}}var hb={tool:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 20l7-7"/><path d="M14 4l6 6-5 5-6-6z" fill="currentColor"/></svg>',pistol:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 8h16v4h-6l-1 5h-4l1-5H6a3 3 0 0 1-3-3z"/></svg>',rifle:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M1 11h18l4-2v3l-4 1h-5l-1 5h-3l1-5H1z"/></svg>',minigun:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="2" y="7" width="14" height="3"/><rect x="2" y="11" width="14" height="3"/><rect x="2" y="15" width="14" height="3"/><rect x="15" y="6" width="6" height="13" rx="2"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2 10h13l5 2-5 2H2z"/><path d="M20 8l3 4-3 4z"/></svg>',build:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21l4-12 6 6-10 6z" fill="currentColor"/><path d="M13 5l6 6"/></svg>',sniper:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="1" y="10" width="20" height="3"/><rect x="6" y="6" width="6" height="3" rx="1"/><path d="M21 9l2 2-2 2z"/></svg>',shotgun:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M1 10h17v5H8l-2 4H3l2-4H1z"/></svg>',hmg:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="1" y="9" width="19" height="5"/><rect x="6" y="14" width="6" height="6"/><path d="M20 9l3 2.5-3 2.5z"/></svg>'},db=[["Tool","tool"],["Pistol","pistol"],["Rifle","rifle"],["Minigun","minigun"],["Rocket","rocket"],["Build","build"],["Sniper","sniper"],["Shotgun","shotgun"],["HMG","hmg"]],fb={1:"pistol",2:"rifle",3:"minigun",4:"rocket",6:"sniper",7:"shotgun",8:"hmg"},ub={floor:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="4" width="16" height="16" rx="2"/></svg>',wall:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="10" y="3" width="4" height="18" rx="1"/></svg>',door:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="9" y="3" width="6" height="18" rx="1"/><circle cx="13" cy="12" r="1.4" fill="#15130e"/></svg>',turret:'<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="13" r="6"/><rect x="12" y="11" width="10" height="4" rx="1"/></svg>',cupboard:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="5" y="3" width="14" height="18" rx="2"/><rect x="11.4" y="5" width="1.2" height="14" fill="#15130e"/></svg>'};function w0(n,e){let t=p=>document.getElementById(p),i=t("hotbar");db.forEach(([p,x],m)=>{let g=document.createElement("div");g.className="slot",g.innerHTML=`<span class="key">${m+1}</span>${hb[x]}<span class="nm">${p}</span>`,g.addEventListener("mousedown",y=>{y.stopPropagation(),Xr(n,m)}),i.appendChild(g)});let s=t("bpieces");for(let p of gs){let x=document.createElement("div");x.className="bpiece",x.dataset.piece=p;let m=Object.entries(Qt[p].cost).map(([g,y])=>y+" "+g).join(" + ");x.innerHTML=`${ub[p]}${Qt[p].name}<br><span style="opacity:.7">${m}</span>`,x.addEventListener("mousedown",g=>{g.stopPropagation(),n.buildPiece=p}),s.appendChild(x)}let r=(p,x)=>t(p).addEventListener("mousedown",m=>{m.stopPropagation(),x(t(p))});r("mapbtn",p=>{e.godView=!e.godView,p.classList.toggle("on",e.godView),p.textContent=e.godView?"Exit Map":"Map View"}),r("ghostbtn",p=>{n.ghost=!n.ghost,p.classList.toggle("on",n.ghost),p.textContent=n.ghost?"Ghost: ON":"Ghost"}),r("rocketbtn",p=>{n.rapidRockets=!n.rapidRockets,p.classList.toggle("on",n.rapidRockets),p.textContent=n.rapidRockets?"Rockets: ON":"Rapid Rockets"}),r("refillbtn",()=>window.__refillAll()),r("boosthardbtn",()=>window.__boostHard()),r("debugbtn",p=>{e.debugPaths=!e.debugPaths,p.classList.toggle("on",e.debugPaths),p.textContent=e.debugPaths?"Debug: ON":"Debug paths"}),t("ghostbtn").classList.add("on"),t("ghostbtn").textContent="Ghost: ON",t("helpToggle").addEventListener("click",()=>{let p=t("help");p.classList.toggle("min"),t("helpToggle").textContent=p.classList.contains("min")?"show":"hide"}),document.querySelectorAll(".spdbtn").forEach(p=>{p.addEventListener("mousedown",x=>{x.stopPropagation(),e.speed=+p.dataset.spd,document.querySelectorAll(".spdbtn").forEach(m=>m.classList.toggle("on",m===p))})});let o=0,a=null,l=!1;function c(){let p=t("shop"),x='<h3>Trade Shop</h3><div style="margin-bottom:8px">Scrap: <b id="shop-scrap">0</b></div><div class="cols"><div class="col"><h5>SELL \u2192 SCRAP</h5>';Vt.trades.forEach(([m,g,y],v)=>{x+=`<div class="trow"><span>${g} ${m} \u2192 ${y} scrap</span><button data-trade="${v}">Sell</button></div>`}),x+='</div><div class="col"><h5>BUY WEAPONS + GEAR</h5>';for(let m in Vt.buys)x+=`<div class="trow"><span id="shopown-${m}">${ln[m].name} <small>+${Vt.buys[m].ammo} ammo</small></span><button data-buy="${m}">${Vt.buys[m].cost} scrap</button></div>`;x+=`<div class="trow"><span>Jackhammer <small>3\xD7 gather</small></span><button data-misc="jackhammer">${Vt.jackhammer} scrap</button></div>`,x+=`<div class="trow"><span>Rifle laser sight</span><button data-misc="laser">${Vt.laser} scrap</button></div>`,x+=`<div class="trow"><span>Wood fence (G)</span><button data-misc="fence">${Vt.fenceWood} wood</button></div>`,x+=`<div class="trow"><span>Grenade (Q)</span><button data-misc="grenade">${Vt.grenade} scrap</button></div>`,x+=`<div class="trow"><span>Supply signal (T)</span><button data-misc="signal">${Vt.signal} scrap</button></div>`,x+=`<div class="trow"><span>+10 HQM</span><button data-misc="hqm">${Vt.hqm.cost} scrap</button></div>`,x+='<div class="trow"><span id="fm-lbl">Facemask</span><button data-misc="facemask">buy</button></div>',x+='<div class="trow"><span id="ba-lbl">Body armor</span><button data-misc="bodyArmor">buy</button></div>',x+=`<div class="trow"><span>Hire worker</span><button data-misc="worker">${Vt.worker} scrap</button></div>`,x+='</div></div><button class="close">Close (E / Esc)</button>',p.innerHTML=x,p.querySelectorAll("button").forEach(m=>{m.addEventListener("mousedown",g=>g.stopPropagation()),m.addEventListener("click",()=>{m.dataset.trade!==void 0?Cu(n,+m.dataset.trade):m.dataset.buy?Su(n,m.dataset.buy):m.dataset.misc?Iu(n,m.dataset.misc):(n.shopOpen=!1,p.classList.add("hidden")),d()})}),d()}function d(){let p=t("shop-scrap");p&&(p.textContent=n.inv.scrap|0);let x=t("fm-lbl");if(x){let g=n.player.facemask+1;x.textContent=g<=3?`Facemask L${g} (${xs.cost[g]} scrap)`:"Facemask MAX"}let m=t("ba-lbl");if(m){let g=n.player.bodyArmor+1;m.textContent=g<=3?`Body armor L${g} (${xs.cost[g]} scrap)`:"Body armor MAX"}for(let g in Vt.buys){let y=t("shopown-"+g);y&&(y.style.color=n.owned[g]?"var(--accent2)":"var(--ink)")}}function h(p){let x=t("store"),m=n.deploys.get(p);if(!m)return;let g=`<h3>${m.type==="cupboard"?"Tool Cupboard":"Storage"}</h3>`;for(let y of["wood","stone","metal","scrap"])g+=`<div class="strow"><span class="ic ${y}"></span>
        ...
        <span></span></div>`;g+='<button class="close">Close (E / Esc)</button>',x.innerHTML=g,x.querySelectorAll("button").forEach(y=>{y.addEventListener("mousedown",v=>v.stopPropagation()),y.addEventListener("click",()=>{if(y.dataset.mv){let[v,M]=y.dataset.mv.split(",");Pu(n,v,+M),f()}else n.storeOpen=null,x.classList.add("hidden")})}),f()}function f(){let p=n.deploys.get(n.storeOpen);if(!(!p||!p.store))for(let x of["wood","stone","metal","scrap"]){let m=t("st-"+x),g=t("inv-"+x);m&&(m.textContent=p.store[x]|0),g&&(g.textContent=n.inv[x]|0)}}return{closeModals(){t("store").classList.add("hidden"),t("shop").classList.add("hidden")},update(){t("r-wood").textContent=n.inv.wood|0,t("r-stone").textContent=n.inv.stone|0,t("r-metal").textContent=n.inv.metal|0,t("r-scrap").textContent=n.inv.scrap|0;let p=Math.floor(n.t/60),x=Math.floor(n.t%60);t("playtime").textContent=p+":"+String(x).padStart(2,"0");let m=n.player,g=Math.max(0,m.health/m.maxhp),y=t("hpfill");y.style.width=g*100+"%",y.style.background=g>.5?"linear-gradient(180deg,#9ccb5a,#6fae3e)":g>.25?"linear-gradient(180deg,#e0c14e,#c9962f)":"linear-gradient(180deg,#d76a4a,#b23b2a)",t("hptxt").textContent=Math.ceil(Math.max(0,m.health));let v=i.children;for(let E=0;E<v.length;E++){v[E].classList.toggle("sel",n.slot===E);let P=fb[E];v[E].classList.toggle("dim",!!P&&!n.owned[P])}if(t("buildmenu").classList.toggle("hidden",!n.buildMode),n.buildMode)for(let E of s.children){E.classList.toggle("sel",E.dataset.piece===n.buildPiece);let P=!0;for(let _ in Qt[E.dataset.piece].cost)(n.inv[_]||0)<Qt[E.dataset.piece].cost[_]&&(P=!1);E.classList.toggle("cant",!P)}let M=Wr(n);if(t("ammo").classList.toggle("hidden",!M),M){let E=n.weapons[M];t("ammo-mag").innerHTML=`${E.ammo} <small>/ ${E.reserve}</small>`;let P=M==="minigun"&&E.spin>0&&E.spin<ln.minigun.windup;t("ammo-rl").textContent=E.reloading>0?"RELOADING":P?"SPINNING\u2026":E.ammo===0?"PRESS R":""}let A=t("tip");n.tip?(A.textContent=n.tip.text,A.classList.add("show")):A.classList.remove("show"),n.shopOpen!==l?(l=n.shopOpen,t("shop").classList.toggle("hidden",!n.shopOpen),n.shopOpen&&c()):n.shopOpen&&n.tick%30===0&&d(),n.storeOpen!==a?(a=n.storeOpen,t("store").classList.toggle("hidden",!n.storeOpen),n.storeOpen&&h(n.storeOpen)):n.storeOpen&&n.tick%30===0&&f(),n.t-o>.4&&(o=n.t,u())}};function u(){let p=[];p.push({id:qe,name:"You",col:"#c4d66a",alive:!n.player.dead,you:!0,kills:n.playerKills,scrap:n.inv.scrap|0,res:n.inv.wood+n.inv.stone+n.inv.metal|0,tier:""});for(let y of n.teams){let v=0,M=0,A=0,E=!1;for(let _ of n.units)_.owner===y.owner&&(v+=_.kills,M+=_.scrap,A+=_.inv.wood+_.inv.stone+_.inv.metal,_.eliminated||(E=!0));let P=y.bases.find(_=>!_.dead);if(P){let _=n.deploys.get(P.tcKey);_&&_.store&&(A+=_.store.wood+_.store.stone+_.store.metal,M+=_.store.scrap)}p.push({id:y.id,name:"Base "+(y.id+1),col:y.col,alive:E&&!y.eliminated,kills:v,scrap:M|0,res:A|0,tier:y.hard?"HARD":y.weak?"EASY":""})}let x=null,m=0;for(let y of p)!y.you&&y.alive&&y.kills>m&&(m=y.kills,x=y.id);p.sort((y,v)=>v.scrap-y.scrap||v.kills-y.kills||v.res-y.res);let g=y=>y>=1e4?(y/1e3|0)+"k":y>=1e3?(y/1e3).toFixed(1)+"k":y;t("lb-rows").innerHTML=p.map(y=>`
