...
`)+`
`+g);let w=y+m+o,E=y+g+a,v=Wp(s,s.VERTEX_SHADER,w),b=Wp(s,s.FRAGMENT_SHADER,E);s.attachShader(x,v),s.attachShader(x,b),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(S){if(n.debug.checkShaderErrors){let P=s.getProgramInfoLog(x)||"",z=s.getShaderInfoLog(v)||"",X=s.getShaderInfoLog(b)||"",D=P.trim(),k=z.trim(),G=X.trim(),re=!0,L=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(re=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,v,b);else{let V=qp(s,v,"vertex"),ee=qp(s,b,"fragment");Xe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,uM=[new B(1,0,0),new B(-1,0,0),new B(0,1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1)],pM=[new B(0,-1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1),new B(0,-1,0),new B(0,-1,0)],em=new Mt,So=new B,sf=new B;function mM(n,e,t){let i=new ar,s=new $e,r=new $e,o=new Ht,a=new Qa,l=new ja,c={},f=t.maxTextureSize,h={[Ai]:Mn,[Mn]:Ai,[Bn]:Bn},d=new Ln({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $e},radius:{value:4}},vertexShader:fM,fragmentShader:dM}),u=d.clone();u.defines.HORIZONTAL_PASS=1;let p=new qt;p.setAttribute("position",new Kt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new _e(p,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=_o;let g=this.type;this.render=function(b,R,_){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;this.type===$u&&(qe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=_o);let M=n.getRenderTarget(),C=n.getActiveCubeFace(),S=n.getActiveMipmapLevel(),P=n.state;P.setBlending(ci),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);let z=g!==this.type;z&&R.traverse(function(X){X.material&&(Array.isArray(X.material)?X.material.forEach(D=>D.needsUpdate=!0):X.material.needsUpdate=!0)});for(let X=0,D=b.length;X<D;X++){let k=b[X],G=k.shadow;if(G===void 0){qe("WebGLShadowMap:",k,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);let re=G.getFrameExtents();s.multiply(re),r.copy(G.mapSize),(s.x>f||s.y>f)&&(s.x>f&&(r.x=Math.floor(f/re.x),s.x=r.x*re.x,G.mapSize.x=r.x),s.y>f&&(r.y=Math.floor(f/re.y),s.y=r.y*re.y,G.mapSize.y=r.y));let L=n.state.buffers.depth.getReversed();if(G.camera._reversedDepth=L,G.map===null||z===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===cr){if(k.isPointLight){qe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Pn(s.x,s.y,{format:os,type:fi,minFilter:hn,magFilter:hn,generateMipmaps:!1}),G.map.texture.name=k.name+".shadowMap",G.map.depthTexture=new Pi(s.x,s.y,zn),G.map.depthTexture.name=k.name+".shadowMapDepth",G.map.depthTexture.format=ii,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=an,G.map.depthTexture.magFilter=an}else k.isPointLight?(G.map=new rc(s.x),G.map.depthTexture=new $a(s.x,$n)):(G.map=new Pn(s.x,s.y),G.map.depthTexture=new Pi(s.x,s.y,$n)),G.map.depthTexture.name=k.name+".shadowMap",G.map.depthTexture.format=ii,this.type===_o?(G.map.depthTexture.compareFunction=L?tc:ec,G.map.depthTexture.minFilter=hn,G.map.depthTexture.magFilter=hn):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=an,G.map.depthTexture.magFilter=an);G.camera.updateProjectionMatrix()}let V=G.map.isWebGLCubeRenderTarget?6:1;for(let ee=0;ee<V;ee++){if(G.map.isWebGLCubeRenderTarget)n.setRenderTarget(G.map,ee),n.clear();else{ee===0&&(n.setRenderTarget(G.map),n.clear());let fe=G.getViewport(ee);o.set(r.x*fe.x,r.y*fe.y,r.x*fe.z,r.y*fe.w),P.viewport(o)}if(k.isPointLight){let fe=G.camera,De=G.matrix,$=k.distance||fe.far;$!==fe.far&&(fe.far=$,fe.updateProjectionMatrix()),So.setFromMatrixPosition(k.matrixWorld),fe.position.copy(So),sf.copy(fe.position),sf.add(uM[ee]),fe.up.copy(pM[ee]),fe.lookAt(sf),fe.updateMatrixWorld(),De.makeTranslation(-So.x,-So.y,-So.z),em.multiplyMatrices(fe.projectionMatrix,fe.matrixWorldInverse),G._frustum.setFromProjectionMatrix(em,fe.coordinateSystem,fe.reversedDepth)}else G.updateMatrices(k);i=G.getFrustum(),E(R,_,G.camera,k,this.type)}G.isPointLightShadow!==!0&&this.type===cr&&y(G,_),G.needsUpdate=!1}g=this.type,m.needsUpdate=!1,n.setRenderTarget(M,C,S)};function y(b,R){let _=e.update(x);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,u.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,u.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Pn(s.x,s.y,{format:os,type:fi})),d.uniforms.shadow_pass.value=b.map.depthTexture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,n.setRenderTarget(b.mapPass),n.clear(),n.renderBufferDirect(R,null,_,d,x,null),u.uniforms.shadow_pass.value=b.mapPass.texture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,n.setRenderTarget(b.map),n.clear(),n.renderBufferDirect(R,null,_,u,x,null)}function w(b,R,_,M){let C=null,S=_.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(S!==void 0)C=S;else if(C=_.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){let P=C.uuid,z=R.uuid,X=c[P];X===void 0&&(X={},c[P]=X);let D=X[z];D===void 0&&(D=C.clone(),X[z]=D,R.addEventListener("dispose",v)),C=D}if(C.visible=R.visible,C.wireframe=R.wireframe,M===cr?C.side=R.shadowSide!==null?R.shadowSide:R.side:C.side=R.shadowSide!==null?R.shadowSide:h[R.side],C.alphaMap=R.alphaMap,C.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,C.map=R.map,C.clipShadows=R.clipShadows,C.clippingPlanes=R.clippingPlanes,C.clipIntersection=R.clipIntersection,C.displacementMap=R.displacementMap,C.displacementScale=R.displacementScale,C.displacementBias=R.displacementBias,C.wireframeLinewidth=R.wireframeLinewidth,C.linewidth=R.linewidth,_.isPointLight===!0&&C.isMeshDistanceMaterial===!0){let P=n.properties.get(C);P.light=_}return C}function E(b,R,_,M,C){if(b.visible===!1)return;if(b.layers.test(R.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&C===cr)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,b.matrixWorld);let z=e.update(b),X=b.material;if(Array.isArray(X)){let D=z.groups;for(let k=0,G=D.length;k<G;k++){let re=D[k],L=X[re.materialIndex];if(L&&L.visible){let V=w(b,L,M,C);b.onBeforeShadow(n,b,R,_,z,V,re),n.renderBufferDirect(_,null,z,V,b,re),b.onAfterShadow(n,b,R,_,z,V,re)}}}else if(X.visible){let D=w(b,X,M,C);b.onBeforeShadow(n,b,R,_,z,D,null),n.renderBufferDirect(_,null,z,D,b,null),b.onAfterShadow(n,b,R,_,z,D,null)}}let P=b.children;for(let z=0,X=P.length;z<X;z++)E(P[z],R,_,M,C)}function v(b){b.target.removeEventListener("dispose",v);for(let _ in c){let M=c[_],C=b.target.uuid;C in M&&(M[C].dispose(),delete M[C])}}}function gM(n,e){function t(){let U=!1,me=new Ht,ne=null,Re=new Ht(0,0,0,0);return{setMask:function(xe){ne!==xe&&!U&&(n.colorMask(xe,xe,xe,xe),ne=xe)},setLocked:function(xe){U=xe},setClear:function(xe,le,Fe,Qe,Yt){Yt===!0&&(xe*=Qe,le*=Qe,Fe*=Qe),me.set(xe,le,Fe,Qe),Re.equals(me)===!1&&(n.clearColor(xe,le,Fe,Qe),Re.copy(me))},reset:function(){U=!1,ne=null,Re.set(-1,0,0,0)}}}function i(){let U=!1,me=!1,ne=null,Re=null,xe=null;return{setReversed:function(le){if(me!==le){let Fe=e.get("EXT_clip_control");le?Fe.clipControlEXT(Fe.LOWER_LEFT_EXT,Fe.ZERO_TO_ONE_EXT):Fe.clipControlEXT(Fe.LOWER_LEFT_EXT,Fe.NEGATIVE_ONE_TO_ONE_EXT),me=le;let Qe=xe;xe=null,this.setClear(Qe)}},getReversed:function(){return me},setTest:function(le){le?j(n.DEPTH_TEST):oe(n.DEPTH_TEST)},setMask:function(le){ne!==le&&!U&&(n.depthMask(le),ne=le)},setFunc:function(le){if(me&&(le=Cp[le]),Re!==le){switch(le){case La:n.depthFunc(n.NEVER);break;case Da:n.depthFunc(n.ALWAYS);break;case Na:n.depthFunc(n.LESS);break;case bs:n.depthFunc(n.LEQUAL);break;case Ua:n.depthFunc(n.EQUAL);break;case Fa:n.depthFunc(n.GEQUAL);break;case ka:n.depthFunc(n.GREATER);break;case Oa:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Re=le}},setLocked:function(le){U=le},setClear:function(le){xe!==le&&(xe=le,me&&(le=1-le),n.clearDepth(le))},reset:function(){U=!1,ne=null,Re=null,xe=null,me=!1}}}function s(){let U=!1,me=null,ne=null,Re=null,xe=null,le=null,Fe=null,Qe=null,Yt=null;return{setTest:function(bt){U||(bt?j(n.STENCIL_TEST):oe(n.STENCIL_TEST))},setMask:function(bt){me!==bt&&!U&&(n.stencilMask(bt),me=bt)},setFunc:function(bt,pi,Kn){(ne!==bt||Re!==pi||xe!==Kn)&&(n.stencilFunc(bt,pi,Kn),ne=bt,Re=pi,xe=Kn)},setOp:function(bt,pi,Kn){(le!==bt||Fe!==pi||Qe!==Kn)&&(n.stencilOp(bt,pi,Kn),le=bt,Fe=pi,Qe=Kn)},setLocked:function(bt){U=bt},setClear:function(bt){Yt!==bt&&(n.clearStencil(bt),Yt=bt)},reset:function(){U=!1,me=null,ne=null,Re=null,xe=null,le=null,Fe=null,Qe=null,Yt=null}}}let r=new t,o=new i,a=new s,l=new WeakMap,c=new WeakMap,f={},h={},d={},u=new WeakMap,p=[],x=null,m=!1,g=null,y=null,w=null,E=null,v=null,b=null,R=null,_=new tt(0,0,0),M=0,C=!1,S=null,P=null,z=null,X=null,D=null,k=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),G=!1,re=0,L=n.getParameter(n.VERSION);L.indexOf("WebGL")!==-1?(re=parseFloat(/^WebGL (\d)/.exec(L)[1]),G=re>=1):L.indexOf("OpenGL ES")!==-1&&(re=parseFloat(/^OpenGL ES (\d)/.exec(L)[1]),G=re>=2);let V=null,ee={},fe=n.getParameter(n.SCISSOR_BOX),De=n.getParameter(n.VIEWPORT),$=new Ht().fromArray(fe),J=new Ht().fromArray(De);function N(U,me,ne,Re){let xe=new Uint8Array(4),le=n.createTexture();n.bindTexture(U,le),n.texParameteri(U,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(U,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Fe=0;Fe<ne;Fe++)U===n.TEXTURE_3D||U===n.TEXTURE_2D_ARRAY?n.texImage3D(me,0,n.RGBA,1,1,Re,0,n.RGBA,n.UNSIGNED_BYTE,xe):n.texImage2D(me+Fe,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,xe);return le}let q={};q[n.TEXTURE_2D]=N(n.TEXTURE_2D,n.TEXTURE_2D,1),q[n.TEXTURE_CUBE_MAP]=N(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[n.TEXTURE_2D_ARRAY]=N(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),q[n.TEXTURE_3D]=N(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),j(n.DEPTH_TEST),o.setFunc(bs),St(!1),It(Ih),j(n.CULL_FACE),Ye(ci);function j(U){f[U]!==!0&&(n.enable(U),f[U]=!0)}function oe(U){f[U]!==!1&&(n.disable(U),f[U]=!1)}function we(U,me){return d[U]!==me?(n.bindFramebuffer(U,me),d[U]=me,U===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=me),U===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=me),!0):!1}function Ie(U,me){let ne=p,Re=!1;if(U){ne=u.get(me),ne===void 0&&(ne=[],u.set(me,ne));let xe=U.textures;if(ne.length!==xe.length||ne[0]!==n.COLOR_ATTACHMENT0){for(let le=0,Fe=xe.length;le<Fe;le++)ne[le]=n.COLOR_ATTACHMENT0+le;ne.length=xe.length,Re=!0}}else ne[0]!==n.BACK&&(ne[0]=n.BACK,Re=!0);Re&&n.drawBuffers(ne)}function Ne(U){return x!==U?(n.useProgram(U),x=U,!0):!1}let Ge={[$i]:n.FUNC_ADD,[Ju]:n.FUNC_SUBTRACT,[Qu]:n.FUNC_REVERSE_SUBTRACT};Ge[ju]=n.MIN,Ge[ep]=n.MAX;let Ze={[tp]:n.ZERO,[np]:n.ONE,[ip]:n.SRC_COLOR,[Ia]:n.SRC_ALPHA,[cp]:n.SRC_ALPHA_SATURATE,[ap]:n.DST_COLOR,[rp]:n.DST_ALPHA,[sp]:n.ONE_MINUS_SRC_COLOR,[Pa]:n.ONE_MINUS_SRC_ALPHA,[lp]:n.ONE_MINUS_DST_COLOR,[op]:n.ONE_MINUS_DST_ALPHA,[hp]:n.CONSTANT_COLOR,[fp]:n.ONE_MINUS_CONSTANT_COLOR,[dp]:n.CONSTANT_ALPHA,[up]:n.ONE_MINUS_CONSTANT_ALPHA};function Ye(U,me,ne,Re,xe,le,Fe,Qe,Yt,bt){if(U===ci){m===!0&&(oe(n.BLEND),m=!1);return}if(m===!1&&(j(n.BLEND),m=!0),U!==Ku){if(U!==g||bt!==C){if((y!==$i||v!==$i)&&(n.blendEquation(n.FUNC_ADD),y=$i,v=$i),bt)switch(U){case Zi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Di:n.blendFunc(n.ONE,n.ONE);break;case Ph:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Lh:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Xe("WebGLState: Invalid blending: ",U);break}else switch(U){case Zi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Di:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Ph:Xe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Lh:Xe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Xe("WebGLState: Invalid blending: ",U);break}w=null,E=null,b=null,R=null,_.set(0,0,0),M=0,g=U,C=bt}return}xe=xe||me,le=le||ne,Fe=Fe||Re,(me!==y||xe!==v)&&(n.blendEquationSeparate(Ge[me],Ge[xe]),y=me,v=xe),(ne!==w||Re!==E||le!==b||Fe!==R)&&(n.blendFuncSeparate(Ze[ne],Ze[Re],Ze[le],Ze[Fe]),w=ne,E=Re,b=le,R=Fe),(Qe.equals(_)===!1||Yt!==M)&&(n.blendColor(Qe.r,Qe.g,Qe.b,Yt),_.copy(Qe),M=Yt),g=U,C=!1}function Oe(U,me){U.side===Bn?oe(n.CULL_FACE):j(n.CULL_FACE);let ne=U.side===Mn;me&&(ne=!ne),St(ne),U.blending===Zi&&U.transparent===!1?Ye(ci):Ye(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),r.setMask(U.colorWrite);let Re=U.stencilWrite;a.setTest(Re),Re&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),O(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?j(n.SAMPLE_ALPHA_TO_COVERAGE):oe(n.SAMPLE_ALPHA_TO_COVERAGE)}function St(U){S!==U&&(U?n.frontFace(n.CW):n.frontFace(n.CCW),S=U)}function It(U){U!==Yu?(j(n.CULL_FACE),U!==P&&(U===Ih?n.cullFace(n.BACK):U===Zu?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):oe(n.CULL_FACE),P=U}function En(U){U!==z&&(G&&n.lineWidth(U),z=U)}function O(U,me,ne){U?(j(n.POLYGON_OFFSET_FILL),(X!==me||D!==ne)&&(X=me,D=ne,o.getReversed()&&(me=-me),n.polygonOffset(me,ne))):oe(n.POLYGON_OFFSET_FILL)}function jt(U){U?j(n.SCISSOR_TEST):oe(n.SCISSOR_TEST)}function lt(U){U===void 0&&(U=n.TEXTURE0+k-1),V!==U&&(n.activeTexture(U),V=U)}function Pt(U,me,ne){ne===void 0&&(V===null?ne=n.TEXTURE0+k-1:ne=V);let Re=ee[ne];Re===void 0&&(Re={type:void 0,texture:void 0},ee[ne]=Re),(Re.type!==U||Re.texture!==me)&&(V!==ne&&(n.activeTexture(ne),V=ne),n.bindTexture(U,me||q[U]),Re.type=U,Re.texture=me)}function ve(){let U=ee[V];U!==void 0&&U.type!==void 0&&(n.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function Vt(){try{n.compressedTexImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function I(){try{n.compressedTexImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function T(){try{n.texSubImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function W(){try{n.texSubImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function ie(){try{n.compressedTexSubImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function he(){try{n.compressedTexSubImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function ue(){try{n.texStorage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function ye(){try{n.texStorage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function te(){try{n.texImage2D(...arguments)}catch(U){Xe("WebGLState:",U)}}function se(){try{n.texImage3D(...arguments)}catch(U){Xe("WebGLState:",U)}}function Ee(U){return h[U]!==void 0?h[U]:n.getParameter(U)}function Pe(U,me){h[U]!==me&&(n.pixelStorei(U,me),h[U]=me)}function ge(U){$.equals(U)===!1&&(n.scissor(U.x,U.y,U.z,U.w),$.copy(U))}function pe(U){J.equals(U)===!1&&(n.viewport(U.x,U.y,U.z,U.w),J.copy(U))}function Ke(U,me){let ne=c.get(me);ne===void 0&&(ne=new WeakMap,c.set(me,ne));let Re=ne.get(U);Re===void 0&&(Re=n.getUniformBlockIndex(me,U.name),ne.set(U,Re))}function nt(U,me){let Re=c.get(me).get(U);l.get(me)!==Re&&(n.uniformBlockBinding(me,Re,U.__bindingPointIndex),l.set(me,Re))}function pt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),f={},h={},V=null,ee={},d={},u=new WeakMap,p=[],x=null,m=!1,g=null,y=null,w=null,E=null,v=null,b=null,R=null,_=new tt(0,0,0),M=0,C=!1,S=null,P=null,z=null,X=null,D=null,$.set(0,0,n.canvas.width,n.canvas.height),J.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:j,disable:oe,bindFramebuffer:we,drawBuffers:Ie,useProgram:Ne,setBlending:Ye,setMaterial:Oe,setFlipSided:St,setCullFace:It,setLineWidth:En,setPolygonOffset:O,setScissorTest:jt,activeTexture:lt,bindTexture:Pt,unbindTexture:ve,compressedTexImage2D:Vt,compressedTexImage3D:I,texImage2D:te,texImage3D:se,pixelStorei:Pe,getParameter:Ee,updateUBOMapping:Ke,uniformBlockBinding:nt,texStorage2D:ue,texStorage3D:ye,texSubImage2D:T,texSubImage3D:W,compressedTexSubImage2D:ie,compressedTexSubImage3D:he,scissor:ge,viewport:pe,reset:pt}}function xM(n,e,t,i,s,r,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new $e,f=new WeakMap,h=new Set,d,u=new WeakMap,p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(I,T){return p?new OffscreenCanvas(I,T):Kr("canvas")}function m(I,T,W){let ie=1,he=Vt(I);if((he.width>W||he.height>W)&&(ie=W/Math.max(he.width,he.height)),ie<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){let ue=Math.floor(ie*he.width),ye=Math.floor(ie*he.height);d===void 0&&(d=x(ue,ye));let te=T?x(ue,ye):d;return te.width=ue,te.height=ye,te.getContext("2d").drawImage(I,0,0,ue,ye),qe("WebGLRenderer: Texture has been resized from ("+he.width+"x"+he.height+") to ("+ue+"x"+ye+")."),te}else return"data"in I&&qe("WebGLRenderer: Image in DataTexture is too big ("+he.width+"x"+he.height+")."),I;return I}function g(I){return I.generateMipmaps}function y(I){n.generateMipmap(I)}function w(I){return I.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?n.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function E(I,T,W,ie,he,ue=!1){if(I!==null){if(n[I]!==void 0)return n[I];qe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let ye;ie&&(ye=e.get("EXT_texture_norm16"),ye||qe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let te=T;if(T===n.RED&&(W===n.FLOAT&&(te=n.R32F),W===n.HALF_FLOAT&&(te=n.R16F),W===n.UNSIGNED_BYTE&&(te=n.R8),W===n.UNSIGNED_SHORT&&ye&&(te=ye.R16_EXT),W===n.SHORT&&ye&&(te=ye.R16_SNORM_EXT)),T===n.RED_INTEGER&&(W===n.UNSIGNED_BYTE&&(te=n.R8UI),W===n.UNSIGNED_SHORT&&(te=n.R16UI),W===n.UNSIGNED_INT&&(te=n.R32UI),W===n.BYTE&&(te=n.R8I),W===n.SHORT&&(te=n.R16I),W===n.INT&&(te=n.R32I)),T===n.RG&&(W===n.FLOAT&&(te=n.RG32F),W===n.HALF_FLOAT&&(te=n.RG16F),W===n.UNSIGNED_BYTE&&(te=n.RG8),W===n.UNSIGNED_SHORT&&ye&&(te=ye.RG16_EXT),W===n.SHORT&&ye&&(te=ye.RG16_SNORM_EXT)),T===n.RG_INTEGER&&(W===n.UNSIGNED_BYTE&&(te=n.RG8UI),W===n.UNSIGNED_SHORT&&(te=n.RG16UI),W===n.UNSIGNED_INT&&(te=n.RG32UI),W===n.BYTE&&(te=n.RG8I),W===n.SHORT&&(te=n.RG16I),W===n.INT&&(te=n.RG32I)),T===n.RGB_INTEGER&&(W===n.UNSIGNED_BYTE&&(te=n.RGB8UI),W===n.UNSIGNED_SHORT&&(te=n.RGB16UI),W===n.UNSIGNED_INT&&(te=n.RGB32UI),W===n.BYTE&&(te=n.RGB8I),W===n.SHORT&&(te=n.RGB16I),W===n.INT&&(te=n.RGB32I)),T===n.RGBA_INTEGER&&(W===n.UNSIGNED_BYTE&&(te=n.RGBA8UI),W===n.UNSIGNED_SHORT&&(te=n.RGBA16UI),W===n.UNSIGNED_INT&&(te=n.RGBA32UI),W===n.BYTE&&(te=n.RGBA8I),W===n.SHORT&&(te=n.RGBA16I),W===n.INT&&(te=n.RGBA32I)),T===n.RGB&&(W===n.UNSIGNED_SHORT&&ye&&(te=ye.RGB16_EXT),W===n.SHORT&&ye&&(te=ye.RGB16_SNORM_EXT),W===n.UNSIGNED_INT_5_9_9_9_REV&&(te=n.RGB9_E5),W===n.UNSIGNED_INT_10F_11F_11F_REV&&(te=n.R11F_G11F_B10F)),T===n.RGBA){let se=ue?$r:ct.getTransfer(he);W===n.FLOAT&&(te=n.RGBA32F),W===n.HALF_FLOAT&&(te=n.RGBA16F),W===n.UNSIGNED_BYTE&&(te=se===vt?n.SRGB8_ALPHA8:n.RGBA8),W===n.UNSIGNED_SHORT&&ye&&(te=ye.RGBA16_EXT),W===n.SHORT&&ye&&(te=ye.RGBA16_SNORM_EXT),W===n.UNSIGNED_SHORT_4_4_4_4&&(te=n.RGBA4),W===n.UNSIGNED_SHORT_5_5_5_1&&(te=n.RGB5_A1)}return(te===n.R16F||te===n.R32F||te===n.RG16F||te===n.RG32F||te===n.RGBA16F||te===n.RGBA32F)&&e.get("EXT_color_buffer_float"),te}function v(I,T){let W;return I?T===null||T===$n||T===fr?W=n.DEPTH24_STENCIL8:T===zn?W=n.DEPTH32F_STENCIL8:T===hr&&(W=n.DEPTH24_STENCIL8,qe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===$n||T===fr?W=n.DEPTH_COMPONENT24:T===zn?W=n.DEPTH_COMPONENT32F:T===hr&&(W=n.DEPTH_COMPONENT16),W}function b(I,T){return g(I)===!0||I.isFramebufferTexture&&I.minFilter!==an&&I.minFilter!==hn?Math.log2(Math.max(T.width,T.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?T.mipmaps.length:1}function R(I){let T=I.target;T.removeEventListener("dispose",R),M(T),T.isVideoTexture&&f.delete(T),T.isHTMLTexture&&h.delete(T)}function _(I){let T=I.target;T.removeEventListener("dispose",_),S(T)}function M(I){let T=i.get(I);if(T.__webglInit===void 0)return;let W=I.source,ie=u.get(W);if(ie){let he=ie[T.__cacheKey];he.usedTimes--,he.usedTimes===0&&C(I),Object.keys(ie).length===0&&u.delete(W)}i.remove(I)}function C(I){let T=i.get(I);n.deleteTexture(T.__webglTexture);let W=I.source,ie=u.get(W);delete ie[T.__cacheKey],o.memory.textures--}function S(I){let T=i.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),i.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let ie=0;ie<6;ie++){if(Array.isArray(T.__webglFramebuffer[ie]))for(let he=0;he<T.__webglFramebuffer[ie].length;he++)n.deleteFramebuffer(T.__webglFramebuffer[ie][he]);else n.deleteFramebuffer(T.__webglFramebuffer[ie]);T.__webglDepthbuffer&&n.deleteRenderbuffer(T.__webglDepthbuffer[ie])}else{if(Array.isArray(T.__webglFramebuffer))for(let ie=0;ie<T.__webglFramebuffer.length;ie++)n.deleteFramebuffer(T.__webglFramebuffer[ie]);else n.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&n.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&n.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let ie=0;ie<T.__webglColorRenderbuffer.length;ie++)T.__webglColorRenderbuffer[ie]&&n.deleteRenderbuffer(T.__webglColorRenderbuffer[ie]);T.__webglDepthRenderbuffer&&n.deleteRenderbuffer(T.__webglDepthRenderbuffer)}let W=I.textures;for(let ie=0,he=W.length;ie<he;ie++){let ue=i.get(W[ie]);ue.__webglTexture&&(n.deleteTexture(ue.__webglTexture),o.memory.textures--),i.remove(W[ie])}i.remove(I)}let P=0;function z(){P=0}function X(){return P}function D(I){P=I}function k(){let I=P;return I>=s.maxTextures&&qe("WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+s.maxTextures),P+=1,I}function G(I){let T=[];return T.push(I.wrapS),T.push(I.wrapT),T.push(I.wrapR||0),T.push(I.magFilter),T.push(I.minFilter),T.push(I.anisotropy),T.push(I.internalFormat),T.push(I.format),T.push(I.type),T.push(I.generateMipmaps),T.push(I.premultiplyAlpha),T.push(I.flipY),T.push(I.unpackAlignment),T.push(I.colorSpace),T.join()}function re(I,T){let W=i.get(I);if(I.isVideoTexture&&Pt(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&W.__version!==I.version){let ie=I.image;if(ie===null)qe("WebGLRenderer: Texture marked for update but no image data found.");else if(ie.complete===!1)qe("WebGLRenderer: Texture marked for update but image is incomplete");else{oe(W,I,T);return}}else I.isExternalTexture&&(W.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,W.__webglTexture,n.TEXTURE0+T)}function L(I,T){let W=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&W.__version!==I.version){oe(W,I,T);return}else I.isExternalTexture&&(W.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,W.__webglTexture,n.TEXTURE0+T)}function V(I,T){let W=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&W.__version!==I.version){oe(W,I,T);return}t.bindTexture(n.TEXTURE_3D,W.__webglTexture,n.TEXTURE0+T)}function ee(I,T){let W=i.get(I);if(I.isCubeDepthTexture!==!0&&I.version>0&&W.__version!==I.version){we(W,I,T);return}t.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture,n.TEXTURE0+T)}let fe={[Ba]:n.REPEAT,[ni]:n.CLAMP_TO_EDGE,[za]:n.MIRRORED_REPEAT},De={[an]:n.NEAREST,[gp]:n.NEAREST_MIPMAP_NEAREST,[Mo]:n.NEAREST_MIPMAP_LINEAR,[hn]:n.LINEAR,[ml]:n.LINEAR_MIPMAP_NEAREST,[hi]:n.LINEAR_MIPMAP_LINEAR},$={[_p]:n.NEVER,[Tp]:n.ALWAYS,[vp]:n.LESS,[ec]:n.LEQUAL,[Mp]:n.EQUAL,[tc]:n.GEQUAL,[bp]:n.GREATER,[wp]:n.NOTEQUAL};function J(I,T){if(T.type===zn&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===hn||T.magFilter===ml||T.magFilter===Mo||T.magFilter===hi||T.minFilter===hn||T.minFilter===ml||T.minFilter===Mo||T.minFilter===hi)&&qe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(I,n.TEXTURE_WRAP_S,fe[T.wrapS]),n.texParameteri(I,n.TEXTURE_WRAP_T,fe[T.wrapT]),(I===n.TEXTURE_3D||I===n.TEXTURE_2D_ARRAY)&&n.texParameteri(I,n.TEXTURE_WRAP_R,fe[T.wrapR]),n.texParameteri(I,n.TEXTURE_MAG_FILTER,De[T.magFilter]),n.texParameteri(I,n.TEXTURE_MIN_FILTER,De[T.minFilter]),T.compareFunction&&(n.texParameteri(I,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(I,n.TEXTURE_COMPARE_FUNC,$[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===an||T.minFilter!==Mo&&T.minFilter!==hi||T.type===zn&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||i.get(T).__currentAnisotropy){let W=e.get("EXT_texture_filter_anisotropic");n.texParameterf(I,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,s.getMaxAnisotropy())),i.get(T).__currentAnisotropy=T.anisotropy}}}function N(I,T){let W=!1;I.__webglInit===void 0&&(I.__webglInit=!0,T.addEventListener("dispose",R));let ie=T.source,he=u.get(ie);he===void 0&&(he={},u.set(ie,he));let ue=G(T);if(ue!==I.__cacheKey){he[ue]===void 0&&(he[ue]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,W=!0),he[ue].usedTimes++;let ye=he[I.__cacheKey];ye!==void 0&&(he[I.__cacheKey].usedTimes--,ye.usedTimes===0&&C(T)),I.__cacheKey=ue,I.__webglTexture=he[ue].texture}return W}function q(I,T,W){return Math.floor(Math.floor(I/W)/T)}function j(I,T,W,ie){let ue=I.updateRanges;if(ue.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,T.width,T.height,W,ie,T.data);else{ue.sort((Pe,ge)=>Pe.start-ge.start);let ye=0;for(let Pe=1;Pe<ue.length;Pe++){let ge=ue[ye],pe=ue[Pe],Ke=ge.start+ge.count,nt=q(pe.start,T.width,4),pt=q(ge.start,T.width,4);pe.start<=Ke+1&&nt===pt&&q(pe.start+pe.count-1,T.width,4)===nt?ge.count=Math.max(ge.count,pe.start+pe.count-ge.start):(++ye,ue[ye]=pe)}ue.length=ye+1;let te=t.getParameter(n.UNPACK_ROW_LENGTH),se=t.getParameter(n.UNPACK_SKIP_PIXELS),Ee=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,T.width);for(let Pe=0,ge=ue.length;Pe<ge;Pe++){let pe=ue[Pe],Ke=Math.floor(pe.start/4),nt=Math.ceil(pe.count/4),pt=Ke%T.width,U=Math.floor(Ke/T.width),me=nt,ne=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,pt),t.pixelStorei(n.UNPACK_SKIP_ROWS,U),t.texSubImage2D(n.TEXTURE_2D,0,pt,U,me,ne,W,ie,T.data)}I.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,te),t.pixelStorei(n.UNPACK_SKIP_PIXELS,se),t.pixelStorei(n.UNPACK_SKIP_ROWS,Ee)}}function oe(I,T,W){let ie=n.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(ie=n.TEXTURE_2D_ARRAY),T.isData3DTexture&&(ie=n.TEXTURE_3D);let he=N(I,T),ue=T.source;t.bindTexture(ie,I.__webglTexture,n.TEXTURE0+W);let ye=i.get(ue);if(ue.version!==ye.__version||he===!0){if(t.activeTexture(n.TEXTURE0+W),(typeof ImageBitmap<"u"&&T.image instanceof ImageBitmap)===!1){let ne=ct.getPrimaries(ct.workingColorSpace),Re=T.colorSpace===Ni?null:ct.getPrimaries(T.colorSpace),xe=T.colorSpace===Ni||ne===Re?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,T.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe)}t.pixelStorei(n.UNPACK_ALIGNMENT,T.unpackAlignment);let se=m(T.image,!1,s.maxTextureSize);se=ve(T,se);let Ee=r.convert(T.format,T.colorSpace),Pe=r.convert(T.type),ge=E(T.internalFormat,Ee,Pe,T.normalized,T.colorSpace,T.isVideoTexture);J(ie,T);let pe,Ke=T.mipmaps,nt=T.isVideoTexture!==!0,pt=ye.__version===void 0||he===!0,U=ue.dataReady,me=b(T,se);if(T.isDepthTexture)ge=v(T.format===rs,T.type),pt&&(nt?t.texStorage2D(n.TEXTURE_2D,1,ge,se.width,se.height):t.texImage2D(n.TEXTURE_2D,0,ge,se.width,se.height,0,Ee,Pe,null));else if(T.isDataTexture)if(Ke.length>0){nt&&pt&&t.texStorage2D(n.TEXTURE_2D,me,ge,Ke[0].width,Ke[0].height);for(let ne=0,Re=Ke.length;ne<Re;ne++)pe=Ke[ne],nt?U&&t.texSubImage2D(n.TEXTURE_2D,ne,0,0,pe.width,pe.height,Ee,Pe,pe.data):t.texImage2D(n.TEXTURE_2D,ne,ge,pe.width,pe.height,0,Ee,Pe,pe.data);T.generateMipmaps=!1}else nt?(pt&&t.texStorage2D(n.TEXTURE_2D,me,ge,se.width,se.height),U&&j(T,se,Ee,Pe)):t.texImage2D(n.TEXTURE_2D,0,ge,se.width,se.height,0,Ee,Pe,se.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){nt&&pt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,me,ge,Ke[0].width,Ke[0].height,se.depth);for(let ne=0,Re=Ke.length;ne<Re;ne++)if(pe=Ke[ne],T.format!==Hn)if(Ee!==null)if(nt){if(U)if(T.layerUpdates.size>0){let xe=Jh(pe.width,pe.height,T.format,T.type);for(let le of T.layerUpdates){let Fe=pe.data.subarray(le*xe/pe.data.BYTES_PER_ELEMENT,(le+1)*xe/pe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ne,0,0,le,pe.width,pe.height,1,Ee,Fe)}T.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ne,0,0,0,pe.width,pe.height,se.depth,Ee,pe.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ne,ge,pe.width,pe.height,se.depth,0,pe.data,0,0);else qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else nt?U&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ne,0,0,0,pe.width,pe.height,se.depth,Ee,Pe,pe.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ne,ge,pe.width,pe.height,se.depth,0,Ee,Pe,pe.data)}else{nt&&pt&&t.texStorage2D(n.TEXTURE_2D,me,ge,Ke[0].width,Ke[0].height);for(let ne=0,Re=Ke.length;ne<Re;ne++)pe=Ke[ne],T.format!==Hn?Ee!==null?nt?U&&t.compressedTexSubImage2D(n.TEXTURE_2D,ne,0,0,pe.width,pe.height,Ee,pe.data):t.compressedTexImage2D(n.TEXTURE_2D,ne,ge,pe.width,pe.height,0,pe.data):qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):nt?U&&t.texSubImage2D(n.TEXTURE_2D,ne,0,0,pe.width,pe.height,Ee,Pe,pe.data):t.texImage2D(n.TEXTURE_2D,ne,ge,pe.width,pe.height,0,Ee,Pe,pe.data)}else if(T.isDataArrayTexture)if(nt){if(pt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,me,ge,se.width,se.height,se.depth),U)if(T.layerUpdates.size>0){let ne=Jh(se.width,se.height,T.format,T.type);for(let Re of T.layerUpdates){let xe=se.data.subarray(Re*ne/se.data.BYTES_PER_ELEMENT,(Re+1)*ne/se.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,Re,se.width,se.height,1,Ee,Pe,xe)}T.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,Ee,Pe,se.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,ge,se.width,se.height,se.depth,0,Ee,Pe,se.data);else if(T.isData3DTexture)nt?(pt&&t.texStorage3D(n.TEXTURE_3D,me,ge,se.width,se.height,se.depth),U&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,Ee,Pe,se.data)):t.texImage3D(n.TEXTURE_3D,0,ge,se.width,se.height,se.depth,0,Ee,Pe,se.data);else if(T.isFramebufferTexture){if(pt)if(nt)t.texStorage2D(n.TEXTURE_2D,me,ge,se.width,se.height);else{let ne=se.width,Re=se.height;for(let xe=0;xe<me;xe++)t.texImage2D(n.TEXTURE_2D,xe,ge,ne,Re,0,Ee,Pe,null),ne>>=1,Re>>=1}}else if(T.isHTMLTexture){if("texElementImage2D"in n){let ne=n.canvas;if(ne.hasAttribute("layoutsubtree")||ne.setAttribute("layoutsubtree","true"),se.parentNode!==ne){ne.appendChild(se),h.add(T),ne.onpaint=Qe=>{let Yt=Qe.changedElements;for(let bt of h)Yt.includes(bt.image)&&(bt.needsUpdate=!0)},ne.requestPaint();return}let Re=0,xe=n.RGBA,le=n.RGBA,Fe=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,Re,xe,le,Fe,se),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Ke.length>0){if(nt&&pt){let ne=Vt(Ke[0]);t.texStorage2D(n.TEXTURE_2D,me,ge,ne.width,ne.height)}for(let ne=0,Re=Ke.length;ne<Re;ne++)pe=Ke[ne],nt?U&&t.texSubImage2D(n.TEXTURE_2D,ne,0,0,Ee,Pe,pe):t.texImage2D(n.TEXTURE_2D,ne,ge,Ee,Pe,pe);T.generateMipmaps=!1}else if(nt){if(pt){let ne=Vt(se);t.texStorage2D(n.TEXTURE_2D,me,ge,ne.width,ne.height)}U&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ee,Pe,se)}else t.texImage2D(n.TEXTURE_2D,0,ge,Ee,Pe,se);g(T)&&y(ie),ye.__version=ue.version,T.onUpdate&&T.onUpdate(T)}I.__version=T.version}function we(I,T,W){if(T.image.length!==6)return;let ie=N(I,T),he=T.source;t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+W);let ue=i.get(he);if(he.version!==ue.__version||ie===!0){t.activeTexture(n.TEXTURE0+W);let ye=ct.getPrimaries(ct.workingColorSpace),te=T.colorSpace===Ni?null:ct.getPrimaries(T.colorSpace),se=T.colorSpace===Ni||ye===te?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,T.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,T.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,se);let Ee=T.isCompressedTexture||T.image[0].isCompressedTexture,Pe=T.image[0]&&T.image[0].isDataTexture,ge=[];for(let le=0;le<6;le++)!Ee&&!Pe?ge[le]=m(T.image[le],!0,s.maxCubemapSize):ge[le]=Pe?T.image[le].image:T.image[le],ge[le]=ve(T,ge[le]);let pe=ge[0],Ke=r.convert(T.format,T.colorSpace),nt=r.convert(T.type),pt=E(T.internalFormat,Ke,nt,T.normalized,T.colorSpace),U=T.isVideoTexture!==!0,me=ue.__version===void 0||ie===!0,ne=he.dataReady,Re=b(T,pe);J(n.TEXTURE_CUBE_MAP,T);let xe;if(Ee){U&&me&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Re,pt,pe.width,pe.height);for(let le=0;le<6;le++){xe=ge[le].mipmaps;for(let Fe=0;Fe<xe.length;Fe++){let Qe=xe[Fe];T.format!==Hn?Ke!==null?U?ne&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Fe,0,0,Qe.width,Qe.height,Ke,Qe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Fe,pt,Qe.width,Qe.height,0,Qe.data):qe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?ne&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Fe,0,0,Qe.width,Qe.height,Ke,nt,Qe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Fe,pt,Qe.width,Qe.height,0,Ke,nt,Qe.data)}}}else{if(xe=T.mipmaps,U&&me){xe.length>0&&Re++;let le=Vt(ge[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Re,pt,le.width,le.height)}for(let le=0;le<6;le++)if(Pe){U?ne&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,ge[le].width,ge[le].height,Ke,nt,ge[le].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,pt,ge[le].width,ge[le].height,0,Ke,nt,ge[le].data);for(let Fe=0;Fe<xe.length;Fe++){let Yt=xe[Fe].image[le].image;U?ne&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Fe+1,0,0,Yt.width,Yt.height,Ke,nt,Yt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Fe+1,pt,Yt.width,Yt.height,0,Ke,nt,Yt.data)}}else{U?ne&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,Ke,nt,ge[le]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,pt,Ke,nt,ge[le]);for(let Fe=0;Fe<xe.length;Fe++){let Qe=xe[Fe];U?ne&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Fe+1,0,0,Ke,nt,Qe.image[le]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,Fe+1,pt,Ke,nt,Qe.image[le])}}}g(T)&&y(n.TEXTURE_CUBE_MAP),ue.__version=he.version,T.onUpdate&&T.onUpdate(T)}I.__version=T.version}function Ie(I,T,W,ie,he,ue){let ye=r.convert(W.format,W.colorSpace),te=r.convert(W.type),se=E(W.internalFormat,ye,te,W.normalized,W.colorSpace),Ee=i.get(T),Pe=i.get(W);if(Pe.__renderTarget=T,!Ee.__hasExternalTextures){let ge=Math.max(1,T.width>>ue),pe=Math.max(1,T.height>>ue);he===n.TEXTURE_3D||he===n.TEXTURE_2D_ARRAY?t.texImage3D(he,ue,se,ge,pe,T.depth,0,ye,te,null):t.texImage2D(he,ue,se,ge,pe,0,ye,te,null)}t.bindFramebuffer(n.FRAMEBUFFER,I),lt(T)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ie,he,Pe.__webglTexture,0,jt(T)):(he===n.TEXTURE_2D||he>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&he<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ie,he,Pe.__webglTexture,ue),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ne(I,T,W){if(n.bindRenderbuffer(n.RENDERBUFFER,I),T.depthBuffer){let ie=T.depthTexture,he=ie&&ie.isDepthTexture?ie.type:null,ue=v(T.stencilBuffer,he),ye=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;lt(T)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,jt(T),ue,T.width,T.height):W?n.renderbufferStorageMultisample(n.RENDERBUFFER,jt(T),ue,T.width,T.height):n.renderbufferStorage(n.RENDERBUFFER,ue,T.width,T.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ye,n.RENDERBUFFER,I)}else{let ie=T.textures;for(let he=0;he<ie.length;he++){let ue=ie[he],ye=r.convert(ue.format,ue.colorSpace),te=r.convert(ue.type),se=E(ue.internalFormat,ye,te,ue.normalized,ue.colorSpace);lt(T)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,jt(T),se,T.width,T.height):W?n.renderbufferStorageMultisample(n.RENDERBUFFER,jt(T),se,T.width,T.height):n.renderbufferStorage(n.RENDERBUFFER,se,T.width,T.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ge(I,T,W){let ie=T.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,I),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let he=i.get(T.depthTexture);if(he.__renderTarget=T,(!he.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),ie){if(he.__webglInit===void 0&&(he.__webglInit=!0,T.depthTexture.addEventListener("dispose",R)),he.__webglTexture===void 0){he.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,he.__webglTexture),J(n.TEXTURE_CUBE_MAP,T.depthTexture);let Ee=r.convert(T.depthTexture.format),Pe=r.convert(T.depthTexture.type),ge;T.depthTexture.format===ii?ge=n.DEPTH_COMPONENT24:T.depthTexture.format===rs&&(ge=n.DEPTH24_STENCIL8);for(let pe=0;pe<6;pe++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,ge,T.width,T.height,0,Ee,Pe,null)}}else re(T.depthTexture,0);let ue=he.__webglTexture,ye=jt(T),te=ie?n.TEXTURE_CUBE_MAP_POSITIVE_X+W:n.TEXTURE_2D,se=T.depthTexture.format===rs?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(T.depthTexture.format===ii)lt(T)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,se,te,ue,0,ye):n.framebufferTexture2D(n.FRAMEBUFFER,se,te,ue,0);else if(T.depthTexture.format===rs)lt(T)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,se,te,ue,0,ye):n.framebufferTexture2D(n.FRAMEBUFFER,se,te,ue,0);else throw new Error("Unknown depthTexture format")}function Ze(I){let T=i.get(I),W=I.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==I.depthTexture){let ie=I.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),ie){let he=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,ie.removeEventListener("dispose",he)};ie.addEventListener("dispose",he),T.__depthDisposeCallback=he}T.__boundDepthTexture=ie}if(I.depthTexture&&!T.__autoAllocateDepthBuffer)if(W)for(let ie=0;ie<6;ie++)Ge(T.__webglFramebuffer[ie],I,ie);else{let ie=I.texture.mipmaps;ie&&ie.length>0?Ge(T.__webglFramebuffer[0],I,0):Ge(T.__webglFramebuffer,I,0)}else if(W){T.__webglDepthbuffer=[];for(let ie=0;ie<6;ie++)if(t.bindFramebuffer(n.FRAMEBUFFER,T.__webglFramebuffer[ie]),T.__webglDepthbuffer[ie]===void 0)T.__webglDepthbuffer[ie]=n.createRenderbuffer(),Ne(T.__webglDepthbuffer[ie],I,!1);else{let he=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=T.__webglDepthbuffer[ie];n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,ue)}}else{let ie=I.texture.mipmaps;if(ie&&ie.length>0?t.bindFramebuffer(n.FRAMEBUFFER,T.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=n.createRenderbuffer(),Ne(T.__webglDepthbuffer,I,!1);else{let he=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=T.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,ue)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ye(I,T,W){let ie=i.get(I);T!==void 0&&Ie(ie.__webglFramebuffer,I,I.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),W!==void 0&&Ze(I)}function Oe(I){let T=I.texture,W=i.get(I),ie=i.get(T);I.addEventListener("dispose",_);let he=I.textures,ue=I.isWebGLCubeRenderTarget===!0,ye=he.length>1;if(ye||(ie.__webglTexture===void 0&&(ie.__webglTexture=n.createTexture()),ie.__version=T.version,o.memory.textures++),ue){W.__webglFramebuffer=[];for(let te=0;te<6;te++)if(T.mipmaps&&T.mipmaps.length>0){W.__webglFramebuffer[te]=[];for(let se=0;se<T.mipmaps.length;se++)W.__webglFramebuffer[te][se]=n.createFramebuffer()}else W.__webglFramebuffer[te]=n.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){W.__webglFramebuffer=[];for(let te=0;te<T.mipmaps.length;te++)W.__webglFramebuffer[te]=n.createFramebuffer()}else W.__webglFramebuffer=n.createFramebuffer();if(ye)for(let te=0,se=he.length;te<se;te++){let Ee=i.get(he[te]);Ee.__webglTexture===void 0&&(Ee.__webglTexture=n.createTexture(),o.memory.textures++)}if(I.samples>0&&lt(I)===!1){W.__webglMultisampledFramebuffer=n.createFramebuffer(),W.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let te=0;te<he.length;te++){let se=he[te];W.__webglColorRenderbuffer[te]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,W.__webglColorRenderbuffer[te]);let Ee=r.convert(se.format,se.colorSpace),Pe=r.convert(se.type),ge=E(se.internalFormat,Ee,Pe,se.normalized,se.colorSpace,I.isXRRenderTarget===!0),pe=jt(I);n.renderbufferStorageMultisample(n.RENDERBUFFER,pe,ge,I.width,I.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+te,n.RENDERBUFFER,W.__webglColorRenderbuffer[te])}n.bindRenderbuffer(n.RENDERBUFFER,null),I.depthBuffer&&(W.__webglDepthRenderbuffer=n.createRenderbuffer(),Ne(W.__webglDepthRenderbuffer,I,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ue){t.bindTexture(n.TEXTURE_CUBE_MAP,ie.__webglTexture),J(n.TEXTURE_CUBE_MAP,T);for(let te=0;te<6;te++)if(T.mipmaps&&T.mipmaps.length>0)for(let se=0;se<T.mipmaps.length;se++)Ie(W.__webglFramebuffer[te][se],I,T,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+te,se);else Ie(W.__webglFramebuffer[te],I,T,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0);g(T)&&y(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ye){for(let te=0,se=he.length;te<se;te++){let Ee=he[te],Pe=i.get(Ee),ge=n.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(ge=I.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ge,Pe.__webglTexture),J(ge,Ee),Ie(W.__webglFramebuffer,I,Ee,n.COLOR_ATTACHMENT0+te,ge,0),g(Ee)&&y(ge)}t.unbindTexture()}else{let te=n.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(te=I.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(te,ie.__webglTexture),J(te,T),T.mipmaps&&T.mipmaps.length>0)for(let se=0;se<T.mipmaps.length;se++)Ie(W.__webglFramebuffer[se],I,T,n.COLOR_ATTACHMENT0,te,se);else Ie(W.__webglFramebuffer,I,T,n.COLOR_ATTACHMENT0,te,0);g(T)&&y(te),t.unbindTexture()}I.depthBuffer&&Ze(I)}function St(I){let T=I.textures;for(let W=0,ie=T.length;W<ie;W++){let he=T[W];if(g(he)){let ue=w(I),ye=i.get(he).__webglTexture;t.bindTexture(ue,ye),y(ue),t.unbindTexture()}}}let It=[],En=[];function O(I){if(I.samples>0){if(lt(I)===!1){let T=I.textures,W=I.width,ie=I.height,he=n.COLOR_BUFFER_BIT,ue=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ye=i.get(I),te=T.length>1;if(te)for(let Ee=0;Ee<T.length;Ee++)t.bindFramebuffer(n.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ee,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ye.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ee,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ye.__webglMultisampledFramebuffer);let se=I.texture.mipmaps;se&&se.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ye.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ye.__webglFramebuffer);for(let Ee=0;Ee<T.length;Ee++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(he|=n.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(he|=n.STENCIL_BUFFER_BIT)),te){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ye.__webglColorRenderbuffer[Ee]);let Pe=i.get(T[Ee]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Pe,0)}n.blitFramebuffer(0,0,W,ie,0,0,W,ie,he,n.NEAREST),l===!0&&(It.length=0,En.length=0,It.push(n.COLOR_ATTACHMENT0+Ee),I.depthBuffer&&I.resolveDepthBuffer===!1&&(It.push(ue),En.push(ue),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,En)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,It))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),te)for(let Ee=0;Ee<T.length;Ee++){t.bindFramebuffer(n.FRAMEBUFFER,ye.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ee,n.RENDERBUFFER,ye.__webglColorRenderbuffer[Ee]);let Pe=i.get(T[Ee]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ye.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ee,n.TEXTURE_2D,Pe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ye.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&l){let T=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[T])}}}function jt(I){return Math.min(s.maxSamples,I.samples)}function lt(I){let T=i.get(I);return I.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function Pt(I){let T=o.render.frame;f.get(I)!==T&&(f.set(I,T),I.update())}function ve(I,T){let W=I.colorSpace,ie=I.format,he=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||W!==Zr&&W!==Ni&&(ct.getTransfer(W)===vt?(ie!==Hn||he!==Tn)&&qe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Xe("WebGLTextures: Unsupported texture color space:",W)),T}function Vt(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(c.width=I.naturalWidth||I.width,c.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(c.width=I.displayWidth,c.height=I.displayHeight):(c.width=I.width,c.height=I.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=z,this.getTextureUnits=X,this.setTextureUnits=D,this.setTexture2D=re,this.setTexture2DArray=L,this.setTexture3D=V,this.setTextureCube=ee,this.rebindTextures=Ye,this.setupRenderTarget=Oe,this.updateRenderTargetMipmap=St,this.updateMultisampleRenderTarget=O,this.setupDepthRenderbuffer=Ze,this.setupFrameBufferTexture=Ie,this.useMultisampledRTT=lt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function yM(n,e){function t(i,s=Ni){let r,o=ct.getTransfer(s);if(i===Tn)return n.UNSIGNED_BYTE;if(i===xl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===yl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Gh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Wh)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Hh)return n.BYTE;if(i===Vh)return n.SHORT;if(i===hr)return n.UNSIGNED_SHORT;if(i===gl)return n.INT;if(i===$n)return n.UNSIGNED_INT;if(i===zn)return n.FLOAT;if(i===fi)return n.HALF_FLOAT;if(i===Xh)return n.ALPHA;if(i===qh)return n.RGB;if(i===Hn)return n.RGBA;if(i===ii)return n.DEPTH_COMPONENT;if(i===rs)return n.DEPTH_STENCIL;if(i===_l)return n.RED;if(i===vl)return n.RED_INTEGER;if(i===os)return n.RG;if(i===Ml)return n.RG_INTEGER;if(i===bl)return n.RGBA_INTEGER;if(i===bo||i===wo||i===To||i===Eo)if(o===vt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===bo)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===wo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===To)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Eo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===bo)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===wo)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===To)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Eo)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===wl||i===Tl||i===El||i===Al)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===wl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Tl)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===El)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Al)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Rl||i===Cl||i===Sl||i===Il||i===Pl||i===Ao||i===Ll)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Rl||i===Cl)return o===vt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Sl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===Il)return r.COMPRESSED_R11_EAC;if(i===Pl)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Ao)return r.COMPRESSED_RG11_EAC;if(i===Ll)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Dl||i===Nl||i===Ul||i===Fl||i===kl||i===Ol||i===Bl||i===zl||i===Hl||i===Vl||i===Gl||i===Wl||i===Xl||i===ql)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Dl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Nl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Ul)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Fl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===kl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Ol)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Bl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===zl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Hl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Vl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Gl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Wl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Xl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ql)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Yl||i===Zl||i===$l)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Yl)return o===vt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Zl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===$l)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Kl||i===Jl||i===Ro||i===Ql)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Kl)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Jl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Ro)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Ql)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===fr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}var _M=`
void main() {
