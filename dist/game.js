...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function F_(n,e,t){let i=new Float32Array(Is),s=new O(0,1,0);return new Nn({name:"SphericalGaussianBlur",defines:{n:Is,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function Bp(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function zp(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cc(),fragmentShader:`
...
`)+`
`+g);let w=y+m+o,E=y+g+a,v=Yp(s,s.VERTEX_SHADER,w),b=Yp(s,s.FRAGMENT_SHADER,E);s.attachShader(x,v),s.attachShader(x,b),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function A(S){if(n.debug.checkShaderErrors){let P=s.getProgramInfoLog(x)||"",G=s.getShaderInfoLog(v)||"",q=s.getShaderInfoLog(b)||"",N=P.trim(),B=G.trim(),W=q.trim(),se=!0,oe=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(se=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,v,b);else{let de=Kp(s,v,"vertex"),Re=Kp(s,b,"fragment");Ye("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
