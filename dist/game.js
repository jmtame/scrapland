...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function k_(n,e,t){let i=new Float32Array(Is),s=new z(0,1,0);return new Un({name:"SphericalGaussianBlur",defines:{n:Is,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function Bp(){return new Un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function zp(){return new Un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cc(),fragmentShader:`
	...
	`}var ac=class extends Nn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new ho(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`].filter(Do).join(`
`)),o=ff(o),o=$p(o,t),o=Jp(o,t),a=ff(a),a=$p(a,t),a=Jp(a,t),o=Qp(o),a=Qp(a),t.isRawShaderMaterial!==!0&&(_=`#version 300 es
...
`)+`
`+g);let w=_+m+o,E=_+g+a,P=Yp(s,s.VERTEX_SHADER,w),T=Yp(s,s.FRAGMENT_SHADER,E);s.attachShader(x,P),s.attachShader(x,T),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function S(y){if(n.debug.checkShaderErrors){let C=s.getProgramInfoLog(x)||"",D=s.getShaderInfoLog(P)||"",k=s.getShaderInfoLog(T)||"",L=C.trim(),F=D.trim(),G=k.trim(),ie=!0,oe=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(ie=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,P,T);else{let de=Kp(s,P,"vertex"),Re=Kp(s,T,"fragment");Ye("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,_M=[new z(1,0,0),new z(-1,0,0),new z(0,1,0),new z(0,-1,0),new z(0,0,1),new z(0,0,-1)],vM=[new z(0,-1,0),new z(0,-1,0),new z(0,0,1),new z(0,0,-1),new z(0,-1,0),new z(0,-1,0)],im=new ut,Lo=new z,of=new z;function MM(n,e,t){let i=new ur,s=new Ke,r=new Ke,o=new Ht,a=new el,l=new tl,c={},h=t.maxTextureSize,f={[Ii]:gn,[gn]:Ii,[Rn]:Rn},d=new Un({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ke},radius:{value:4}},vertexShader:xM,fragmentShader:yM}),u=d.clone();u.defines.HORIZONTAL_PASS=1;let p=new Yt;p.setAttribute("position",new Qt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new fe(p,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=bo;let g=this.type;this.render=function(T,S,v){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===Qu&&(Ze("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=bo);let M=n.getRenderTarget(),R=n.getActiveCubeFace(),y=n.getActiveMipmapLevel(),C=n.state;C.setBlending(ui),C.buffers.depth.getReversed()===!0?C.buffers.color.setClear(0,0,0,0):C.buffers.color.setClear(1,1,1,1),C.buffers.depth.setTest(!0),C.setScissorTest(!1);let D=g!==this.type;D&&S.traverse(function(k){k.material&&(Array.isArray(k.material)?k.material.forEach(L=>L.needsUpdate=!0):k.material.needsUpdate=!0)});for(let k=0,L=T.length;k<L;k++){let F=T[k],G=F.shadow;if(G===void 0){Ze("WebGLShadowMap:",F,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);let ie=G.getFrameExtents();s.multiply(ie),r.copy(G.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/ie.x),s.x=r.x*ie.x,G.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/ie.y),s.y=r.y*ie.y,G.mapSize.y=r.y));let oe=n.state.buffers.depth.getReversed();if(G.camera._reversedDepth=oe,G.map===null||D===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===mr){if(F.isPointLight){Ze("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Nn(s.x,s.y,{format:ls,type:mi,minFilter:mn,magFilter:mn,generateMipmaps:!1}),G.map.texture.name=F.name+".shadowMap",G.map.depthTexture=new Ui(s.x,s.y,Wn),G.map.depthTexture.name=F.name+".shadowMapDepth",G.map.depthTexture.format=ai,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=dn,G.map.depthTexture.magFilter=dn}else F.isPointLight?(G.map=new ac(s.x),G.map.depthTexture=new Ja(s.x,jn)):(G.map=new Nn(s.x,s.y),G.map.depthTexture=new Ui(s.x,s.y,jn)),G.map.depthTexture.name=F.name+".shadowMap",G.map.depthTexture.format=ai,this.type===bo?(G.map.depthTexture.compareFunction=oe?ic:nc,G.map.depthTexture.minFilter=mn,G.map.depthTexture.magFilter=mn):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=dn,G.map.depthTexture.magFilter=dn);G.camera.updateProjectionMatrix()}let de=G.map.isWebGLCubeRenderTarget?6:1;for(let Re=0;Re<de;Re++){if(G.map.isWebGLCubeRenderTarget)n.setRenderTarget(G.map,Re),n.clear();else{Re===0&&(n.setRenderTarget(G.map),n.clear());let Ue=G.getViewport(Re);o.set(r.x*Ue.x,r.y*Ue.y,r.x*Ue.z,r.y*Ue.w),C.viewport(o)}if(F.isPointLight){let Ue=G.camera,X=G.matrix,U=F.distance||Ue.far;U!==Ue.far&&(Ue.far=U,Ue.updateProjectionMatrix()),Lo.setFromMatrixPosition(F.matrixWorld),Ue.position.copy(Lo),of.copy(Ue.position),of.add(_M[Re]),Ue.up.copy(vM[Re]),Ue.lookAt(of),Ue.updateMatrixWorld(),X.makeTranslation(-Lo.x,-Lo.y,-Lo.z),im.multiplyMatrices(Ue.projectionMatrix,Ue.matrixWorldInverse),G._frustum.setFromProjectionMatrix(im,Ue.coordinateSystem,Ue.reversedDepth)}else G.updateMatrices(F);i=G.getFrustum(),E(S,v,G.camera,F,this.type)}G.isPointLightShadow!==!0&&this.type===mr&&_(G,v),G.needsUpdate=!1}g=this.type,m.needsUpdate=!1,n.setRenderTarget(M,R,y)};function _(T,S){let v=e.update(x);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,u.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,u.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Nn(s.x,s.y,{format:ls,type:mi})),d.uniforms.shadow_pass.value=T.map.depthTexture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(S,null,v,d,x,null),u.uniforms.shadow_pass.value=T.mapPass.texture,u.uniforms.resolution.value=T.mapSize,u.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(S,null,v,u,x,null)}function w(T,S,v,M){let R=null,y=v.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(y!==void 0)R=y;else if(R=v.isPointLight===!0?l:a,n.localClippingEnabled&&S.clipShadows===!0&&Array.isArray(S.clippingPlanes)&&S.clippingPlanes.length!==0||S.displacementMap&&S.displacementScale!==0||S.alphaMap&&S.alphaTest>0||S.map&&S.alphaTest>0||S.alphaToCoverage===!0){let C=R.uuid,D=S.uuid,k=c[C];k===void 0&&(k={},c[C]=k);let L=k[D];L===void 0&&(L=R.clone(),k[D]=L,S.addEventListener("dispose",P)),R=L}if(R.visible=S.visible,R.wireframe=S.wireframe,M===mr?R.side=S.shadowSide!==null?S.shadowSide:S.side:R.side=S.shadowSide!==null?S.shadowSide:f[S.side],R.alphaMap=S.alphaMap,R.alphaTest=S.alphaToCoverage===!0?.5:S.alphaTest,R.map=S.map,R.clipShadows=S.clipShadows,R.clippingPlanes=S.clippingPlanes,R.clipIntersection=S.clipIntersection,R.displacementMap=S.displacementMap,R.displacementScale=S.displacementScale,R.displacementBias=S.displacementBias,R.wireframeLinewidth=S.wireframeLinewidth,R.linewidth=S.linewidth,v.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let C=n.properties.get(R);C.light=v}return R}function E(T,S,v,M,R){if(T.visible===!1)return;if(T.layers.test(S.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&R===mr)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,T.matrixWorld);let D=e.update(T),k=T.material;if(Array.isArray(k)){let L=D.groups;for(let F=0,G=L.length;F<G;F++){let ie=L[F],oe=k[ie.materialIndex];if(oe&&oe.visible){let de=w(T,oe,M,R);T.onBeforeShadow(n,T,S,v,D,de,ie),n.renderBufferDirect(v,null,D,de,T,ie),T.onAfterShadow(n,T,S,v,D,de,ie)}}}else if(k.visible){let L=w(T,k,M,R);T.onBeforeShadow(n,T,S,v,D,L,null),n.renderBufferDirect(v,null,D,L,T,null),T.onAfterShadow(n,T,S,v,D,L,null)}}let C=T.children;for(let D=0,k=C.length;D<k;D++)E(C[D],S,v,M,R)}function P(T){T.target.removeEventListener("dispose",P);for(let v in c){let M=c[v],R=T.target.uuid;R in M&&(M[R].dispose(),delete M[R])}}}function bM(n,e){function t(){let O=!1,me=new Ht,ee=null,Se=new Ht(0,0,0,0);return{setMask:function(xe){ee!==xe&&!O&&(n.colorMask(xe,xe,xe,xe),ee=xe)},setLocked:function(xe){O=xe},setClear:function(xe,ae,Be,et,Kt){Kt===!0&&(xe*=et,ae*=et,Be*=et),me.set(xe,ae,Be,et),Se.equals(me)===!1&&(n.clearColor(xe,ae,Be,et),Se.copy(me))},reset:function(){O=!1,ee=null,Se.set(-1,0,0,0)}}}function i(){let O=!1,me=!1,ee=null,Se=null,xe=null;return{setReversed:function(ae){if(me!==ae){let Be=e.get("EXT_clip_control");ae?Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.ZERO_TO_ONE_EXT):Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.NEGATIVE_ONE_TO_ONE_EXT),me=ae;let et=xe;xe=null,this.setClear(et)}},getReversed:function(){return me},setTest:function(ae){ae?J(n.DEPTH_TEST):he(n.DEPTH_TEST)},setMask:function(ae){ee!==ae&&!O&&(n.depthMask(ae),ee=ae)},setFunc:function(ae){if(me&&(ae=Pp[ae]),Se!==ae){switch(ae){case Ua:n.depthFunc(n.NEVER);break;case ka:n.depthFunc(n.ALWAYS);break;case Fa:n.depthFunc(n.LESS);break;case Ts:n.depthFunc(n.LEQUAL);break;case Oa:n.depthFunc(n.EQUAL);break;case Ba:n.depthFunc(n.GEQUAL);break;case za:n.depthFunc(n.GREATER);break;case Ha:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Se=ae}},setLocked:function(ae){O=ae},setClear:function(ae){xe!==ae&&(xe=ae,me&&(ae=1-ae),n.clearDepth(ae))},reset:function(){O=!1,ee=null,Se=null,xe=null,me=!1}}}function s(){let O=!1,me=null,ee=null,Se=null,xe=null,ae=null,Be=null,et=null,Kt=null;return{setTest:function(Tt){O||(Tt?J(n.STENCIL_TEST):he(n.STENCIL_TEST))},setMask:function(Tt){me!==Tt&&!O&&(n.stencilMask(Tt),me=Tt)},setFunc:function(Tt,yi,ei){(ee!==Tt||Se!==yi||xe!==ei)&&(n.stencilFunc(Tt,yi,ei),ee=Tt,Se=yi,xe=ei)},setOp:function(Tt,yi,ei){(ae!==Tt||Be!==yi||et!==ei)&&(n.stencilOp(Tt,yi,ei),ae=Tt,Be=yi,et=ei)},setLocked:function(Tt){O=Tt},setClear:function(Tt){Kt!==Tt&&(n.clearStencil(Tt),Kt=Tt)},reset:function(){O=!1,me=null,ee=null,Se=null,xe=null,ae=null,Be=null,et=null,Kt=null}}}let r=new t,o=new i,a=new s,l=new WeakMap,c=new WeakMap,h={},f={},d={},u=new WeakMap,p=[],x=null,m=!1,g=null,_=null,w=null,E=null,P=null,T=null,S=null,v=new $e(0,0,0),M=0,R=!1,y=null,C=null,D=null,k=null,L=null,F=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),G=!1,ie=0,oe=n.getParameter(n.VERSION);oe.indexOf("WebGL")!==-1?(ie=parseFloat(/^WebGL (\d)/.exec(oe)[1]),G=ie>=1):oe.indexOf("OpenGL ES")!==-1&&(ie=parseFloat(/^OpenGL ES (\d)/.exec(oe)[1]),G=ie>=2);let de=null,Re={},Ue=n.getParameter(n.SCISSOR_BOX),X=n.getParameter(n.VIEWPORT),U=new Ht().fromArray(Ue),B=new Ht().fromArray(X);function N(O,me,ee,Se){let xe=new Uint8Array(4),ae=n.createTexture();n.bindTexture(O,ae),n.texParameteri(O,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(O,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Be=0;Be<ee;Be++)O===n.TEXTURE_3D||O===n.TEXTURE_2D_ARRAY?n.texImage3D(me,0,n.RGBA,1,1,Se,0,n.RGBA,n.UNSIGNED_BYTE,xe):n.texImage2D(me+Be,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,xe);return ae}let q={};q[n.TEXTURE_2D]=N(n.TEXTURE_2D,n.TEXTURE_2D,1),q[n.TEXTURE_CUBE_MAP]=N(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[n.TEXTURE_2D_ARRAY]=N(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),q[n.TEXTURE_3D]=N(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),J(n.DEPTH_TEST),o.setFunc(Ts),yt(!1),_t(Lh),J(n.CULL_FACE),We(ui);function J(O){h[O]!==!0&&(n.enable(O),h[O]=!0)}function he(O){h[O]!==!1&&(n.disable(O),h[O]=!1)}function Te(O,me){return d[O]!==me?(n.bindFramebuffer(O,me),d[O]=me,O===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=me),O===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=me),!0):!1}function be(O,me){let ee=p,Se=!1;if(O){ee=u.get(me),ee===void 0&&(ee=[],u.set(me,ee));let xe=O.textures;if(ee.length!==xe.length||ee[0]!==n.COLOR_ATTACHMENT0){for(let ae=0,Be=xe.length;ae<Be;ae++)ee[ae]=n.COLOR_ATTACHMENT0+ae;ee.length=xe.length,Se=!0}}else ee[0]!==n.BACK&&(ee[0]=n.BACK,Se=!0);Se&&n.drawBuffers(ee)}function Oe(O){return x!==O?(n.useProgram(O),x=O,!0):!1}let Ie={[Qi]:n.FUNC_ADD,[ep]:n.FUNC_SUBTRACT,[tp]:n.FUNC_REVERSE_SUBTRACT};Ie[np]=n.MIN,Ie[ip]=n.MAX;let ke={[sp]:n.ZERO,[rp]:n.ONE,[op]:n.SRC_COLOR,[Da]:n.SRC_ALPHA,[dp]:n.SRC_ALPHA_SATURATE,[hp]:n.DST_COLOR,[lp]:n.DST_ALPHA,[ap]:n.ONE_MINUS_SRC_COLOR,[Na]:n.ONE_MINUS_SRC_ALPHA,[fp]:n.ONE_MINUS_DST_COLOR,[cp]:n.ONE_MINUS_DST_ALPHA,[up]:n.CONSTANT_COLOR,[pp]:n.ONE_MINUS_CONSTANT_COLOR,[mp]:n.CONSTANT_ALPHA,[gp]:n.ONE_MINUS_CONSTANT_ALPHA};function We(O,me,ee,Se,xe,ae,Be,et,Kt,Tt){if(O===ui){m===!0&&(he(n.BLEND),m=!1);return}if(m===!1&&(J(n.BLEND),m=!0),O!==ju){if(O!==g||Tt!==R){if((_!==Qi||P!==Qi)&&(n.blendEquation(n.FUNC_ADD),_=Qi,P=Qi),Tt)switch(O){case Ji:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Gn:n.blendFunc(n.ONE,n.ONE);break;case Dh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nh:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Ye("WebGLState: Invalid blending: ",O);break}else switch(O){case Ji:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Gn:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Dh:Ye("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Nh:Ye("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ye("WebGLState: Invalid blending: ",O);break}w=null,E=null,T=null,S=null,v.set(0,0,0),M=0,g=O,R=Tt}return}xe=xe||me,ae=ae||ee,Be=Be||Se,(me!==_||xe!==P)&&(n.blendEquationSeparate(Ie[me],Ie[xe]),_=me,P=xe),(ee!==w||Se!==E||ae!==T||Be!==S)&&(n.blendFuncSeparate(ke[ee],ke[Se],ke[ae],ke[Be]),w=ee,E=Se,T=ae,S=Be),(et.equals(v)===!1||Kt!==M)&&(n.blendColor(et.r,et.g,et.b,Kt),v.copy(et),M=Kt),g=O,R=!1}function Pe(O,me){O.side===Rn?he(n.CULL_FACE):J(n.CULL_FACE);let ee=O.side===gn;me&&(ee=!ee),yt(ee),O.blending===Ji&&O.transparent===!1?We(ui):We(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),o.setFunc(O.depthFunc),o.setTest(O.depthTest),o.setMask(O.depthWrite),r.setMask(O.colorWrite);let Se=O.stencilWrite;a.setTest(Se),Se&&(a.setMask(O.stencilWriteMask),a.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),a.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),V(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?J(n.SAMPLE_ALPHA_TO_COVERAGE):he(n.SAMPLE_ALPHA_TO_COVERAGE)}function yt(O){y!==O&&(O?n.frontFace(n.CW):n.frontFace(n.CCW),y=O)}function _t(O){O!==$u?(J(n.CULL_FACE),O!==C&&(O===Lh?n.cullFace(n.BACK):O===Ju?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):he(n.CULL_FACE),C=O}function un(O){O!==D&&(G&&n.lineWidth(O),D=O)}function V(O,me,ee){O?(J(n.POLYGON_OFFSET_FILL),(k!==me||L!==ee)&&(k=me,L=ee,o.getReversed()&&(me=-me),n.polygonOffset(me,ee))):he(n.POLYGON_OFFSET_FILL)}function nn(O){O?J(n.SCISSOR_TEST):he(n.SCISSOR_TEST)}function ct(O){O===void 0&&(O=n.TEXTURE0+F-1),de!==O&&(n.activeTexture(O),de=O)}function Lt(O,me,ee){ee===void 0&&(de===null?ee=n.TEXTURE0+F-1:ee=de);let Se=Re[ee];Se===void 0&&(Se={type:void 0,texture:void 0},Re[ee]=Se),(Se.type!==O||Se.texture!==me)&&(de!==ee&&(n.activeTexture(ee),de=ee),n.bindTexture(O,me||q[O]),Se.type=O,Se.texture=me)}function ve(){let O=Re[de];O!==void 0&&O.type!==void 0&&(n.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function Gt(){try{n.compressedTexImage2D(...arguments)}catch(O){Ye("WebGLState:",O)}}function I(){try{n.compressedTexImage3D(...arguments)}catch(O){Ye("WebGLState:",O)}}function b(){try{n.texSubImage2D(...arguments)}catch(O){Ye("WebGLState:",O)}}function Y(){try{n.texSubImage3D(...arguments)}catch(O){Ye("WebGLState:",O)}}function te(){try{n.compressedTexSubImage2D(...arguments)}catch(O){Ye("WebGLState:",O)}}function ce(){try{n.compressedTexSubImage3D(...arguments)}catch(O){Ye("WebGLState:",O)}}function ue(){try{n.texStorage2D(...arguments)}catch(O){Ye("WebGLState:",O)}}function _e(){try{n.texStorage3D(...arguments)}catch(O){Ye("WebGLState:",O)}}function j(){try{n.texImage2D(...arguments)}catch(O){Ye("WebGLState:",O)}}function ne(){try{n.texImage3D(...arguments)}catch(O){Ye("WebGLState:",O)}}function Ae(O){return f[O]!==void 0?f[O]:n.getParameter(O)}function De(O,me){f[O]!==me&&(n.pixelStorei(O,me),f[O]=me)}function ge(O){U.equals(O)===!1&&(n.scissor(O.x,O.y,O.z,O.w),U.copy(O))}function pe(O){B.equals(O)===!1&&(n.viewport(O.x,O.y,O.z,O.w),B.copy(O))}function Je(O,me){let ee=c.get(me);ee===void 0&&(ee=new WeakMap,c.set(me,ee));let Se=ee.get(O);Se===void 0&&(Se=n.getUniformBlockIndex(me,O.name),ee.set(O,Se))}function it(O,me){let Se=c.get(me).get(O);l.get(me)!==Se&&(n.uniformBlockBinding(me,Se,O.__bindingPointIndex),l.set(me,Se))}function mt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),h={},f={},de=null,Re={},d={},u=new WeakMap,p=[],x=null,m=!1,g=null,_=null,w=null,E=null,P=null,T=null,S=null,v=new $e(0,0,0),M=0,R=!1,y=null,C=null,D=null,k=null,L=null,U.set(0,0,n.canvas.width,n.canvas.height),B.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:J,disable:he,bindFramebuffer:Te,drawBuffers:be,useProgram:Oe,setBlending:We,setMaterial:Pe,setFlipSided:yt,setCullFace:_t,setLineWidth:un,setPolygonOffset:V,setScissorTest:nn,activeTexture:ct,bindTexture:Lt,unbindTexture:ve,compressedTexImage2D:Gt,compressedTexImage3D:I,texImage2D:j,texImage3D:ne,pixelStorei:De,getParameter:Ae,updateUBOMapping:Je,uniformBlockBinding:it,texStorage2D:ue,texStorage3D:_e,texSubImage2D:b,texSubImage3D:Y,compressedTexSubImage2D:te,compressedTexSubImage3D:ce,scissor:ge,viewport:pe,reset:mt}}function wM(n,e,t,i,s,r,o){let a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ke,h=new WeakMap,f=new Set,d,u=new WeakMap,p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(I,b){return p?new OffscreenCanvas(I,b):eo("canvas")}function m(I,b,Y){let te=1,ce=Gt(I);if((ce.width>Y||ce.height>Y)&&(te=Y/Math.max(ce.width,ce.height)),te<1)if(typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&I instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&I instanceof ImageBitmap||typeof VideoFrame<"u"&&I instanceof VideoFrame){let ue=Math.floor(te*ce.width),_e=Math.floor(te*ce.height);d===void 0&&(d=x(ue,_e));let j=b?x(ue,_e):d;return j.width=ue,j.height=_e,j.getContext("2d").drawImage(I,0,0,ue,_e),Ze("WebGLRenderer: Texture has been resized from ("+ce.width+"x"+ce.height+") to ("+ue+"x"+_e+")."),j}else return"data"in I&&Ze("WebGLRenderer: Image in DataTexture is too big ("+ce.width+"x"+ce.height+")."),I;return I}function g(I){return I.generateMipmaps}function _(I){n.generateMipmap(I)}function w(I){return I.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:I.isWebGL3DRenderTarget?n.TEXTURE_3D:I.isWebGLArrayRenderTarget||I.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function E(I,b,Y,te,ce,ue=!1){if(I!==null){if(n[I]!==void 0)return n[I];Ze("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+I+"'")}let _e;te&&(_e=e.get("EXT_texture_norm16"),_e||Ze("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=b;if(b===n.RED&&(Y===n.FLOAT&&(j=n.R32F),Y===n.HALF_FLOAT&&(j=n.R16F),Y===n.UNSIGNED_BYTE&&(j=n.R8),Y===n.UNSIGNED_SHORT&&_e&&(j=_e.R16_EXT),Y===n.SHORT&&_e&&(j=_e.R16_SNORM_EXT)),b===n.RED_INTEGER&&(Y===n.UNSIGNED_BYTE&&(j=n.R8UI),Y===n.UNSIGNED_SHORT&&(j=n.R16UI),Y===n.UNSIGNED_INT&&(j=n.R32UI),Y===n.BYTE&&(j=n.R8I),Y===n.SHORT&&(j=n.R16I),Y===n.INT&&(j=n.R32I)),b===n.RG&&(Y===n.FLOAT&&(j=n.RG32F),Y===n.HALF_FLOAT&&(j=n.RG16F),Y===n.UNSIGNED_BYTE&&(j=n.RG8),Y===n.UNSIGNED_SHORT&&_e&&(j=_e.RG16_EXT),Y===n.SHORT&&_e&&(j=_e.RG16_SNORM_EXT)),b===n.RG_INTEGER&&(Y===n.UNSIGNED_BYTE&&(j=n.RG8UI),Y===n.UNSIGNED_SHORT&&(j=n.RG16UI),Y===n.UNSIGNED_INT&&(j=n.RG32UI),Y===n.BYTE&&(j=n.RG8I),Y===n.SHORT&&(j=n.RG16I),Y===n.INT&&(j=n.RG32I)),b===n.RGB_INTEGER&&(Y===n.UNSIGNED_BYTE&&(j=n.RGB8UI),Y===n.UNSIGNED_SHORT&&(j=n.RGB16UI),Y===n.UNSIGNED_INT&&(j=n.RGB32UI),Y===n.BYTE&&(j=n.RGB8I),Y===n.SHORT&&(j=n.RGB16I),Y===n.INT&&(j=n.RGB32I)),b===n.RGBA_INTEGER&&(Y===n.UNSIGNED_BYTE&&(j=n.RGBA8UI),Y===n.UNSIGNED_SHORT&&(j=n.RGBA16UI),Y===n.UNSIGNED_INT&&(j=n.RGBA32UI),Y===n.BYTE&&(j=n.RGBA8I),Y===n.SHORT&&(j=n.RGBA16I),Y===n.INT&&(j=n.RGBA32I)),b===n.RGB&&(Y===n.UNSIGNED_SHORT&&_e&&(j=_e.RGB16_EXT),Y===n.SHORT&&_e&&(j=_e.RGB16_SNORM_EXT),Y===n.UNSIGNED_INT_5_9_9_9_REV&&(j=n.RGB9_E5),Y===n.UNSIGNED_INT_10F_11F_11F_REV&&(j=n.R11F_G11F_B10F)),b===n.RGBA){let ne=ue?jr:ht.getTransfer(ce);Y===n.FLOAT&&(j=n.RGBA32F),Y===n.HALF_FLOAT&&(j=n.RGBA16F),Y===n.UNSIGNED_BYTE&&(j=ne===wt?n.SRGB8_ALPHA8:n.RGBA8),Y===n.UNSIGNED_SHORT&&_e&&(j=_e.RGBA16_EXT),Y===n.SHORT&&_e&&(j=_e.RGBA16_SNORM_EXT),Y===n.UNSIGNED_SHORT_4_4_4_4&&(j=n.RGBA4),Y===n.UNSIGNED_SHORT_5_5_5_1&&(j=n.RGB5_A1)}return(j===n.R16F||j===n.R32F||j===n.RG16F||j===n.RG32F||j===n.RGBA16F||j===n.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function P(I,b){let Y;return I?b===null||b===jn||b===xr?Y=n.DEPTH24_STENCIL8:b===Wn?Y=n.DEPTH32F_STENCIL8:b===gr&&(Y=n.DEPTH24_STENCIL8,Ze("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===jn||b===xr?Y=n.DEPTH_COMPONENT24:b===Wn?Y=n.DEPTH_COMPONENT32F:b===gr&&(Y=n.DEPTH_COMPONENT16),Y}function T(I,b){return g(I)===!0||I.isFramebufferTexture&&I.minFilter!==dn&&I.minFilter!==mn?Math.log2(Math.max(b.width,b.height))+1:I.mipmaps!==void 0&&I.mipmaps.length>0?I.mipmaps.length:I.isCompressedTexture&&Array.isArray(I.image)?b.mipmaps.length:1}function S(I){let b=I.target;b.removeEventListener("dispose",S),M(b),b.isVideoTexture&&h.delete(b),b.isHTMLTexture&&f.delete(b)}function v(I){let b=I.target;b.removeEventListener("dispose",v),y(b)}function M(I){let b=i.get(I);if(b.__webglInit===void 0)return;let Y=I.source,te=u.get(Y);if(te){let ce=te[b.__cacheKey];ce.usedTimes--,ce.usedTimes===0&&R(I),Object.keys(te).length===0&&u.delete(Y)}i.remove(I)}function R(I){let b=i.get(I);n.deleteTexture(b.__webglTexture);let Y=I.source,te=u.get(Y);delete te[b.__cacheKey],o.memory.textures--}function y(I){let b=i.get(I);if(I.depthTexture&&(I.depthTexture.dispose(),i.remove(I.depthTexture)),I.isWebGLCubeRenderTarget)for(let te=0;te<6;te++){if(Array.isArray(b.__webglFramebuffer[te]))for(let ce=0;ce<b.__webglFramebuffer[te].length;ce++)n.deleteFramebuffer(b.__webglFramebuffer[te][ce]);else n.deleteFramebuffer(b.__webglFramebuffer[te]);b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer[te])}else{if(Array.isArray(b.__webglFramebuffer))for(let te=0;te<b.__webglFramebuffer.length;te++)n.deleteFramebuffer(b.__webglFramebuffer[te]);else n.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&n.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let te=0;te<b.__webglColorRenderbuffer.length;te++)b.__webglColorRenderbuffer[te]&&n.deleteRenderbuffer(b.__webglColorRenderbuffer[te]);b.__webglDepthRenderbuffer&&n.deleteRenderbuffer(b.__webglDepthRenderbuffer)}let Y=I.textures;for(let te=0,ce=Y.length;te<ce;te++){let ue=i.get(Y[te]);ue.__webglTexture&&(n.deleteTexture(ue.__webglTexture),o.memory.textures--),i.remove(Y[te])}i.remove(I)}let C=0;function D(){C=0}function k(){return C}function L(I){C=I}function F(){let I=C;return I>=s.maxTextures&&Ze("WebGLTextures: Trying to use "+I+" texture units while this GPU supports only "+s.maxTextures),C+=1,I}function G(I){let b=[];return b.push(I.wrapS),b.push(I.wrapT),b.push(I.wrapR||0),b.push(I.magFilter),b.push(I.minFilter),b.push(I.anisotropy),b.push(I.internalFormat),b.push(I.format),b.push(I.type),b.push(I.generateMipmaps),b.push(I.premultiplyAlpha),b.push(I.flipY),b.push(I.unpackAlignment),b.push(I.colorSpace),b.join()}function ie(I,b){let Y=i.get(I);if(I.isVideoTexture&&Lt(I),I.isRenderTargetTexture===!1&&I.isExternalTexture!==!0&&I.version>0&&Y.__version!==I.version){let te=I.image;if(te===null)Ze("WebGLRenderer: Texture marked for update but no image data found.");else if(te.complete===!1)Ze("WebGLRenderer: Texture marked for update but image is incomplete");else{he(Y,I,b);return}}else I.isExternalTexture&&(Y.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,Y.__webglTexture,n.TEXTURE0+b)}function oe(I,b){let Y=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&Y.__version!==I.version){he(Y,I,b);return}else I.isExternalTexture&&(Y.__webglTexture=I.sourceTexture?I.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,Y.__webglTexture,n.TEXTURE0+b)}function de(I,b){let Y=i.get(I);if(I.isRenderTargetTexture===!1&&I.version>0&&Y.__version!==I.version){he(Y,I,b);return}t.bindTexture(n.TEXTURE_3D,Y.__webglTexture,n.TEXTURE0+b)}function Re(I,b){let Y=i.get(I);if(I.isCubeDepthTexture!==!0&&I.version>0&&Y.__version!==I.version){Te(Y,I,b);return}t.bindTexture(n.TEXTURE_CUBE_MAP,Y.__webglTexture,n.TEXTURE0+b)}let Ue={[Es]:n.REPEAT,[oi]:n.CLAMP_TO_EDGE,[Va]:n.MIRRORED_REPEAT},X={[dn]:n.NEAREST,[_p]:n.NEAREST_MIPMAP_NEAREST,[To]:n.NEAREST_MIPMAP_LINEAR,[mn]:n.LINEAR,[xl]:n.LINEAR_MIPMAP_NEAREST,[pi]:n.LINEAR_MIPMAP_LINEAR},U={[bp]:n.NEVER,[Rp]:n.ALWAYS,[wp]:n.LESS,[nc]:n.LEQUAL,[Tp]:n.EQUAL,[ic]:n.GEQUAL,[Ep]:n.GREATER,[Ap]:n.NOTEQUAL};function B(I,b){if(b.type===Wn&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===mn||b.magFilter===xl||b.magFilter===To||b.magFilter===pi||b.minFilter===mn||b.minFilter===xl||b.minFilter===To||b.minFilter===pi)&&Ze("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(I,n.TEXTURE_WRAP_S,Ue[b.wrapS]),n.texParameteri(I,n.TEXTURE_WRAP_T,Ue[b.wrapT]),(I===n.TEXTURE_3D||I===n.TEXTURE_2D_ARRAY)&&n.texParameteri(I,n.TEXTURE_WRAP_R,Ue[b.wrapR]),n.texParameteri(I,n.TEXTURE_MAG_FILTER,X[b.magFilter]),n.texParameteri(I,n.TEXTURE_MIN_FILTER,X[b.minFilter]),b.compareFunction&&(n.texParameteri(I,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(I,n.TEXTURE_COMPARE_FUNC,U[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===dn||b.minFilter!==To&&b.minFilter!==pi||b.type===Wn&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){let Y=e.get("EXT_texture_filter_anisotropic");n.texParameterf(I,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function N(I,b){let Y=!1;I.__webglInit===void 0&&(I.__webglInit=!0,b.addEventListener("dispose",S));let te=b.source,ce=u.get(te);ce===void 0&&(ce={},u.set(te,ce));let ue=G(b);if(ue!==I.__cacheKey){ce[ue]===void 0&&(ce[ue]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,Y=!0),ce[ue].usedTimes++;let _e=ce[I.__cacheKey];_e!==void 0&&(ce[I.__cacheKey].usedTimes--,_e.usedTimes===0&&R(b)),I.__cacheKey=ue,I.__webglTexture=ce[ue].texture}return Y}function q(I,b,Y){return Math.floor(Math.floor(I/Y)/b)}function J(I,b,Y,te){let ue=I.updateRanges;if(ue.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,b.width,b.height,Y,te,b.data);else{ue.sort((De,ge)=>De.start-ge.start);let _e=0;for(let De=1;De<ue.length;De++){let ge=ue[_e],pe=ue[De],Je=ge.start+ge.count,it=q(pe.start,b.width,4),mt=q(ge.start,b.width,4);pe.start<=Je+1&&it===mt&&q(pe.start+pe.count-1,b.width,4)===it?ge.count=Math.max(ge.count,pe.start+pe.count-ge.start):(++_e,ue[_e]=pe)}ue.length=_e+1;let j=t.getParameter(n.UNPACK_ROW_LENGTH),ne=t.getParameter(n.UNPACK_SKIP_PIXELS),Ae=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,b.width);for(let De=0,ge=ue.length;De<ge;De++){let pe=ue[De],Je=Math.floor(pe.start/4),it=Math.ceil(pe.count/4),mt=Je%b.width,O=Math.floor(Je/b.width),me=it,ee=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,mt),t.pixelStorei(n.UNPACK_SKIP_ROWS,O),t.texSubImage2D(n.TEXTURE_2D,0,mt,O,me,ee,Y,te,b.data)}I.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,j),t.pixelStorei(n.UNPACK_SKIP_PIXELS,ne),t.pixelStorei(n.UNPACK_SKIP_ROWS,Ae)}}function he(I,b,Y){let te=n.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(te=n.TEXTURE_2D_ARRAY),b.isData3DTexture&&(te=n.TEXTURE_3D);let ce=N(I,b),ue=b.source;t.bindTexture(te,I.__webglTexture,n.TEXTURE0+Y);let _e=i.get(ue);if(ue.version!==_e.__version||ce===!0){if(t.activeTexture(n.TEXTURE0+Y),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){let ee=ht.getPrimaries(ht.workingColorSpace),Se=b.colorSpace===Fi?null:ht.getPrimaries(b.colorSpace),xe=b.colorSpace===Fi||ee===Se?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe)}t.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment);let ne=m(b.image,!1,s.maxTextureSize);ne=ve(b,ne);let Ae=r.convert(b.format,b.colorSpace),De=r.convert(b.type),ge=E(b.internalFormat,Ae,De,b.normalized,b.colorSpace,b.isVideoTexture);B(te,b);let pe,Je=b.mipmaps,it=b.isVideoTexture!==!0,mt=_e.__version===void 0||ce===!0,O=ue.dataReady,me=T(b,ne);if(b.isDepthTexture)ge=P(b.format===as,b.type),mt&&(it?t.texStorage2D(n.TEXTURE_2D,1,ge,ne.width,ne.height):t.texImage2D(n.TEXTURE_2D,0,ge,ne.width,ne.height,0,Ae,De,null));else if(b.isDataTexture)if(Je.length>0){it&&mt&&t.texStorage2D(n.TEXTURE_2D,me,ge,Je[0].width,Je[0].height);for(let ee=0,Se=Je.length;ee<Se;ee++)pe=Je[ee],it?O&&t.texSubImage2D(n.TEXTURE_2D,ee,0,0,pe.width,pe.height,Ae,De,pe.data):t.texImage2D(n.TEXTURE_2D,ee,ge,pe.width,pe.height,0,Ae,De,pe.data);b.generateMipmaps=!1}else it?(mt&&t.texStorage2D(n.TEXTURE_2D,me,ge,ne.width,ne.height),O&&J(b,ne,Ae,De)):t.texImage2D(n.TEXTURE_2D,0,ge,ne.width,ne.height,0,Ae,De,ne.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){it&&mt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,me,ge,Je[0].width,Je[0].height,ne.depth);for(let ee=0,Se=Je.length;ee<Se;ee++)if(pe=Je[ee],b.format!==Xn)if(Ae!==null)if(it){if(O)if(b.layerUpdates.size>0){let xe=jh(pe.width,pe.height,b.format,b.type);for(let ae of b.layerUpdates){let Be=pe.data.subarray(ae*xe/pe.data.BYTES_PER_ELEMENT,(ae+1)*xe/pe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,ae,pe.width,pe.height,1,Ae,Be)}b.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,0,pe.width,pe.height,ne.depth,Ae,pe.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ee,ge,pe.width,pe.height,ne.depth,0,pe.data,0,0);else Ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else it?O&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,0,pe.width,pe.height,ne.depth,Ae,De,pe.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ee,ge,pe.width,pe.height,ne.depth,0,Ae,De,pe.data)}else{it&&mt&&t.texStorage2D(n.TEXTURE_2D,me,ge,Je[0].width,Je[0].height);for(let ee=0,Se=Je.length;ee<Se;ee++)pe=Je[ee],b.format!==Xn?Ae!==null?it?O&&t.compressedTexSubImage2D(n.TEXTURE_2D,ee,0,0,pe.width,pe.height,Ae,pe.data):t.compressedTexImage2D(n.TEXTURE_2D,ee,ge,pe.width,pe.height,0,pe.data):Ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):it?O&&t.texSubImage2D(n.TEXTURE_2D,ee,0,0,pe.width,pe.height,Ae,De,pe.data):t.texImage2D(n.TEXTURE_2D,ee,ge,pe.width,pe.height,0,Ae,De,pe.data)}else if(b.isDataArrayTexture)if(it){if(mt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,me,ge,ne.width,ne.height,ne.depth),O)if(b.layerUpdates.size>0){let ee=jh(ne.width,ne.height,b.format,b.type);for(let Se of b.layerUpdates){let xe=ne.data.subarray(Se*ee/ne.data.BYTES_PER_ELEMENT,(Se+1)*ee/ne.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,Se,ne.width,ne.height,1,Ae,De,xe)}b.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,Ae,De,ne.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,ge,ne.width,ne.height,ne.depth,0,Ae,De,ne.data);else if(b.isData3DTexture)it?(mt&&t.texStorage3D(n.TEXTURE_3D,me,ge,ne.width,ne.height,ne.depth),O&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,Ae,De,ne.data)):t.texImage3D(n.TEXTURE_3D,0,ge,ne.width,ne.height,ne.depth,0,Ae,De,ne.data);else if(b.isFramebufferTexture){if(mt)if(it)t.texStorage2D(n.TEXTURE_2D,me,ge,ne.width,ne.height);else{let ee=ne.width,Se=ne.height;for(let xe=0;xe<me;xe++)t.texImage2D(n.TEXTURE_2D,xe,ge,ee,Se,0,Ae,De,null),ee>>=1,Se>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in n){let ee=n.canvas;if(ee.hasAttribute("layoutsubtree")||ee.setAttribute("layoutsubtree","true"),ne.parentNode!==ee){ee.appendChild(ne),f.add(b),ee.onpaint=et=>{let Kt=et.changedElements;for(let Tt of f)Kt.includes(Tt.image)&&(Tt.needsUpdate=!0)},ee.requestPaint();return}let Se=0,xe=n.RGBA,ae=n.RGBA,Be=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,Se,xe,ae,Be,ne),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Je.length>0){if(it&&mt){let ee=Gt(Je[0]);t.texStorage2D(n.TEXTURE_2D,me,ge,ee.width,ee.height)}for(let ee=0,Se=Je.length;ee<Se;ee++)pe=Je[ee],it?O&&t.texSubImage2D(n.TEXTURE_2D,ee,0,0,Ae,De,pe):t.texImage2D(n.TEXTURE_2D,ee,ge,Ae,De,pe);b.generateMipmaps=!1}else if(it){if(mt){let ee=Gt(ne);t.texStorage2D(n.TEXTURE_2D,me,ge,ee.width,ee.height)}O&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ae,De,ne)}else t.texImage2D(n.TEXTURE_2D,0,ge,Ae,De,ne);g(b)&&_(te),_e.__version=ue.version,b.onUpdate&&b.onUpdate(b)}I.__version=b.version}function Te(I,b,Y){if(b.image.length!==6)return;let te=N(I,b),ce=b.source;t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+Y);let ue=i.get(ce);if(ce.version!==ue.__version||te===!0){t.activeTexture(n.TEXTURE0+Y);let _e=ht.getPrimaries(ht.workingColorSpace),j=b.colorSpace===Fi?null:ht.getPrimaries(b.colorSpace),ne=b.colorSpace===Fi||_e===j?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ne);let Ae=b.isCompressedTexture||b.image[0].isCompressedTexture,De=b.image[0]&&b.image[0].isDataTexture,ge=[];for(let ae=0;ae<6;ae++)!Ae&&!De?ge[ae]=m(b.image[ae],!0,s.maxCubemapSize):ge[ae]=De?b.image[ae].image:b.image[ae],ge[ae]=ve(b,ge[ae]);let pe=ge[0],Je=r.convert(b.format,b.colorSpace),it=r.convert(b.type),mt=E(b.internalFormat,Je,it,b.normalized,b.colorSpace),O=b.isVideoTexture!==!0,me=ue.__version===void 0||te===!0,ee=ce.dataReady,Se=T(b,pe);B(n.TEXTURE_CUBE_MAP,b);let xe;if(Ae){O&&me&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Se,mt,pe.width,pe.height);for(let ae=0;ae<6;ae++){xe=ge[ae].mipmaps;for(let Be=0;Be<xe.length;Be++){let et=xe[Be];b.format!==Xn?Je!==null?O?ee&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be,0,0,et.width,et.height,Je,et.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be,mt,et.width,et.height,0,et.data):Ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be,0,0,et.width,et.height,Je,it,et.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be,mt,et.width,et.height,0,Je,it,et.data)}}}else{if(xe=b.mipmaps,O&&me){xe.length>0&&Se++;let ae=Gt(ge[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Se,mt,ae.width,ae.height)}for(let ae=0;ae<6;ae++)if(De){O?ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,ge[ae].width,ge[ae].height,Je,it,ge[ae].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,mt,ge[ae].width,ge[ae].height,0,Je,it,ge[ae].data);for(let Be=0;Be<xe.length;Be++){let Kt=xe[Be].image[ae].image;O?ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be+1,0,0,Kt.width,Kt.height,Je,it,Kt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be+1,mt,Kt.width,Kt.height,0,Je,it,Kt.data)}}else{O?ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,Je,it,ge[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,mt,Je,it,ge[ae]);for(let Be=0;Be<xe.length;Be++){let et=xe[Be];O?ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be+1,0,0,Je,it,et.image[ae]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Be+1,mt,Je,it,et.image[ae])}}}g(b)&&_(n.TEXTURE_CUBE_MAP),ue.__version=ce.version,b.onUpdate&&b.onUpdate(b)}I.__version=b.version}function be(I,b,Y,te,ce,ue){let _e=r.convert(Y.format,Y.colorSpace),j=r.convert(Y.type),ne=E(Y.internalFormat,_e,j,Y.normalized,Y.colorSpace),Ae=i.get(b),De=i.get(Y);if(De.__renderTarget=b,!Ae.__hasExternalTextures){let ge=Math.max(1,b.width>>ue),pe=Math.max(1,b.height>>ue);ce===n.TEXTURE_3D||ce===n.TEXTURE_2D_ARRAY?t.texImage3D(ce,ue,ne,ge,pe,b.depth,0,_e,j,null):t.texImage2D(ce,ue,ne,ge,pe,0,_e,j,null)}t.bindFramebuffer(n.FRAMEBUFFER,I),ct(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,te,ce,De.__webglTexture,0,nn(b)):(ce===n.TEXTURE_2D||ce>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ce<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,te,ce,De.__webglTexture,ue),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Oe(I,b,Y){if(n.bindRenderbuffer(n.RENDERBUFFER,I),b.depthBuffer){let te=b.depthTexture,ce=te&&te.isDepthTexture?te.type:null,ue=P(b.stencilBuffer,ce),_e=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;ct(b)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,nn(b),ue,b.width,b.height):Y?n.renderbufferStorageMultisample(n.RENDERBUFFER,nn(b),ue,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,ue,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,_e,n.RENDERBUFFER,I)}else{let te=b.textures;for(let ce=0;ce<te.length;ce++){let ue=te[ce],_e=r.convert(ue.format,ue.colorSpace),j=r.convert(ue.type),ne=E(ue.internalFormat,_e,j,ue.normalized,ue.colorSpace);ct(b)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,nn(b),ne,b.width,b.height):Y?n.renderbufferStorageMultisample(n.RENDERBUFFER,nn(b),ne,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,ne,b.width,b.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ie(I,b,Y){let te=b.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,I),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");let ce=i.get(b.depthTexture);if(ce.__renderTarget=b,(!ce.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),te){if(ce.__webglInit===void 0&&(ce.__webglInit=!0,b.depthTexture.addEventListener("dispose",S)),ce.__webglTexture===void 0){ce.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,ce.__webglTexture),B(n.TEXTURE_CUBE_MAP,b.depthTexture);let Ae=r.convert(b.depthTexture.format),De=r.convert(b.depthTexture.type),ge;b.depthTexture.format===ai?ge=n.DEPTH_COMPONENT24:b.depthTexture.format===as&&(ge=n.DEPTH24_STENCIL8);for(let pe=0;pe<6;pe++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,ge,b.width,b.height,0,Ae,De,null)}}else ie(b.depthTexture,0);let ue=ce.__webglTexture,_e=nn(b),j=te?n.TEXTURE_CUBE_MAP_POSITIVE_X+Y:n.TEXTURE_2D,ne=b.depthTexture.format===as?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(b.depthTexture.format===ai)ct(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ne,j,ue,0,_e):n.framebufferTexture2D(n.FRAMEBUFFER,ne,j,ue,0);else if(b.depthTexture.format===as)ct(b)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ne,j,ue,0,_e):n.framebufferTexture2D(n.FRAMEBUFFER,ne,j,ue,0);else throw new Error("Unknown depthTexture format")}function ke(I){let b=i.get(I),Y=I.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==I.depthTexture){let te=I.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),te){let ce=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,te.removeEventListener("dispose",ce)};te.addEventListener("dispose",ce),b.__depthDisposeCallback=ce}b.__boundDepthTexture=te}if(I.depthTexture&&!b.__autoAllocateDepthBuffer)if(Y)for(let te=0;te<6;te++)Ie(b.__webglFramebuffer[te],I,te);else{let te=I.texture.mipmaps;te&&te.length>0?Ie(b.__webglFramebuffer[0],I,0):Ie(b.__webglFramebuffer,I,0)}else if(Y){b.__webglDepthbuffer=[];for(let te=0;te<6;te++)if(t.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[te]),b.__webglDepthbuffer[te]===void 0)b.__webglDepthbuffer[te]=n.createRenderbuffer(),Oe(b.__webglDepthbuffer[te],I,!1);else{let ce=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=b.__webglDepthbuffer[te];n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,ce,n.RENDERBUFFER,ue)}}else{let te=I.texture.mipmaps;if(te&&te.length>0?t.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=n.createRenderbuffer(),Oe(b.__webglDepthbuffer,I,!1);else{let ce=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=b.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,ce,n.RENDERBUFFER,ue)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function We(I,b,Y){let te=i.get(I);b!==void 0&&be(te.__webglFramebuffer,I,I.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),Y!==void 0&&ke(I)}function Pe(I){let b=I.texture,Y=i.get(I),te=i.get(b);I.addEventListener("dispose",v);let ce=I.textures,ue=I.isWebGLCubeRenderTarget===!0,_e=ce.length>1;if(_e||(te.__webglTexture===void 0&&(te.__webglTexture=n.createTexture()),te.__version=b.version,o.memory.textures++),ue){Y.__webglFramebuffer=[];for(let j=0;j<6;j++)if(b.mipmaps&&b.mipmaps.length>0){Y.__webglFramebuffer[j]=[];for(let ne=0;ne<b.mipmaps.length;ne++)Y.__webglFramebuffer[j][ne]=n.createFramebuffer()}else Y.__webglFramebuffer[j]=n.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){Y.__webglFramebuffer=[];for(let j=0;j<b.mipmaps.length;j++)Y.__webglFramebuffer[j]=n.createFramebuffer()}else Y.__webglFramebuffer=n.createFramebuffer();if(_e)for(let j=0,ne=ce.length;j<ne;j++){let Ae=i.get(ce[j]);Ae.__webglTexture===void 0&&(Ae.__webglTexture=n.createTexture(),o.memory.textures++)}if(I.samples>0&&ct(I)===!1){Y.__webglMultisampledFramebuffer=n.createFramebuffer(),Y.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let j=0;j<ce.length;j++){let ne=ce[j];Y.__webglColorRenderbuffer[j]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,Y.__webglColorRenderbuffer[j]);let Ae=r.convert(ne.format,ne.colorSpace),De=r.convert(ne.type),ge=E(ne.internalFormat,Ae,De,ne.normalized,ne.colorSpace,I.isXRRenderTarget===!0),pe=nn(I);n.renderbufferStorageMultisample(n.RENDERBUFFER,pe,ge,I.width,I.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+j,n.RENDERBUFFER,Y.__webglColorRenderbuffer[j])}n.bindRenderbuffer(n.RENDERBUFFER,null),I.depthBuffer&&(Y.__webglDepthRenderbuffer=n.createRenderbuffer(),Oe(Y.__webglDepthRenderbuffer,I,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ue){t.bindTexture(n.TEXTURE_CUBE_MAP,te.__webglTexture),B(n.TEXTURE_CUBE_MAP,b);for(let j=0;j<6;j++)if(b.mipmaps&&b.mipmaps.length>0)for(let ne=0;ne<b.mipmaps.length;ne++)be(Y.__webglFramebuffer[j][ne],I,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+j,ne);else be(Y.__webglFramebuffer[j],I,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);g(b)&&_(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let j=0,ne=ce.length;j<ne;j++){let Ae=ce[j],De=i.get(Ae),ge=n.TEXTURE_2D;(I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(ge=I.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ge,De.__webglTexture),B(ge,Ae),be(Y.__webglFramebuffer,I,Ae,n.COLOR_ATTACHMENT0+j,ge,0),g(Ae)&&_(ge)}t.unbindTexture()}else{let j=n.TEXTURE_2D;if((I.isWebGL3DRenderTarget||I.isWebGLArrayRenderTarget)&&(j=I.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(j,te.__webglTexture),B(j,b),b.mipmaps&&b.mipmaps.length>0)for(let ne=0;ne<b.mipmaps.length;ne++)be(Y.__webglFramebuffer[ne],I,b,n.COLOR_ATTACHMENT0,j,ne);else be(Y.__webglFramebuffer,I,b,n.COLOR_ATTACHMENT0,j,0);g(b)&&_(j),t.unbindTexture()}I.depthBuffer&&ke(I)}function yt(I){let b=I.textures;for(let Y=0,te=b.length;Y<te;Y++){let ce=b[Y];if(g(ce)){let ue=w(I),_e=i.get(ce).__webglTexture;t.bindTexture(ue,_e),_(ue),t.unbindTexture()}}}let _t=[],un=[];function V(I){if(I.samples>0){if(ct(I)===!1){let b=I.textures,Y=I.width,te=I.height,ce=n.COLOR_BUFFER_BIT,ue=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,_e=i.get(I),j=b.length>1;if(j)for(let Ae=0;Ae<b.length;Ae++)t.bindFramebuffer(n.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ae,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,_e.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ae,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer);let ne=I.texture.mipmaps;ne&&ne.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,_e.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let Ae=0;Ae<b.length;Ae++){if(I.resolveDepthBuffer&&(I.depthBuffer&&(ce|=n.DEPTH_BUFFER_BIT),I.stencilBuffer&&I.resolveStencilBuffer&&(ce|=n.STENCIL_BUFFER_BIT)),j){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,_e.__webglColorRenderbuffer[Ae]);let De=i.get(b[Ae]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,De,0)}n.blitFramebuffer(0,0,Y,te,0,0,Y,te,ce,n.NEAREST),l===!0&&(_t.length=0,un.length=0,_t.push(n.COLOR_ATTACHMENT0+Ae),I.depthBuffer&&I.resolveDepthBuffer===!1&&(_t.push(ue),un.push(ue),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,un)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,_t))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),j)for(let Ae=0;Ae<b.length;Ae++){t.bindFramebuffer(n.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ae,n.RENDERBUFFER,_e.__webglColorRenderbuffer[Ae]);let De=i.get(b[Ae]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,_e.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ae,n.TEXTURE_2D,De,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(I.depthBuffer&&I.resolveDepthBuffer===!1&&l){let b=I.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[b])}}}function nn(I){return Math.min(s.maxSamples,I.samples)}function ct(I){let b=i.get(I);return I.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Lt(I){let b=o.render.frame;h.get(I)!==b&&(h.set(I,b),I.update())}function ve(I,b){let Y=I.colorSpace,te=I.format,ce=I.type;return I.isCompressedTexture===!0||I.isVideoTexture===!0||Y!==Qr&&Y!==Fi&&(ht.getTransfer(Y)===wt?(te!==Xn||ce!==Cn)&&Ze("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ye("WebGLTextures: Unsupported texture color space:",Y)),b}function Gt(I){return typeof HTMLImageElement<"u"&&I instanceof HTMLImageElement?(c.width=I.naturalWidth||I.width,c.height=I.naturalHeight||I.height):typeof VideoFrame<"u"&&I instanceof VideoFrame?(c.width=I.displayWidth,c.height=I.displayHeight):(c.width=I.width,c.height=I.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=D,this.getTextureUnits=k,this.setTextureUnits=L,this.setTexture2D=ie,this.setTexture2DArray=oe,this.setTexture3D=de,this.setTextureCube=Re,this.rebindTextures=We,this.setupRenderTarget=Pe,this.updateRenderTargetMipmap=yt,this.updateMultisampleRenderTarget=V,this.setupDepthRenderbuffer=ke,this.setupFrameBufferTexture=be,this.useMultisampledRTT=ct,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function TM(n,e){function t(i,s=Fi){let r,o=ht.getTransfer(s);if(i===Cn)return n.UNSIGNED_BYTE;if(i===_l)return n.UNSIGNED_SHORT_4_4_4_4;if(i===vl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Xh)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===qh)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Gh)return n.BYTE;if(i===Wh)return n.SHORT;if(i===gr)return n.UNSIGNED_SHORT;if(i===yl)return n.INT;if(i===jn)return n.UNSIGNED_INT;if(i===Wn)return n.FLOAT;if(i===mi)return n.HALF_FLOAT;if(i===Yh)return n.ALPHA;if(i===Zh)return n.RGB;if(i===Xn)return n.RGBA;if(i===ai)return n.DEPTH_COMPONENT;if(i===as)return n.DEPTH_STENCIL;if(i===Ml)return n.RED;if(i===bl)return n.RED_INTEGER;if(i===ls)return n.RG;if(i===wl)return n.RG_INTEGER;if(i===Tl)return n.RGBA_INTEGER;if(i===Eo||i===Ao||i===Ro||i===Co)if(o===wt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Eo)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Ao)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ro)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Co)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Eo)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Ao)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ro)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Co)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===El||i===Al||i===Rl||i===Cl)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===El)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Al)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Rl)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Cl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Sl||i===Il||i===Pl||i===Ll||i===Dl||i===So||i===Nl)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Sl||i===Il)return o===wt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Pl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===Ll)return r.COMPRESSED_R11_EAC;if(i===Dl)return r.COMPRESSED_SIGNED_R11_EAC;if(i===So)return r.COMPRESSED_RG11_EAC;if(i===Nl)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Ul||i===kl||i===Fl||i===Ol||i===Bl||i===zl||i===Hl||i===Vl||i===Gl||i===Wl||i===Xl||i===ql||i===Yl||i===Zl)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Ul)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===kl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Fl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Ol)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Bl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===zl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Hl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Vl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Gl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Wl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Xl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===ql)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Yl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Zl)return o===wt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Kl||i===$l||i===Jl)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Kl)return o===wt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===$l)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Jl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Ql||i===jl||i===Io||i===ec)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Ql)return r.COMPRESSED_RED_RGTC1_EXT;if(i===jl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Io)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ec)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===xr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}var EM=`
void main() {
...
}`,pf=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let i=new fo(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,i=new Un({vertexShader:EM,fragmentShader:AM,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new fe(new Vn(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},mf=class extends li{constructor(e,t){super();let i=this,s=null,r=1,o=null,a="local-floor",l=1,c=null,h=null,f=null,d=null,u=null,p=null,x=typeof XRWebGLBinding<"u",m=new pf,g={},_=t.getContextAttributes(),w=null,E=null,P=[],T=[],S=new Ke,v=null,M=new Mn;M.viewport=new Ht;let R=new Mn;R.viewport=new Ht;let y=[M,R],C=new ul,D=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(N){let q=P[N];return q===void 0&&(q=new fr,P[N]=q),q.getTargetRaySpace()},this.getControllerGrip=function(N){let q=P[N];return q===void 0&&(q=new fr,P[N]=q),q.getGripSpace()},this.getHand=function(N){let q=P[N];return q===void 0&&(q=new fr,P[N]=q),q.getHandSpace()};function L(N){let q=T.indexOf(N.inputSource);if(q===-1)return;let J=P[q];J!==void 0&&(J.update(N.inputSource,N.frame,c||o),J.dispatchEvent({type:N.type,data:N.inputSource}))}function F(){s.removeEventListener("select",L),s.removeEventListener("selectstart",L),s.removeEventListener("selectend",L),s.removeEventListener("squeeze",L),s.removeEventListener("squeezestart",L),s.removeEventListener("squeezeend",L),s.removeEventListener("end",F),s.removeEventListener("inputsourceschange",G);for(let N=0;N<P.length;N++){let q=T[N];q!==null&&(T[N]=null,P[N].disconnect(q))}D=null,k=null,m.reset();for(let N in g)delete g[N];e.setRenderTarget(w),u=null,d=null,f=null,s=null,E=null,B.stop(),i.isPresenting=!1,e.setPixelRatio(v),e.setSize(S.width,S.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(N){r=N,i.isPresenting===!0&&Ze("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(N){a=N,i.isPresenting===!0&&Ze("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(N){c=N},this.getBaseLayer=function(){return d!==null?d:u},this.getBinding=function(){return f===null&&x&&(f=new XRWebGLBinding(s,t)),f},this.getFrame=function(){return p},this.getSession=function(){return s},this.setSession=async function(N){if(s=N,s!==null){if(w=e.getRenderTarget(),s.addEventListener("select",L),s.addEventListener("selectstart",L),s.addEventListener("selectend",L),s.addEventListener("squeeze",L),s.addEventListener("squeezestart",L),s.addEventListener("squeezeend",L),s.addEventListener("end",F),s.addEventListener("inputsourceschange",G),_.xrCompatible!==!0&&await t.makeXRCompatible(),v=e.getPixelRatio(),e.getSize(S),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let J=null,he=null,Te=null;_.depth&&(Te=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,J=_.stencil?as:ai,he=_.stencil?xr:jn);let be={colorFormat:t.RGBA8,depthFormat:Te,scaleFactor:r};f=this.getBinding(),d=f.createProjectionLayer(be),s.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),E=new Nn(d.textureWidth,d.textureHeight,{format:Xn,type:Cn,depthTexture:new Ui(d.textureWidth,d.textureHeight,he,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let J={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:r};u=new XRWebGLLayer(s,t,J),s.updateRenderState({baseLayer:u}),e.setPixelRatio(1),e.setSize(u.framebufferWidth,u.framebufferHeight,!1),E=new Nn(u.framebufferWidth,u.framebufferHeight,{format:Xn,type:Cn,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),B.setContext(s),B.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function G(N){for(let q=0;q<N.removed.length;q++){let J=N.removed[q],he=T.indexOf(J);he>=0&&(T[he]=null,P[he].disconnect(J))}for(let q=0;q<N.added.length;q++){let J=N.added[q],he=T.indexOf(J);if(he===-1){for(let be=0;be<P.length;be++)if(be>=T.length){T.push(J),he=be;break}else if(T[be]===null){T[be]=J,he=be;break}if(he===-1)break}let Te=P[he];Te&&Te.connect(J)}}let ie=new z,oe=new z;function de(N,q,J){ie.setFromMatrixPosition(q.matrixWorld),oe.setFromMatrixPosition(J.matrixWorld);let he=ie.distanceTo(oe),Te=q.projectionMatrix.elements,be=J.projectionMatrix.elements,Oe=Te[14]/(Te[10]-1),Ie=Te[14]/(Te[10]+1),ke=(Te[9]+1)/Te[5],We=(Te[9]-1)/Te[5],Pe=(Te[8]-1)/Te[0],yt=(be[8]+1)/be[0],_t=Oe*Pe,un=Oe*yt,V=he/(-Pe+yt),nn=V*-Pe;if(q.matrixWorld.decompose(N.position,N.quaternion,N.scale),N.translateX(nn),N.translateZ(V),N.matrixWorld.compose(N.position,N.quaternion,N.scale),N.matrixWorldInverse.copy(N.matrixWorld).invert(),Te[10]===-1)N.projectionMatrix.copy(q.projectionMatrix),N.projectionMatrixInverse.copy(q.projectionMatrixInverse);else{let ct=Oe+V,Lt=Ie+V,ve=_t-nn,Gt=un+(he-nn),I=ke*Ie/Lt*ct,b=We*Ie/Lt*ct;N.projectionMatrix.makePerspective(ve,Gt,I,b,ct,Lt),N.projectionMatrixInverse.copy(N.projectionMatrix).invert()}}function Re(N,q){q===null?N.matrixWorld.copy(N.matrix):N.matrixWorld.multiplyMatrices(q.matrixWorld,N.matrix),N.matrixWorldInverse.copy(N.matrixWorld).invert()}this.updateCamera=function(N){if(s===null)return;let q=N.near,J=N.far;m.texture!==null&&(m.depthNear>0&&(q=m.depthNear),m.depthFar>0&&(J=m.depthFar)),C.near=R.near=M.near=q,C.far=R.far=M.far=J,(D!==C.near||k!==C.far)&&(s.updateRenderState({depthNear:C.near,depthFar:C.far}),D=C.near,k=C.far),C.layers.mask=N.layers.mask|6,M.layers.mask=C.layers.mask&-5,R.layers.mask=C.layers.mask&-3;let he=N.parent,Te=C.cameras;Re(C,he);for(let be=0;be<Te.length;be++)Re(Te[be],he);Te.length===2?de(C,M,R):C.projectionMatrix.copy(M.projectionMatrix),Ue(N,C,he)};function Ue(N,q,J){J===null?N.matrix.copy(q.matrixWorld):(N.matrix.copy(J.matrixWorld),N.matrix.invert(),N.matrix.multiply(q.matrixWorld)),N.matrix.decompose(N.position,N.quaternion,N.scale),N.updateMatrixWorld(!0),N.projectionMatrix.copy(q.projectionMatrix),N.projectionMatrixInverse.copy(q.projectionMatrixInverse),N.isPerspectiveCamera&&(N.fov=qa*2*Math.atan(1/N.projectionMatrix.elements[5]),N.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(d===null&&u===null))return l},this.setFoveation=function(N){l=N,d!==null&&(d.fixedFoveation=N),u!==null&&u.fixedFoveation!==void 0&&(u.fixedFoveation=N)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(C)},this.getCameraTexture=function(N){return g[N]};let X=null;function U(N,q){if(h=q.getViewerPose(c||o),p=q,h!==null){let J=h.views;u!==null&&(e.setRenderTargetFramebuffer(E,u.framebuffer),e.setRenderTarget(E));let he=!1;J.length!==C.cameras.length&&(C.cameras.length=0,he=!0);for(let Ie=0;Ie<J.length;Ie++){let ke=J[Ie],We=null;if(u!==null)We=u.getViewport(ke);else{let yt=f.getViewSubImage(d,ke);We=yt.viewport,Ie===0&&(e.setRenderTargetTextures(E,yt.colorTexture,yt.depthStencilTexture),e.setRenderTarget(E))}let Pe=y[Ie];Pe===void 0&&(Pe=new Mn,Pe.layers.enable(Ie),Pe.viewport=new Ht,y[Ie]=Pe),Pe.matrix.fromArray(ke.transform.matrix),Pe.matrix.decompose(Pe.position,Pe.quaternion,Pe.scale),Pe.projectionMatrix.fromArray(ke.projectionMatrix),Pe.projectionMatrixInverse.copy(Pe.projectionMatrix).invert(),Pe.viewport.set(We.x,We.y,We.width,We.height),Ie===0&&(C.matrix.copy(Pe.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),he===!0&&C.cameras.push(Pe)}let Te=s.enabledFeatures;if(Te&&Te.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&x){f=i.getBinding();let Ie=f.getDepthInformation(J[0]);Ie&&Ie.isValid&&Ie.texture&&m.init(Ie,s.renderState)}if(Te&&Te.includes("camera-access")&&x){e.state.unbindTexture(),f=i.getBinding();for(let Ie=0;Ie<J.length;Ie++){let ke=J[Ie].camera;if(ke){let We=g[ke];We||(We=new fo,g[ke]=We);let Pe=f.getCameraImage(ke);We.sourceTexture=Pe}}}}for(let J=0;J<P.length;J++){let he=T[J],Te=P[J];he!==null&&Te!==void 0&&Te.update(he,q,c||o)}X&&X(N,q),q.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:q}),p=null}let B=new sm;B.setAnimationLoop(U),this.setAnimationLoop=function(N){X=N},this.dispose=function(){}}},RM=new ut,hm=new je;hm.set(-1,0,0,0,1,0,0,0,1);function CM(n,e){function t(m,g){m.matrixAutoUpdate===!0&&m.updateMatrix(),g.value.copy(m.matrix)}function i(m,g){g.color.getRGB(m.fogColor.value,$h(n)),g.isFog?(m.fogNear.value=g.near,m.fogFar.value=g.far):g.isFogExp2&&(m.fogDensity.value=g.density)}function s(m,g,_,w,E){g.isNodeMaterial?g.uniformsNeedUpdate=!1:g.isMeshBasicMaterial?r(m,g):g.isMeshLambertMaterial?(r(m,g),g.envMap&&(m.envMapIntensity.value=g.envMapIntensity)):g.isMeshToonMaterial?(r(m,g),f(m,g)):g.isMeshPhongMaterial?(r(m,g),h(m,g),g.envMap&&(m.envMapIntensity.value=g.envMapIntensity)):g.isMeshStandardMaterial?(r(m,g),d(m,g),g.isMeshPhysicalMaterial&&u(m,g,E)):g.isMeshMatcapMaterial?(r(m,g),p(m,g)):g.isMeshDepthMaterial?r(m,g):g.isMeshDistanceMaterial?(r(m,g),x(m,g)):g.isMeshNormalMaterial?r(m,g):g.isLineBasicMaterial?(o(m,g),g.isLineDashedMaterial&&a(m,g)):g.isPointsMaterial?l(m,g,_,w):g.isSpriteMaterial?c(m,g):g.isShadowMaterial?(m.color.value.copy(g.color),m.opacity.value=g.opacity):g.isShaderMaterial&&(g.uniformsNeedUpdate=!1)}function r(m,g){m.opacity.value=g.opacity,g.color&&m.diffuse.value.copy(g.color),g.emissive&&m.emissive.value.copy(g.emissive).multiplyScalar(g.emissiveIntensity),g.map&&(m.map.value=g.map,t(g.map,m.mapTransform)),g.alphaMap&&(m.alphaMap.value=g.alphaMap,t(g.alphaMap,m.alphaMapTransform)),g.bumpMap&&(m.bumpMap.value=g.bumpMap,t(g.bumpMap,m.bumpMapTransform),m.bumpScale.value=g.bumpScale,g.side===gn&&(m.bumpScale.value*=-1)),g.normalMap&&(m.normalMap.value=g.normalMap,t(g.normalMap,m.normalMapTransform),m.normalScale.value.copy(g.normalScale),g.side===gn&&m.normalScale.value.negate()),g.displacementMap&&(m.displacementMap.value=g.displacementMap,t(g.displacementMap,m.displacementMapTransform),m.displacementScale.value=g.displacementScale,m.displacementBias.value=g.displacementBias),g.emissiveMap&&(m.emissiveMap.value=g.emissiveMap,t(g.emissiveMap,m.emissiveMapTransform)),g.specularMap&&(m.specularMap.value=g.specularMap,t(g.specularMap,m.specularMapTransform)),g.alphaTest>0&&(m.alphaTest.value=g.alphaTest);let _=e.get(g),w=_.envMap,E=_.envMapRotation;w&&(m.envMap.value=w,m.envMapRotation.value.setFromMatrix4(RM.makeRotationFromEuler(E)).transpose(),w.isCubeTexture&&w.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(hm),m.reflectivity.value=g.reflectivity,m.ior.value=g.ior,m.refractionRatio.value=g.refractionRatio),g.lightMap&&(m.lightMap.value=g.lightMap,m.lightMapIntensity.value=g.lightMapIntensity,t(g.lightMap,m.lightMapTransform)),g.aoMap&&(m.aoMap.value=g.aoMap,m.aoMapIntensity.value=g.aoMapIntensity,t(g.aoMap,m.aoMapTransform))}function o(m,g){m.diffuse.value.copy(g.color),m.opacity.value=g.opacity,g.map&&(m.map.value=g.map,t(g.map,m.mapTransform))}function a(m,g){m.dashSize.value=g.dashSize,m.totalSize.value=g.dashSize+g.gapSize,m.scale.value=g.scale}function l(m,g,_,w){m.diffuse.value.copy(g.color),m.opacity.value=g.opacity,m.size.value=g.size*_,m.scale.value=w*.5,g.map&&(m.map.value=g.map,t(g.map,m.uvTransform)),g.alphaMap&&(m.alphaMap.value=g.alphaMap,t(g.alphaMap,m.alphaMapTransform)),g.alphaTest>0&&(m.alphaTest.value=g.alphaTest)}function c(m,g){m.diffuse.value.copy(g.color),m.opacity.value=g.opacity,m.rotation.value=g.rotation,g.map&&(m.map.value=g.map,t(g.map,m.mapTransform)),g.alphaMap&&(m.alphaMap.value=g.alphaMap,t(g.alphaMap,m.alphaMapTransform)),g.alphaTest>0&&(m.alphaTest.value=g.alphaTest)}function h(m,g){m.specular.value.copy(g.specular),m.shininess.value=Math.max(g.shininess,1e-4)}function f(m,g){g.gradientMap&&(m.gradientMap.value=g.gradientMap)}function d(m,g){m.metalness.value=g.metalness,g.metalnessMap&&(m.metalnessMap.value=g.metalnessMap,t(g.metalnessMap,m.metalnessMapTransform)),m.roughness.value=g.roughness,g.roughnessMap&&(m.roughnessMap.value=g.roughnessMap,t(g.roughnessMap,m.roughnessMapTransform)),g.envMap&&(m.envMapIntensity.value=g.envMapIntensity)}function u(m,g,_){m.ior.value=g.ior,g.sheen>0&&(m.sheenColor.value.copy(g.sheenColor).multiplyScalar(g.sheen),m.sheenRoughness.value=g.sheenRoughness,g.sheenColorMap&&(m.sheenColorMap.value=g.sheenColorMap,t(g.sheenColorMap,m.sheenColorMapTransform)),g.sheenRoughnessMap&&(m.sheenRoughnessMap.value=g.sheenRoughnessMap,t(g.sheenRoughnessMap,m.sheenRoughnessMapTransform))),g.clearcoat>0&&(m.clearcoat.value=g.clearcoat,m.clearcoatRoughness.value=g.clearcoatRoughness,g.clearcoatMap&&(m.clearcoatMap.value=g.clearcoatMap,t(g.clearcoatMap,m.clearcoatMapTransform)),g.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=g.clearcoatRoughnessMap,t(g.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),g.clearcoatNormalMap&&(m.clearcoatNormalMap.value=g.clearcoatNormalMap,t(g.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(g.clearcoatNormalScale),g.side===gn&&m.clearcoatNormalScale.value.negate())),g.dispersion>0&&(m.dispersion.value=g.dispersion),g.iridescence>0&&(m.iridescence.value=g.iridescence,m.iridescenceIOR.value=g.iridescenceIOR,m.iridescenceThicknessMinimum.value=g.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=g.iridescenceThicknessRange[1],g.iridescenceMap&&(m.iridescenceMap.value=g.iridescenceMap,t(g.iridescenceMap,m.iridescenceMapTransform)),g.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=g.iridescenceThicknessMap,t(g.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),g.transmission>0&&(m.transmission.value=g.transmission,m.transmissionSamplerMap.value=_.texture,m.transmissionSamplerSize.value.set(_.width,_.height),g.transmissionMap&&(m.transmissionMap.value=g.transmissionMap,t(g.transmissionMap,m.transmissionMapTransform)),m.thickness.value=g.thickness,g.thicknessMap&&(m.thicknessMap.value=g.thicknessMap,t(g.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=g.attenuationDistance,m.attenuationColor.value.copy(g.attenuationColor)),g.anisotropy>0&&(m.anisotropyVector.value.set(g.anisotropy*Math.cos(g.anisotropyRotation),g.anisotropy*Math.sin(g.anisotropyRotation)),g.anisotropyMap&&(m.anisotropyMap.value=g.anisotropyMap,t(g.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=g.specularIntensity,m.specularColor.value.copy(g.specularColor),g.specularColorMap&&(m.specularColorMap.value=g.specularColorMap,t(g.specularColorMap,m.specularColorMapTransform)),g.specularIntensityMap&&(m.specularIntensityMap.value=g.specularIntensityMap,t(g.specularIntensityMap,m.specularIntensityMapTransform))}function p(m,g){g.matcap&&(m.matcap.value=g.matcap)}function x(m,g){let _=e.get(g).light;m.referencePosition.value.setFromMatrixPosition(_.matrixWorld),m.nearDistance.value=_.shadow.camera.near,m.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function SM(n,e,t,i){let s={},r={},o=[],a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(_,w){let E=w.program;i.uniformBlockBinding(_,E)}function c(_,w){let E=s[_.id];E===void 0&&(p(_),E=h(_),s[_.id]=E,_.addEventListener("dispose",m));let P=w.program;i.updateUBOMapping(_,P);let T=e.render.frame;r[_.id]!==T&&(d(_),r[_.id]=T)}function h(_){let w=f();_.__bindingPointIndex=w;let E=n.createBuffer(),P=_.__size,T=_.usage;return n.bindBuffer(n.UNIFORM_BUFFER,E),n.bufferData(n.UNIFORM_BUFFER,P,T),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,w,E),E}function f(){for(let _=0;_<a;_++)if(o.indexOf(_)===-1)return o.push(_),_;return Ye("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(_){let w=s[_.id],E=_.uniforms,P=_.__cache;n.bindBuffer(n.UNIFORM_BUFFER,w);for(let T=0,S=E.length;T<S;T++){let v=Array.isArray(E[T])?E[T]:[E[T]];for(let M=0,R=v.length;M<R;M++){let y=v[M];if(u(y,T,M,P)===!0){let C=y.__offset,D=Array.isArray(y.value)?y.value:[y.value],k=0;for(let L=0;L<D.length;L++){let F=D[L],G=x(F);typeof F=="number"||typeof F=="boolean"?(y.__data[0]=F,n.bufferSubData(n.UNIFORM_BUFFER,C+k,y.__data)):F.isMatrix3?(y.__data[0]=F.elements[0],y.__data[1]=F.elements[1],y.__data[2]=F.elements[2],y.__data[3]=0,y.__data[4]=F.elements[3],y.__data[5]=F.elements[4],y.__data[6]=F.elements[5],y.__data[7]=0,y.__data[8]=F.elements[6],y.__data[9]=F.elements[7],y.__data[10]=F.elements[8],y.__data[11]=0):ArrayBuffer.isView(F)?y.__data.set(new F.constructor(F.buffer,F.byteOffset,y.__data.length)):(F.toArray(y.__data,k),k+=G.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,C,y.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function u(_,w,E,P){let T=_.value,S=w+"_"+E;if(P[S]===void 0)return typeof T=="number"||typeof T=="boolean"?P[S]=T:ArrayBuffer.isView(T)?P[S]=T.slice():P[S]=T.clone(),!0;{let v=P[S];if(typeof T=="number"||typeof T=="boolean"){if(v!==T)return P[S]=T,!0}else{if(ArrayBuffer.isView(T))return!0;if(v.equals(T)===!1)return v.copy(T),!0}}return!1}function p(_){let w=_.uniforms,E=0,P=16;for(let S=0,v=w.length;S<v;S++){let M=Array.isArray(w[S])?w[S]:[w[S]];for(let R=0,y=M.length;R<y;R++){let C=M[R],D=Array.isArray(C.value)?C.value:[C.value];for(let k=0,L=D.length;k<L;k++){let F=D[k],G=x(F),ie=E%P,oe=ie%G.boundary,de=ie+oe;E+=oe,de!==0&&P-de<G.storage&&(E+=P-de),C.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),C.__offset=E,E+=G.storage}}}let T=E%P;return T>0&&(E+=P-T),_.__size=E,_.__cache={},this}function x(_){let w={boundary:0,storage:0};return typeof _=="number"||typeof _=="boolean"?(w.boundary=4,w.storage=4):_.isVector2?(w.boundary=8,w.storage=8):_.isVector3||_.isColor?(w.boundary=16,w.storage=12):_.isVector4?(w.boundary=16,w.storage=16):_.isMatrix3?(w.boundary=48,w.storage=48):_.isMatrix4?(w.boundary=64,w.storage=64):_.isTexture?Ze("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(_)?(w.boundary=16,w.storage=_.byteLength):Ze("WebGLRenderer: Unsupported uniform value type.",_),w}function m(_){let w=_.target;w.removeEventListener("dispose",m);let E=o.indexOf(w.__bindingPointIndex);o.splice(E,1),n.deleteBuffer(s[w.id]),delete s[w.id],delete r[w.id]}function g(){for(let _ in s)n.deleteBuffer(s[_]);o=[],s={},r={}}return{bind:l,update:c,dispose:g}}var IM=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),gi=null;function PM(){return gi===null&&(gi=new lo(IM,16,16,ls,mi),gi.name="DFG_LUT",gi.minFilter=mn,gi.magFilter=mn,gi.wrapS=oi,gi.wrapT=oi,gi.generateMipmaps=!1,gi.needsUpdate=!0),gi}var lc=class{constructor(e={}){let{canvas:t=Cp(),context:i=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:d=!1,outputBufferType:u=Cn}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;let x=u,m=new Set([Tl,wl,bl]),g=new Set([Cn,jn,gr,xr,_l,vl]),_=new Uint32Array(4),w=new Int32Array(4),E=new z,P=null,T=null,S=[],v=[],M=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Qn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let R=this,y=!1,C=null;this._outputColorSpace=fn;let D=0,k=0,L=null,F=-1,G=null,ie=new Ht,oe=new Ht,de=null,Re=new $e(0),Ue=0,X=t.width,U=t.height,B=1,N=null,q=null,J=new Ht(0,0,X,U),he=new Ht(0,0,X,U),Te=!1,be=new ur,Oe=!1,Ie=!1,ke=new ut,We=new z,Pe=new Ht,yt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},_t=!1;function un(){return L===null?B:1}let V=i;function nn(A,W){return t.getContext(A,W)}try{let A={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${"184"}`),t.addEventListener("webglcontextlost",ae,!1),t.addEventListener("webglcontextrestored",Be,!1),t.addEventListener("webglcontextcreationerror",et,!1),V===null){let W="webgl2";if(V=nn(W,A),V===null)throw nn(W)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw Ye("WebGLRenderer: "+A.message),A}let ct,Lt,ve,Gt,I,b,Y,te,ce,ue,_e,j,ne,Ae,De,ge,pe,Je,it,mt,O,me,ee;function Se(){ct=new O_(V),ct.init(),O=new TM(V,ct),Lt=new I_(V,ct,e,O),ve=new bM(V,ct),Lt.reversedDepthBuffer&&d&&ve.buffers.depth.setReversed(!0),Gt=new H_(V),I=new lM,b=new wM(V,ct,ve,I,Lt,O,Gt),Y=new F_(R),te=new Xg(V),me=new C_(V,te),ce=new B_(V,te,Gt,me),ue=new G_(V,ce,te,me,Gt),Je=new V_(V,Lt,b),De=new P_(I),_e=new aM(R,Y,ct,Lt,me,De),j=new CM(R,I),ne=new hM,Ae=new gM(ct),pe=new R_(R,Y,ve,ue,p,l),ge=new MM(R,ue,Lt),ee=new SM(V,Gt,Lt,ve),it=new S_(V,ct,Gt),mt=new z_(V,ct,Gt),Gt.programs=_e.programs,R.capabilities=Lt,R.extensions=ct,R.properties=I,R.renderLists=ne,R.shadowMap=ge,R.state=ve,R.info=Gt}Se(),x!==Cn&&(M=new X_(x,t.width,t.height,s,r));let xe=new mf(R,V);this.xr=xe,this.getContext=function(){return V},this.getContextAttributes=function(){return V.getContextAttributes()},this.forceContextLoss=function(){let A=ct.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){let A=ct.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return B},this.setPixelRatio=function(A){A!==void 0&&(B=A,this.setSize(X,U,!1))},this.getSize=function(A){return A.set(X,U)},this.setSize=function(A,W,$=!0){if(xe.isPresenting){Ze("WebGLRenderer: Can't change size while VR device is presenting.");return}X=A,U=W,t.width=Math.floor(A*B),t.height=Math.floor(W*B),$===!0&&(t.style.width=A+"px",t.style.height=W+"px"),M!==null&&M.setSize(t.width,t.height),this.setViewport(0,0,A,W)},this.getDrawingBufferSize=function(A){return A.set(X*B,U*B).floor()},this.setDrawingBufferSize=function(A,W,$){X=A,U=W,B=$,t.width=Math.floor(A*$),t.height=Math.floor(W*$),this.setViewport(0,0,A,W)},this.setEffects=function(A){if(x===Cn){Ye("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(A){for(let W=0;W<A.length;W++)if(A[W].isOutputPass===!0){Ze("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}M.setEffects(A||[])},this.getCurrentViewport=function(A){return A.copy(ie)},this.getViewport=function(A){return A.copy(J)},this.setViewport=function(A,W,$,Z){A.isVector4?J.set(A.x,A.y,A.z,A.w):J.set(A,W,$,Z),ve.viewport(ie.copy(J).multiplyScalar(B).round())},this.getScissor=function(A){return A.copy(he)},this.setScissor=function(A,W,$,Z){A.isVector4?he.set(A.x,A.y,A.z,A.w):he.set(A,W,$,Z),ve.scissor(oe.copy(he).multiplyScalar(B).round())},this.getScissorTest=function(){return Te},this.setScissorTest=function(A){ve.setScissorTest(Te=A)},this.setOpaqueSort=function(A){N=A},this.setTransparentSort=function(A){q=A},this.getClearColor=function(A){return A.copy(pe.getClearColor())},this.setClearColor=function(){pe.setClearColor(...arguments)},this.getClearAlpha=function(){return pe.getClearAlpha()},this.setClearAlpha=function(){pe.setClearAlpha(...arguments)},this.clear=function(A=!0,W=!0,$=!0){let Z=0;if(A){let K=!1;if(L!==null){let Ee=L.texture.format;K=m.has(Ee)}if(K){let Ee=L.texture.type,Ne=g.has(Ee),we=pe.getClearColor(),Fe=pe.getClearAlpha(),He=we.r,tt=we.g,ot=we.b;Ne?(_[0]=He,_[1]=tt,_[2]=ot,_[3]=Fe,V.clearBufferuiv(V.COLOR,0,_)):(w[0]=He,w[1]=tt,w[2]=ot,w[3]=Fe,V.clearBufferiv(V.COLOR,0,w))}else Z|=V.COLOR_BUFFER_BIT}W&&(Z|=V.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),$&&(Z|=V.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),Z!==0&&V.clear(Z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(A){A.setRenderer(this),C=A},this.dispose=function(){t.removeEventListener("webglcontextlost",ae,!1),t.removeEventListener("webglcontextrestored",Be,!1),t.removeEventListener("webglcontextcreationerror",et,!1),pe.dispose(),ne.dispose(),Ae.dispose(),I.dispose(),Y.dispose(),ue.dispose(),me.dispose(),ee.dispose(),_e.dispose(),xe.dispose(),xe.removeEventListener("sessionstart",Mf),xe.removeEventListener("sessionend",bf),ds.stop()};function ae(A){A.preventDefault(),to("WebGLRenderer: Context Lost."),y=!0}function Be(){to("WebGLRenderer: Context Restored."),y=!1;let A=Gt.autoReset,W=ge.enabled,$=ge.autoUpdate,Z=ge.needsUpdate,K=ge.type;Se(),Gt.autoReset=A,ge.enabled=W,ge.autoUpdate=$,ge.needsUpdate=Z,ge.type=K}function et(A){Ye("WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Kt(A){let W=A.target;W.removeEventListener("dispose",Kt),Tt(W)}function Tt(A){yi(A),I.remove(A)}function yi(A){let W=I.get(A).programs;W!==void 0&&(W.forEach(function($){_e.releaseProgram($)}),A.isShaderMaterial&&_e.releaseShaderCache(A))}this.renderBufferDirect=function(A,W,$,Z,K,Ee){W===null&&(W=yt);let Ne=K.isMesh&&K.matrixWorld.determinant()<0,we=Sm(A,W,$,Z,K);ve.setMaterial(Z,Ne);let Fe=$.index,He=1;if(Z.wireframe===!0){if(Fe=ce.getWireframeAttribute($),Fe===void 0)return;He=2}let tt=$.drawRange,ot=$.attributes.position,Xe=tt.start*He,Et=(tt.start+tt.count)*He;Ee!==null&&(Xe=Math.max(Xe,Ee.start*He),Et=Math.min(Et,(Ee.start+Ee.count)*He)),Fe!==null?(Xe=Math.max(Xe,0),Et=Math.min(Et,Fe.count)):ot!=null&&(Xe=Math.max(Xe,0),Et=Math.min(Et,ot.count));let $t=Et-Xe;if($t<0||$t===1/0)return;me.setup(K,Z,we,$,Fe);let Wt,Rt=it;if(Fe!==null&&(Wt=te.get(Fe),Rt=mt,Rt.setIndex(Wt)),K.isMesh)Z.wireframe===!0?(ve.setLineWidth(Z.wireframeLinewidth*un()),Rt.setMode(V.LINES)):Rt.setMode(V.TRIANGLES);else if(K.isLine){let xn=Z.linewidth;xn===void 0&&(xn=1),ve.setLineWidth(xn*un()),K.isLineSegments?Rt.setMode(V.LINES):K.isLineLoop?Rt.setMode(V.LINE_LOOP):Rt.setMode(V.LINE_STRIP)}else K.isPoints?Rt.setMode(V.POINTS):K.isSprite&&Rt.setMode(V.TRIANGLES);if(K.isBatchedMesh)if(ct.get("WEBGL_multi_draw"))Rt.renderMultiDraw(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount);else{let xn=K._multiDrawStarts,Le=K._multiDrawCounts,Sn=K._multiDrawCount,pt=Fe?te.get(Fe).bytesPerElement:1,Fn=I.get(Z).currentProgram.getUniforms();for(let ti=0;ti<Sn;ti++)Fn.setValue(V,"_gl_DrawID",ti),Rt.render(xn[ti]/pt,Le[ti])}else if(K.isInstancedMesh)Rt.renderInstances(Xe,$t,K.count);else if($.isInstancedBufferGeometry){let xn=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,Le=Math.min($.instanceCount,xn);Rt.renderInstances(Xe,$t,Le)}else Rt.render(Xe,$t)};function ei(A,W,$){A.transparent===!0&&A.side===Rn&&A.forceSinglePass===!1?(A.side=gn,A.needsUpdate=!0,Uo(A,W,$),A.side=Ii,A.needsUpdate=!0,Uo(A,W,$),A.side=Rn):Uo(A,W,$)}this.compile=function(A,W,$=null){$===null&&($=A),T=Ae.get($),T.init(W),v.push(T),$.traverseVisible(function(K){K.isLight&&K.layers.test(W.layers)&&(T.pushLight(K),K.castShadow&&T.pushShadow(K))}),A!==$&&A.traverseVisible(function(K){K.isLight&&K.layers.test(W.layers)&&(T.pushLight(K),K.castShadow&&T.pushShadow(K))}),T.setupLights();let Z=new Set;return A.traverse(function(K){if(!(K.isMesh||K.isPoints||K.isLine||K.isSprite))return;let Ee=K.material;if(Ee)if(Array.isArray(Ee))for(let Ne=0;Ne<Ee.length;Ne++){let we=Ee[Ne];ei(we,$,K),Z.add(we)}else ei(Ee,$,K),Z.add(Ee)}),T=v.pop(),Z},this.compileAsync=function(A,W,$=null){let Z=this.compile(A,W,$);return new Promise(K=>{function Ee(){if(Z.forEach(function(Ne){I.get(Ne).currentProgram.isReady()&&Z.delete(Ne)}),Z.size===0){K(A);return}setTimeout(Ee,10)}ct.get("KHR_parallel_shader_compile")!==null?Ee():setTimeout(Ee,10)})};let gc=null;function Rm(A){gc&&gc(A)}function Mf(){ds.stop()}function bf(){ds.start()}let ds=new sm;ds.setAnimationLoop(Rm),typeof self<"u"&&ds.setContext(self),this.setAnimationLoop=function(A){gc=A,xe.setAnimationLoop(A),A===null?ds.stop():ds.start()},xe.addEventListener("sessionstart",Mf),xe.addEventListener("sessionend",bf),this.render=function(A,W){if(W!==void 0&&W.isCamera!==!0){Ye("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(y===!0)return;C!==null&&C.renderStart(A,W);let $=xe.enabled===!0&&xe.isPresenting===!0,Z=M!==null&&(L===null||$)&&M.begin(R,L);if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),W.parent===null&&W.matrixWorldAutoUpdate===!0&&W.updateMatrixWorld(),xe.enabled===!0&&xe.isPresenting===!0&&(M===null||M.isCompositing()===!1)&&(xe.cameraAutoUpdate===!0&&xe.updateCamera(W),W=xe.getCamera()),A.isScene===!0&&A.onBeforeRender(R,A,W,L),T=Ae.get(A,v.length),T.init(W),T.state.textureUnits=b.getTextureUnits(),v.push(T),ke.multiplyMatrices(W.projectionMatrix,W.matrixWorldInverse),be.setFromProjectionMatrix(ke,Jn,W.reversedDepth),Ie=this.localClippingEnabled,Oe=De.init(this.clippingPlanes,Ie),P=ne.get(A,S.length),P.init(),S.push(P),xe.enabled===!0&&xe.isPresenting===!0){let Ne=R.xr.getDepthSensingMesh();Ne!==null&&xc(Ne,W,-1/0,R.sortObjects)}xc(A,W,0,R.sortObjects),P.finish(),R.sortObjects===!0&&P.sort(N,q),_t=xe.enabled===!1||xe.isPresenting===!1||xe.hasDepthSensing()===!1,_t&&pe.addToRenderList(P,A),this.info.render.frame++,Oe===!0&&De.beginShadows();let K=T.state.shadowsArray;if(ge.render(K,A,W),Oe===!0&&De.endShadows(),this.info.autoReset===!0&&this.info.reset(),(Z&&M.hasRenderPass())===!1){let Ne=P.opaque,we=P.transmissive;if(T.setupLights(),W.isArrayCamera){let Fe=W.cameras;if(we.length>0)for(let He=0,tt=Fe.length;He<tt;He++){let ot=Fe[He];Tf(Ne,we,A,ot)}_t&&pe.render(A);for(let He=0,tt=Fe.length;He<tt;He++){let ot=Fe[He];wf(P,A,ot,ot.viewport)}}else we.length>0&&Tf(Ne,we,A,W),_t&&pe.render(A),wf(P,A,W)}L!==null&&k===0&&(b.updateMultisampleRenderTarget(L),b.updateRenderTargetMipmap(L)),Z&&M.end(R),A.isScene===!0&&A.onAfterRender(R,A,W),me.resetDefaultState(),F=-1,G=null,v.pop(),v.length>0?(T=v[v.length-1],b.setTextureUnits(T.state.textureUnits),Oe===!0&&De.setGlobalState(R.clippingPlanes,T.state.camera)):T=null,S.pop(),S.length>0?P=S[S.length-1]:P=null,C!==null&&C.renderEnd()};function xc(A,W,$,Z){if(A.visible===!1)return;if(A.layers.test(W.layers)){if(A.isGroup)$=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(W);else if(A.isLightProbeGrid)T.pushLightProbeGrid(A);else if(A.isLight)T.pushLight(A),A.castShadow&&T.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||be.intersectsSprite(A)){Z&&Pe.setFromMatrixPosition(A.matrixWorld).applyMatrix4(ke);let Ne=ue.update(A),we=A.material;we.visible&&P.push(A,Ne,we,$,Pe.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||be.intersectsObject(A))){let Ne=ue.update(A),we=A.material;if(Z&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),Pe.copy(A.boundingSphere.center)):(Ne.boundingSphere===null&&Ne.computeBoundingSphere(),Pe.copy(Ne.boundingSphere.center)),Pe.applyMatrix4(A.matrixWorld).applyMatrix4(ke)),Array.isArray(we)){let Fe=Ne.groups;for(let He=0,tt=Fe.length;He<tt;He++){let ot=Fe[He],Xe=we[ot.materialIndex];Xe&&Xe.visible&&P.push(A,Ne,Xe,$,Pe.z,ot)}}else we.visible&&P.push(A,Ne,we,$,Pe.z,null)}}let Ee=A.children;for(let Ne=0,we=Ee.length;Ne<we;Ne++)xc(Ee[Ne],W,$,Z)}function wf(A,W,$,Z){let{opaque:K,transmissive:Ee,transparent:Ne}=A;T.setupLightsView($),Oe===!0&&De.setGlobalState(R.clippingPlanes,$),Z&&ve.viewport(ie.copy(Z)),K.length>0&&No(K,W,$),Ee.length>0&&No(Ee,W,$),Ne.length>0&&No(Ne,W,$),ve.buffers.depth.setTest(!0),ve.buffers.depth.setMask(!0),ve.buffers.color.setMask(!0),ve.setPolygonOffset(!1)}function Tf(A,W,$,Z){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;if(T.state.transmissionRenderTarget[Z.id]===void 0){let Xe=ct.has("EXT_color_buffer_half_float")||ct.has("EXT_color_buffer_float");T.state.transmissionRenderTarget[Z.id]=new Nn(1,1,{generateMipmaps:!0,type:Xe?mi:Cn,minFilter:pi,samples:Math.max(4,Lt.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ht.workingColorSpace})}let Ee=T.state.transmissionRenderTarget[Z.id],Ne=Z.viewport||ie;Ee.setSize(Ne.z*R.transmissionResolutionScale,Ne.w*R.transmissionResolutionScale);let we=R.getRenderTarget(),Fe=R.getActiveCubeFace(),He=R.getActiveMipmapLevel();R.setRenderTarget(Ee),R.getClearColor(Re),Ue=R.getClearAlpha(),Ue<1&&R.setClearColor(16777215,.5),R.clear(),_t&&pe.render($);let tt=R.toneMapping;R.toneMapping=Qn;let ot=Z.viewport;if(Z.viewport!==void 0&&(Z.viewport=void 0),T.setupLightsView(Z),Oe===!0&&De.setGlobalState(R.clippingPlanes,Z),No(A,$,Z),b.updateMultisampleRenderTarget(Ee),b.updateRenderTargetMipmap(Ee),ct.has("WEBGL_multisampled_render_to_texture")===!1){let Xe=!1;for(let Et=0,$t=W.length;Et<$t;Et++){let Wt=W[Et],{object:Rt,geometry:xn,material:Le,group:Sn}=Wt;if(Le.side===Rn&&Rt.layers.test(Z.layers)){let pt=Le.side;Le.side=gn,Le.needsUpdate=!0,Ef(Rt,$,Z,xn,Le,Sn),Le.side=pt,Le.needsUpdate=!0,Xe=!0}}Xe===!0&&(b.updateMultisampleRenderTarget(Ee),b.updateRenderTargetMipmap(Ee))}R.setRenderTarget(we,Fe,He),R.setClearColor(Re,Ue),ot!==void 0&&(Z.viewport=ot),R.toneMapping=tt}function No(A,W,$){let Z=W.isScene===!0?W.overrideMaterial:null;for(let K=0,Ee=A.length;K<Ee;K++){let Ne=A[K],{object:we,geometry:Fe,group:He}=Ne,tt=Ne.material;tt.allowOverride===!0&&Z!==null&&(tt=Z),we.layers.test($.layers)&&Ef(we,W,$,Fe,tt,He)}}function Ef(A,W,$,Z,K,Ee){A.onBeforeRender(R,W,$,Z,K,Ee),A.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),K.onBeforeRender(R,W,$,Z,A,Ee),K.transparent===!0&&K.side===Rn&&K.forceSinglePass===!1?(K.side=gn,K.needsUpdate=!0,R.renderBufferDirect($,W,Z,K,A,Ee),K.side=Ii,K.needsUpdate=!0,R.renderBufferDirect($,W,Z,K,A,Ee),K.side=Rn):R.renderBufferDirect($,W,Z,K,A,Ee),A.onAfterRender(R,W,$,Z,K,Ee)}function Uo(A,W,$){W.isScene!==!0&&(W=yt);let Z=I.get(A),K=T.state.lights,Ee=T.state.shadowsArray,Ne=K.state.version,we=_e.getParameters(A,K.state,Ee,W,$,T.state.lightProbeGridArray),Fe=_e.getProgramCacheKey(we),He=Z.programs;Z.environment=A.isMeshStandardMaterial||A.isMeshLambertMaterial||A.isMeshPhongMaterial?W.environment:null,Z.fog=W.fog;let tt=A.isMeshStandardMaterial||A.isMeshLambertMaterial&&!A.envMap||A.isMeshPhongMaterial&&!A.envMap;Z.envMap=Y.get(A.envMap||Z.environment,tt),Z.envMapRotation=Z.environment!==null&&A.envMap===null?W.environmentRotation:A.envMapRotation,He===void 0&&(A.addEventListener("dispose",Kt),He=new Map,Z.programs=He);let ot=He.get(Fe);if(ot!==void 0){if(Z.currentProgram===ot&&Z.lightsStateVersion===Ne)return Rf(A,we),ot}else we.uniforms=_e.getUniforms(A),C!==null&&A.isNodeMaterial&&C.build(A,$,we),A.onBeforeCompile(we,R),ot=_e.acquireProgram(we,Fe),He.set(Fe,ot),Z.uniforms=we.uniforms;let Xe=Z.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Xe.clippingPlanes=De.uniform),Rf(A,we),Z.needsLights=Pm(A),Z.lightsStateVersion=Ne,Z.needsLights&&(Xe.ambientLightColor.value=K.state.ambient,Xe.lightProbe.value=K.state.probe,Xe.directionalLights.value=K.state.directional,Xe.directionalLightShadows.value=K.state.directionalShadow,Xe.spotLights.value=K.state.spot,Xe.spotLightShadows.value=K.state.spotShadow,Xe.rectAreaLights.value=K.state.rectArea,Xe.ltc_1.value=K.state.rectAreaLTC1,Xe.ltc_2.value=K.state.rectAreaLTC2,Xe.pointLights.value=K.state.point,Xe.pointLightShadows.value=K.state.pointShadow,Xe.hemisphereLights.value=K.state.hemi,Xe.directionalShadowMatrix.value=K.state.directionalShadowMatrix,Xe.spotLightMatrix.value=K.state.spotLightMatrix,Xe.spotLightMap.value=K.state.spotLightMap,Xe.pointShadowMatrix.value=K.state.pointShadowMatrix),Z.lightProbeGrid=T.state.lightProbeGridArray.length>0,Z.currentProgram=ot,Z.uniformsList=null,ot}function Af(A){if(A.uniformsList===null){let W=A.currentProgram.getUniforms();A.uniformsList=_r.seqWithValue(W.seq,A.uniforms)}return A.uniformsList}function Rf(A,W){let $=I.get(A);$.outputColorSpace=W.outputColorSpace,$.batching=W.batching,$.batchingColor=W.batchingColor,$.instancing=W.instancing,$.instancingColor=W.instancingColor,$.instancingMorph=W.instancingMorph,$.skinning=W.skinning,$.morphTargets=W.morphTargets,$.morphNormals=W.morphNormals,$.morphColors=W.morphColors,$.morphTargetsCount=W.morphTargetsCount,$.numClippingPlanes=W.numClippingPlanes,$.numIntersection=W.numClipIntersection,$.vertexAlphas=W.vertexAlphas,$.vertexTangents=W.vertexTangents,$.toneMapping=W.toneMapping}function Cm(A,W){if(A.length===0)return null;if(A.length===1)return A[0].texture!==null?A[0]:null;E.setFromMatrixPosition(W.matrixWorld);for(let $=0,Z=A.length;$<Z;$++){let K=A[$];if(K.texture!==null&&K.boundingBox.containsPoint(E))return K}return null}function Sm(A,W,$,Z,K){W.isScene!==!0&&(W=yt),b.resetTextureUnits();let Ee=W.fog,Ne=Z.isMeshStandardMaterial||Z.isMeshLambertMaterial||Z.isMeshPhongMaterial?W.environment:null,we=L===null?R.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:ht.workingColorSpace,Fe=Z.isMeshStandardMaterial||Z.isMeshLambertMaterial&&!Z.envMap||Z.isMeshPhongMaterial&&!Z.envMap,He=Y.get(Z.envMap||Ne,Fe),tt=Z.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,ot=!!$.attributes.tangent&&(!!Z.normalMap||Z.anisotropy>0),Xe=!!$.morphAttributes.position,Et=!!$.morphAttributes.normal,$t=!!$.morphAttributes.color,Wt=Qn;Z.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(Wt=R.toneMapping);let Rt=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,xn=Rt!==void 0?Rt.length:0,Le=I.get(Z),Sn=T.state.lights;if(Oe===!0&&(Ie===!0||A!==G)){let Dt=A===G&&Z.id===F;De.setState(Z,A,Dt)}let pt=!1;Z.version===Le.__version?(Le.needsLights&&Le.lightsStateVersion!==Sn.state.version||Le.outputColorSpace!==we||K.isBatchedMesh&&Le.batching===!1||!K.isBatchedMesh&&Le.batching===!0||K.isBatchedMesh&&Le.batchingColor===!0&&K.colorTexture===null||K.isBatchedMesh&&Le.batchingColor===!1&&K.colorTexture!==null||K.isInstancedMesh&&Le.instancing===!1||!K.isInstancedMesh&&Le.instancing===!0||K.isSkinnedMesh&&Le.skinning===!1||!K.isSkinnedMesh&&Le.skinning===!0||K.isInstancedMesh&&Le.instancingColor===!0&&K.instanceColor===null||K.isInstancedMesh&&Le.instancingColor===!1&&K.instanceColor!==null||K.isInstancedMesh&&Le.instancingMorph===!0&&K.morphTexture===null||K.isInstancedMesh&&Le.instancingMorph===!1&&K.morphTexture!==null||Le.envMap!==He||Z.fog===!0&&Le.fog!==Ee||Le.numClippingPlanes!==void 0&&(Le.numClippingPlanes!==De.numPlanes||Le.numIntersection!==De.numIntersection)||Le.vertexAlphas!==tt||Le.vertexTangents!==ot||Le.morphTargets!==Xe||Le.morphNormals!==Et||Le.morphColors!==$t||Le.toneMapping!==Wt||Le.morphTargetsCount!==xn||!!Le.lightProbeGrid!=T.state.lightProbeGridArray.length>0)&&(pt=!0):(pt=!0,Le.__version=Z.version);let Fn=Le.currentProgram;pt===!0&&(Fn=Uo(Z,W,K),C&&Z.isNodeMaterial&&C.onUpdateProgram(Z,Fn,Le));let ti=!1,Oi=!1,Ns=!1,Ct=Fn.getUniforms(),Jt=Le.uniforms;if(ve.useProgram(Fn.program)&&(ti=!0,Oi=!0,Ns=!0),Z.id!==F&&(F=Z.id,Oi=!0),Le.needsLights){let Dt=Cm(T.state.lightProbeGridArray,K);Le.lightProbeGrid!==Dt&&(Le.lightProbeGrid=Dt,Oi=!0)}if(ti||G!==A){ve.buffers.depth.getReversed()&&A.reversedDepth!==!0&&(A._reversedDepth=!0,A.updateProjectionMatrix()),Ct.setValue(V,"projectionMatrix",A.projectionMatrix),Ct.setValue(V,"viewMatrix",A.matrixWorldInverse);let zi=Ct.map.cameraPosition;zi!==void 0&&zi.setValue(V,We.setFromMatrixPosition(A.matrixWorld)),Lt.logarithmicDepthBuffer&&Ct.setValue(V,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(Z.isMeshPhongMaterial||Z.isMeshToonMaterial||Z.isMeshLambertMaterial||Z.isMeshBasicMaterial||Z.isMeshStandardMaterial||Z.isShaderMaterial)&&Ct.setValue(V,"isOrthographic",A.isOrthographicCamera===!0),G!==A&&(G=A,Oi=!0,Ns=!0)}if(Le.needsLights&&(Sn.state.directionalShadowMap.length>0&&Ct.setValue(V,"directionalShadowMap",Sn.state.directionalShadowMap,b),Sn.state.spotShadowMap.length>0&&Ct.setValue(V,"spotShadowMap",Sn.state.spotShadowMap,b),Sn.state.pointShadowMap.length>0&&Ct.setValue(V,"pointShadowMap",Sn.state.pointShadowMap,b)),K.isSkinnedMesh){Ct.setOptional(V,K,"bindMatrix"),Ct.setOptional(V,K,"bindMatrixInverse");let Dt=K.skeleton;Dt&&(Dt.boneTexture===null&&Dt.computeBoneTexture(),Ct.setValue(V,"boneTexture",Dt.boneTexture,b))}K.isBatchedMesh&&(Ct.setOptional(V,K,"batchingTexture"),Ct.setValue(V,"batchingTexture",K._matricesTexture,b),Ct.setOptional(V,K,"batchingIdTexture"),Ct.setValue(V,"batchingIdTexture",K._indirectTexture,b),Ct.setOptional(V,K,"batchingColorTexture"),K._colorsTexture!==null&&Ct.setValue(V,"batchingColorTexture",K._colorsTexture,b));let Bi=$.morphAttributes;if((Bi.position!==void 0||Bi.normal!==void 0||Bi.color!==void 0)&&Je.update(K,$,Fn),(Oi||Le.receiveShadow!==K.receiveShadow)&&(Le.receiveShadow=K.receiveShadow,Ct.setValue(V,"receiveShadow",K.receiveShadow)),(Z.isMeshStandardMaterial||Z.isMeshLambertMaterial||Z.isMeshPhongMaterial)&&Z.envMap===null&&W.environment!==null&&(Jt.envMapIntensity.value=W.environmentIntensity),Jt.dfgLUT!==void 0&&(Jt.dfgLUT.value=PM()),Oi){if(Ct.setValue(V,"toneMappingExposure",R.toneMappingExposure),Le.needsLights&&Im(Jt,Ns),Ee&&Z.fog===!0&&j.refreshFogUniforms(Jt,Ee),j.refreshMaterialUniforms(Jt,Z,B,U,T.state.transmissionRenderTarget[A.id]),Le.needsLights&&Le.lightProbeGrid){let Dt=Le.lightProbeGrid;Jt.probesSH.value=Dt.texture,Jt.probesMin.value.copy(Dt.boundingBox.min),Jt.probesMax.value.copy(Dt.boundingBox.max),Jt.probesResolution.value.copy(Dt.resolution)}_r.upload(V,Af(Le),Jt,b)}if(Z.isShaderMaterial&&Z.uniformsNeedUpdate===!0&&(_r.upload(V,Af(Le),Jt,b),Z.uniformsNeedUpdate=!1),Z.isSpriteMaterial&&Ct.setValue(V,"center",K.center),Ct.setValue(V,"modelViewMatrix",K.modelViewMatrix),Ct.setValue(V,"normalMatrix",K.normalMatrix),Ct.setValue(V,"modelMatrix",K.matrixWorld),Z.uniformsGroups!==void 0){let Dt=Z.uniformsGroups;for(let zi=0,Us=Dt.length;zi<Us;zi++){let Cf=Dt[zi];ee.update(Cf,Fn),ee.bind(Cf,Fn)}}return Fn}function Im(A,W){A.ambientLightColor.needsUpdate=W,A.lightProbe.needsUpdate=W,A.directionalLights.needsUpdate=W,A.directionalLightShadows.needsUpdate=W,A.pointLights.needsUpdate=W,A.pointLightShadows.needsUpdate=W,A.spotLights.needsUpdate=W,A.spotLightShadows.needsUpdate=W,A.rectAreaLights.needsUpdate=W,A.hemisphereLights.needsUpdate=W}function Pm(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return k},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(A,W,$){let Z=I.get(A);Z.__autoAllocateDepthBuffer=A.resolveDepthBuffer===!1,Z.__autoAllocateDepthBuffer===!1&&(Z.__useRenderToTexture=!1),I.get(A.texture).__webglTexture=W,I.get(A.depthTexture).__webglTexture=Z.__autoAllocateDepthBuffer?void 0:$,Z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(A,W){let $=I.get(A);$.__webglFramebuffer=W,$.__useDefaultFramebuffer=W===void 0};let Lm=V.createFramebuffer();this.setRenderTarget=function(A,W=0,$=0){L=A,D=W,k=$;let Z=null,K=!1,Ee=!1;if(A){let we=I.get(A);if(we.__useDefaultFramebuffer!==void 0){ve.bindFramebuffer(V.FRAMEBUFFER,we.__webglFramebuffer),ie.copy(A.viewport),oe.copy(A.scissor),de=A.scissorTest,ve.viewport(ie),ve.scissor(oe),ve.setScissorTest(de),F=-1;return}else if(we.__webglFramebuffer===void 0)b.setupRenderTarget(A);else if(we.__hasExternalTextures)b.rebindTextures(A,I.get(A.texture).__webglTexture,I.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){let tt=A.depthTexture;if(we.__boundDepthTexture!==tt){if(tt!==null&&I.has(tt)&&(A.width!==tt.image.width||A.height!==tt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");b.setupDepthRenderbuffer(A)}}let Fe=A.texture;(Fe.isData3DTexture||Fe.isDataArrayTexture||Fe.isCompressedArrayTexture)&&(Ee=!0);let He=I.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(He[W])?Z=He[W][$]:Z=He[W],K=!0):A.samples>0&&b.useMultisampledRTT(A)===!1?Z=I.get(A).__webglMultisampledFramebuffer:Array.isArray(He)?Z=He[$]:Z=He,ie.copy(A.viewport),oe.copy(A.scissor),de=A.scissorTest}else ie.copy(J).multiplyScalar(B).floor(),oe.copy(he).multiplyScalar(B).floor(),de=Te;if($!==0&&(Z=Lm),ve.bindFramebuffer(V.FRAMEBUFFER,Z)&&ve.drawBuffers(A,Z),ve.viewport(ie),ve.scissor(oe),ve.setScissorTest(de),K){let we=I.get(A.texture);V.framebufferTexture2D(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_CUBE_MAP_POSITIVE_X+W,we.__webglTexture,$)}else if(Ee){let we=W;for(let Fe=0;Fe<A.textures.length;Fe++){let He=I.get(A.textures[Fe]);V.framebufferTextureLayer(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0+Fe,He.__webglTexture,$,we)}}else if(A!==null&&$!==0){let we=I.get(A.texture);V.framebufferTexture2D(V.FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,we.__webglTexture,$)}F=-1},this.readRenderTargetPixels=function(A,W,$,Z,K,Ee,Ne,we=0){if(!(A&&A.isWebGLRenderTarget)){Ye("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Fe=I.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ne!==void 0&&(Fe=Fe[Ne]),Fe){ve.bindFramebuffer(V.FRAMEBUFFER,Fe);try{let He=A.textures[we],tt=He.format,ot=He.type;if(A.textures.length>1&&V.readBuffer(V.COLOR_ATTACHMENT0+we),!Lt.textureFormatReadable(tt)){Ye("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Lt.textureTypeReadable(ot)){Ye("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}W>=0&&W<=A.width-Z&&$>=0&&$<=A.height-K&&V.readPixels(W,$,Z,K,O.convert(tt),O.convert(ot),Ee)}finally{let He=L!==null?I.get(L).__webglFramebuffer:null;ve.bindFramebuffer(V.FRAMEBUFFER,He)}}},this.readRenderTargetPixelsAsync=async function(A,W,$,Z,K,Ee,Ne,we=0){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Fe=I.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ne!==void 0&&(Fe=Fe[Ne]),Fe)if(W>=0&&W<=A.width-Z&&$>=0&&$<=A.height-K){ve.bindFramebuffer(V.FRAMEBUFFER,Fe);let He=A.textures[we],tt=He.format,ot=He.type;if(A.textures.length>1&&V.readBuffer(V.COLOR_ATTACHMENT0+we),!Lt.textureFormatReadable(tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Lt.textureTypeReadable(ot))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let Xe=V.createBuffer();V.bindBuffer(V.PIXEL_PACK_BUFFER,Xe),V.bufferData(V.PIXEL_PACK_BUFFER,Ee.byteLength,V.STREAM_READ),V.readPixels(W,$,Z,K,O.convert(tt),O.convert(ot),0);let Et=L!==null?I.get(L).__webglFramebuffer:null;ve.bindFramebuffer(V.FRAMEBUFFER,Et);let $t=V.fenceSync(V.SYNC_GPU_COMMANDS_COMPLETE,0);return V.flush(),await Ip(V,$t,4),V.bindBuffer(V.PIXEL_PACK_BUFFER,Xe),V.getBufferSubData(V.PIXEL_PACK_BUFFER,0,Ee),V.deleteBuffer(Xe),V.deleteSync($t),Ee}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(A,W=null,$=0){let Z=Math.pow(2,-$),K=Math.floor(A.image.width*Z),Ee=Math.floor(A.image.height*Z),Ne=W!==null?W.x:0,we=W!==null?W.y:0;b.setTexture2D(A,0),V.copyTexSubImage2D(V.TEXTURE_2D,$,0,0,Ne,we,K,Ee),ve.unbindTexture()};let Dm=V.createFramebuffer(),Nm=V.createFramebuffer();this.copyTextureToTexture=function(A,W,$=null,Z=null,K=0,Ee=0){let Ne,we,Fe,He,tt,ot,Xe,Et,$t,Wt=A.isCompressedTexture?A.mipmaps[Ee]:A.image;if($!==null)Ne=$.max.x-$.min.x,we=$.max.y-$.min.y,Fe=$.isBox3?$.max.z-$.min.z:1,He=$.min.x,tt=$.min.y,ot=$.isBox3?$.min.z:0;else{let Jt=Math.pow(2,-K);Ne=Math.floor(Wt.width*Jt),we=Math.floor(Wt.height*Jt),A.isDataArrayTexture?Fe=Wt.depth:A.isData3DTexture?Fe=Math.floor(Wt.depth*Jt):Fe=1,He=0,tt=0,ot=0}Z!==null?(Xe=Z.x,Et=Z.y,$t=Z.z):(Xe=0,Et=0,$t=0);let Rt=O.convert(W.format),xn=O.convert(W.type),Le;W.isData3DTexture?(b.setTexture3D(W,0),Le=V.TEXTURE_3D):W.isDataArrayTexture||W.isCompressedArrayTexture?(b.setTexture2DArray(W,0),Le=V.TEXTURE_2D_ARRAY):(b.setTexture2D(W,0),Le=V.TEXTURE_2D),ve.activeTexture(V.TEXTURE0),ve.pixelStorei(V.UNPACK_FLIP_Y_WEBGL,W.flipY),ve.pixelStorei(V.UNPACK_PREMULTIPLY_ALPHA_WEBGL,W.premultiplyAlpha),ve.pixelStorei(V.UNPACK_ALIGNMENT,W.unpackAlignment);let Sn=ve.getParameter(V.UNPACK_ROW_LENGTH),pt=ve.getParameter(V.UNPACK_IMAGE_HEIGHT),Fn=ve.getParameter(V.UNPACK_SKIP_PIXELS),ti=ve.getParameter(V.UNPACK_SKIP_ROWS),Oi=ve.getParameter(V.UNPACK_SKIP_IMAGES);ve.pixelStorei(V.UNPACK_ROW_LENGTH,Wt.width),ve.pixelStorei(V.UNPACK_IMAGE_HEIGHT,Wt.height),ve.pixelStorei(V.UNPACK_SKIP_PIXELS,He),ve.pixelStorei(V.UNPACK_SKIP_ROWS,tt),ve.pixelStorei(V.UNPACK_SKIP_IMAGES,ot);let Ns=A.isDataArrayTexture||A.isData3DTexture,Ct=W.isDataArrayTexture||W.isData3DTexture;if(A.isDepthTexture){let Jt=I.get(A),Bi=I.get(W),Dt=I.get(Jt.__renderTarget),zi=I.get(Bi.__renderTarget);ve.bindFramebuffer(V.READ_FRAMEBUFFER,Dt.__webglFramebuffer),ve.bindFramebuffer(V.DRAW_FRAMEBUFFER,zi.__webglFramebuffer);for(let Us=0;Us<Fe;Us++)Ns&&(V.framebufferTextureLayer(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,I.get(A).__webglTexture,K,ot+Us),V.framebufferTextureLayer(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,I.get(W).__webglTexture,Ee,$t+Us)),V.blitFramebuffer(He,tt,Ne,we,Xe,Et,Ne,we,V.DEPTH_BUFFER_BIT,V.NEAREST);ve.bindFramebuffer(V.READ_FRAMEBUFFER,null),ve.bindFramebuffer(V.DRAW_FRAMEBUFFER,null)}else if(K!==0||A.isRenderTargetTexture||I.has(A)){let Jt=I.get(A),Bi=I.get(W);ve.bindFramebuffer(V.READ_FRAMEBUFFER,Dm),ve.bindFramebuffer(V.DRAW_FRAMEBUFFER,Nm);for(let Dt=0;Dt<Fe;Dt++)Ns?V.framebufferTextureLayer(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,Jt.__webglTexture,K,ot+Dt):V.framebufferTexture2D(V.READ_FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,Jt.__webglTexture,K),Ct?V.framebufferTextureLayer(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,Bi.__webglTexture,Ee,$t+Dt):V.framebufferTexture2D(V.DRAW_FRAMEBUFFER,V.COLOR_ATTACHMENT0,V.TEXTURE_2D,Bi.__webglTexture,Ee),K!==0?V.blitFramebuffer(He,tt,Ne,we,Xe,Et,Ne,we,V.COLOR_BUFFER_BIT,V.NEAREST):Ct?V.copyTexSubImage3D(Le,Ee,Xe,Et,$t+Dt,He,tt,Ne,we):V.copyTexSubImage2D(Le,Ee,Xe,Et,He,tt,Ne,we);ve.bindFramebuffer(V.READ_FRAMEBUFFER,null),ve.bindFramebuffer(V.DRAW_FRAMEBUFFER,null)}else Ct?A.isDataTexture||A.isData3DTexture?V.texSubImage3D(Le,Ee,Xe,Et,$t,Ne,we,Fe,Rt,xn,Wt.data):W.isCompressedArrayTexture?V.compressedTexSubImage3D(Le,Ee,Xe,Et,$t,Ne,we,Fe,Rt,Wt.data):V.texSubImage3D(Le,Ee,Xe,Et,$t,Ne,we,Fe,Rt,xn,Wt):A.isDataTexture?V.texSubImage2D(V.TEXTURE_2D,Ee,Xe,Et,Ne,we,Rt,xn,Wt.data):A.isCompressedTexture?V.compressedTexSubImage2D(V.TEXTURE_2D,Ee,Xe,Et,Wt.width,Wt.height,Rt,Wt.data):V.texSubImage2D(V.TEXTURE_2D,Ee,Xe,Et,Ne,we,Rt,xn,Wt);ve.pixelStorei(V.UNPACK_ROW_LENGTH,Sn),ve.pixelStorei(V.UNPACK_IMAGE_HEIGHT,pt),ve.pixelStorei(V.UNPACK_SKIP_PIXELS,Fn),ve.pixelStorei(V.UNPACK_SKIP_ROWS,ti),ve.pixelStorei(V.UNPACK_SKIP_IMAGES,Oi),Ee===0&&W.generateMipmaps&&V.generateMipmap(Le),ve.unbindTexture()},this.initRenderTarget=function(A){I.get(A).__webglFramebuffer===void 0&&b.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?b.setTextureCube(A,0):A.isData3DTexture?b.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?b.setTexture2DArray(A,0):b.setTexture2D(A,0),ve.unbindTexture()},this.resetState=function(){D=0,k=0,L=null,ve.reset(),me.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Jn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=ht._getDrawingBufferColorSpace(e),t.unpackColorSpace=ht._getUnpackColorSpace()}};function fm(n,e){let t=new lc({canvas:e.canvas,antialias:!0});t.setPixelRatio(Math.min(2,devicePixelRatio||1)),t.setSize(e.VW,e.VH),t.outputColorSpace=fn;let i=new so;i.background=new $e(861232);let s=new Mn(50,e.VW/e.VH,10,6e4),r=new yo(15397624,4867128,.95);i.add(r);let o=new vo(16773852,1.35);o.position.set(-.45,1,-.3).multiplyScalar(1e3),i.add(o);let a=new en;i.add(a),o.target=a,i.fog=new io(10466494,2600,9e3);let l={renderer:t,scene:i,camera:s,sun:o,hemi:r,cx:n.player.x,cy:n.player.y,dist:1150,elev:.96,shakeX:0,shakeY:0,_ray:new Mo,_plane:new Hn(new z(0,1,0),0),_v3:new z,lightLevel(){return .5+.5*Math.cos(Math.PI*2*(n.t%wr/wr))},resize(){s.aspect=e.VW/e.VH,s.updateProjectionMatrix(),t.setSize(e.VW,e.VH)},update(c){let h=n.player,f=h.x,d=h.y,u=1500,p=.96;if(e.godView){f=se.w/2,d=se.h/2,p=1.52;let S=Math.tan(s.fov/2*Math.PI/180),v=(se.h/2+500)/S,M=(se.w/2+500)/(S*s.aspect);u=Math.max(v,M)*1.02}else h.inCopter&&n.copter&&(u=1850+Math.hypot(n.copter.vx,n.copter.vy)*.9);l._wasGod!==e.godView&&(l._wasGod=e.godView,l.cx=f,l.cy=d,l.dist=u,l.elev=p);let x=Math.min(1,c*(e.godView?6:5));l.cx=Tr(l.cx,f,x),l.cy=Tr(l.cy,d,x),l.dist=Tr(l.dist,u,Math.min(1,c*4)),l.elev=Tr(l.elev,p,Math.min(1,c*4)),n.shake>0?(l.shakeX=(Math.random()*2-1)*n.shake,l.shakeY=(Math.random()*2-1)*n.shake):(l.shakeX=0,l.shakeY=0);let m=l.cx+l.shakeX,g=l.cy+l.shakeY,_=Math.sin(l.elev)*l.dist,w=Math.cos(l.elev)*l.dist;s.position.set(m,_,g+w),s.lookAt(m,0,g),a.position.set(m,0,g);let E=l.lightLevel(),P=Math.sin((1-E)*Math.PI);o.intensity=1+E*.45,o.color.setHSL(.105-P*.045,.52+P*.25,.62-P*.06),r.intensity=.78+E*.25;let T=n.t%wr/wr*Math.PI*2;o.position.set(m+Math.cos(T)*1400,900+E*600,g+Math.sin(T)*1400-400),i.fog.near=l.dist*2.2,i.fog.far=l.dist*8,l._viewR=l.dist*1.9},render(){t.render(i,s)},screenToWorld(c,h){let f=new Ke(c/e.VW*2-1,-(h/e.VH)*2+1);l._ray.setFromCamera(f,s);let d=new z;return l._ray.ray.intersectPlane(l._plane,d),d?{x:d.x,y:d.z}:{x:l.cx,y:l.cy}},worldToScreen(c,h,f=0){return l._v3.set(c,f,h).project(s),{x:(l._v3.x+1)/2*e.VW,y:(-l._v3.y+1)/2*e.VH,behind:l._v3.z>1}},inView(c,h,f=0){let d=c-l.cx,u=h-l.cy;return d*d+u*u<(l._viewR+f)*(l._viewR+f)},viewRect(c=0){let h=l._viewR+c;return{x0:l.cx-h,y0:l.cy-h,x1:l.cx+h,y1:l.cy+h}},get zoom(){return 900/l.dist}};return l.update(.1),l}var fc=.3;function um(n,e){let t=Math.round(se.w*fc),i=Math.round(se.h*fc),s=document.createElement("canvas");s.width=t,s.height=i;let r=s.getContext("2d");r.save(),r.scale(fc,fc),LM(n,r),r.restore();let o=new di(s);o.colorSpace=fn,o.anisotropy=4,o.minFilter=pi;let a=new fe(new Vn(se.w,se.h),new ns({map:o,transparent:!0}));a.rotation.x=-Math.PI/2,a.position.set(se.w/2,0,se.h/2),a.renderOrder=1,e.add(a);let l=new fe(new Vn(se.w*6,se.h*6),new ns({color:1060924}));l.rotation.x=-Math.PI/2,l.position.set(se.w/2,-3,se.h/2),e.add(l);let c=document.createElement("canvas");c.width=256,c.height=256;let h=c.getContext("2d");for(let E=0;E<260;E++){let P=Math.random()*256,T=Math.random()*256;h.fillStyle=`rgba(200,235,245,${.25+Math.random()*.5})`,h.fillRect(P,T,1.6+Math.random()*2.4,1.2)}let f=new di(c);f.wrapS=f.wrapT=Es,f.repeat.set(220,146);let d=new fe(new Vn(se.w*6,se.h*6),new tn({map:f,transparent:!0,opacity:.5,depthWrite:!1,blending:Gn}));d.rotation.x=-Math.PI/2,d.position.set(se.w/2,-1.5,se.h/2),e.add(d);let u=f.clone();u.wrapS=u.wrapT=Es,u.repeat.set(133,88);let p=new fe(new Vn(se.w*6,se.h*6),new tn({map:u,transparent:!0,opacity:.3,depthWrite:!1,blending:Gn}));p.rotation.x=-Math.PI/2,p.position.set(se.w/2,-1.2,se.h/2),e.add(p);let x=document.createElement("canvas");x.width=4,x.height=256;let m=x.getContext("2d"),g=m.createLinearGradient(0,0,0,256);g.addColorStop(0,"#5d9bd3"),g.addColorStop(.62,"#9cc3dd"),g.addColorStop(.78,"#cfddd8"),g.addColorStop(1,"#dfe5da"),m.fillStyle=g,m.fillRect(0,0,4,256);let _=new di(x);_.colorSpace=fn;let w=new fe(new Rs(34e3,18,12,0,Math.PI*2,0,Math.PI/2),new tn({map:_,side:gn,fog:!1}));return w.position.set(se.w/2,-40,se.h/2),e.add(w),e.background=null,{tex:o,sync(E,P,T){let S=d.material.map,v=p.material.map;S.offset.x+=E*.0022,S.offset.y+=E*.0013,v.offset.x-=E*.0011,v.offset.y+=E*8e-4,w.position.set(T.cx,-40,T.cy);let M=T.lightLevel();w.material.color.setHSL(.58,.18,.62+M*.38)}}}function dm(n,e,t){let i=(e+n.world.biomeRidge(t))/se.w,s=.05,r=vi((i-(1/3-s))/(2*s)),o=vi((i-(2/3-s))/(2*s)),a=(d,u,p)=>[d[0]+(u[0]-d[0])*p,d[1]+(u[1]-d[1])*p,d[2]+(u[2]-d[2])*p],l=[181,154,102],c=[74,92,48],h=[185,199,209],f=a(l,c,r);return f=a(f,h,o),f}function gf(n,e){e.beginPath(),n.world.islandPath.forEach((t,i)=>i?e.lineTo(t.x,t.y):e.moveTo(t.x,t.y)),e.closePath()}function LM(n,e){let t=se.w,i=se.h;e.lineJoin="round",e.strokeStyle="rgba(64,124,134,0.45)",e.lineWidth=64,gf(n,e),e.stroke(),e.strokeStyle="rgba(90,150,158,0.30)",e.lineWidth=26,gf(n,e),e.stroke(),e.save(),gf(n,e),e.clip();let s=32;for(let a=0;a<i;a+=s)for(let l=0;l<t;l+=s){if(n.world.landFactor(l+s/2,a+s/2)<=-.25)continue;let[h,f,d]=dm(n,l+s/2,a+s/2),u=Ho(l/s|0,a/s|0),p=Ho(l/96|0,a/96|0),x=.88+u*.14+(p-.5)*.12-a/i*.06;h*=x,f*=x,d*=x,e.fillStyle=`rgb(${h|0},${f|0},${d|0})`,e.fillRect(l-1,a-1,s+2,s+2)}e.lineCap="round";let r=n.world.islandPath;for(let a=0;a<3;a++){let l=a===0?96:a===1?30:7;for(let c=0;c<r.length;c++){let h=r[c],f=r[(c+1)%r.length],d=n.world.biomeAt((h.x+f.x)/2,(h.y+f.y)/2)==="winter";e.strokeStyle=a===0?d?"rgba(214,227,235,0.95)":"rgba(186,166,120,0.95)":a===1?d?"rgba(168,190,204,0.9)":"rgba(146,128,92,0.9)":"rgba(240,248,252,0.55)",e.lineWidth=l,e.beginPath(),e.moveTo(h.x,h.y),e.lineTo(f.x,f.y),e.stroke()}}for(let a of n.world.lakes){e.save(),e.translate(a.x,a.y);let l=()=>{e.beginPath();for(let h=0;h<=28;h++){let f=h/28*Math.PI*2,d=a.r*a.wob[h%28],u=Math.cos(f)*d,p=Math.sin(f)*d*.84;h?e.lineTo(u,p):e.moveTo(u,p)}e.closePath()};e.save(),e.scale(1.06,1.06),l(),e.fillStyle=a.frozen?"rgba(238,246,251,.95)":"rgba(96,118,66,.7)",e.fill(),e.restore(),l();let c=e.createRadialGradient(0,-.3*a.r,a.r*.1,0,0,a.r);a.frozen?(c.addColorStop(0,"#dfeaf2"),c.addColorStop(1,"#96b2c8")):(c.addColorStop(0,"#33687c"),c.addColorStop(1,"#0c2531")),e.fillStyle=c,e.fill(),e.restore()}for(let a of n.world.monuments){let l=e.createRadialGradient(a.x,a.y,a.r*.2,a.x,a.y,a.r);l.addColorStop(0,"rgba(110,106,95,.5)"),l.addColorStop(.8,"rgba(98,94,84,.32)"),l.addColorStop(1,"rgba(90,86,76,0)"),e.fillStyle=l,e.beginPath(),e.arc(a.x,a.y,a.r,0,7),e.fill()}e.lineCap="round";for(let a of n.world.roads)for(let l=0;l<a.pts.length-1;l++){let c=a.pts[l],h=a.pts[l+1],f=Math.min(a.fade[l],a.fade[l+1]);f<=.02||(e.globalAlpha=f,e.strokeStyle="#4f4430",e.lineWidth=a.w,e.beginPath(),e.moveTo(c.x,c.y),e.lineTo(h.x,h.y),e.stroke(),e.strokeStyle="#665838",e.lineWidth=a.w-4,e.beginPath(),e.moveTo(c.x,c.y),e.lineTo(h.x,h.y),e.stroke(),e.globalAlpha=1)}let o=11;for(let a of n.world.rails)for(let l=0;l<a.pts.length-1;l++){let c=a.pts[l],h=a.pts[l+1];e.strokeStyle="#574d40",e.lineWidth=2*o+16,e.beginPath(),e.moveTo(c.x,c.y),e.lineTo(h.x,h.y),e.stroke(),e.strokeStyle="#6b5f4e",e.lineWidth=2*o+7,e.beginPath(),e.moveTo(c.x,c.y),e.lineTo(h.x,h.y),e.stroke();let f=Math.hypot(h.x-c.x,h.y-c.y),d=Math.atan2(h.y-c.y,h.x-c.x),u=-Math.sin(d),p=Math.cos(d);e.strokeStyle="#3a2e1d",e.lineWidth=4.5;for(let x=8;x<f;x+=24){let m=c.x+Math.cos(d)*x,g=c.y+Math.sin(d)*x;e.beginPath(),e.moveTo(m-u*(o+5),g-p*(o+5)),e.lineTo(m+u*(o+5),g+p*(o+5)),e.stroke()}e.strokeStyle="#9aa1a8",e.lineWidth=2.6;for(let x of[-o,o])e.beginPath(),e.moveTo(c.x+u*x,c.y+p*x),e.lineTo(h.x+u*x,h.y+p*x),e.stroke()}for(let a=0;a<i;a+=96)for(let l=0;l<t;l+=96){if(!n.world.onLand(l,a)||n.world.lakeAt(l,a))continue;let c=Ho(l/96|0,a/96|0);if(c>.5)continue;let[h,f,d]=dm(n,l,a);e.fillStyle=`rgba(${h*.75|0},${f*.75|0},${d*.75|0},0.5)`,e.beginPath(),e.ellipse(l+c*80,a+c*7919%1*80,9+c*14,5+c*8,c*6,0,7),e.fill()}e.restore()}var xf=new Map;function ye(n,e={}){let t=n+JSON.stringify(e);return xf.has(t)||xf.set(t,new ns({color:n,emissive:e.emissive||0,emissiveIntensity:e.emissiveIntensity??1,transparent:!!e.transparent,opacity:e.opacity??1,flatShading:!0})),xf.get(t)}var le={box:new ts(1,1,1),cyl:new As(1,1,1,8),cyl6:new As(1,1.18,1,6),cone:new uo(1,1,7),ico:new po(1,0),sphere:new Rs(1,8,6),quad:new Vn(1,1)},dc=null;function pc(){if(dc)return dc;let n=document.createElement("canvas");n.width=64,n.height=64;let e=n.getContext("2d"),t=e.createRadialGradient(32,32,2,32,32,32);return t.addColorStop(0,"rgba(255,255,255,1)"),t.addColorStop(.4,"rgba(255,255,255,0.45)"),t.addColorStop(1,"rgba(255,255,255,0)"),e.fillStyle=t,e.fillRect(0,0,64,64),dc=new di(n),dc}var uc=null;function _f(){if(uc)return uc;let n=document.createElement("canvas");n.width=64,n.height=64;let e=n.getContext("2d"),t=e.createRadialGradient(32,32,4,32,32,30);return t.addColorStop(0,"rgba(8,8,6,0.42)"),t.addColorStop(.7,"rgba(8,8,6,0.22)"),t.addColorStop(1,"rgba(8,8,6,0)"),e.fillStyle=t,e.fillRect(0,0,64,64),uc=new di(n),uc}function hs(n,e=60){let t=new Di({map:pc(),color:n,transparent:!0,blending:Gn,depthWrite:!1}),i=new ji(t);return i.scale.set(e,e,1),i}var yf=null;function Ls(n=40){yf||(yf=new ki(.5,14));let e=new tn({map:_f(),transparent:!0,depthWrite:!1}),t=new fe(yf,e);return t.rotation.x=-Math.PI/2,t.scale.set(n,n*.8,1),t}var mc={wood:9069104,stone:8357517,metal:5791590,armored:4280939},Ds={wood:6111006,stone:5659747,metal:3948871,armored:2567996};var DM=Math.PI*2;function pm(n,e){let t=n.resources.filter(X=>X.type==="tree"),i=n.resources.filter(X=>X.type==="stone"),s=n.resources.filter(X=>X.type==="metal"),r=new Zt(le.cyl,ye(6111008),t.length),o=new Zt(le.cone,ye(16777215),t.length),a=new Zt(le.cone,ye(16777215),t.length),l=new Zt(le.cone,ye(15660281),t.length),c=new Zt(le.ico,ye(9278603),i.length),h=new Zt(le.ico,ye(9271114),s.length),f=new Zt(le.ico,ye(14198864,{emissive:6965776}),s.length);for(let X of[r,o,a,l,c,h,f])X.frustumCulled=!1,e.add(X);let d=new $e,u=new $e,p=[];t.forEach((X,U)=>{let B=.85+X.seed*7.3%1*.4,N=n.world.biomeAt(X.x,X.y)==="winter";p.push(N),d.setHex(N?3953968:3494175).multiplyScalar(B),u.setHex(N?5995082:5274160).multiplyScalar(B),o.setColorAt(U,d),a.setColorAt(U,u)}),o.instanceColor&&(o.instanceColor.needsUpdate=!0),a.instanceColor&&(a.instanceColor.needsUpdate=!0);let x=new ut,m=0;function g(){t.forEach((X,U)=>{let B=X.amount<=0?.001:.55+.45*(X.amount/X.max),N=(X.seed*13.7%1-.5)*.12;x.makeRotationZ(N).scale(new z(7*B,30*B,7*B)).setPosition(X.x,15*B,X.y),r.setMatrixAt(U,x),x.makeRotationY(X.seed).scale(new z(30*B,42*B,30*B)).setPosition(X.x,36*B,X.y),o.setMatrixAt(U,x),x.makeRotationY(X.seed*2).scale(new z(20*B,30*B,20*B)).setPosition(X.x+4,56*B,X.y-3),a.setMatrixAt(U,x);let q=p[U]?B:.001;x.makeScale(13*q,12*q,13*q).setPosition(X.x+4,70*q,X.y-3),l.setMatrixAt(U,x)}),l.instanceMatrix.needsUpdate=!0,i.forEach((X,U)=>{let B=X.amount<=0?.001:(.55+.45*(X.amount/X.max))*X.r;x.makeRotationY(X.seed).scale(new z(B,B*.75,B)).setPosition(X.x,B*.45,X.y),c.setMatrixAt(U,x)}),s.forEach((X,U)=>{let B=X.amount<=0?.001:(.55+.45*(X.amount/X.max))*X.r;x.makeRotationY(X.seed*2).scale(new z(B,B*.7,B)).setPosition(X.x,B*.42,X.y),h.setMatrixAt(U,x),x.makeScale(B*.4,B*.34,B*.4).setPosition(X.x+3,B*.85,X.y-2),f.setMatrixAt(U,x)});for(let X of[r,o,a,c,h,f])X.instanceMatrix.needsUpdate=!0}g();let _=new Zt(le.ico,ye(7896708),n.world.boulders.length||1);n.world.boulders.forEach((X,U)=>{x.makeRotationY(X.seed).scale(new z(X.r,X.r*.8,X.r)).setPosition(X.x,X.r*.45,X.y),_.setMatrixAt(U,x)}),_.frustumCulled=!1,e.add(_);let w=new Zt(le.ico,ye(8685967),n.world.rocks.length||1);n.world.rocks.forEach((X,U)=>{x.makeRotationY(X.seed).scale(new z(X.r,X.r*.6,X.r)).setPosition(X.x,X.r*.3,X.y),w.setMatrixAt(U,x)}),w.frustumCulled=!1,e.add(w);let E=new Zt(le.cyl,ye(7032616),n.world.palms.length||1),P=new Zt(le.cone,ye(5077552),n.world.palms.length||1);n.world.palms.forEach((X,U)=>{x.makeScale(3.4,44,3.4).setPosition(X.x,22,X.y),E.setMatrixAt(U,x),x.makeScale(26,14,26).setPosition(X.x,48,X.y),P.setMatrixAt(U,x)}),E.frustumCulled=!1,P.frustumCulled=!1,e.add(E,P);let T=n.world.flora.filter(X=>X.type==="cactus"),S=new Zt(le.cyl,ye(5143098),T.length||1);T.forEach((X,U)=>{x.makeScale(4.5,22,4.5).setPosition(X.x,11,X.y),S.setMatrixAt(U,x)}),S.frustumCulled=!1,e.add(S);let v=n.world.flora.filter(X=>X.type==="fern"||X.type==="shrub"),M=new Zt(le.ico,ye(5599290),v.length||1);v.forEach((X,U)=>{x.makeScale(8,6,8).setPosition(X.x,4,X.y),M.setMatrixAt(U,x)}),M.frustumCulled=!1,e.add(M),NM(n,e);let R=n.barrels.map(X=>{let U;return X.crate?(U=new fe(le.box,ye(9069104)),U.scale.set(X.r*1.8,X.r*1.5,X.r*1.8),U.position.set(X.x,X.r*.75,X.y)):(U=new fe(le.cyl,ye(10768174)),U.scale.set(X.r*.9,X.r*1.7,X.r*.9),U.position.set(X.x,X.r*.85,X.y)),e.add(U),U}),y={quarryArm:null,gates:[],fadeables:[]};for(let X of n.world.monuments)kM(n,e,X,y);FM(n,e);for(let X of n.world.crossings){let U=new Qe;U.position.set(X.x,0,X.y),U.rotation.y=-X.railAng;for(let B of[-1,1]){let N=new fe(le.box,ye(2500139));N.scale.set(5,20,5),N.position.set(0,10,B*38),U.add(N);let q=new fe(le.box,ye(12597802));q.scale.set(40,3.6,3.6),q.position.set(20,18,B*38);let J=new Qe;J.position.set(0,18,B*38),q.position.set(20,0,0),J.add(q),U.add(J),y.gates.push({pivot:J,cr:X,side:B})}e.add(U)}let C=new Qe;e.add(C);let D=new Map,k=new Map,L=new Map,F=-1,G=new Set;function ie(X){if(X==="p1")return 8308816;let U=n.teams.find(B=>B.owner===X);return U?parseInt(U.col.slice(1),16):8947848}function oe(){if(n.nav.stamp!==F){F=n.nav.stamp,G.clear();for(let[X,U]of n.structures){G.add(X);let B=U.mat,N=k.get(X);if(N&&N.sig!==B&&(C.remove(N.mesh),k.delete(X),N=null),!N){let[q,J]=X.split(",").map(Number),he=new fe(le.box,ye(Ds[U.mat]||Ds.wood));he.scale.set(62,5,62),he.position.set(q*64+64/2,2.5,J*64+64/2),C.add(he),k.set(X,{mesh:he,sig:B})}}for(let[X,U]of k)G.has(X)||(C.remove(U.mesh),k.delete(X));G.clear();for(let[X,U]of n.walls){if(U.hp<=0)continue;G.add(X);let B=U.type+U.mat+(U.open?"o":"c"),N=D.get(X);if(N&&N.sig!==B&&(C.remove(N.mesh),D.delete(X),N=null),!N){let q=St(X,U),J=(q[0]+q[2])/2,he=(q[1]+q[3])/2,Te=q[0]===q[2],be=new Qe,Oe=U.type==="door"?U.mat==="wood"?8016944:mc[U.mat]:mc[U.mat]||mc.wood;if(U.type==="door"&&U.open)for(let Ie of[-26,26]){let ke=new fe(le.box,ye(Ds[U.mat]||Ds.wood));ke.scale.set(Te?11:12,40,Te?12:11),ke.position.set(Te?0:Ie,20,Te?Ie:0),be.add(ke)}else{let Ie=new fe(le.box,ye(Oe)),ke=U.type==="door"?42:48;Ie.scale.set(Te?11:64,ke,Te?64:11),Ie.position.y=ke/2,be.add(Ie);let We=new fe(le.box,ye(Ds[U.mat]||Ds.wood));if(We.scale.set(Te?13:66,4,Te?66:13),We.position.y=ke+2,be.add(We),U.type==="door"){let Pe=new fe(le.sphere,ye(14202462));Pe.scale.set(2.5,2.5,2.5),Pe.position.set(Te?7:10,22,Te?10:7),be.add(Pe)}}be.position.set(J,0,he),C.add(be),D.set(X,{mesh:be,sig:B})}}for(let[X,U]of D)G.has(X)||(C.remove(U.mesh),D.delete(X));G.clear();for(let[X,U]of n.deploys){G.add(X);let B=U.type+(U.tier||"")+U.owner,N=L.get(X);if(N&&N.sig!==B&&(C.remove(N.group),L.delete(X),N=null),!N){let[q,J]=X.split(",").map(Number),he=q*64+64/2,Te=J*64+64/2,be=new Qe;be.position.set(he,0,Te);let Oe={group:be,sig:B};if(U.type==="turret"){let Ie=new fe(le.cyl6,ye(3883320));Ie.scale.set(17,10,17),Ie.position.y=5,be.add(Ie);let ke=new fe(le.cyl,ye(5659980));ke.scale.set(11,10,11),ke.position.y=16,be.add(ke);let We=U.tier===3?6277344:U.tier===2?14721594:10133928,Pe=new Qe;Pe.position.y=18;let yt=new fe(le.box,ye(2237994)),_t=U.tier===3?42:U.tier===2?32:24;yt.scale.set(_t,5,U.tier===2?9:5),yt.position.x=_t/2+6,Pe.add(yt);let un=new fe(le.box,ye(We,{emissive:We,emissiveIntensity:.5}));un.scale.set(4,6,6),un.position.x=_t+8,Pe.add(un),be.add(Pe),Oe.pivot=Pe}else if(U.type==="cupboard"){let Ie=new fe(le.box,ye(ie(U.owner)));Ie.scale.set(42,40,42),Ie.position.y=20,be.add(Ie);let ke=new fe(le.box,ye(2891532));ke.scale.set(46,5,46),ke.position.y=42,be.add(ke);let We=hs(7790698,26);We.position.y=50,be.add(We),Oe.led=We}else{let Ie=new fe(le.box,ye(7031332));Ie.scale.set(40,24,40),Ie.position.y=12,be.add(Ie)}C.add(be),L.set(X,Oe)}}for(let[X,U]of L)G.has(X)||(C.remove(U.group),L.delete(X))}}let de=new Qe;e.add(de);let Re=-1;function Ue(){if(n.fences.length!==Re){Re=n.fences.length,de.clear();for(let X of n.fences){let U=new fe(le.box,ye(8215600));U.scale.set(46,22,5),U.position.set(X.x,11,X.y),U.rotation.y=-X.a,de.add(U)}}}return{sync(X){m-=X,m<=0&&(m=.25,g()),n.barrels.forEach((B,N)=>{R[N].visible=B.hp>0}),oe(),Ue();for(let[B,N]of L){let q=n.deploys.get(B);if(q&&(N.pivot&&(N.pivot.rotation.y=-(q.angle||0)),N.led&&q.store)){let J=q.store.wood+q.store.stone+q.store.metal>0;N.led.material.color.setHex(J?7790698:16734780)}}if(y.quarryArm){let B=n.quarry;y.quarryArm.rotation.z=B&&B.owner?Math.sin(B.arm*2.4)*.35:-.18}for(let B of y.gates)B.pivot.rotation.z=(1-B.cr.gate)*1.35;let U=n.player;for(let B of y.fadeables){let N=U.x-B.x,q=U.y-B.y,he=!U.dead&&N*N+q*q<(B.r+90)*(B.r+90)?.3:1;for(let Te of B.mats)Te.opacity+=(he-Te.opacity)*Math.min(1,X*7)}}}}function NM(n,e){let{hash2:t}=UM,i=[],s=[],r=[],o=13824,a=9216;for(let u=120;u<a-120;u+=150)for(let p=120;p<o-120;p+=150){let x=t(p/150|0,u/150|0);if(x>.62)continue;let m=p+x*977%1*130,g=u+x*467%1*130;if(!n.world.onLand(m,g)||n.world.lakeAt(m,g)||n.world.pathDist(m,g)<40)continue;let _=n.world.biomeAt(m,g);_==="jungle"?i.push({x:m,y:g,h:x}):_==="desert"?x<.3&&s.push({x:m,y:g,h:x}):x<.4&&r.push({x:m,y:g,h:x})}let l=new ut,c=new $e,h=new Zt(le.cone,ye(16777215),i.length||1);i.forEach((u,p)=>{let x=5+u.h*8;l.makeRotationY(u.h*6).scale(new z(x,x*1.8,x)).setPosition(u.x,x*.9,u.y),h.setMatrixAt(p,l),c.setHex(4876846).multiplyScalar(.8+u.h*37%1*.5),h.setColorAt(p,c)});let f=new Zt(le.ico,ye(16777215),s.length||1);s.forEach((u,p)=>{let x=3+u.h*8;l.makeRotationY(u.h*9).scale(new z(x,x*.55,x)).setPosition(u.x,x*.3,u.y),f.setMatrixAt(p,l),c.setHex(10259040).multiplyScalar(.85+u.h*53%1*.3),f.setColorAt(p,c)});let d=new Zt(le.sphere,ye(15265781),r.length||1);r.forEach((u,p)=>{let x=6+u.h*12;l.makeScale(x,x*.4,x*.8).setPosition(u.x,x*.16,u.y),d.setMatrixAt(p,l)});for(let u of[h,f,d])u.frustumCulled=!1,u.instanceColor&&(u.instanceColor.needsUpdate=!0),e.add(u)}var UM={hash2(n,e){let t=n*374761393+e*668265263|0;return t=t^t>>13|0,t=Math.imul(t,1274126177),((t^t>>16)>>>0)/4294967296}};function kM(n,e,t,i){let s=new Qe;s.position.set(t.x,0,t.y);let r=(l,c,h,f,d,u,p,x,m=0,g)=>{let _=new fe(l,ye(c,g));return _.scale.set(h,f,d),_.position.set(u,p,x),_.rotation.y=m,s.add(_),_},o=[],a=(...l)=>{let c=r(...l),h=c.material.clone();return h.transparent=!0,c.material=h,o.push(h),c};if(t.type==="gas"){a(le.box,11027246,216,8,30,0,64,-70);for(let l of[-96,-30,36,96])r(le.box,4147024,6,60,6,l,30,-62);for(let l of[-58,0])r(le.box,5989227,18,30,16,l,15,-22);a(le.box,9081241,54,52,50,58,26,-16),r(le.box,12574959,18,14,2,66,34,10),r(le.box,13279562,26,26,6,-104,40,-62)}else if(t.type==="junk"){for(let l=0;l<5;l++){let c=l/5*DM;r(le.ico,7238780,26,14,20,Math.cos(c)*70,8,Math.sin(c)*54,c)}r(le.box,8011824,56,22,26,-58,11,-40,.3),r(le.box,3824234,56,22,26,54,11,44,-.5),r(le.cyl,2302237,12,16,12,70,8,-50),r(le.cyl,2302237,12,16,12,-66,8,58)}else if(t.type==="warehouse"){a(le.box,8291470,252,70,164,0,35,0),a(le.box,5988971,264,10,176,0,74,0);for(let l of[-72,0,72])a(le.box,2764597,60,46,4,l,23,84);a(le.box,4870488,30,14,16,-38,84,0),a(le.box,4870488,30,14,16,38,84,0)}else if(t.type==="quarry"){r(le.cyl,3814438,46,8,28,-36,4,26),r(le.box,3948871,12,64,12,8,32,-46);let l=new Qe;l.position.set(14,60,-44);let c=new fe(le.box,ye(8226963));c.scale.set(86,9,9),l.add(c);let h=new fe(le.sphere,ye(10768430));h.scale.set(9,9,9),h.position.x=-43,l.add(h),s.add(l),i.quarryArm=l,r(le.box,5061152,4,46,4,-44,23,-58),r(le.box,7236186,24,13,2,-32,40,-58)}o.length&&i.fadeables.push({x:t.x,y:t.y,r:t.r,mats:o}),e.add(s)}function FM(n,e){let t=n.world.shop,i=new Qe;i.position.set(t.x,0,t.y);let s=new fe(le.cyl,ye(6969398));s.scale.set(46,6,46),s.position.y=3,i.add(s);let r=new fe(le.box,ye(10120764));r.scale.set(60,24,22),r.position.set(0,16,2),i.add(r);let o=new fe(le.cone,ye(11751744));o.scale.set(52,26,52),o.position.y=56,i.add(o);for(let l of[-34,34]){let c=new fe(le.cyl,ye(6177574));c.scale.set(3,44,3),c.position.set(l,22,8),i.add(c)}let a=new fe(new mo(gt-7,gt,72),new tn({color:9885695,transparent:!0,opacity:.3,side:Rn,depthWrite:!1}));a.rotation.x=-Math.PI/2,a.position.y=1.2,i.add(a),e.add(i)}var vf=13081716;function Vt(n,e,t,i,s,r,o){let a=new fe(le.box,ye(n));return a.scale.set(e,t,i),a.position.set(s,r,o),a}function ln(n,e,t,i,s,r=1,o=1){let a=new fe(le.sphere,ye(n));return a.scale.set(e,e*r,e*o),a.position.set(t,i,s),a}var mm={pistol:n=>n.add(Vt(2303519,10,4,3.4,11,0,0)),rifle:n=>{n.add(Vt(2303519,20,3.6,3.4,15,0,0)),n.add(Vt(4864544,5,5,3.8,7,-1,0))},shotgun:n=>{n.add(Vt(2827808,16,4.6,4,13,0,0)),n.add(Vt(5980710,5,5.5,4.2,5,-1,0))},hmg:n=>{n.add(Vt(2303519,24,5,4.4,16,0,0)),n.add(Vt(3817271,6,7,4.8,10,-3,0))},tool:n=>{n.add(Vt(5980710,13,3,3,9,0,0)),n.add(Vt(12173511,4,8,3.4,16,1,0))},rocket:n=>{n.add(Vt(3751983,22,6.5,6,14,1,0)),n.add(Vt(16751421,3,7,6.4,25,1,0))},hammer:n=>{n.add(Vt(5980710,11,3,3,8,0,0)),n.add(Vt(10133928,4,7,4.4,14,1,0))}};function ym(n,e={}){let t=new Qe,i={};i.shadow=Ls(46),i.shadow.position.y=1,t.add(i.shadow);for(let c of["L","R"]){let h=new Qe;h.position.set(0,12,c==="L"?-3.2:3.2);let f=Vt(3289130,4.6,12,4.6,0,-6,0);h.add(f),t.add(h),i["leg"+c]=h}i.torso=Vt(n,10,14,12,0,24.5,0),t.add(i.torso),i.torsoShade=Vt(gm(n,.7),10.4,4.5,12.4,0,19,0),t.add(i.torsoShade),i.armor=Vt(9804963,11,10,13,.8,24.5,0),i.armor.visible=!1,t.add(i.armor),i.pack=Vt(4866100,4,9,8,-7,25,0),t.add(i.pack),i.armL=new Qe,i.armL.position.set(0,30,-7.4);let s=Vt(vf,3.6,11,3.6,0,-5,0);i.armL.add(s),t.add(i.armL),i.armR=new Qe,i.armR.position.set(2,29,7.4),i.armR.add(Vt(vf,9,3.6,3.6,4.5,0,-1.5)),i.gun=new Qe,i.armR.add(i.gun),t.add(i.armR),i.head=new Qe,i.head.position.y=38,i.head.add(ln(vf,5.6,0,0,0));let r=new fe(le.sphere,ye(e.hairCol??3811864));r.scale.set(5.9,4.4,5.9),r.position.y=2.2,i.head.add(r);let o=new fe(le.cyl,ye(n));o.scale.set(5.9,1.6,5.9),o.position.y=1.2,i.head.add(o),i.band=o,i.helmet=new Qe;let a=new fe(le.sphere,ye(10136504));a.scale.set(6.3,6.3,6.3),i.helmet.add(a);let l=Vt(1119516,3,3,9.5,4.6,-.5,0);return i.helmet.add(l),i.helmet.visible=!1,i.head.add(i.helmet),t.add(i.head),t.userData={parts:i,colHex:n,phase:Math.random()*7,setGun(c){t.userData.gunKind!==c&&(t.userData.gunKind=c,i.gun.clear(),(mm[c]||mm.pistol)(i.gun))},setArmor(c,h){i.armor.visible=c>0,c>0&&(i.armor.material=ye(c>=3?6126235:c===2?9804963:8746824)),i.helmet.visible=h>0,h>0&&(i.helmet.children[0].material=ye(h>=3?8163017:h===2?10136504:13482898))},setColor(c){t.userData.colHex!==c&&(t.userData.colHex=c,i.torso.material=ye(c),i.torsoShade.material=ye(gm(c,.7)),o.material=ye(c))},animate(c,h,f){let d=c*11+t.userData.phase,u=Math.sin(d)*.75*h;i.legL.rotation.z=u,i.legR.rotation.z=-u,i.armL.rotation.z=-u*.7,t.position.y=Math.abs(Math.sin(d))*1.4*h,f?i.armR.rotation.z=-.5+Math.sin(c*9)*.55:i.armR.rotation.z=0}},t.userData.setGun(e.gun||"pistol"),t}function gm(n,e){let t=Math.min(255,(n>>16&255)*e)|0,i=Math.min(255,(n>>8&255)*e)|0,s=Math.min(255,(n&255)*e)|0;return t<<16|i<<8|s}function xm(n,e,t,i,s,r){let o=[];for(let a of[-1,1])for(let l of[-1,1]){let c=new Qe;c.position.set(a*i,r,l*s);let h=new fe(le.cyl,ye(e));h.scale.set(t*.16,r,t*.16),h.position.y=-r/2,c.add(h),n.add(c),o.push({pivot:c,phase:a*l>0?0:Math.PI})}return o}function _m(n,e){let t=new Qe,i={legs:[],extra:null},s={boar:[8282692,5521451],wolf:[7698047,4605773],bear:[6375471,3812380],polarbear:[14542315,11451592],alligator:[5599286,3229980],snake:[11704890,7430430],scorpion:[8278566,4664850]}[n]||[8947848,5592405],[r,o]=s,a=Ls(e*3.2);if(a.position.y=.8,t.add(a),n==="snake"){i.segs=[];for(let c=0;c<6;c++){let h=ln(c%2?o:r,e*(.55-c*.05),-c*e*.5,e*.4,0);t.add(h),i.segs.push(h)}let l=ln(r,e*.62,e*.45,e*.45,0,.8,.9);t.add(l),i.head=l}else if(n==="scorpion"){t.add(ln(o,e*.85,0,e*.4,0,.5,.8)),t.add(ln(r,e*.62,e*.2,e*.55,0,.5,.75));for(let f of[-1,1])t.add(Vt(r,e*.8,e*.2,e*.18,e*.75,e*.35,f*e*.5)),t.add(ln(o,e*.26,e*1.2,e*.35,f*e*.62));i.tail=new Qe,i.tail.position.set(-e*.7,e*.5,0);let l=0,c=0;for(let f=0;f<3;f++)l-=e*.3,c+=e*.34,i.tail.add(ln(o,e*.2,l,c,0));let h=new fe(le.cone,ye(3810320));h.scale.set(e*.14,e*.3,e*.14),h.position.set(l+e*.16,c+e*.22,0),h.rotation.z=-1,i.tail.add(h),t.add(i.tail)}else if(n==="alligator"){let l=e*.55;t.add(ln(o,e,0,l,0,.5,.72)),t.add(ln(r,e*.82,0,l+e*.18,0,.42,.6)),t.add(ln(r,e*.5,e*1.15,l,0,.5,.62)),t.add(Vt(o,e*.9,e*.16,e*.5,e*1.25,l-e*.1,0)),t.add(ln(o,e*.62,-e*1.05,l,0,.45,.6)),t.add(ln(o,e*.4,-e*1.7,l*.9,0,.45,.55));for(let c=0;c<4;c++){let h=new fe(le.cone,ye(o));h.scale.set(e*.12,e*.25,e*.12),h.position.set(-e*.6+c*e*.42,l+e*.42,0),t.add(h)}i.legs=xm(t,o,e,e*.55,e*.5,l*.8)}else{let l=n==="bear"||n==="polarbear"?1.18:1,c=e*.78*l;t.add(ln(o,e*1.05*l,0,c,0,.78,.78)),t.add(ln(r,e*.92*l,0,c+e*.12,0,.72,.7)),l>1&&t.add(ln(r,e*.7,-e*.25,c+e*.55,0));let h=e*(n==="wolf"?.46:.55),f=new Qe;if(f.position.set(e*.95*l,c+e*.18,0),f.add(ln(r,h,0,0,0)),n==="wolf"){f.add(ln(o,h*.55,h*.8,-h*.15,0,.7,.6));for(let d of[-1,1]){let u=new fe(le.cone,ye(o));u.scale.set(h*.3,h*.6,h*.3),u.position.set(-h*.3,h*.85,d*h*.5),f.add(u)}}else if(n==="boar"){f.add(ln(o,h*.5,h*.85,-h*.2,0,.7,.8));for(let d of[-1,1]){let u=new fe(le.cone,ye(15261903));u.scale.set(h*.12,h*.4,h*.12),u.position.set(h*.9,-h*.25,d*h*.4),u.rotation.z=.7,f.add(u)}}else for(let d of[-1,1])f.add(ln(o,h*.28,-h*.2,h*.85,d*h*.6));t.add(f),i.head=f,i.legs=xm(t,o,e*l,e*.5*l,e*.42*l,c*.85)}return t.userData={...i,phase:Math.random()*7,animate(l,c){let h=l*9+t.userData.phase;for(let f of i.legs)f.pivot.rotation.z=Math.sin(h+f.phase)*.55*c;if(i.segs)for(let f=0;f<i.segs.length;f++)i.segs[f].position.z=Math.sin(l*7-f*.8)*e*.3*(.4+c);i.tail&&(i.tail.rotation.z=Math.sin(l*3)*.08),i.head&&!i.segs&&(i.head.rotation.z=Math.sin(l*2.2+t.userData.phase)*.06)}},t}var v2=Math.PI*2,OM={0:"tool",1:"pistol",2:"rifle",3:"hmg",4:"rocket",5:"hammer",6:"rifle",7:"shotgun",8:"hmg"},fs=class{constructor(e,t){this.scene=e,this.make=t,this.map=new Map,this.seen=new Set,this.miss=new Map}get(e,...t){this.seen.add(e);let i=this.map.get(e);return i||(i=this.make(...t),this.map.set(e,i),this.scene.add(i)),i.visible=!0,i}sweep(){for(let[e,t]of this.map)if(this.seen.has(e))this.miss.delete(e);else{t.visible=!1;let i=(this.miss.get(e)||0)+1;i>300?(this.scene.remove(t),this.map.delete(e),this.miss.delete(e)):this.miss.set(e,i)}this.seen.clear()}};function vm(n,e){let t=new fs(e,(T,S)=>ym(T,{gun:S})),i=new fs(e,(T,S)=>_m(T,S)),s=new fs(e,T=>{let S=new Qe,v=new fe(le.sphere,ye(T));v.scale.set(20,12,14),v.position.y=12,S.add(v);let M=new fe(le.box,ye(2896680));M.scale.set(26,5,5),M.position.set(-22,14,0),S.add(M);let R=new fe(le.box,r());R.scale.set(52,1.5,5),R.position.y=22,S.add(R);let y=Ls(60);return y.position.y=1,S.add(y),S.userData={rotor:R,sh:y},S});function r(){return ye(1645589)}let o=new fs(e,T=>{let S=new Qe,v=new fe(le.sphere,ye(T));v.scale.set(34,17,22),v.position.y=16,S.add(v);let M=new fe(le.box,ye(2501666));M.scale.set(40,7,7),M.position.set(-36,20,0),S.add(M);let R=new fe(le.box,r());R.scale.set(84,2,7),R.position.y=30,S.add(R);let y=Ls(96);return y.position.y=1,S.add(y),S.userData={rotor:R,sh:y},S}),a=new fs(e,T=>T()),l=new fs(e,(T,S)=>hs(T,S)),c=700,h=new Zt(le.quad,new tn({color:2366482,transparent:!0,opacity:.34,depthWrite:!1,side:Rn}),c);h.frustumCulled=!1,e.add(h);let f=new ut,d=new ut,u=new z,p=1200,x=new Yt,m=new Float32Array(p*3),g=new Float32Array(p*3);x.setAttribute("position",new Qt(m,3)),x.setAttribute("color",new Qt(g,3));let _=new es(x,new Ni({size:7,vertexColors:!0,transparent:!0,opacity:.9,sizeAttenuation:!0,depthWrite:!1}));_.frustumCulled=!1,e.add(_);let w=new Map;function E(T){let S=w.get(T);if(!S){S=new $e;try{if(T.startsWith("rgba")){let v=T.match(/rgba?\(([\d.]+),\s*([\d.]+),\s*([\d.]+)/);v&&S.setRGB(+v[1]/255,+v[2]/255,+v[3]/255)}else S.set(T)}catch{S.setRGB(.7,.7,.7)}w.set(T,S)}return S}function P(T,S,v,M,R,y={}){T.position.set(S,0,v),T.rotation.y=-M;let C=T.userData;C.setColor(R),y.gun&&C.setGun(y.gun),C.setArmor(y.bodyArmor||0,y.facemask||0),C.animate(n.t,y.moveAmt??0,!!y.gathering)}return{sync(T,S){for(let y of n.units){if(y.dead||y.eliminated)continue;if(y.copter&&!y.copter.destroyed&&S.inView(y.copter.x,y.copter.y,200)){let L=s.get(y.copter,parseInt(y.col.slice(1),16)),F=y.flying&&y.state==="trade";L.position.set(y.copter.x,F?70:0,y.copter.y),L.rotation.y=-(y.copter.angle||0),L.userData.rotor.rotation.y=y.copter.rotor||0,L.userData.sh.position.y=F?-68:1}if(y.flying||!S.inView(y.x,y.y,200))continue;let C=parseInt((y.ally?"#7ec850":y.col).slice(1),16),D=t.get(y,C,y.gun),k=Math.min(1,Math.hypot(y.vx,y.vy)/120);P(D,y.x,y.y,y.angle,C,{gun:y.gathering?"tool":y.gun,moveAmt:k,gathering:y.gathering,bodyArmor:y.bodyArmor,facemask:y.facemask})}let v=n.player;if(!v.inCopter){let y=t.get(v,8030800,"pistol"),C=v.moving?1:0;P(y,v.x,v.y,v.angle,v.hurt>0?12876382:8030800,{gun:OM[n.slot]||"pistol",moveAmt:C,gathering:v.swing>0&&n.slot===0,bodyArmor:v.bodyArmor,facemask:v.facemask}),v.dead&&(y.visible=!1)}if(n.copter&&!n.copter.destroyed){let y=s.get(n.copter,6121548),C=v.inCopter;y.position.set(n.copter.x,C?80:0,n.copter.y),y.rotation.y=-(n.copter.angle||0),y.userData.rotor.rotation.y=(n.copter.rotor||0)*3,y.userData.sh.position.y=C?-78:1}for(let y of n.guards){if(y.dead||!S.inView(y.x,y.y,150))continue;let C=t.get(y,12410412,"rifle"),D=Math.min(1,Math.hypot(y.vx||0,y.vy||0)/90+.2);P(C,y.x,y.y,y.angle,12410412,{gun:"rifle",moveAmt:D,facemask:1})}for(let y of n.animals){if(y.dead||!S.inView(y.x,y.y,150))continue;let C=i.get(y,y.type,y.r);C.position.set(y.x,0,y.y);let D=Math.hypot(y.vx||0,y.vy||0),k=D>2?Math.atan2(y.vy,y.vx):y.dir;C.rotation.y=-k,C.userData.animate(n.t,Math.min(1,D/80))}for(let y of n.transports){let C=y.owner===Ve?8308816:parseInt((n.teams.find(L=>L.owner===y.owner)||{col:"#888888"}).col.slice(1),16),D=o.get(y,C),k=y.state==="fly"||y.state==="return"||y.riders.length>0;D.position.set(y.x,k?110:4,y.y),D.rotation.y=-y.angle,D.userData.rotor.rotation.y=y.rotor,D.userData.sh.position.y=k?-106:1}for(let y of n.trains){let C=a.get(y,()=>{let D=new Qe,k=new fe(le.box,ye(3817544));k.scale.set(48,30,26),k.position.y=15,D.add(k);for(let F of[-46,-90]){let G=new fe(le.box,ye(5917238));G.scale.set(38,24,24),G.position.set(F,12,0),D.add(G)}let L=hs(16771491,40);return L.position.set(28,14,0),D.add(L),D});C.position.set(y.x,0,y.y),C.rotation.y=-y.ang}for(let y of n.convoys){if(y.dead)continue;let C=a.get(y,()=>{let D=new Qe,k=new fe(le.box,ye(5660746));k.scale.set(68,24,36),k.position.y=12,D.add(k);let L=new Qe;L.position.y=28;let F=new fe(le.cyl,ye(3752499));F.scale.set(12,9,12),L.add(F);let G=new fe(le.box,ye(1250830));G.scale.set(32,5,5),G.position.x=20,L.add(G),D.add(L),D.userData={turret:L};let ie=Ls(90);return ie.position.y=1,D.add(ie),D});C.position.set(y.x,0,y.y),C.rotation.y=-y.ang,C.userData.turret.rotation.y=-(y.taim-y.ang);for(let D of y.guards){if(D.dead)continue;let k=t.get(D,7305806,"rifle");P(k,D.x,D.y,D.angle,7305806,{gun:"rifle",moveAmt:.6,facemask:2})}}if(n.patrol){let y=n.patrol,C=a.get("patrol",()=>{let D=new Qe,k=new fe(le.sphere,ye(4740158));k.scale.set(32,15,18),D.add(k);let L=new fe(le.box,ye(3357744));L.scale.set(36,6,6),L.position.x=-34,D.add(L);let F=new fe(le.box,r());return F.scale.set(96,2,8),F.position.y=14,D.add(F),D.userData={rotor:F},D});C.position.set(y.x,150,y.y),C.rotation.y=-y.angle,C.userData.rotor.rotation.y=y.rotor}if(n.plane){let y=a.get("plane",()=>{let C=new Qe,D=new fe(le.sphere,ye(8291985));D.scale.set(28,8,8),C.add(D);let k=new fe(le.box,ye(7041660));return k.scale.set(10,2,52),C.add(k),C});y.position.set(n.plane.x,320,n.plane.y),y.rotation.y=n.plane.vx<0?Math.PI:0}if(n.airdrop){let y=n.airdrop,C=a.get("airdrop",()=>{let k=new Qe,L=new fe(le.box,ye(6120530));L.scale.set(30,24,30),L.position.y=12,k.add(L);let F=new fe(le.box,ye(16766827));F.scale.set(32,5,32),F.position.y=12,k.add(F);let G=new fe(le.cone,ye(12079162,{transparent:!0,opacity:.9}));return G.scale.set(34,26,34),G.position.y=56,k.add(G),k.userData={chute:G},k}),D=y.fall<1?(1-y.fall)*320:0;C.position.set(y.x+(y.fall<1?Math.sin(y.sway)*12:0),D,y.fall<1?y.gy:y.y),C.userData.chute.visible=y.fall<1}if(n.lockedCrate){let y=n.lockedCrate,C=a.get("crate",()=>{let k=new Qe,L=new fe(le.box,ye(3948871));L.scale.set(40,26,30),L.position.y=13,k.add(L);let F=hs(16758858,22);return F.position.set(13,26,-8),k.add(F),k.userData={light:F},k});C.position.set(y.x,0,y.y);let D=y.blink%.8<.4;C.userData.light.visible=D,C.userData.light.material.color.setHex(y.started?16758858:13777960)}for(let y of n.bullets){let C=a.get(y,()=>{let k=new Qe,L=new fe(le.box,new tn({color:16771491}));L.scale.set(34,3.6,3.6),k.add(L);let F=new fe(le.box,new tn({color:16771491,transparent:!0,opacity:.55,blending:Gn,depthWrite:!1}));return F.scale.set(40,8,8),k.add(F),k.userData={core:L,halo:F},k});C.position.set(y.x,18,y.y),C.rotation.y=-Math.atan2(y.vy,y.vx);let D=y.col==="hmg"?16734762:y.ricochet?8837375:16771491;C.userData.core.material.color.setHex(D),C.userData.halo.material.color.setHex(D)}for(let y of n.rockets){let C=a.get(y,()=>{let D=new Qe,k=new fe(le.cone,ye(3751983));k.scale.set(5,18,5),k.rotation.z=-Math.PI/2,D.add(k);let L=hs(16751421,34);return L.position.x=-12,D.add(L),D});C.position.set(y.x,18,y.y),C.rotation.y=-Math.atan2(y.vy,y.vx)}for(let y of n.grenades)a.get(y,()=>{let D=new fe(le.sphere,ye(2898466));return D.scale.set(6,6,6),D}).position.set(y.x,8+Math.abs(Math.sin(y.bob*6))*8,y.y);for(let y of n.satchels){let C=a.get(y,()=>{let D=new fe(le.box,ye(3814444));return D.scale.set(14,9,12),D.position.y=4,D});C.position.set(y.x,4,y.y),C.visible=Math.sin(n.t*18)>-.6}for(let y of n.loot){if(!S.inView(y.x,y.y,100))continue;let C=a.get(y,()=>{let k=new fe(le.box,ye(14081248));return k.scale.set(9,9,9),k}),D={wood:12158022,stone:11186616,metal:15245902,scrap:14081248,ammo:16769162,rocket:16751194,sniper:12575743,satchel:13154442,gun:12896701};C.material=ye(D[y.kind]||14081248),C.position.set(y.x,8+Math.sin(y.bob*3)*2.5,y.y),C.rotation.y=y.bob}for(let y of n.fires){let C=l.get(y,16747050,90);C.position.set(y.x,16,y.y);let D=.8+Math.sin(n.t*11+y.x)*.25;C.scale.set(90*D,110*D,1)}for(let y of n.wrecks)a.get(y,()=>{let D=new Qe,k=new fe(le.box,ye(2499614));k.scale.set(30,14,20),k.position.y=7,k.rotation.y=.5,D.add(k);let L=hs(16755260,60);return L.position.y=14,D.add(L),D}).position.set(y.x,0,y.y);for(let y of n.scorch){let C=a.get(y,()=>{let D=new fe(new ki(1,12),new tn({color:1314828,transparent:!0,opacity:.45,depthWrite:!1}));return D.rotation.x=-Math.PI/2,D.position.y=.8,D});C.position.set(y.x,.8,y.y),C.scale.set(y.r,y.r,1)}for(let y of n.flashes){let C=l.get(y,16757322,y.r*2.4);C.position.set(y.x,20,y.y);let D=y.life/y.max;C.material.opacity=D,C.scale.set(y.r*(2.6-D),y.r*(2.6-D),1)}if(n.muzzle){let y=l.get("muzzle",16766827,46);y.position.set(n.muzzle.x,18,n.muzzle.y),y.material.opacity=n.muzzle.t/.08}let M=0;for(let y of n.footprints){if(M>=c)break;let C=1-y.t/10;if(C<.06||!S.inView(y.x,y.y,60))continue;let D=6.2*(.45+.55*C);f.makeRotationY(-y.a),d.makeRotationX(-Math.PI/2),f.multiply(d),u.set(D,D*.55,1),f.scale(u),f.setPosition(y.x,.45+M%9*.025,y.y),h.setMatrixAt(M,f),M++}h.count=M,h.instanceMatrix.needsUpdate=!0;let R=0;for(let y of n.particles){if(R>=p)break;m[R*3]=y.x,m[R*3+1]=10+(1-y.life/y.max)*14,m[R*3+2]=y.y;let C=E(y.col),D=Math.max(0,y.life/y.max);g[R*3]=C.r*D,g[R*3+1]=C.g*D,g[R*3+2]=C.b*D,R++}x.setDrawRange(0,R),x.attributes.position.needsUpdate=!0,x.attributes.color.needsUpdate=!0,t.sweep(),i.sweep(),s.sweep(),o.sweep(),a.sweep(),l.sweep()}}}function Mm(n,e){let i=new Yt,s=new Float32Array(700*3),r=[];for(let m=0;m<700;m++)r.push({x:Math.random(),z:Math.random(),y:Math.random(),sp:.4+Math.random()*.8});i.setAttribute("position",new Qt(s,3));let o=new Ni({color:12374764,size:5,transparent:!0,opacity:0,depthWrite:!1}),a=new es(i,o);a.frustumCulled=!1,e.add(a);let l=[],c=()=>{if(!(l.length||!n.clouds))for(let m of n.clouds){let g=new Di({map:pc(),color:15660023,transparent:!0,opacity:.28*m.op,depthWrite:!1}),_=new ji(g);_.scale.set(m.r*3.2,m.r*1.8,1),e.add(_);let w=new fe(new ki(m.r*1.1,12),new tn({map:_f(),transparent:!0,opacity:.55*m.op,depthWrite:!1}));w.rotation.x=-Math.PI/2,e.add(w),l.push({cl:m,s:_,sh:w})}},h=[],f=()=>{if(!(h.length||!n.fogBanks))for(let m of n.fogBanks){let g=new Di({map:pc(),color:14081766,transparent:!0,opacity:0,depthWrite:!1}),_=new ji(g);_.scale.set(m.r*3,m.r*1.6,1),e.add(_),h.push({f:m,s:_})}},d=new Yt,u=new Float32Array(120);d.setAttribute("position",new Qt(u,3));let p=new Ni({color:14221190,size:9,transparent:!0,opacity:.9,blending:Gn,depthWrite:!1,sizeAttenuation:!0}),x=new es(d,p);return x.frustumCulled=!1,e.add(x),{sync(m,g){c(),f();let _=n.weather,w=(g.cx+n.world.biomeRidge(g.cy))/se.w,E=.085,P=vi((w-(2/3-E))/(2*E)),T=vi((w-(1/3-E))/(2*E))*(1-P),S=_.rain*(T+P);if(o.opacity=Math.min(.75,S*.8),o.color.setHex(P>T?16054524:12374764),o.size=P>T?7:4.5,S>.02){let R=P>T?.12:.55;for(let y=0;y<700;y++){let C=r[y],D=(C.y+n.t*C.sp*R)%1;s[y*3]=g.cx+(C.x-.5)*2*1700+n.wind*60*D,s[y*3+1]=700*(1-D),s[y*3+2]=g.cy+(C.z-.5)*2*1700}i.attributes.position.needsUpdate=!0}for(let{cl:M,s:R,sh:y}of l)R.position.set(M.x,1050,M.y),y.position.set(M.x+64,2.5,M.y+86);for(let{f:M,s:R}of h){let y=n.world.biomeAt(M.x,M.y)==="winter";R.material.opacity=y?0:Math.min(.5,_.fog*M.dens*.5),R.position.set(M.x,26,M.y)}let v=0;if(n.fireflies){let M=1-g.lightLevel();p.opacity=.35+.5*M+.3*Math.min(1,_.fog);for(let R of n.fireflies){if(v>=40)break;n.world.biomeAt(R.x,R.y)==="jungle"&&(u[v*3]=R.x,u[v*3+1]=16+Math.sin(R.ph)*8,u[v*3+2]=R.y,v++)}d.attributes.position.needsUpdate=!0}d.setDrawRange(0,v)}}}function bm(n,e,t){let i=document.createElement("canvas");i.id="overlay",i.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:5",document.body.appendChild(i);let s=i.getContext("2d");function r(){i.width=e.VW,i.height=e.VH}r(),addEventListener("resize",r);let o=(h,f,d=0)=>t.worldToScreen(h,f,d);function a(h,f,d,u,p){s.strokeStyle=u,s.lineWidth=2,p&&s.setLineDash(p),s.beginPath();for(let x=0;x<=36;x++){let m=x/36*Math.PI*2,g=o(h+Math.cos(m)*d,f+Math.sin(m)*d);x?s.lineTo(g.x,g.y):s.moveTo(g.x,g.y)}s.stroke(),s.setLineDash([])}return{draw(){let h=e.VW,f=e.VH;s.clearRect(0,0,h,f);let d=n.t;s.font="bold 13px Trebuchet MS",s.textAlign="center";for(let u of e.godView?[]:n.floats){let p=o(u.ox,u.y,40);if(p.behind)continue;let x=Math.max(0,u.life/u.max);s.globalAlpha=x,s.fillStyle="#000",s.fillText(u.text,p.x+1,p.y-u.lift+1),s.fillStyle=u.col,s.fillText(u.text,p.x,p.y-u.lift)}if(s.globalAlpha=1,n.buildMode&&!e.godView){let m=function(){for(let g in x.cost)if((n.inv[g]||0)<x.cost[g])return!1;return!0},u=kr(n,n.cmd.mx,n.cmd.my),p=Sc(n,Ve,n.buildPiece,u)&&m();s.fillStyle=p?"rgba(180,220,120,.4)":"rgba(210,80,60,.45)",s.strokeStyle=p?"#c4d66a":"#d2553c",s.lineWidth=2;let x=qt[n.buildPiece];if(x.cat==="cell"){let g=u.gx*64,_=u.gy*64;s.beginPath(),[[0,0],[64,0],[64,64],[0,64]].forEach(([w,E],P)=>{let T=o(g+w,_+E);P?s.lineTo(T.x,T.y):s.moveTo(T.x,T.y)}),s.closePath(),s.fill(),s.stroke()}else{let g=St(u.key,{type:n.buildPiece,rot:n.buildRot&1}),_=o(g[0],g[1]),w=o(g[2],g[3]);s.lineWidth=8,s.globalAlpha=.75,s.beginPath(),s.moveTo(_.x,_.y),s.lineTo(w.x,w.y),s.stroke(),s.globalAlpha=1}}if(!e.godView&&!n.player.inCopter){for(let[u,p]of n.deploys){if(p.type!=="cupboard"||p.owner!==Ve)continue;let[x,m]=u.split(",").map(Number);a(x*64+32,m*64+32,Nt,"rgba(126,200,80,0.3)",[10,8])}if(!n.shopOpen&&!n.storeOpen){let u=Math.floor(n.cmd.mx/64),p=Math.floor(n.cmd.my/64),x=n.deploys.get(u+","+p);x&&x.type==="turret"&&a(u*64+32,p*64+32,Bo[x.tier||1].range,"rgba(240,156,72,0.3)",[6,7]);let m=l(u,p);if(m){let g=o(m.x,m.y,50),_=Math.max(0,m.hp/m.max);s.fillStyle="rgba(0,0,0,.7)",s.fillRect(g.x-18,g.y-8,36,5),s.fillStyle=_>.5?"#7bbf4f":_>.25?"#d8b24a":"#c0432f",s.fillRect(g.x-18,g.y-8,36*_,5)}}}if(e.debugPaths){s.font="bold 10px Trebuchet MS";for(let u of n.units){if(u.dead||u.eliminated||u.flying||!t.inView(u.x,u.y,600))continue;let p=u.ally?"#7ec850":u.col;if(u.path&&u.pathI<u.path.length){s.strokeStyle=p,s.lineWidth=1.5,s.globalAlpha=.8,s.beginPath();let m=o(u.x,u.y);s.moveTo(m.x,m.y);for(let g=u.pathI;g<u.path.length;g++)m=o(u.path[g].x,u.path[g].y),s.lineTo(m.x,m.y);s.stroke(),s.globalAlpha=1}let x=o(u.x,u.y,56);s.fillStyle="#000",s.fillText(u.act||u.state,x.x+1,x.y+1),s.fillStyle=p,s.fillText(u.act||u.state,x.x,x.y)}}if(c(n.airdrop&&{x:n.airdrop.x,y:n.airdrop.fall<1?n.airdrop.gy:n.airdrop.y},"AIRDROP","#ffd76b","\u2708"),n.quarry){let u=n.teams.find(p=>p.owner===n.quarry.owner);c(n.quarry,"QUARRY",n.quarry.owner===Ve?"#7ec850":u?u.col:"#b9b39d","Q")}if(n.lockedCrate){let u=n.lockedCrate;c(u,u.started?"CRATE "+Math.ceil(u.t)+"s":"LOCKED CRATE","#ffb84a","C")}if(e.godView){s.font="bold 9px Trebuchet MS";for(let p of n.teams)for(let x of p.bases){if(x.dead)continue;let m=o(x.hx,x.hy);s.fillStyle=p.col,s.fillRect(m.x-6,m.y-6,12,12),s.fillStyle="#fff",s.fillText(String(p.id+1),m.x,m.y+3.5)}for(let p of n.units){if(p.dead||p.eliminated)continue;let x=o(p.x,p.y);s.fillStyle=p.ally?"#7ec850":p.col,s.beginPath(),s.arc(x.x,x.y,p.primary?3.4:2.4,0,7),s.fill()}for(let p of n.raids){let x=o(p.x,p.y);s.fillStyle=`rgba(255,82,56,${.35+.4*(p.t/60)})`,s.beginPath(),s.arc(x.x,x.y,7+3*Math.sin(d*6),0,7),s.fill()}if(n.deathMark){let p=o(n.deathMark.x,n.deathMark.y);s.fillStyle="#000",s.beginPath(),s.arc(p.x,p.y,8,0,7),s.fill(),s.fillStyle="#fff",s.beginPath(),s.arc(p.x,p.y-1,5,0,7),s.fill()}let u=o(n.player.x,n.player.y);s.strokeStyle="#7ec850",s.lineWidth=2.5,s.beginPath(),s.arc(u.x,u.y,11+3*Math.sin(d*6),0,7),s.stroke(),s.font="bold 11px Trebuchet MS",s.fillStyle="#7ec850",s.fillText("YOU",u.x,u.y-18),s.fillStyle="#d8d0ba",s.font="bold 14px Trebuchet MS",s.fillText("Click anywhere on the map to travel there",h/2,f-66)}else{let u=e.mouseSX,p=e.mouseSY;if(u!==void 0){s.strokeStyle="rgba(225,235,195,.9)",s.lineWidth=3,s.lineCap="round";for(let[x,m]of[[1,0],[-1,0],[0,1],[0,-1]])s.beginPath(),s.moveTo(u+x*6,p+m*6),s.lineTo(u+x*15,p+m*15),s.stroke()}}if(n.raidAlarm){let u=Math.min(1,n.raidAlarm.t/1.5);s.fillStyle=`rgba(180,30,20,${.14*u})`,s.fillRect(0,0,h,f),s.textAlign="center",s.font="bold 22px Trebuchet MS",s.fillStyle="rgba(0,0,0,.7)",s.fillText("BASE UNDER ATTACK",h/2+2,54),s.fillStyle=`rgba(255,${80+110*(.5+.5*Math.sin(d*8))},55,${u})`,s.fillText("BASE UNDER ATTACK",h/2,52)}n.player.hurt>0&&(s.fillStyle=`rgba(150,28,18,${n.player.hurt*.4})`,s.fillRect(0,0,h,f)),n.player.dead&&(s.fillStyle="rgba(10,6,4,.55)",s.fillRect(0,0,h,f),s.textAlign="center",s.fillStyle="#e6d9b8",s.font="bold 44px Trebuchet MS",s.fillText("YOU DIED",h/2,f/2-4),s.fillStyle="#b9a06f",s.font="15px Trebuchet MS",s.fillText("respawning\u2026",h/2,f/2+24)),s.textAlign="left",s.font="bold 14px Trebuchet MS",n.elims.forEach((u,p)=>{let x=Math.min(1,u.t/3);s.globalAlpha=x,s.fillStyle="rgba(0,0,0,.5)",s.fillRect(h/2-130,92+p*24,264,20),s.fillStyle="#e2664a",s.fillText(u.text,h/2-122,106+p*24)}),s.globalAlpha=1,s.textAlign="center"}};function l(h,f){let d=n.deploys.get(h+","+f);if(d)return{x:h*64+32,y:f*64+32,hp:d.hp,max:d.max};let u=n.structures.get(h+","+f);if(u)return{x:h*64+32,y:f*64+32,hp:u.hp,max:u.max};for(let p of["V,"+h+","+f,"V,"+(h+1)+","+f,"H,"+h+","+f,"H,"+h+","+(f+1)]){let x=n.walls.get(p);if(!x)continue;let m=St(p,x),g=(m[0]+m[2])/2,_=(m[1]+m[3])/2;if(Math.hypot(n.cmd.mx-g,n.cmd.my-_)<16)return{x:g,y:_,hp:x.hp,max:x.max}}return null}function c(h,f,d,u){if(!h)return;let p=o(h.x,h.y),x=e.VW,m=e.VH;if(s.textAlign="center",!p.behind&&p.x>0&&p.x<x&&p.y>0&&p.y<m){if(e.godView)return;s.font="bold 11px Trebuchet MS",s.fillStyle="rgba(0,0,0,.7)",s.fillText(f,p.x+1,p.y-49),s.fillStyle=d,s.fillText(f,p.x,p.y-50)}else{let g=Math.max(54,Math.min(x-54,p.x)),_=Math.max(54,Math.min(m-54,p.behind?m-54:p.y));s.fillStyle=d,s.globalAlpha=.92,s.beginPath(),s.arc(g,_,14,0,7),s.fill(),s.globalAlpha=1,s.fillStyle="#1c1812",s.font="bold 13px Trebuchet MS",s.fillText(u,g,_+4.5)}}}function Tm(n,e,t,i){let s={},r=e.canvas,o=(l,c)=>{let h=t.screenToWorld(l,c);n.cmd.mx=h.x,n.cmd.my=h.y,e.mouseSX=l,e.mouseSY=c};addEventListener("keydown",l=>{let c=l.key.toLowerCase();if(n.storeOpen){(c==="escape"||c==="e")&&(n.storeOpen=null,i.closeModals()),l.preventDefault();return}if(n.shopOpen){(c==="escape"||c==="e")&&(n.shopOpen=!1,i.closeModals()),l.preventDefault();return}s[c]=!0,a(),c==="e"&&Od(n),c==="g"&&!n.player.inCopter&&Gd(n),c==="q"&&(n.buildMode?wm(n,1):n.player.inCopter||Vd(n)),c==="t"&&!n.buildMode&&!n.player.inCopter&&Bc(n,n.cmd.mx,n.cmd.my),/^Digit[1-9]$|^Numpad[1-9]$/.test(l.code)&&!n.player.inCopter&&Ur(n,+l.code.slice(-1)-1),c==="b"&&!n.player.inCopter&&Ur(n,n.buildMode?0:5),c==="r"&&(n.buildMode?n.buildRot=(n.buildRot+1)%4:Hc(n)),c==="u"&&Hd(n),["w","a","s","d"," "].includes(c)&&l.preventDefault()}),addEventListener("keyup",l=>{s[l.key.toLowerCase()]=!1,a()}),addEventListener("blur",()=>{for(let l in s)s[l]=!1;a(),n.cmd.fireHeld=!1});function a(){n.cmd.up=!!s.w,n.cmd.down=!!s.s,n.cmd.left=!!s.a,n.cmd.right=!!s.d,n.cmd.run=!!s.shift}addEventListener("wheel",l=>{n.buildMode&&!n.shopOpen&&!n.storeOpen&&(wm(n,l.deltaY>0?1:-1),l.preventDefault())},{passive:!1}),r.addEventListener("mousemove",l=>{let c=r.getBoundingClientRect();o(l.clientX-c.left,l.clientY-c.top)}),r.addEventListener("mousedown",l=>{let c=r.getBoundingClientRect();if(o(l.clientX-c.left,l.clientY-c.top),l.button===0){if(e.godView){BM(n,e);return}if(n.cmd.fireHeld=!0,n.buildMode)Bd(n);else if(!n.shopOpen&&!n.storeOpen){let h=n.slot;ea(n)}}else l.button===2&&n.buildMode&&zd(n)}),addEventListener("mouseup",()=>{n.cmd.fireHeld=!1}),r.addEventListener("contextmenu",l=>l.preventDefault()),setInterval(()=>{e.mouseSX!==void 0&&o(e.mouseSX,e.mouseSY)},50)}function wm(n,e){let t=us.indexOf(n.buildPiece);n.buildPiece=us[(t+e+us.length)%us.length]}function BM(n,e){let t=n.cmd.mx,i=n.cmd.my;t=nt(t,Xt,13824-Xt),i=nt(i,Xt,9216-Xt);for(let s=0;s<24&&Mt(n,t,i,Xt);s++)t+=(Math.random()*2-1)*40,i+=(Math.random()*2-1)*40;n.player.x=t,n.player.y=i,n.player.inCopter=!1,e.godView=!1,document.getElementById("mapbtn").classList.remove("on"),document.getElementById("mapbtn").textContent="Map View",n.tip={text:"arrived",t:1.2}}var zM={tool:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 20l7-7"/><path d="M14 4l6 6-5 5-6-6z" fill="currentColor"/></svg>',pistol:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 8h16v4h-6l-1 5h-4l1-5H6a3 3 0 0 1-3-3z"/></svg>',rifle:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M1 11h18l4-2v3l-4 1h-5l-1 5h-3l1-5H1z"/></svg>',minigun:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="2" y="7" width="14" height="3"/><rect x="2" y="11" width="14" height="3"/><rect x="2" y="15" width="14" height="3"/><rect x="15" y="6" width="6" height="13" rx="2"/></svg>',rocket:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2 10h13l5 2-5 2H2z"/><path d="M20 8l3 4-3 4z"/></svg>',build:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21l4-12 6 6-10 6z" fill="currentColor"/><path d="M13 5l6 6"/></svg>',sniper:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="1" y="10" width="20" height="3"/><rect x="6" y="6" width="6" height="3" rx="1"/><path d="M21 9l2 2-2 2z"/></svg>',shotgun:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M1 10h17v5H8l-2 4H3l2-4H1z"/></svg>',hmg:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="1" y="9" width="19" height="5"/><rect x="6" y="14" width="6" height="6"/><path d="M20 9l3 2.5-3 2.5z"/></svg>'},HM=[["Tool","tool"],["Pistol","pistol"],["Rifle","rifle"],["Minigun","minigun"],["Rocket","rocket"],["Build","build"],["Sniper","sniper"],["Shotgun","shotgun"],["HMG","hmg"]],VM={1:"pistol",2:"rifle",3:"minigun",4:"rocket",6:"sniper",7:"shotgun",8:"hmg"},GM={floor:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="4" width="16" height="16" rx="2"/></svg>',wall:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="10" y="3" width="4" height="18" rx="1"/></svg>',door:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="9" y="3" width="6" height="18" rx="1"/><circle cx="13" cy="12" r="1.4" fill="#15130e"/></svg>',turret:'<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="13" r="6"/><rect x="12" y="11" width="10" height="4" rx="1"/></svg>',cupboard:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="5" y="3" width="14" height="18" rx="2"/><rect x="11.4" y="5" width="1.2" height="14" fill="#15130e"/></svg>'};function Em(n,e){let t=p=>document.getElementById(p),i=t("hotbar");HM.forEach(([p,x],m)=>{let g=document.createElement("div");g.className="slot",g.innerHTML=`<span class="key">${m+1}</span>${zM[x]}<span class="nm">${p}</span>`,g.addEventListener("mousedown",_=>{_.stopPropagation(),Ur(n,m)}),i.appendChild(g)});let s=t("bpieces");for(let p of us){let x=document.createElement("div");x.className="bpiece",x.dataset.piece=p;let m=Object.entries(qt[p].cost).map(([g,_])=>_+" "+g).join(" + ");x.innerHTML=`${GM[p]}${qt[p].name}<br><span style="opacity:.7">${m}</span>`,x.addEventListener("mousedown",g=>{g.stopPropagation(),n.buildPiece=p}),s.appendChild(x)}let r=(p,x)=>t(p).addEventListener("mousedown",m=>{m.stopPropagation(),x(t(p))});r("mapbtn",p=>{e.godView=!e.godView,p.classList.toggle("on",e.godView),p.textContent=e.godView?"Exit Map":"Map View"}),r("ghostbtn",p=>{n.ghost=!n.ghost,p.classList.toggle("on",n.ghost),p.textContent=n.ghost?"Ghost: ON":"Ghost"}),r("rocketbtn",p=>{n.rapidRockets=!n.rapidRockets,p.classList.toggle("on",n.rapidRockets),p.textContent=n.rapidRockets?"Rockets: ON":"Rapid Rockets"}),r("refillbtn",()=>window.__refillAll()),r("boosthardbtn",()=>window.__boostHard()),r("debugbtn",p=>{e.debugPaths=!e.debugPaths,p.classList.toggle("on",e.debugPaths),p.textContent=e.debugPaths?"Debug: ON":"Debug paths"}),t("ghostbtn").classList.add("on"),t("ghostbtn").textContent="Ghost: ON",t("helpToggle").addEventListener("click",()=>{let p=t("help");p.classList.toggle("min"),t("helpToggle").textContent=p.classList.contains("min")?"show":"hide"}),document.querySelectorAll(".spdbtn").forEach(p=>{p.addEventListener("mousedown",x=>{x.stopPropagation(),e.speed=+p.dataset.spd,document.querySelectorAll(".spdbtn").forEach(m=>m.classList.toggle("on",m===p))})});let o=0,a=null,l=!1;function c(){let p=t("shop"),x='<h3>Trade Shop</h3><div style="margin-bottom:8px">Scrap: <b id="shop-scrap">0</b></div><div class="cols"><div class="col"><h5>SELL \u2192 SCRAP</h5>';kt.trades.forEach(([m,g,_],w)=>{x+=`<div class="trow"><span>${g} ${m} \u2192 ${_} scrap</span><button data-trade="${w}">Sell</button></div>`}),x+='</div><div class="col"><h5>BUY WEAPONS + GEAR</h5>';for(let m in kt.buys)x+=`<div class="trow"><span id="shopown-${m}">${sn[m].name} <small>+${kt.buys[m].ammo} ammo</small></span><button data-buy="${m}">${kt.buys[m].cost} scrap</button></div>`;x+=`<div class="trow"><span>Jackhammer <small>3\xD7 gather</small></span><button data-misc="jackhammer">${kt.jackhammer} scrap</button></div>`,x+=`<div class="trow"><span>Rifle laser sight</span><button data-misc="laser">${kt.laser} scrap</button></div>`,x+=`<div class="trow"><span>Wood fence (G)</span><button data-misc="fence">${kt.fenceWood} wood</button></div>`,x+=`<div class="trow"><span>Grenade (Q)</span><button data-misc="grenade">${kt.grenade} scrap</button></div>`,x+=`<div class="trow"><span>Supply signal (T)</span><button data-misc="signal">${kt.signal} scrap</button></div>`,x+=`<div class="trow"><span>+10 HQM</span><button data-misc="hqm">${kt.hqm.cost} scrap</button></div>`,x+='<div class="trow"><span id="fm-lbl">Facemask</span><button data-misc="facemask">buy</button></div>',x+='<div class="trow"><span id="ba-lbl">Body armor</span><button data-misc="bodyArmor">buy</button></div>',x+=`<div class="trow"><span>Hire worker</span><button data-misc="worker">${kt.worker} scrap</button></div>`,x+='</div></div><button class="close">Close (E / Esc)</button>',p.innerHTML=x,p.querySelectorAll("button").forEach(m=>{m.addEventListener("mousedown",g=>g.stopPropagation()),m.addEventListener("click",()=>{m.dataset.trade!==void 0?Wd(n,+m.dataset.trade):m.dataset.buy?Xd(n,m.dataset.buy):m.dataset.misc?qd(n,m.dataset.misc):(n.shopOpen=!1,p.classList.add("hidden")),h()})}),h()}function h(){let p=t("shop-scrap");p&&(p.textContent=n.inv.scrap|0);let x=t("fm-lbl");if(x){let g=n.player.facemask+1;x.textContent=g<=3?`Facemask L${g} (${ps.cost[g]} scrap)`:"Facemask MAX"}let m=t("ba-lbl");if(m){let g=n.player.bodyArmor+1;m.textContent=g<=3?`Body armor L${g} (${ps.cost[g]} scrap)`:"Body armor MAX"}for(let g in kt.buys){let _=t("shopown-"+g);_&&(_.style.color=n.owned[g]?"var(--accent2)":"var(--ink)")}}function f(p){let x=t("store"),m=n.deploys.get(p);if(!m)return;let g=`<h3>${m.type==="cupboard"?"Tool Cupboard":"Storage"}</h3>`;for(let _ of["wood","stone","metal","scrap"])g+=`<div class="strow"><span class="ic ${_}"></span>
        <button data-mv="${_},-9999">\u25C0 all</button><button data-mv="${_},-0.1">\u25C0 10%</button>
        <span class="cnt"><b id="st-${_}">0</b> store \xB7 bag <b id="inv-${_}">0</b></span>
        <button data-mv="${_},0.1">10% \u25B6</button><button data-mv="${_},9999">all \u25B6</button>
        <span></span></div>`;g+='<button class="close">Close (E / Esc)</button>',x.innerHTML=g,x.querySelectorAll("button").forEach(_=>{_.addEventListener("mousedown",w=>w.stopPropagation()),_.addEventListener("click",()=>{if(_.dataset.mv){let[w,E]=_.dataset.mv.split(",");Yd(n,w,+E),d()}else n.storeOpen=null,x.classList.add("hidden")})}),d()}function d(){let p=n.deploys.get(n.storeOpen);if(!(!p||!p.store))for(let x of["wood","stone","metal","scrap"]){let m=t("st-"+x),g=t("inv-"+x);m&&(m.textContent=p.store[x]|0),g&&(g.textContent=n.inv[x]|0)}}return{closeModals(){t("store").classList.add("hidden"),t("shop").classList.add("hidden")},update(){t("r-wood").textContent=n.inv.wood|0,t("r-stone").textContent=n.inv.stone|0,t("r-metal").textContent=n.inv.metal|0,t("r-scrap").textContent=n.inv.scrap|0;let p=Math.floor(n.t/60),x=Math.floor(n.t%60);t("playtime").textContent=p+":"+String(x).padStart(2,"0");let m=n.player,g=Math.max(0,m.health/m.maxhp),_=t("hpfill");_.style.width=g*100+"%",_.style.background=g>.5?"linear-gradient(180deg,#9ccb5a,#6fae3e)":g>.25?"linear-gradient(180deg,#e0c14e,#c9962f)":"linear-gradient(180deg,#d76a4a,#b23b2a)",t("hptxt").textContent=Math.ceil(Math.max(0,m.health));let w=i.children;for(let T=0;T<w.length;T++){w[T].classList.toggle("sel",n.slot===T);let S=VM[T];w[T].classList.toggle("dim",!!S&&!n.owned[S])}if(t("buildmenu").classList.toggle("hidden",!n.buildMode),n.buildMode)for(let T of s.children){T.classList.toggle("sel",T.dataset.piece===n.buildPiece);let S=!0;for(let v in qt[T.dataset.piece].cost)(n.inv[v]||0)<qt[T.dataset.piece].cost[v]&&(S=!1);T.classList.toggle("cant",!S)}let E=Nr(n);if(t("ammo").classList.toggle("hidden",!E),E){let T=n.weapons[E];t("ammo-mag").innerHTML=`${T.ammo} <small>/ ${T.reserve}</small>`;let S=E==="minigun"&&T.spin>0&&T.spin<sn.minigun.windup;t("ammo-rl").textContent=T.reloading>0?"RELOADING":S?"SPINNING\u2026":T.ammo===0?"PRESS R":""}let P=t("tip");n.tip?(P.textContent=n.tip.text,P.classList.add("show")):P.classList.remove("show"),n.shopOpen!==l?(l=n.shopOpen,t("shop").classList.toggle("hidden",!n.shopOpen),n.shopOpen&&c()):n.shopOpen&&n.tick%30===0&&h(),n.storeOpen!==a?(a=n.storeOpen,t("store").classList.toggle("hidden",!n.storeOpen),n.storeOpen&&f(n.storeOpen)):n.storeOpen&&n.tick%30===0&&d(),n.t-o>.4&&(o=n.t,u())}};function u(){let p=[];p.push({id:Ve,name:"You",col:"#c4d66a",alive:!n.player.dead,you:!0,kills:n.playerKills,scrap:n.inv.scrap|0,res:n.inv.wood+n.inv.stone+n.inv.metal|0,tier:""});for(let _ of n.teams){let w=0,E=0,P=0,T=!1;for(let v of n.units)v.owner===_.owner&&(w+=v.kills,E+=v.scrap,P+=v.inv.wood+v.inv.stone+v.inv.metal,v.eliminated||(T=!0));let S=_.bases.find(v=>!v.dead);if(S){let v=n.deploys.get(S.tcKey);v&&v.store&&(P+=v.store.wood+v.store.stone+v.store.metal,E+=v.store.scrap)}p.push({id:_.id,name:"Base "+(_.id+1),col:_.col,alive:T&&!_.eliminated,kills:w,scrap:E|0,res:P|0,tier:_.hard?"HARD":_.weak?"EASY":""})}let x=null,m=0;for(let _ of p)!_.you&&_.alive&&_.kills>m&&(m=_.kills,x=_.id);p.sort((_,w)=>w.scrap-_.scrap||w.kills-_.kills||w.res-_.res);let g=_=>_>=1e4?(_/1e3|0)+"k":_>=1e3?(_/1e3).toFixed(1)+"k":_;t("lb-rows").innerHTML=p.map(_=>`
      <div class="lbr ${_.alive?"":"dead"} ${_.id===x?"lb-bounty":""}">
        <span class="dot" style="background:${_.col}"></span>
        <span class="nm">${_.id===x?"\u2605 ":""}${_.name}</span>
        ${_.tier?`<span class="pill ${_.tier.toLowerCase()}">${_.tier}</span>`:""}
        <span>${_.kills}</span><span style="color:var(--ink-dim)">${g(_.scrap)}</span><span style="color:var(--ink-dim)">${g(_.res)}</span>
